...
export function getOrganizationInfo(args: GetOrganizationInfoArgs, opts?: pulumi.InvokeOptions): Promise<GetOrganizationInfoResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:certificateservice/getOrganizationInfo:getOrganizationInfo", {
        "id": args.id,
    }, opts);
}
...
export function getOrganizationInfoOutput(args: GetOrganizationInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrganizationInfoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:certificateservice/getOrganizationInfo:getOrganizationInfo", {
        "id": args.id,
    }, opts);
}
