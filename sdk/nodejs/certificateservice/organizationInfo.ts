 ...
 *
 * const example = new bytepluscc.certificateservice.OrganizationInfo("example", {
 *     type: "Individual",
...
export class OrganizationInfo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:certificateservice/organizationInfo:OrganizationInfo';
