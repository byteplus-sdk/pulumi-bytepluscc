...
export function getChildCertInstance(args: GetChildCertInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetChildCertInstanceResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:certificateservice/getChildCertInstance:getChildCertInstance", {
        "id": args.id,
    }, opts);
}
...
export function getChildCertInstanceOutput(args: GetChildCertInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetChildCertInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:certificateservice/getChildCertInstance:getChildCertInstance", {
        "id": args.id,
    }, opts);
}
