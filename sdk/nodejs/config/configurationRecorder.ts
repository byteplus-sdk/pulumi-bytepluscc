 ...
 *
 * const example = new bytepluscc.config.ConfigurationRecorder("example", {
...
export class ConfigurationRecorder extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:config/configurationRecorder:ConfigurationRecorder';
