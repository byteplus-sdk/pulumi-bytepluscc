...
export function getKeyMaterial(args: GetKeyMaterialArgs, opts?: pulumi.InvokeOptions): Promise<GetKeyMaterialResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:kms/getKeyMaterial:getKeyMaterial", {
        "id": args.id,
    }, opts);
}
...
export function getKeyMaterialOutput(args: GetKeyMaterialOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKeyMaterialResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:kms/getKeyMaterial:getKeyMaterial", {
        "id": args.id,
    }, opts);
}
