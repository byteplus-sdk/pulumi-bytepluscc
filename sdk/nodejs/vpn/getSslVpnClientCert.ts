...
export function getSslVpnClientCert(args: GetSslVpnClientCertArgs, opts?: pulumi.InvokeOptions): Promise<GetSslVpnClientCertResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert", {
        "id": args.id,
    }, opts);
}
...
export function getSslVpnClientCertOutput(args: GetSslVpnClientCertOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSslVpnClientCertResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert", {
        "id": args.id,
    }, opts);
}
