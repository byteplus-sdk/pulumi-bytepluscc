 ...
 *
 * const vpnVpnConnectionDemo = new bytepluscc.vpn.VpnConnection("VpnVpnConnectionDemo", {
...
export class VpnConnection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:vpn/vpnConnection:VpnConnection';
