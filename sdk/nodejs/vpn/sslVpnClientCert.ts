 ...
 *
 * const vPNSslVpnClientCertDemo = new bytepluscc.vpn.SslVpnClientCert("VPNSslVpnClientCertDemo", {
...
export class SslVpnClientCert extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert';
