...
export function getSslVpnServer(args: GetSslVpnServerArgs, opts?: pulumi.InvokeOptions): Promise<GetSslVpnServerResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpn/getSslVpnServer:getSslVpnServer", {
        "id": args.id,
    }, opts);
}
...
export function getSslVpnServerOutput(args: GetSslVpnServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSslVpnServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpn/getSslVpnServer:getSslVpnServer", {
        "id": args.id,
    }, opts);
}
