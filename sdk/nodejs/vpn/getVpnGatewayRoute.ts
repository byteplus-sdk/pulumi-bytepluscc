...
export function getVpnGatewayRoute(args: GetVpnGatewayRouteArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnGatewayRouteResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpn/getVpnGatewayRoute:getVpnGatewayRoute", {
        "id": args.id,
    }, opts);
}
...
export function getVpnGatewayRouteOutput(args: GetVpnGatewayRouteOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpnGatewayRouteResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpn/getVpnGatewayRoute:getVpnGatewayRoute", {
        "id": args.id,
    }, opts);
}
