...
export function getDefaultNodePool(args: GetDefaultNodePoolArgs, opts?: pulumi.InvokeOptions): Promise<GetDefaultNodePoolResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vke/getDefaultNodePool:getDefaultNodePool", {
        "id": args.id,
    }, opts);
}
...
export function getDefaultNodePoolOutput(args: GetDefaultNodePoolOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDefaultNodePoolResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vke/getDefaultNodePool:getDefaultNodePool", {
        "id": args.id,
    }, opts);
}
