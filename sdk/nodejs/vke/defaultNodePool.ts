 ...
 *
 * const vkeDefaultNodePoolDemo = new bytepluscc.vke.DefaultNodePool("VkeDefaultNodePoolDemo", {
...
export class DefaultNodePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:vke/defaultNodePool:DefaultNodePool';
