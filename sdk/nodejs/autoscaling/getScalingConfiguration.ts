...
export function getScalingConfiguration(args: GetScalingConfigurationArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingConfigurationResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:autoscaling/getScalingConfiguration:getScalingConfiguration", {
        "id": args.id,
    }, opts);
}
...
export function getScalingConfigurationOutput(args: GetScalingConfigurationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScalingConfigurationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:autoscaling/getScalingConfiguration:getScalingConfiguration", {
        "id": args.id,
    }, opts);
}
