 ...
 *
 * const autoScalingScalingPolicyDemo = new bytepluscc.autoscaling.ScalingPolicy("AutoScalingScalingPolicyDemo", {
...
export class ScalingPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:autoscaling/scalingPolicy:ScalingPolicy';
