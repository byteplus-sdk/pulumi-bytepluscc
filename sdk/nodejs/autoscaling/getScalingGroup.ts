...
export function getScalingGroup(args: GetScalingGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetScalingGroupResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:autoscaling/getScalingGroup:getScalingGroup", {
        "id": args.id,
    }, opts);
}
...
export function getScalingGroupOutput(args: GetScalingGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScalingGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:autoscaling/getScalingGroup:getScalingGroup", {
        "id": args.id,
    }, opts);
}
