 ...
 *
 * const autoScalingDemo = new bytepluscc.autoscaling.ScalingConfiguration("AutoScalingDemo", {
...
export class ScalingConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration';
