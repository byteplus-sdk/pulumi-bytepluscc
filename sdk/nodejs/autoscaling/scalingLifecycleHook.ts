 ...
 *
 * const scalingLifecycleHookDemo = new bytepluscc.autoscaling.ScalingLifecycleHook("ScalingLifecycleHookDemo", {
...
export class ScalingLifecycleHook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook';
