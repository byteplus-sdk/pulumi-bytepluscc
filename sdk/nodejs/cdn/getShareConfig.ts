...
export function getShareConfig(args: GetShareConfigArgs, opts?: pulumi.InvokeOptions): Promise<GetShareConfigResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:cdn/getShareConfig:getShareConfig", {
        "id": args.id,
    }, opts);
}
...
export function getShareConfigOutput(args: GetShareConfigOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetShareConfigResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:cdn/getShareConfig:getShareConfig", {
        "id": args.id,
    }, opts);
}
