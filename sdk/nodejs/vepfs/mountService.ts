 ...
 *
 * const vEPFSMountServiceDemo = new bytepluscc.vepfs.MountService("VEPFSMountServiceDemo", {
...
export class MountService extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:vepfs/mountService:MountService';
