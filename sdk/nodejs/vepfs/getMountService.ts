...
export function getMountService(args: GetMountServiceArgs, opts?: pulumi.InvokeOptions): Promise<GetMountServiceResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vepfs/getMountService:getMountService", {
        "id": args.id,
    }, opts);
}
...
export function getMountServiceOutput(args: GetMountServiceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMountServiceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vepfs/getMountService:getMountService", {
        "id": args.id,
    }, opts);
}
