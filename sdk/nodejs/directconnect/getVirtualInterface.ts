...
export function getVirtualInterface(args: GetVirtualInterfaceArgs, opts?: pulumi.InvokeOptions): Promise<GetVirtualInterfaceResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:directconnect/getVirtualInterface:getVirtualInterface", {
        "id": args.id,
    }, opts);
}
...
export function getVirtualInterfaceOutput(args: GetVirtualInterfaceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVirtualInterfaceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:directconnect/getVirtualInterface:getVirtualInterface", {
        "id": args.id,
    }, opts);
}
