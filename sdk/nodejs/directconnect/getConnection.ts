...
export function getConnection(args: GetConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetConnectionResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:directconnect/getConnection:getConnection", {
        "id": args.id,
    }, opts);
}
...
export function getConnectionOutput(args: GetConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:directconnect/getConnection:getConnection", {
        "id": args.id,
    }, opts);
}
