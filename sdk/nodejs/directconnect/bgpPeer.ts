 ...
 *
 * const directConnectBgpPeerDemo = new bytepluscc.directconnect.BgpPeer("DirectConnectBgpPeerDemo", {
 *     authKey: "QWExxxx",
...
export class BgpPeer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:directconnect/bgpPeer:BgpPeer';
