...
export function getGatewayRoute(args: GetGatewayRouteArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayRouteResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:directconnect/getGatewayRoute:getGatewayRoute", {
        "id": args.id,
    }, opts);
}
...
export function getGatewayRouteOutput(args: GetGatewayRouteOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayRouteResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:directconnect/getGatewayRoute:getGatewayRoute", {
        "id": args.id,
    }, opts);
}
