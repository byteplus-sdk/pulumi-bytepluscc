...
export function getNatFireWallControlPolicy(args: GetNatFireWallControlPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetNatFireWallControlPolicyResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:fwcenter/getNatFireWallControlPolicy:getNatFireWallControlPolicy", {
        "id": args.id,
    }, opts);
}
...
export function getNatFireWallControlPolicyOutput(args: GetNatFireWallControlPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNatFireWallControlPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:fwcenter/getNatFireWallControlPolicy:getNatFireWallControlPolicy", {
        "id": args.id,
    }, opts);
}
