 ...
 *
 * const example = new bytepluscc.fwcenter.NatFireWallControlPolicy("Example", {
...
export class NatFireWallControlPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy';
