...
export function getAddressBook(args: GetAddressBookArgs, opts?: pulumi.InvokeOptions): Promise<GetAddressBookResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:fwcenter/getAddressBook:getAddressBook", {
        "id": args.id,
    }, opts);
}
...
export function getAddressBookOutput(args: GetAddressBookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAddressBookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:fwcenter/getAddressBook:getAddressBook", {
        "id": args.id,
    }, opts);
}
