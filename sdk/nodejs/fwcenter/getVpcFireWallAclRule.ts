...
export function getVpcFireWallAclRule(args: GetVpcFireWallAclRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetVpcFireWallAclRuleResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:fwcenter/getVpcFireWallAclRule:getVpcFireWallAclRule", {
        "id": args.id,
    }, opts);
}
...
export function getVpcFireWallAclRuleOutput(args: GetVpcFireWallAclRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpcFireWallAclRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:fwcenter/getVpcFireWallAclRule:getVpcFireWallAclRule", {
        "id": args.id,
    }, opts);
}
