...
export function getControlPolicy(args: GetControlPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetControlPolicyResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:fwcenter/getControlPolicy:getControlPolicy", {
        "id": args.id,
    }, opts);
}
...
export function getControlPolicyOutput(args: GetControlPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetControlPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:fwcenter/getControlPolicy:getControlPolicy", {
        "id": args.id,
    }, opts);
}
