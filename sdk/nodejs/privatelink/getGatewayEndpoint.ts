...
export function getGatewayEndpoint(args: GetGatewayEndpointArgs, opts?: pulumi.InvokeOptions): Promise<GetGatewayEndpointResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:privatelink/getGatewayEndpoint:getGatewayEndpoint", {
        "id": args.id,
    }, opts);
}
...
export function getGatewayEndpointOutput(args: GetGatewayEndpointOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayEndpointResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:privatelink/getGatewayEndpoint:getGatewayEndpoint", {
        "id": args.id,
    }, opts);
}
