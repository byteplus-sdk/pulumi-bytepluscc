...
export function getVpcEndpointConnection(args: GetVpcEndpointConnectionArgs, opts?: pulumi.InvokeOptions): Promise<GetVpcEndpointConnectionResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:privatelink/getVpcEndpointConnection:getVpcEndpointConnection", {
        "id": args.id,
    }, opts);
}
...
export function getVpcEndpointConnectionOutput(args: GetVpcEndpointConnectionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpcEndpointConnectionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:privatelink/getVpcEndpointConnection:getVpcEndpointConnection", {
        "id": args.id,
    }, opts);
}
