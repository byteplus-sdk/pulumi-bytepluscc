 ...
 *
 * const aPIGUpstreamAIProviderDemo = new bytepluscc.apig.Upstream("APIGUpstreamAIProviderDemo", {
...
export class Upstream extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:apig/upstream:Upstream';
