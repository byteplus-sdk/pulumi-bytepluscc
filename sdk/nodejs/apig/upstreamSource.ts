 ...
 *
 * const upstreamSourceNacosDemo = new bytepluscc.apig.UpstreamSource("UpstreamSourceNacosDemo", {
...
export class UpstreamSource extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:apig/upstreamSource:UpstreamSource';
