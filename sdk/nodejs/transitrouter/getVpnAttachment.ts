...
export function getVpnAttachment(args: GetVpnAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetVpnAttachmentResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:transitrouter/getVpnAttachment:getVpnAttachment", {
        "id": args.id,
    }, opts);
}
...
export function getVpnAttachmentOutput(args: GetVpnAttachmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVpnAttachmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:transitrouter/getVpnAttachment:getVpnAttachment", {
        "id": args.id,
    }, opts);
}
