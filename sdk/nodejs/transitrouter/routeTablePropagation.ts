 ...
 *
 * const routeTablePropagationDemo = new bytepluscc.transitrouter.RouteTablePropagation("RouteTablePropagationDemo", {
...
export class RouteTablePropagation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation';
