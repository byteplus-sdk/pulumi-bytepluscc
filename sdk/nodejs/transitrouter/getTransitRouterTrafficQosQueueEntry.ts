...
export function getTransitRouterTrafficQosQueueEntry(args: GetTransitRouterTrafficQosQueueEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetTransitRouterTrafficQosQueueEntryResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:transitrouter/getTransitRouterTrafficQosQueueEntry:getTransitRouterTrafficQosQueueEntry", {
        "id": args.id,
    }, opts);
}
...
export function getTransitRouterTrafficQosQueueEntryOutput(args: GetTransitRouterTrafficQosQueueEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTransitRouterTrafficQosQueueEntryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:transitrouter/getTransitRouterTrafficQosQueueEntry:getTransitRouterTrafficQosQueueEntry", {
        "id": args.id,
    }, opts);
}
