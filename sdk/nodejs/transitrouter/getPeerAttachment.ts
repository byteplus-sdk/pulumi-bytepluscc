...
export function getPeerAttachment(args: GetPeerAttachmentArgs, opts?: pulumi.InvokeOptions): Promise<GetPeerAttachmentResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment", {
        "id": args.id,
    }, opts);
}
...
export function getPeerAttachmentOutput(args: GetPeerAttachmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPeerAttachmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment", {
        "id": args.id,
    }, opts);
}
