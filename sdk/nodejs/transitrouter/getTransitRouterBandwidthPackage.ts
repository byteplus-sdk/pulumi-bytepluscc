...
export function getTransitRouterBandwidthPackage(args: GetTransitRouterBandwidthPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetTransitRouterBandwidthPackageResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:transitrouter/getTransitRouterBandwidthPackage:getTransitRouterBandwidthPackage", {
        "id": args.id,
    }, opts);
}
...
export function getTransitRouterBandwidthPackageOutput(args: GetTransitRouterBandwidthPackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTransitRouterBandwidthPackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:transitrouter/getTransitRouterBandwidthPackage:getTransitRouterBandwidthPackage", {
        "id": args.id,
    }, opts);
}
