 ...
 *
 * const nLBServerGroupDemo = new bytepluscc.clb.NlbServerGroup("NLBServerGroupDemo", {
...
export class NlbServerGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:clb/nlbServerGroup:NlbServerGroup';
