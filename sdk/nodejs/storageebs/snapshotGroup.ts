 ...
 *
 * const storageEBSSnapshotGroupDemo = new bytepluscc.storageebs.SnapshotGroup("StorageEBSSnapshotGroupDemo", {
 *     name: "ccapi-test",
 *     projectName: "default",
...
export class SnapshotGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:storageebs/snapshotGroup:SnapshotGroup';
