...
export function getSnapshot(args: GetSnapshotArgs, opts?: pulumi.InvokeOptions): Promise<GetSnapshotResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:storageebs/getSnapshot:getSnapshot", {
        "id": args.id,
    }, opts);
}
...
export function getSnapshotOutput(args: GetSnapshotOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSnapshotResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:storageebs/getSnapshot:getSnapshot", {
        "id": args.id,
    }, opts);
}
