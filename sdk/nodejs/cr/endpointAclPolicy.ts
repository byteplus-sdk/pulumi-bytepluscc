 ...
 *
 * const cREndpointAclPolicyDemo = new bytepluscc.cr.EndpointAclPolicy("CREndpointAclPolicyDemo", {
 *     registry: "xxxxx",
 *     type: "Public",
 *     entry: "0.0.0.0/0",
...
export class EndpointAclPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy';
