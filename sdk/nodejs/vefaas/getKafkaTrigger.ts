...
export function getKafkaTrigger(args: GetKafkaTriggerArgs, opts?: pulumi.InvokeOptions): Promise<GetKafkaTriggerResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vefaas/getKafkaTrigger:getKafkaTrigger", {
        "id": args.id,
    }, opts);
}
...
export function getKafkaTriggerOutput(args: GetKafkaTriggerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetKafkaTriggerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vefaas/getKafkaTrigger:getKafkaTrigger", {
        "id": args.id,
    }, opts);
}
