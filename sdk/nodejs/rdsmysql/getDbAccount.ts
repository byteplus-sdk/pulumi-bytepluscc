...
export function getDbAccount(args: GetDbAccountArgs, opts?: pulumi.InvokeOptions): Promise<GetDbAccountResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:rdsmysql/getDbAccount:getDbAccount", {
        "id": args.id,
    }, opts);
}
...
export function getDbAccountOutput(args: GetDbAccountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbAccountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:rdsmysql/getDbAccount:getDbAccount", {
        "id": args.id,
    }, opts);
}
