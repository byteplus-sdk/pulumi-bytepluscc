 ...
 *
 * const rdsMysqlAllowListDemo = new bytepluscc.rdsmysql.AllowList("RdsMysqlAllowListDemo", {
...
export class AllowList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:rdsmysql/allowList:AllowList';
