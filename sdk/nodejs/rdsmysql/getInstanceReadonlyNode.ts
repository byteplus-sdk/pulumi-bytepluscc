...
export function getInstanceReadonlyNode(args: GetInstanceReadonlyNodeArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceReadonlyNodeResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:rdsmysql/getInstanceReadonlyNode:getInstanceReadonlyNode", {
        "id": args.id,
    }, opts);
}
...
export function getInstanceReadonlyNodeOutput(args: GetInstanceReadonlyNodeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceReadonlyNodeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:rdsmysql/getInstanceReadonlyNode:getInstanceReadonlyNode", {
        "id": args.id,
    }, opts);
}
