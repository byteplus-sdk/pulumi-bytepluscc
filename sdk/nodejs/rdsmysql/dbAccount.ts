 ...
 *
 * const rDSMySQLDBAccountDemo = new bytepluscc.rdsmysql.DbAccount("RDSMySQLDBAccountDemo", {
...
export class DbAccount extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:rdsmysql/dbAccount:DbAccount';
