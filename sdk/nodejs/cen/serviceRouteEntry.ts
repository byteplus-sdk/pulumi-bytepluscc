 ...
 *
 * const cENServiceRouteEntryDemo = new bytepluscc.cen.ServiceRouteEntry("CENServiceRouteEntryDemo", {
...
export class ServiceRouteEntry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry';
