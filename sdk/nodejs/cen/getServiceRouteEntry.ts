...
export function getServiceRouteEntry(args: GetServiceRouteEntryArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceRouteEntryResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:cen/getServiceRouteEntry:getServiceRouteEntry", {
        "id": args.id,
    }, opts);
}
...
export function getServiceRouteEntryOutput(args: GetServiceRouteEntryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceRouteEntryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:cen/getServiceRouteEntry:getServiceRouteEntry", {
        "id": args.id,
    }, opts);
}
