 ...
 *
 * const cenGranInstanceDemo = new bytepluscc.cen.GrantInstance("CenGranInstanceDemo", {
 *     cenId: "cen-2v72wo******",
 *     cenOwnerId: "210102***",
...
export class GrantInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cen/grantInstance:GrantInstance';
