...
export function getInterRegionBandwidth(args: GetInterRegionBandwidthArgs, opts?: pulumi.InvokeOptions): Promise<GetInterRegionBandwidthResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:cen/getInterRegionBandwidth:getInterRegionBandwidth", {
        "id": args.id,
    }, opts);
}
...
export function getInterRegionBandwidthOutput(args: GetInterRegionBandwidthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInterRegionBandwidthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:cen/getInterRegionBandwidth:getInterRegionBandwidth", {
        "id": args.id,
    }, opts);
}
