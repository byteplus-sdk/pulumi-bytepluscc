...
export function getBandwidthPackage(args: GetBandwidthPackageArgs, opts?: pulumi.InvokeOptions): Promise<GetBandwidthPackageResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:cen/getBandwidthPackage:getBandwidthPackage", {
        "id": args.id,
    }, opts);
}
...
export function getBandwidthPackageOutput(args: GetBandwidthPackageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBandwidthPackageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:cen/getBandwidthPackage:getBandwidthPackage", {
        "id": args.id,
    }, opts);
}
