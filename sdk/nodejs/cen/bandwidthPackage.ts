 ...
 *
 * const cENBandwidthPackageDemo = new bytepluscc.cen.BandwidthPackage("CENBandwidthPackageDemo", {
 *     bandwidth: 3,
 *     billingType: 4,
...
export class BandwidthPackage extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cen/bandwidthPackage:BandwidthPackage';
