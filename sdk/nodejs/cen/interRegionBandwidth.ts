 ...
 *
 * const cENInterRegionBandwidthDemo = new bytepluscc.cen.InterRegionBandwidth("CENInterRegionBandwidthDemo", {
...
export class InterRegionBandwidth extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth';
