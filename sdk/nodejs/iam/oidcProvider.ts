 ...
 *
 * const iAMOidcProviderDemo = new bytepluscc.iam.OidcProvider("IAMOidcProviderDemo", {
...
export class OidcProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:iam/oidcProvider:OidcProvider';
