 ...
 *
 * const iAMAllowedIpAddressDemo = new bytepluscc.iam.AllowedIpAddress("IAMAllowedIpAddressDemo", {
 *     userId: "2109xxxxx",
 *     ipLists: [
 *         {
 *             ip: "192.168.1.100",
...
export class AllowedIpAddress extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:iam/allowedIpAddress:AllowedIpAddress';
