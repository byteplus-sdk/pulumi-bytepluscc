 ...
 *
 * const iAMSamlProviderDemo = new bytepluscc.iam.SamlProvider("IAMSamlProviderDemo", {
...
export class SamlProvider extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:iam/samlProvider:SamlProvider';
