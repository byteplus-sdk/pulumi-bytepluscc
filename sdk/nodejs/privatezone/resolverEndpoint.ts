 ...
 *
 * const privateZoneResolverEndpointDemo = new bytepluscc.privatezone.ResolverEndpoint("PrivateZoneResolverEndpointDemo", {
...
export class ResolverEndpoint extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint';
