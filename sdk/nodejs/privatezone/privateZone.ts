 ...
 *
 * const privateZoneDemo = new bytepluscc.privatezone.PrivateZone("PrivateZoneDemo", {
...
export class PrivateZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:privatezone/privateZone:PrivateZone';
