 ...
 *
 * const cloudIdentityPermissionSetDemo = new bytepluscc.cloudidentity.PermissionSet("CloudIdentityPermissionSetDemo", {
 *     description: "cc-test",
 *     name: "cctest-test",
...
export class PermissionSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cloudidentity/permissionSet:PermissionSet';
