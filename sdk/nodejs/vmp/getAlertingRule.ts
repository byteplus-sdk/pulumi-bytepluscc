...
export function getAlertingRule(args: GetAlertingRuleArgs, opts?: pulumi.InvokeOptions): Promise<GetAlertingRuleResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vmp/getAlertingRule:getAlertingRule", {
        "id": args.id,
    }, opts);
}
...
export function getAlertingRuleOutput(args: GetAlertingRuleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlertingRuleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vmp/getAlertingRule:getAlertingRule", {
        "id": args.id,
    }, opts);
}
