 ...
 *
 * const rDSMsSQLAllowlistDemo = new bytepluscc.rdsmssql.AllowList("RDSMsSQLAllowlistDemo", {
 *     projectName: "default",
...
export class AllowList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:rdsmssql/allowList:AllowList';
