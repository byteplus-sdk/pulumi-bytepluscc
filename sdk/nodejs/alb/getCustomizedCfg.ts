...
export function getCustomizedCfg(args: GetCustomizedCfgArgs, opts?: pulumi.InvokeOptions): Promise<GetCustomizedCfgResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:alb/getCustomizedCfg:getCustomizedCfg", {
        "id": args.id,
    }, opts);
}
...
export function getCustomizedCfgOutput(args: GetCustomizedCfgOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomizedCfgResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:alb/getCustomizedCfg:getCustomizedCfg", {
        "id": args.id,
    }, opts);
}
