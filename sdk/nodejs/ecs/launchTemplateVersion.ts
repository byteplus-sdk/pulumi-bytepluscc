 ...
 *
 * const ecsLaunchTemplateVersionDemo = new bytepluscc.ecs.LaunchTemplateVersion("EcsLaunchTemplateVersionDemo", {
...
export class LaunchTemplateVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion';
