...
export function getDeploymentSet(args: GetDeploymentSetArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentSetResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:ecs/getDeploymentSet:getDeploymentSet", {
        "id": args.id,
    }, opts);
}
...
export function getDeploymentSetOutput(args: GetDeploymentSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDeploymentSetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:ecs/getDeploymentSet:getDeploymentSet", {
        "id": args.id,
    }, opts);
}
