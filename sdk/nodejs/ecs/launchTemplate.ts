 ...
 *
 * const ecsLaunchTemplateDemo = new bytepluscc.ecs.LaunchTemplate("EcsLaunchTemplateDemo", {
...
export class LaunchTemplate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:ecs/launchTemplate:LaunchTemplate';
