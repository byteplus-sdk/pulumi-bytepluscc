 ...
 *
 * const rabbitMQAllowListDemo = new bytepluscc.rabbitmq.AllowList("RabbitMQAllowListDemo", {
 *     allowListType: "IPv4",
...
export class AllowList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:rabbitmq/allowList:AllowList';
