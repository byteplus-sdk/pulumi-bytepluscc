...
export function getIpv6AddressBandwidth(args: GetIpv6AddressBandwidthArgs, opts?: pulumi.InvokeOptions): Promise<GetIpv6AddressBandwidthResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpc/getIpv6AddressBandwidth:getIpv6AddressBandwidth", {
        "id": args.id,
    }, opts);
}
...
export function getIpv6AddressBandwidthOutput(args: GetIpv6AddressBandwidthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpv6AddressBandwidthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpc/getIpv6AddressBandwidth:getIpv6AddressBandwidth", {
        "id": args.id,
    }, opts);
}
