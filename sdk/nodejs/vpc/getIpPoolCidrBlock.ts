...
export function getIpPoolCidrBlock(args: GetIpPoolCidrBlockArgs, opts?: pulumi.InvokeOptions): Promise<GetIpPoolCidrBlockResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpc/getIpPoolCidrBlock:getIpPoolCidrBlock", {
        "id": args.id,
    }, opts);
}
...
export function getIpPoolCidrBlockOutput(args: GetIpPoolCidrBlockOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpPoolCidrBlockResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpc/getIpPoolCidrBlock:getIpPoolCidrBlock", {
        "id": args.id,
    }, opts);
}
