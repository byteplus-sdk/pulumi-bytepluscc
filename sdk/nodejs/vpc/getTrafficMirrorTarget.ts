...
export function getTrafficMirrorTarget(args: GetTrafficMirrorTargetArgs, opts?: pulumi.InvokeOptions): Promise<GetTrafficMirrorTargetResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:vpc/getTrafficMirrorTarget:getTrafficMirrorTarget", {
        "id": args.id,
    }, opts);
}
...
export function getTrafficMirrorTargetOutput(args: GetTrafficMirrorTargetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTrafficMirrorTargetResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:vpc/getTrafficMirrorTarget:getTrafficMirrorTarget", {
        "id": args.id,
    }, opts);
}
