...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "bytepluscc:firewallcenter/dnsControlPolicy:DnsControlPolicy":
...
pulumi.runtime.registerResourceModule("bytepluscc", "firewallcenter/dnsControlPolicy", _module)
