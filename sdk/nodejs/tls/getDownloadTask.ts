...
export function getDownloadTask(args: GetDownloadTaskArgs, opts?: pulumi.InvokeOptions): Promise<GetDownloadTaskResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:tls/getDownloadTask:getDownloadTask", {
        "id": args.id,
    }, opts);
}
...
export function getDownloadTaskOutput(args: GetDownloadTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDownloadTaskResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:tls/getDownloadTask:getDownloadTask", {
        "id": args.id,
    }, opts);
}
