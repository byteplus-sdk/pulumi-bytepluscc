 ...
 *
 * const tLSAlarmNotifyGroupDemo = new bytepluscc.tls.AlarmNotifyGroup("TLSAlarmNotifyGroupDemo", {
...
export class AlarmNotifyGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup';
