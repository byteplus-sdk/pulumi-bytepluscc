 ...
 *
 * const tLSScheduleSqlTaskDemo = new bytepluscc.tls.ScheduleSqlTask("TLSScheduleSqlTaskDemo", {
...
export class ScheduleSqlTask extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask';
