...
export function getAlarmNotifyGroup(args: GetAlarmNotifyGroupArgs, opts?: pulumi.InvokeOptions): Promise<GetAlarmNotifyGroupResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:tls/getAlarmNotifyGroup:getAlarmNotifyGroup", {
        "id": args.id,
    }, opts);
}
...
export function getAlarmNotifyGroupOutput(args: GetAlarmNotifyGroupOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmNotifyGroupResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:tls/getAlarmNotifyGroup:getAlarmNotifyGroup", {
        "id": args.id,
    }, opts);
}
