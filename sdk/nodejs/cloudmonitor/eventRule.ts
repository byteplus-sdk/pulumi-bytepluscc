 ...
 *
 * const cloudMonitorEventRuleDemo = new bytepluscc.cloudmonitor.EventRule("CloudMonitorEventRuleDemo", {
...
export class EventRule extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'bytepluscc:cloudmonitor/eventRule:EventRule';
