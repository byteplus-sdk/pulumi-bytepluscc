...
export function getParameterTemplate(args: GetParameterTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetParameterTemplateResult> {
    ...
    return pulumi.runtime.invoke("bytepluscc:rdspostgresql/getParameterTemplate:getParameterTemplate", {
        "id": args.id,
    }, opts);
}
...
export function getParameterTemplateOutput(args: GetParameterTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetParameterTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("bytepluscc:rdspostgresql/getParameterTemplate:getParameterTemplate", {
        "id": args.id,
    }, opts);
}
