...
def get_pool(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:gtm/getPool:getPool', __args__, opts=opts, typ=GetPoolResult).value
...
def get_pool_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:gtm/getPool:getPool', __args__, opts=opts, typ=GetPoolResult)
