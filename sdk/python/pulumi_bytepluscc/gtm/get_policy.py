...
def get_policy(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:gtm/getPolicy:getPolicy', __args__, opts=opts, typ=GetPolicyResult).value
...
def get_policy_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:gtm/getPolicy:getPolicy', __args__, opts=opts, typ=GetPolicyResult)
