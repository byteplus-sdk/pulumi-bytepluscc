...
def get_policies(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPoliciesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:gtm/getPolicies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult).value
...
def get_policies_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPoliciesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:gtm/getPolicies:getPolicies', __args__, opts=opts, typ=GetPoliciesResult)
