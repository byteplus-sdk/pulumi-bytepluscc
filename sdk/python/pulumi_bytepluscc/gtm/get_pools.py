...
def get_pools(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPoolsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:gtm/getPools:getPools', __args__, opts=opts, typ=GetPoolsResult).value
...
def get_pools_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPoolsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:gtm/getPools:getPools', __args__, opts=opts, typ=GetPoolsResult)
