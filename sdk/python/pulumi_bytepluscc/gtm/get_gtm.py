...
def get_gtm(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:gtm/getGtm:getGtm', __args__, opts=opts, typ=GetGtmResult).value
...
def get_gtm_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:gtm/getGtm:getGtm', __args__, opts=opts, typ=GetGtmResult)
