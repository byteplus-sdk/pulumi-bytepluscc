...
def get_address_book(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:fwcenter/getAddressBook:getAddressBook', __args__, opts=opts, typ=GetAddressBookResult).value
...
def get_address_book_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:fwcenter/getAddressBook:getAddressBook', __args__, opts=opts, typ=GetAddressBookResult)
