...
def get_event_rule(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudmonitor/getEventRule:getEventRule', __args__, opts=opts, typ=GetEventRuleResult).value
...
def get_event_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudmonitor/getEventRule:getEventRule', __args__, opts=opts, typ=GetEventRuleResult)
