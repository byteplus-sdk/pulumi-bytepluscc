...
@pulumi.type_token("bytepluscc:cloudmonitor/eventRule:EventRule")
class EventRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cloud_monitor_event_rule_demo = bytepluscc.cloudmonitor.EventRule("CloudMonitorEventRuleDemo",
    ...
    def _internal_init(__self__,
        ...
        super(EventRule, __self__).__init__(
            'bytepluscc:cloudmonitor/eventRule:EventRule',
            resource_name,
            __props__,
            opts)
