...
def get_contact_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudmonitor/getContactGroup:getContactGroup', __args__, opts=opts, typ=GetContactGroupResult).value
...
def get_contact_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudmonitor/getContactGroup:getContactGroup', __args__, opts=opts, typ=GetContactGroupResult)
