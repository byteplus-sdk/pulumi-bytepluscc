...
def get_contact(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudmonitor/getContact:getContact', __args__, opts=opts, typ=GetContactResult).value
...
def get_contact_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudmonitor/getContact:getContact', __args__, opts=opts, typ=GetContactResult)
