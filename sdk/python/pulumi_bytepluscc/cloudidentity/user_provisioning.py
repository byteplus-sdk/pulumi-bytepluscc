...
@pulumi.type_token("bytepluscc:cloudidentity/userProvisioning:UserProvisioning")
class UserProvisioning(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cloud_identity_user_provisioning_demo = bytepluscc.cloudidentity.UserProvisioning("CloudIdentityUserProvisioningDemo",
            target_id="2103612***",
    ...
    def _internal_init(__self__,
        ...
        super(UserProvisioning, __self__).__init__(
            'bytepluscc:cloudidentity/userProvisioning:UserProvisioning',
            resource_name,
            __props__,
            opts)
