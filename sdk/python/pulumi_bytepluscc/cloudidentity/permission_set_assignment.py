...
@pulumi.type_token("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment")
class PermissionSetAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PermissionSetAssignment, __self__).__init__(
            'bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment',
            resource_name,
            __props__,
            opts)
