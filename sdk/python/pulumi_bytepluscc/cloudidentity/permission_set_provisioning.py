...
@pulumi.type_token("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning")
class PermissionSetProvisioning(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(PermissionSetProvisioning, __self__).__init__(
            'bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning',
            resource_name,
            __props__,
            opts)
