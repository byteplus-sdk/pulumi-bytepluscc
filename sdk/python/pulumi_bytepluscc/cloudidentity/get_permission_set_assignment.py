...
def get_permission_set_assignment(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudidentity/getPermissionSetAssignment:getPermissionSetAssignment', __args__, opts=opts, typ=GetPermissionSetAssignmentResult).value
...
def get_permission_set_assignment_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudidentity/getPermissionSetAssignment:getPermissionSetAssignment', __args__, opts=opts, typ=GetPermissionSetAssignmentResult)
