...
def get_groups(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetGroupsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudidentity/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult).value
...
def get_groups_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGroupsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudidentity/getGroups:getGroups', __args__, opts=opts, typ=GetGroupsResult)
