...
def get_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudidentity/getGroup:getGroup', __args__, opts=opts, typ=GetGroupResult).value
...
def get_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudidentity/getGroup:getGroup', __args__, opts=opts, typ=GetGroupResult)
