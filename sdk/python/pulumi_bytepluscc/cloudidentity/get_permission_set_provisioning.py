...
def get_permission_set_provisioning(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cloudidentity/getPermissionSetProvisioning:getPermissionSetProvisioning', __args__, opts=opts, typ=GetPermissionSetProvisioningResult).value
...
def get_permission_set_provisioning_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cloudidentity/getPermissionSetProvisioning:getPermissionSetProvisioning', __args__, opts=opts, typ=GetPermissionSetProvisioningResult)
