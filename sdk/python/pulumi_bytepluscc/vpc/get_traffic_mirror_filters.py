...
def get_traffic_mirror_filters(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrafficMirrorFiltersResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpc/getTrafficMirrorFilters:getTrafficMirrorFilters', __args__, opts=opts, typ=GetTrafficMirrorFiltersResult).value
...
def get_traffic_mirror_filters_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTrafficMirrorFiltersResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpc/getTrafficMirrorFilters:getTrafficMirrorFilters', __args__, opts=opts, typ=GetTrafficMirrorFiltersResult)
