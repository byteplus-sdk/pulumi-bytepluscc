...
def get_traffic_mirror_sessions(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrafficMirrorSessionsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpc/getTrafficMirrorSessions:getTrafficMirrorSessions', __args__, opts=opts, typ=GetTrafficMirrorSessionsResult).value
...
def get_traffic_mirror_sessions_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTrafficMirrorSessionsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpc/getTrafficMirrorSessions:getTrafficMirrorSessions', __args__, opts=opts, typ=GetTrafficMirrorSessionsResult)
