...
def get_ip_pool(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpc/getIpPool:getIpPool', __args__, opts=opts, typ=GetIpPoolResult).value
...
def get_ip_pool_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpc/getIpPool:getIpPool', __args__, opts=opts, typ=GetIpPoolResult)
