...
def get_instances(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInstancesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vedbm/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult).value
...
def get_instances_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstancesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vedbm/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
