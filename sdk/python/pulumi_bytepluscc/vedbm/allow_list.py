...
@pulumi.type_token("bytepluscc:vedbm/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        v_edbm_allow_list_demo = bytepluscc.vedbm.AllowList("VEDBMAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:vedbm/allowList:AllowList',
            resource_name,
            __props__,
            opts)
