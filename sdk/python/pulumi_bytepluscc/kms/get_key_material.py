...
def get_key_material(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:kms/getKeyMaterial:getKeyMaterial', __args__, opts=opts, typ=GetKeyMaterialResult).value
...
def get_key_material_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:kms/getKeyMaterial:getKeyMaterial', __args__, opts=opts, typ=GetKeyMaterialResult)
