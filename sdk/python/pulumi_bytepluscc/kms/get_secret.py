...
def get_secret(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:kms/getSecret:getSecret', __args__, opts=opts, typ=GetSecretResult).value
...
def get_secret_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:kms/getSecret:getSecret', __args__, opts=opts, typ=GetSecretResult)
