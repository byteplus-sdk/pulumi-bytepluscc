...
def get_notification_configuration(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:autoscaling/getNotificationConfiguration:getNotificationConfiguration', __args__, opts=opts, typ=GetNotificationConfigurationResult).value
...
def get_notification_configuration_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:autoscaling/getNotificationConfiguration:getNotificationConfiguration', __args__, opts=opts, typ=GetNotificationConfigurationResult)
