...
@pulumi.type_token("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration")
class NotificationConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(NotificationConfiguration, __self__).__init__(
            'bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration',
            resource_name,
            __props__,
            opts)
