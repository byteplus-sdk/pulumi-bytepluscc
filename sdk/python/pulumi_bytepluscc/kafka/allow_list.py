...
@pulumi.type_token("bytepluscc:kafka/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        kafka_allow_list_demo = bytepluscc.kafka.AllowList("KafkaAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:kafka/allowList:AllowList',
            resource_name,
            __props__,
            opts)
