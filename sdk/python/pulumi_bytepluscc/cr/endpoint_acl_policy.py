...
@pulumi.type_token("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy")
class EndpointAclPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        c_r_endpoint_acl_policy_demo = bytepluscc.cr.EndpointAclPolicy("CREndpointAclPolicyDemo",
            registry="xxxxx",
            type="Public",
            entry="0.0.0.0/0",
    ...
    def _internal_init(__self__,
        ...
        super(EndpointAclPolicy, __self__).__init__(
            'bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy',
            resource_name,
            __props__,
            opts)
