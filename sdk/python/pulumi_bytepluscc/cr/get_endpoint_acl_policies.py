...
def get_endpoint_acl_policies(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEndpointAclPoliciesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cr/getEndpointAclPolicies:getEndpointAclPolicies', __args__, opts=opts, typ=GetEndpointAclPoliciesResult).value
...
def get_endpoint_acl_policies_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEndpointAclPoliciesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cr/getEndpointAclPolicies:getEndpointAclPolicies', __args__, opts=opts, typ=GetEndpointAclPoliciesResult)
