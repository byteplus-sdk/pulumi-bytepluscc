...
def get_parameter_templates(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetParameterTemplatesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:rdsmysql/getParameterTemplates:getParameterTemplates', __args__, opts=opts, typ=GetParameterTemplatesResult).value
...
def get_parameter_templates_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetParameterTemplatesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:rdsmysql/getParameterTemplates:getParameterTemplates', __args__, opts=opts, typ=GetParameterTemplatesResult)
