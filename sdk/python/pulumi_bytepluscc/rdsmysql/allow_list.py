...
@pulumi.type_token("bytepluscc:rdsmysql/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rds_mysql_allow_list_demo = bytepluscc.rdsmysql.AllowList("RdsMysqlAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:rdsmysql/allowList:AllowList',
            resource_name,
            __props__,
            opts)
