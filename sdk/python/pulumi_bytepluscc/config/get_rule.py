...
def get_rule(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:config/getRule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:config/getRule:getRule', __args__, opts=opts, typ=GetRuleResult)
