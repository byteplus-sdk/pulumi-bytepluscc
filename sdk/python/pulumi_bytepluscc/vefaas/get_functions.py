...
def get_functions(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetFunctionsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vefaas/getFunctions:getFunctions', __args__, opts=opts, typ=GetFunctionsResult).value
...
def get_functions_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFunctionsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vefaas/getFunctions:getFunctions', __args__, opts=opts, typ=GetFunctionsResult)
