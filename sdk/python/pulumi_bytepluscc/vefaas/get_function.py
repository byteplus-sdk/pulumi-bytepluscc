...
def get_function(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vefaas/getFunction:getFunction', __args__, opts=opts, typ=GetFunctionResult).value
...
def get_function_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vefaas/getFunction:getFunction', __args__, opts=opts, typ=GetFunctionResult)
