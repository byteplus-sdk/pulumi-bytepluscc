...
def get_release(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vefaas/getRelease:getRelease', __args__, opts=opts, typ=GetReleaseResult).value
...
def get_release_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vefaas/getRelease:getRelease', __args__, opts=opts, typ=GetReleaseResult)
