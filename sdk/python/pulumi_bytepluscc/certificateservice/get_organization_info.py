...
def get_organization_info(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:certificateservice/getOrganizationInfo:getOrganizationInfo', __args__, opts=opts, typ=GetOrganizationInfoResult).value
...
def get_organization_info_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:certificateservice/getOrganizationInfo:getOrganizationInfo', __args__, opts=opts, typ=GetOrganizationInfoResult)
