...
def get_parameter_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:redis/getParameterGroup:getParameterGroup', __args__, opts=opts, typ=GetParameterGroupResult).value
...
def get_parameter_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:redis/getParameterGroup:getParameterGroup', __args__, opts=opts, typ=GetParameterGroupResult)
