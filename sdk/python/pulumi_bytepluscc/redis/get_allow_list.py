...
def get_allow_list(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:redis/getAllowList:getAllowList', __args__, opts=opts, typ=GetAllowListResult).value
...
def get_allow_list_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:redis/getAllowList:getAllowList', __args__, opts=opts, typ=GetAllowListResult)
