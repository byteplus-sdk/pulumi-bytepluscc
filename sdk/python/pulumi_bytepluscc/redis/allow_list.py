...
@pulumi.type_token("bytepluscc:redis/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        redis_allow_list_demo = bytepluscc.redis.AllowList("RedisAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:redis/allowList:AllowList',
            resource_name,
            __props__,
            opts)
