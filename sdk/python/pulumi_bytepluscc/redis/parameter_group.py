...
@pulumi.type_token("bytepluscc:redis/parameterGroup:ParameterGroup")
class ParameterGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        redis_parameter_group_demo = bytepluscc.index.RedisParametergroup("RedisParameterGroupDemo",
            engine_version=6.0,
    ...
    def _internal_init(__self__,
        ...
        super(ParameterGroup, __self__).__init__(
            'bytepluscc:redis/parameterGroup:ParameterGroup',
            resource_name,
            __props__,
            opts)
