...
def get_accounts(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccountsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:redis/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult).value
...
def get_accounts_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccountsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:redis/getAccounts:getAccounts', __args__, opts=opts, typ=GetAccountsResult)
