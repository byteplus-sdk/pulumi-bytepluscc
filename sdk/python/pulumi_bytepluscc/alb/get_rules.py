...
def get_rules(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRulesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:alb/getRules:getRules', __args__, opts=opts, typ=GetRulesResult).value
...
def get_rules_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRulesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:alb/getRules:getRules', __args__, opts=opts, typ=GetRulesResult)
