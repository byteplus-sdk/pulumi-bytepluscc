...
@pulumi.type_token("bytepluscc:iam/samlProvider:SamlProvider")
class SamlProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        i_am_saml_provider_demo = bytepluscc.iam.SamlProvider("IAMSamlProviderDemo",
    ...
    def _internal_init(__self__,
        ...
        super(SamlProvider, __self__).__init__(
            'bytepluscc:iam/samlProvider:SamlProvider',
            resource_name,
            __props__,
            opts)
