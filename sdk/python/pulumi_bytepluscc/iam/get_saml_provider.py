...
def get_saml_provider(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:iam/getSamlProvider:getSamlProvider', __args__, opts=opts, typ=GetSamlProviderResult).value
...
def get_saml_provider_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:iam/getSamlProvider:getSamlProvider', __args__, opts=opts, typ=GetSamlProviderResult)
