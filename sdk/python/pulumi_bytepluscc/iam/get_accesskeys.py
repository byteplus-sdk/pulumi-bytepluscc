...
def get_accesskeys(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAccesskeysResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:iam/getAccesskeys:getAccesskeys', __args__, opts=opts, typ=GetAccesskeysResult).value
...
def get_accesskeys_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccesskeysResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:iam/getAccesskeys:getAccesskeys', __args__, opts=opts, typ=GetAccesskeysResult)
