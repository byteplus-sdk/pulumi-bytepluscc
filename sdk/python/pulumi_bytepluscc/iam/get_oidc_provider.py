...
def get_oidc_provider(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:iam/getOidcProvider:getOidcProvider', __args__, opts=opts, typ=GetOidcProviderResult).value
...
def get_oidc_provider_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:iam/getOidcProvider:getOidcProvider', __args__, opts=opts, typ=GetOidcProviderResult)
