...
@pulumi.type_token("bytepluscc:iam/oidcProvider:OidcProvider")
class OidcProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        i_am_oidc_provider_demo = bytepluscc.iam.OidcProvider("IAMOidcProviderDemo",
    ...
    def _internal_init(__self__,
        ...
        super(OidcProvider, __self__).__init__(
            'bytepluscc:iam/oidcProvider:OidcProvider',
            resource_name,
            __props__,
            opts)
