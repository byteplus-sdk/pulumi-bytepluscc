...
def get_databases(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDatabasesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:rdspostgresql/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult).value
...
def get_databases_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDatabasesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:rdspostgresql/getDatabases:getDatabases', __args__, opts=opts, typ=GetDatabasesResult)
