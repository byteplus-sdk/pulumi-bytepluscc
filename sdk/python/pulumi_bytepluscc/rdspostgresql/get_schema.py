...
def get_schema(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:rdspostgresql/getSchema:getSchema', __args__, opts=opts, typ=GetSchemaResult).value
...
def get_schema_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:rdspostgresql/getSchema:getSchema', __args__, opts=opts, typ=GetSchemaResult)
