...
def get_parameter_template(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:rdspostgresql/getParameterTemplate:getParameterTemplate', __args__, opts=opts, typ=GetParameterTemplateResult).value
...
def get_parameter_template_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:rdspostgresql/getParameterTemplate:getParameterTemplate', __args__, opts=opts, typ=GetParameterTemplateResult)
