...
def get_record(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:dns/getRecord:getRecord', __args__, opts=opts, typ=GetRecordResult).value
...
def get_record_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:dns/getRecord:getRecord', __args__, opts=opts, typ=GetRecordResult)
