...
def get_backup_schedule(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:dns/getBackupSchedule:getBackupSchedule', __args__, opts=opts, typ=GetBackupScheduleResult).value
...
def get_backup_schedule_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:dns/getBackupSchedule:getBackupSchedule', __args__, opts=opts, typ=GetBackupScheduleResult)
