...
def get_backup(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:dns/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult).value
...
def get_backup_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:dns/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult)
