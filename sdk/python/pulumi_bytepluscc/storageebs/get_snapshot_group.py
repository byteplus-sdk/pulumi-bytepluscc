...
def get_snapshot_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:storageebs/getSnapshotGroup:getSnapshotGroup', __args__, opts=opts, typ=GetSnapshotGroupResult).value
...
def get_snapshot_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:storageebs/getSnapshotGroup:getSnapshotGroup', __args__, opts=opts, typ=GetSnapshotGroupResult)
