...
@pulumi.type_token("bytepluscc:storageebs/snapshotGroup:SnapshotGroup")
class SnapshotGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        storage_ebs_snapshot_group_demo = bytepluscc.storageebs.SnapshotGroup("StorageEBSSnapshotGroupDemo",
            name="ccapi-test",
    ...
    def _internal_init(__self__,
        ...
        super(SnapshotGroup, __self__).__init__(
            'bytepluscc:storageebs/snapshotGroup:SnapshotGroup',
            resource_name,
            __props__,
            opts)
