...
def get_project(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getProject:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getProject:getProject', __args__, opts=opts, typ=GetProjectResult)
