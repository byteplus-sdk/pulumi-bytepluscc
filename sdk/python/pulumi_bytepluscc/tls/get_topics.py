...
def get_topics(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTopicsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getTopics:getTopics', __args__, opts=opts, typ=GetTopicsResult).value
...
def get_topics_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTopicsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getTopics:getTopics', __args__, opts=opts, typ=GetTopicsResult)
