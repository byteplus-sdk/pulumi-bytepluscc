...
def get_schedule_sql_task(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask', __args__, opts=opts, typ=GetScheduleSqlTaskResult).value
...
def get_schedule_sql_task_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask', __args__, opts=opts, typ=GetScheduleSqlTaskResult)
