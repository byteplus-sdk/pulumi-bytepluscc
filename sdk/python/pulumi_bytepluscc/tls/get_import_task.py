...
def get_import_task(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getImportTask:getImportTask', __args__, opts=opts, typ=GetImportTaskResult).value
...
def get_import_task_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getImportTask:getImportTask', __args__, opts=opts, typ=GetImportTaskResult)
