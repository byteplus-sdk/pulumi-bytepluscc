...
def get_etl(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getEtl:getEtl', __args__, opts=opts, typ=GetEtlResult).value
...
def get_etl_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getEtl:getEtl', __args__, opts=opts, typ=GetEtlResult)
