...
def get_alarm_webhook_integration_type(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getAlarmWebhookIntegrationType:getAlarmWebhookIntegrationType', __args__, opts=opts, typ=GetAlarmWebhookIntegrationTypeResult).value
...
def get_alarm_webhook_integration_type_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getAlarmWebhookIntegrationType:getAlarmWebhookIntegrationType', __args__, opts=opts, typ=GetAlarmWebhookIntegrationTypeResult)
