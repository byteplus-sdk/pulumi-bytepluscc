...
def get_download_task(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getDownloadTask:getDownloadTask', __args__, opts=opts, typ=GetDownloadTaskResult).value
...
def get_download_task_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getDownloadTask:getDownloadTask', __args__, opts=opts, typ=GetDownloadTaskResult)
