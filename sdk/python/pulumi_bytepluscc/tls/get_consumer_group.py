...
def get_consumer_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getConsumerGroup:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult).value
...
def get_consumer_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getConsumerGroup:getConsumerGroup', __args__, opts=opts, typ=GetConsumerGroupResult)
