...
def get_alarm(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getAlarm:getAlarm', __args__, opts=opts, typ=GetAlarmResult).value
...
def get_alarm_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getAlarm:getAlarm', __args__, opts=opts, typ=GetAlarmResult)
