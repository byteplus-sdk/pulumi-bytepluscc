...
def get_index(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getIndex:getIndex', __args__, opts=opts, typ=GetIndexResult).value
...
def get_index_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getIndex:getIndex', __args__, opts=opts, typ=GetIndexResult)
