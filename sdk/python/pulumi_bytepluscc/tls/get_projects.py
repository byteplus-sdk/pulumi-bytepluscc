...
def get_projects(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProjectsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult).value
...
def get_projects_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProjectsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult)
