...
def get_alarm_notify_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getAlarmNotifyGroup:getAlarmNotifyGroup', __args__, opts=opts, typ=GetAlarmNotifyGroupResult).value
...
def get_alarm_notify_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getAlarmNotifyGroup:getAlarmNotifyGroup', __args__, opts=opts, typ=GetAlarmNotifyGroupResult)
