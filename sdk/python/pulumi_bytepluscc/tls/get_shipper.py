...
def get_shipper(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getShipper:getShipper', __args__, opts=opts, typ=GetShipperResult).value
...
def get_shipper_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getShipper:getShipper', __args__, opts=opts, typ=GetShipperResult)
