...
def get_rule(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getRule:getRule', __args__, opts=opts, typ=GetRuleResult).value
...
def get_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getRule:getRule', __args__, opts=opts, typ=GetRuleResult)
