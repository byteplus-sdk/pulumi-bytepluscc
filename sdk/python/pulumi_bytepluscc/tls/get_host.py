...
def get_host(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getHost:getHost', __args__, opts=opts, typ=GetHostResult).value
...
def get_host_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getHost:getHost', __args__, opts=opts, typ=GetHostResult)
