...
def get_hosts(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetHostsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:tls/getHosts:getHosts', __args__, opts=opts, typ=GetHostsResult).value
...
def get_hosts_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetHostsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:tls/getHosts:getHosts', __args__, opts=opts, typ=GetHostsResult)
