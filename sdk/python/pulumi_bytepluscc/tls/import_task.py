...
@pulumi.type_token("bytepluscc:tls/importTask:ImportTask")
class ImportTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        t_ls_import_task_demo = bytepluscc.tls.ImportTask("TLSImportTaskDemo",
    ...
    def _internal_init(__self__,
        ...
        super(ImportTask, __self__).__init__(
            'bytepluscc:tls/importTask:ImportTask',
            resource_name,
            __props__,
            opts)
