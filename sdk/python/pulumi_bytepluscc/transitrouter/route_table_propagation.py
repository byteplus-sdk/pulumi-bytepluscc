...
@pulumi.type_token("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation")
class RouteTablePropagation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        route_table_propagation_demo = bytepluscc.transitrouter.RouteTablePropagation("RouteTablePropagationDemo",
    ...
    def _internal_init(__self__,
        ...
        super(RouteTablePropagation, __self__).__init__(
            'bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation',
            resource_name,
            __props__,
            opts)
