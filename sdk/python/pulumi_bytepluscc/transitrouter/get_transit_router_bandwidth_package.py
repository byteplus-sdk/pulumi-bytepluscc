...
def get_transit_router_bandwidth_package(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:transitrouter/getTransitRouterBandwidthPackage:getTransitRouterBandwidthPackage', __args__, opts=opts, typ=GetTransitRouterBandwidthPackageResult).value
...
def get_transit_router_bandwidth_package_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:transitrouter/getTransitRouterBandwidthPackage:getTransitRouterBandwidthPackage', __args__, opts=opts, typ=GetTransitRouterBandwidthPackageResult)
