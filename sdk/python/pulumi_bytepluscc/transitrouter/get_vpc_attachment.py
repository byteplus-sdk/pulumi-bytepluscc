...
def get_vpc_attachment(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:transitrouter/getVpcAttachment:getVpcAttachment', __args__, opts=opts, typ=GetVpcAttachmentResult).value
...
def get_vpc_attachment_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:transitrouter/getVpcAttachment:getVpcAttachment', __args__, opts=opts, typ=GetVpcAttachmentResult)
