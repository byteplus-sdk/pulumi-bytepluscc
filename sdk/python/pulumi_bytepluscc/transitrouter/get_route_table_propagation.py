...
def get_route_table_propagation(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:transitrouter/getRouteTablePropagation:getRouteTablePropagation', __args__, opts=opts, typ=GetRouteTablePropagationResult).value
...
def get_route_table_propagation_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:transitrouter/getRouteTablePropagation:getRouteTablePropagation', __args__, opts=opts, typ=GetRouteTablePropagationResult)
