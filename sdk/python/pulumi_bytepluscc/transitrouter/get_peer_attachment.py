...
def get_peer_attachment(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment', __args__, opts=opts, typ=GetPeerAttachmentResult).value
...
def get_peer_attachment_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment', __args__, opts=opts, typ=GetPeerAttachmentResult)
