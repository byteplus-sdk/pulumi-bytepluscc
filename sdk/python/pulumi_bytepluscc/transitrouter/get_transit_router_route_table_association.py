...
def get_transit_router_route_table_association(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:transitrouter/getTransitRouterRouteTableAssociation:getTransitRouterRouteTableAssociation', __args__, opts=opts, typ=GetTransitRouterRouteTableAssociationResult).value
...
def get_transit_router_route_table_association_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:transitrouter/getTransitRouterRouteTableAssociation:getTransitRouterRouteTableAssociation', __args__, opts=opts, typ=GetTransitRouterRouteTableAssociationResult)
