...
def get_vpn_gateway_route(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpn/getVpnGatewayRoute:getVpnGatewayRoute', __args__, opts=opts, typ=GetVpnGatewayRouteResult).value
...
def get_vpn_gateway_route_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpn/getVpnGatewayRoute:getVpnGatewayRoute', __args__, opts=opts, typ=GetVpnGatewayRouteResult)
