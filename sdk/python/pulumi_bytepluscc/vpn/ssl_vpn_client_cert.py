...
@pulumi.type_token("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert")
class SslVpnClientCert(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        v_pnssl_vpn_client_cert_demo = bytepluscc.vpn.SslVpnClientCert("VPNSslVpnClientCertDemo",
    ...
    def _internal_init(__self__,
        ...
        super(SslVpnClientCert, __self__).__init__(
            'bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert',
            resource_name,
            __props__,
            opts)
