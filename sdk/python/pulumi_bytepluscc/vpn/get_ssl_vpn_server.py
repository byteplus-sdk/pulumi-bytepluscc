...
def get_ssl_vpn_server(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpn/getSslVpnServer:getSslVpnServer', __args__, opts=opts, typ=GetSslVpnServerResult).value
...
def get_ssl_vpn_server_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpn/getSslVpnServer:getSslVpnServer', __args__, opts=opts, typ=GetSslVpnServerResult)
