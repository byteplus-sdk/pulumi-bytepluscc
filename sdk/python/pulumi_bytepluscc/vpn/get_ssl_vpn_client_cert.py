...
def get_ssl_vpn_client_cert(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert', __args__, opts=opts, typ=GetSslVpnClientCertResult).value
...
def get_ssl_vpn_client_cert_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert', __args__, opts=opts, typ=GetSslVpnClientCertResult)
