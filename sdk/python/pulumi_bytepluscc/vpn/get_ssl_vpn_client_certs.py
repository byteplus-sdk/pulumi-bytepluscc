...
def get_ssl_vpn_client_certs(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSslVpnClientCertsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vpn/getSslVpnClientCerts:getSslVpnClientCerts', __args__, opts=opts, typ=GetSslVpnClientCertsResult).value
...
def get_ssl_vpn_client_certs_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSslVpnClientCertsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vpn/getSslVpnClientCerts:getSslVpnClientCerts', __args__, opts=opts, typ=GetSslVpnClientCertsResult)
