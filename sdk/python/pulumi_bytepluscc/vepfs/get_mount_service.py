...
def get_mount_service(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vepfs/getMountService:getMountService', __args__, opts=opts, typ=GetMountServiceResult).value
...
def get_mount_service_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vepfs/getMountService:getMountService', __args__, opts=opts, typ=GetMountServiceResult)
