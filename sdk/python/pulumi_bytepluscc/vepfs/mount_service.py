...
@pulumi.type_token("bytepluscc:vepfs/mountService:MountService")
class MountService(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        v_epfs_mount_service_demo = bytepluscc.vepfs.MountService("VEPFSMountServiceDemo",
    ...
    def _internal_init(__self__,
        ...
        super(MountService, __self__).__init__(
            'bytepluscc:vepfs/mountService:MountService',
            resource_name,
            __props__,
            opts)
