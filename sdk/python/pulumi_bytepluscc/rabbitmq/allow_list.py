...
@pulumi.type_token("bytepluscc:rabbitmq/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        rabbit_mq_allow_list_demo = bytepluscc.index.RabbitmqAllowlist("RabbitMQAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:rabbitmq/allowList:AllowList',
            resource_name,
            __props__,
            opts)
