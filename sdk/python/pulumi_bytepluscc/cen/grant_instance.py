...
@pulumi.type_token("bytepluscc:cen/grantInstance:GrantInstance")
class GrantInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        cen_gran_instance_demo = bytepluscc.cen.GrantInstance("CenGranInstanceDemo",
            cen_id="cen-2v72wo******",
            cen_owner_id="210102***",
    ...
    def _internal_init(__self__,
        ...
        super(GrantInstance, __self__).__init__(
            'bytepluscc:cen/grantInstance:GrantInstance',
            resource_name,
            __props__,
            opts)
