...
def get_route_entry(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cen/getRouteEntry:getRouteEntry', __args__, opts=opts, typ=GetRouteEntryResult).value
...
def get_route_entry_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cen/getRouteEntry:getRouteEntry', __args__, opts=opts, typ=GetRouteEntryResult)
