...
def get_inter_region_bandwidth(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cen/getInterRegionBandwidth:getInterRegionBandwidth', __args__, opts=opts, typ=GetInterRegionBandwidthResult).value
...
def get_inter_region_bandwidth_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cen/getInterRegionBandwidth:getInterRegionBandwidth', __args__, opts=opts, typ=GetInterRegionBandwidthResult)
