...
def get_bandwidth_package(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cen/getBandwidthPackage:getBandwidthPackage', __args__, opts=opts, typ=GetBandwidthPackageResult).value
...
def get_bandwidth_package_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cen/getBandwidthPackage:getBandwidthPackage', __args__, opts=opts, typ=GetBandwidthPackageResult)
