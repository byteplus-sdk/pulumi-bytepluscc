...
@pulumi.type_token("bytepluscc:cen/routeEntry:RouteEntry")
class RouteEntry(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        c_en_route_entry_demo = bytepluscc.cen.RouteEntry("CENRouteEntryDemo",
            instance_type="VPC",
    ...
    def _internal_init(__self__,
        ...
        super(RouteEntry, __self__).__init__(
            'bytepluscc:cen/routeEntry:RouteEntry',
            resource_name,
            __props__,
            opts)
