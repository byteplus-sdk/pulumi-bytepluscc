...
@pulumi.type_token("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth")
class InterRegionBandwidth(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        c_en_inter_region_bandwidth_demo = bytepluscc.cen.InterRegionBandwidth("CENInterRegionBandwidthDemo",
    ...
    def _internal_init(__self__,
        ...
        super(InterRegionBandwidth, __self__).__init__(
            'bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth',
            resource_name,
            __props__,
            opts)
