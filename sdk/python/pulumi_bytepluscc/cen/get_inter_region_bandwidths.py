...
def get_inter_region_bandwidths(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetInterRegionBandwidthsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cen/getInterRegionBandwidths:getInterRegionBandwidths', __args__, opts=opts, typ=GetInterRegionBandwidthsResult).value
...
def get_inter_region_bandwidths_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInterRegionBandwidthsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cen/getInterRegionBandwidths:getInterRegionBandwidths', __args__, opts=opts, typ=GetInterRegionBandwidthsResult)
