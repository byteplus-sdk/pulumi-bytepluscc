...
def get_gateway_endpoint(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:privatelink/getGatewayEndpoint:getGatewayEndpoint', __args__, opts=opts, typ=GetGatewayEndpointResult).value
...
def get_gateway_endpoint_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:privatelink/getGatewayEndpoint:getGatewayEndpoint', __args__, opts=opts, typ=GetGatewayEndpointResult)
