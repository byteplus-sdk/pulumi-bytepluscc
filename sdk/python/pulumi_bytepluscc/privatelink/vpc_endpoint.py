...
@pulumi.type_token("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint")
class VpcEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        private_link_vpc_endpoint_demo = bytepluscc.privatelink.VpcEndpoint("PrivateLinkVpcEndpointDemo",
    ...
    def _internal_init(__self__,
        ...
        super(VpcEndpoint, __self__).__init__(
            'bytepluscc:privatelink/vpcEndpoint:VpcEndpoint',
            resource_name,
            __props__,
            opts)
