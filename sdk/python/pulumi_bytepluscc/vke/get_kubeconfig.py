...
def get_kubeconfig(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vke/getKubeconfig:getKubeconfig', __args__, opts=opts, typ=GetKubeconfigResult).value
...
def get_kubeconfig_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vke/getKubeconfig:getKubeconfig', __args__, opts=opts, typ=GetKubeconfigResult)
