...
def get_nodes(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNodesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:vke/getNodes:getNodes', __args__, opts=opts, typ=GetNodesResult).value
...
def get_nodes_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNodesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:vke/getNodes:getNodes', __args__, opts=opts, typ=GetNodesResult)
