...
@pulumi.type_token("bytepluscc:vke/kubeconfig:Kubeconfig")
class Kubeconfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        v_ke_kubeconfig_demo = bytepluscc.vke.Kubeconfig("VKEKubeconfigDemo",
            cluster_id="cd****",
            type="Private",
            valid_duration=2)
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Kubeconfig, __self__).__init__(
            'bytepluscc:vke/kubeconfig:Kubeconfig',
            resource_name,
            __props__,
            opts)
