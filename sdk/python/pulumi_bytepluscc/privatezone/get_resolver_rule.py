...
def get_resolver_rule(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:privatezone/getResolverRule:getResolverRule', __args__, opts=opts, typ=GetResolverRuleResult).value
...
def get_resolver_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:privatezone/getResolverRule:getResolverRule', __args__, opts=opts, typ=GetResolverRuleResult)
