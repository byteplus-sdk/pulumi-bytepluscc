...
def get_private_zone(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:privatezone/getPrivateZone:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult).value
...
def get_private_zone_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:privatezone/getPrivateZone:getPrivateZone', __args__, opts=opts, typ=GetPrivateZoneResult)
