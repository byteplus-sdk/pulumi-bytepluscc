...
@pulumi.type_token("bytepluscc:mongodb/sslState:SslState")
class SslState(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_dbssl_state_demo = bytepluscc.mongodb.SslState("MongoDBSSLStateDemo",
    ...
    def _internal_init(__self__,
        ...
        super(SslState, __self__).__init__(
            'bytepluscc:mongodb/sslState:SslState',
            resource_name,
            __props__,
            opts)
