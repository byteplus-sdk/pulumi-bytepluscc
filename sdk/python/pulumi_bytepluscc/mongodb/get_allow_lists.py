...
def get_allow_lists(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAllowListsResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:mongodb/getAllowLists:getAllowLists', __args__, opts=opts, typ=GetAllowListsResult).value
...
def get_allow_lists_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAllowListsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:mongodb/getAllowLists:getAllowLists', __args__, opts=opts, typ=GetAllowListsResult)
