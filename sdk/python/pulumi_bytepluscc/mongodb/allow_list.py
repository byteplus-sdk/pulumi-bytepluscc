...
@pulumi.type_token("bytepluscc:mongodb/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        mongo_db_allow_list_demo = bytepluscc.mongodb.AllowList("MongoDBAllowListDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:mongodb/allowList:AllowList',
            resource_name,
            __props__,
            opts)
