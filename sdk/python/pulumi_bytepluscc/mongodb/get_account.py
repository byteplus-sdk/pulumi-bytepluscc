...
def get_account(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:mongodb/getAccount:getAccount', __args__, opts=opts, typ=GetAccountResult).value
...
def get_account_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:mongodb/getAccount:getAccount', __args__, opts=opts, typ=GetAccountResult)
