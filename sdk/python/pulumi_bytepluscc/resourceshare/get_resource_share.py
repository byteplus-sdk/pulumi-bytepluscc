...
def get_resource_share(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:resourceshare/getResourceShare:getResourceShare', __args__, opts=opts, typ=GetResourceShareResult).value
...
def get_resource_share_output(id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:resourceshare/getResourceShare:getResourceShare', __args__, opts=opts, typ=GetResourceShareResult)
