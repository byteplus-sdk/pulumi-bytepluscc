...
def get_nlb_security_policy(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy', __args__, opts=opts, typ=GetNlbSecurityPolicyResult).value
...
def get_nlb_security_policy_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy', __args__, opts=opts, typ=GetNlbSecurityPolicyResult)
