...
def get_backup(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:rdsmssql/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult).value
...
def get_backup_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:rdsmssql/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult)
