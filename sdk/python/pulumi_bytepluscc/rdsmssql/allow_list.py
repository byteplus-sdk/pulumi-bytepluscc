...
@pulumi.type_token("bytepluscc:rdsmssql/allowList:AllowList")
class AllowList(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        r_dsms_sql_allowlist_demo = bytepluscc.rdsmssql.AllowList("RDSMsSQLAllowlistDemo",
    ...
    def _internal_init(__self__,
        ...
        super(AllowList, __self__).__init__(
            'bytepluscc:rdsmssql/allowList:AllowList',
            resource_name,
            __props__,
            opts)
