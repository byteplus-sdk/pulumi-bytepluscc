...
def get_host_group(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:waf/getHostGroup:getHostGroup', __args__, opts=opts, typ=GetHostGroupResult).value
...
def get_host_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:waf/getHostGroup:getHostGroup', __args__, opts=opts, typ=GetHostGroupResult)
