...
def get_organization(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:organization/getOrganization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult).value
...
def get_organization_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:organization/getOrganization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
