...
def get_services(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServicesResult:
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:id/getServices:getServices', __args__, opts=opts, typ=GetServicesResult).value
...
def get_services_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetServicesResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:id/getServices:getServices', __args__, opts=opts, typ=GetServicesResult)
