...
def get_hpc_cluster(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:ecs/getHpcCluster:getHpcCluster', __args__, opts=opts, typ=GetHpcClusterResult).value
...
def get_hpc_cluster_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:ecs/getHpcCluster:getHpcCluster', __args__, opts=opts, typ=GetHpcClusterResult)
