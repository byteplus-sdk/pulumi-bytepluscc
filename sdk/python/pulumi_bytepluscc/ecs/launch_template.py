...
@pulumi.type_token("bytepluscc:ecs/launchTemplate:LaunchTemplate")
class LaunchTemplate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ecs_launch_template_demo = bytepluscc.ecs.LaunchTemplate("EcsLaunchTemplateDemo",
    ...
    def _internal_init(__self__,
        ...
        super(LaunchTemplate, __self__).__init__(
            'bytepluscc:ecs/launchTemplate:LaunchTemplate',
            resource_name,
            __props__,
            opts)
