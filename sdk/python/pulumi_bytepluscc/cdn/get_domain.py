...
def get_domain(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:cdn/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult).value
...
def get_domain_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:cdn/getDomain:getDomain', __args__, opts=opts, typ=GetDomainResult)
