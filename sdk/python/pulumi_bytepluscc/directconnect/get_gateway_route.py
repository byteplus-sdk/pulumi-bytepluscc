...
def get_gateway_route(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:directconnect/getGatewayRoute:getGatewayRoute', __args__, opts=opts, typ=GetGatewayRouteResult).value
...
def get_gateway_route_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:directconnect/getGatewayRoute:getGatewayRoute', __args__, opts=opts, typ=GetGatewayRouteResult)
