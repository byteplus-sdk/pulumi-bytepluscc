...
@pulumi.type_token("bytepluscc:directconnect/bgpPeer:BgpPeer")
class BgpPeer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        direct_connect_bgp_peer_demo = bytepluscc.directconnect.BgpPeer("DirectConnectBgpPeerDemo",
            auth_key="QWExxxx",
    ...
    def _internal_init(__self__,
        ...
        super(BgpPeer, __self__).__init__(
            'bytepluscc:directconnect/bgpPeer:BgpPeer',
            resource_name,
            __props__,
            opts)
