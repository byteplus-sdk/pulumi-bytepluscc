...
def get_virtual_interface(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:directconnect/getVirtualInterface:getVirtualInterface', __args__, opts=opts, typ=GetVirtualInterfaceResult).value
...
def get_virtual_interface_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:directconnect/getVirtualInterface:getVirtualInterface', __args__, opts=opts, typ=GetVirtualInterfaceResult)
