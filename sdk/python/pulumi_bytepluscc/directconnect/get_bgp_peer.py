...
def get_bgp_peer(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:directconnect/getBgpPeer:getBgpPeer', __args__, opts=opts, typ=GetBgpPeerResult).value
...
def get_bgp_peer_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:directconnect/getBgpPeer:getBgpPeer', __args__, opts=opts, typ=GetBgpPeerResult)
