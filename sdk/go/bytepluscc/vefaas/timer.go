...
func NewTimer(ctx *pulumi.Context,
	...
	var resource Timer
	err := ctx.RegisterResource("bytepluscc:vefaas/timer:Timer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTimer(ctx *pulumi.Context,
	...
	var resource Timer
	err := ctx.ReadResource("bytepluscc:vefaas/timer:Timer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
