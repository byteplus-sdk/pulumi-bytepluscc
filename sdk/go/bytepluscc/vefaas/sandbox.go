...
func NewSandbox(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vefaas/sandbox:Sandbox", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSandbox(ctx *pulumi.Context,
	...
	var resource Sandbox
	err := ctx.ReadResource("bytepluscc:vefaas/sandbox:Sandbox", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
