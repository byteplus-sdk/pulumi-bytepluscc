...
func NewKafkaTrigger(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKafkaTrigger(ctx *pulumi.Context,
	...
	var resource KafkaTrigger
	err := ctx.ReadResource("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
