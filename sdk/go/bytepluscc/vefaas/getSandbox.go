...
func LookupSandbox(ctx *pulumi.Context, args *LookupSandboxArgs, opts ...pulumi.InvokeOption) (*LookupSandboxResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vefaas/getSandbox:getSandbox", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSandboxOutput(ctx *pulumi.Context, args LookupSandboxOutputArgs, opts ...pulumi.InvokeOption) LookupSandboxResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSandboxResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:vefaas/getSandbox:getSandbox", args, LookupSandboxResultOutput{}, options).(LookupSandboxResultOutput), nil
