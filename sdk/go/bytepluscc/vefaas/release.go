...
func NewRelease(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vefaas/release:Release", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRelease(ctx *pulumi.Context,
	...
	var resource Release
	err := ctx.ReadResource("bytepluscc:vefaas/release:Release", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
