...
func NewHpcCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/hpcCluster:HpcCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHpcCluster(ctx *pulumi.Context,
	...
	var resource HpcCluster
	err := ctx.ReadResource("bytepluscc:ecs/hpcCluster:HpcCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
