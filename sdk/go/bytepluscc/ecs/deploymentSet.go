...
func NewDeploymentSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/deploymentSet:DeploymentSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDeploymentSet(ctx *pulumi.Context,
	...
	var resource DeploymentSet
	err := ctx.ReadResource("bytepluscc:ecs/deploymentSet:DeploymentSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
