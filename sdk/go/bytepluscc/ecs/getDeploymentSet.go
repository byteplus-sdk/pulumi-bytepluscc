...
func LookupDeploymentSet(ctx *pulumi.Context, args *LookupDeploymentSetArgs, opts ...pulumi.InvokeOption) (*LookupDeploymentSetResult, error) {
	...
	err := ctx.Invoke("bytepluscc:ecs/getDeploymentSet:getDeploymentSet", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDeploymentSetOutput(ctx *pulumi.Context, args LookupDeploymentSetOutputArgs, opts ...pulumi.InvokeOption) LookupDeploymentSetResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDeploymentSetResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:ecs/getDeploymentSet:getDeploymentSet", args, LookupDeploymentSetResultOutput{}, options).(LookupDeploymentSetResultOutput), nil
