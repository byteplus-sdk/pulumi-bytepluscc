...
func NewInvocation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/invocation:Invocation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInvocation(ctx *pulumi.Context,
	...
	var resource Invocation
	err := ctx.ReadResource("bytepluscc:ecs/invocation:Invocation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
