...
func NewLaunchTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLaunchTemplate(ctx *pulumi.Context,
	...
	var resource LaunchTemplate
	err := ctx.ReadResource("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
