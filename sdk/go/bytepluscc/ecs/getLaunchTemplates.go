...
func GetLaunchTemplates(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetLaunchTemplatesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:ecs/getLaunchTemplates:getLaunchTemplates", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetLaunchTemplatesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetLaunchTemplatesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetLaunchTemplatesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:ecs/getLaunchTemplates:getLaunchTemplates", nil, GetLaunchTemplatesResultOutput{}, options).(GetLaunchTemplatesResultOutput), nil
