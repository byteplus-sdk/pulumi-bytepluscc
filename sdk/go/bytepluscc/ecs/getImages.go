...
func GetImages(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetImagesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:ecs/getImages:getImages", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetImagesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetImagesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetImagesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:ecs/getImages:getImages", nil, GetImagesResultOutput{}, options).(GetImagesResultOutput), nil
