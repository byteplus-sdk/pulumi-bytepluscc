...
func GetKeypairs(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetKeypairsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:ecs/getKeypairs:getKeypairs", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetKeypairsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetKeypairsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetKeypairsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:ecs/getKeypairs:getKeypairs", nil, GetKeypairsResultOutput{}, options).(GetKeypairsResultOutput), nil
