...
func NewLaunchTemplateVersion(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLaunchTemplateVersion(ctx *pulumi.Context,
	...
	var resource LaunchTemplateVersion
	err := ctx.ReadResource("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
