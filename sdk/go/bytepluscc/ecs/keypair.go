...
func NewKeypair(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ecs/keypair:Keypair", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeypair(ctx *pulumi.Context,
	...
	var resource Keypair
	err := ctx.ReadResource("bytepluscc:ecs/keypair:Keypair", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
