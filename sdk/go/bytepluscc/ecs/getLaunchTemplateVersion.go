...
func LookupLaunchTemplateVersion(ctx *pulumi.Context, args *LookupLaunchTemplateVersionArgs, opts ...pulumi.InvokeOption) (*LookupLaunchTemplateVersionResult, error) {
	...
	err := ctx.Invoke("bytepluscc:ecs/getLaunchTemplateVersion:getLaunchTemplateVersion", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupLaunchTemplateVersionOutput(ctx *pulumi.Context, args LookupLaunchTemplateVersionOutputArgs, opts ...pulumi.InvokeOption) LookupLaunchTemplateVersionResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupLaunchTemplateVersionResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:ecs/getLaunchTemplateVersion:getLaunchTemplateVersion", args, LookupLaunchTemplateVersionResultOutput{}, options).(LookupLaunchTemplateVersionResultOutput), nil
