...
func LookupDnsControlPolicy(ctx *pulumi.Context, args *LookupDnsControlPolicyArgs, opts ...pulumi.InvokeOption) (*LookupDnsControlPolicyResult, error) {
	...
	err := ctx.Invoke("bytepluscc:firewallcenter/getDnsControlPolicy:getDnsControlPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupDnsControlPolicyOutput(ctx *pulumi.Context, args LookupDnsControlPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupDnsControlPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupDnsControlPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:firewallcenter/getDnsControlPolicy:getDnsControlPolicy", args, LookupDnsControlPolicyResultOutput{}, options).(LookupDnsControlPolicyResultOutput), nil
