...
func NewSslVpnClientCert(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslVpnClientCert(ctx *pulumi.Context,
	...
	var resource SslVpnClientCert
	err := ctx.ReadResource("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
