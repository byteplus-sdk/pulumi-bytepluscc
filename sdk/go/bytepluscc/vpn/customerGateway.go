...
func NewCustomerGateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpn/customerGateway:CustomerGateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomerGateway(ctx *pulumi.Context,
	...
	var resource CustomerGateway
	err := ctx.ReadResource("bytepluscc:vpn/customerGateway:CustomerGateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
