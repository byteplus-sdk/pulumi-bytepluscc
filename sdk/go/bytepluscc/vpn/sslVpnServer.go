...
func NewSslVpnServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslVpnServer(ctx *pulumi.Context,
	...
	var resource SslVpnServer
	err := ctx.ReadResource("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
