...
func GetSslVpnClientCerts(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSslVpnClientCertsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpn/getSslVpnClientCerts:getSslVpnClientCerts", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSslVpnClientCertsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSslVpnClientCertsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSslVpnClientCertsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpn/getSslVpnClientCerts:getSslVpnClientCerts", nil, GetSslVpnClientCertsResultOutput{}, options).(GetSslVpnClientCertsResultOutput), nil
