...
func GetSslVpnServers(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSslVpnServersResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpn/getSslVpnServers:getSslVpnServers", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSslVpnServersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSslVpnServersResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSslVpnServersResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpn/getSslVpnServers:getSslVpnServers", nil, GetSslVpnServersResultOutput{}, options).(GetSslVpnServersResultOutput), nil
