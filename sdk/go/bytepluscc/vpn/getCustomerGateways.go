...
func GetCustomerGateways(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetCustomerGatewaysResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpn/getCustomerGateways:getCustomerGateways", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCustomerGatewaysOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCustomerGatewaysResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCustomerGatewaysResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpn/getCustomerGateways:getCustomerGateways", nil, GetCustomerGatewaysResultOutput{}, options).(GetCustomerGatewaysResultOutput), nil
