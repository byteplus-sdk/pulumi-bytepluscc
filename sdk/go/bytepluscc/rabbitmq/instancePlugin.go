...
func NewInstancePlugin(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstancePlugin(ctx *pulumi.Context,
	...
	var resource InstancePlugin
	err := ctx.ReadResource("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
