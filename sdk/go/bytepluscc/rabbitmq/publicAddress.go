...
func NewPublicAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPublicAddress(ctx *pulumi.Context,
	...
	var resource PublicAddress
	err := ctx.ReadResource("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
