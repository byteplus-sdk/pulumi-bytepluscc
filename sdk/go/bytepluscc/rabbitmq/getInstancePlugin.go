...
func LookupInstancePlugin(ctx *pulumi.Context, args *LookupInstancePluginArgs, opts ...pulumi.InvokeOption) (*LookupInstancePluginResult, error) {
	...
	err := ctx.Invoke("bytepluscc:rabbitmq/getInstancePlugin:getInstancePlugin", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupInstancePluginOutput(ctx *pulumi.Context, args LookupInstancePluginOutputArgs, opts ...pulumi.InvokeOption) LookupInstancePluginResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupInstancePluginResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:rabbitmq/getInstancePlugin:getInstancePlugin", args, LookupInstancePluginResultOutput{}, options).(LookupInstancePluginResultOutput), nil
