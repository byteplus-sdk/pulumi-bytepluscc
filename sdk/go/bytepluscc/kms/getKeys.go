...
func GetKeys(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetKeysResult, error) {
	...
	err := ctx.Invoke("bytepluscc:kms/getKeys:getKeys", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetKeysOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetKeysResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetKeysResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:kms/getKeys:getKeys", nil, GetKeysResultOutput{}, options).(GetKeysResultOutput), nil
	}).(GetKeysResultOutput)
}
