...
func LookupKeyRing(ctx *pulumi.Context, args *LookupKeyRingArgs, opts ...pulumi.InvokeOption) (*LookupKeyRingResult, error) {
	...
	err := ctx.Invoke("bytepluscc:kms/getKeyRing:getKeyRing", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupKeyRingOutput(ctx *pulumi.Context, args LookupKeyRingOutputArgs, opts ...pulumi.InvokeOption) LookupKeyRingResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupKeyRingResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:kms/getKeyRing:getKeyRing", args, LookupKeyRingResultOutput{}, options).(LookupKeyRingResultOutput), nil
