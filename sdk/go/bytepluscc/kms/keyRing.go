...
func NewKeyRing(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:kms/keyRing:KeyRing", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKeyRing(ctx *pulumi.Context,
	...
	var resource KeyRing
	err := ctx.ReadResource("bytepluscc:kms/keyRing:KeyRing", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
