...
func GetGatewayRoutes(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetGatewayRoutesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:directconnect/getGatewayRoutes:getGatewayRoutes", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetGatewayRoutesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetGatewayRoutesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetGatewayRoutesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:directconnect/getGatewayRoutes:getGatewayRoutes", nil, GetGatewayRoutesResultOutput{}, options).(GetGatewayRoutesResultOutput), nil
