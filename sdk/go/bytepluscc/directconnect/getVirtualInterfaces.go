...
func GetVirtualInterfaces(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVirtualInterfacesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:directconnect/getVirtualInterfaces:getVirtualInterfaces", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVirtualInterfacesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVirtualInterfacesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVirtualInterfacesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:directconnect/getVirtualInterfaces:getVirtualInterfaces", nil, GetVirtualInterfacesResultOutput{}, options).(GetVirtualInterfacesResultOutput), nil
