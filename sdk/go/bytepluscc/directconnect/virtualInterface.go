...
func NewVirtualInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualInterface(ctx *pulumi.Context,
	...
	var resource VirtualInterface
	err := ctx.ReadResource("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
