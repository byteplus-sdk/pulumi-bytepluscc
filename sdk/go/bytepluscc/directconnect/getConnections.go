...
func GetConnections(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetConnectionsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:directconnect/getConnections:getConnections", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetConnectionsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetConnectionsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetConnectionsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:directconnect/getConnections:getConnections", nil, GetConnectionsResultOutput{}, options).(GetConnectionsResultOutput), nil
