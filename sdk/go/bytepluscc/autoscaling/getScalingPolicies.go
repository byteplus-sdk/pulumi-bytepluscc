...
func GetScalingPolicies(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetScalingPoliciesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:autoscaling/getScalingPolicies:getScalingPolicies", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetScalingPoliciesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetScalingPoliciesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetScalingPoliciesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:autoscaling/getScalingPolicies:getScalingPolicies", nil, GetScalingPoliciesResultOutput{}, options).(GetScalingPoliciesResultOutput), nil
