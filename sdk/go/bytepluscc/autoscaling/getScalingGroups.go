...
func GetScalingGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetScalingGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:autoscaling/getScalingGroups:getScalingGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetScalingGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetScalingGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetScalingGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:autoscaling/getScalingGroups:getScalingGroups", nil, GetScalingGroupsResultOutput{}, options).(GetScalingGroupsResultOutput), nil
