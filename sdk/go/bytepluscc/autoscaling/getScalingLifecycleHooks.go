...
func GetScalingLifecycleHooks(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetScalingLifecycleHooksResult, error) {
	...
	err := ctx.Invoke("bytepluscc:autoscaling/getScalingLifecycleHooks:getScalingLifecycleHooks", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetScalingLifecycleHooksOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetScalingLifecycleHooksResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetScalingLifecycleHooksResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:autoscaling/getScalingLifecycleHooks:getScalingLifecycleHooks", nil, GetScalingLifecycleHooksResultOutput{}, options).(GetScalingLifecycleHooksResultOutput), nil
