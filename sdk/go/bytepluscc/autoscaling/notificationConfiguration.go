...
func NewNotificationConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNotificationConfiguration(ctx *pulumi.Context,
	...
	var resource NotificationConfiguration
	err := ctx.ReadResource("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
