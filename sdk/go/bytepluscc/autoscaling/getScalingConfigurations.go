...
func GetScalingConfigurations(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetScalingConfigurationsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:autoscaling/getScalingConfigurations:getScalingConfigurations", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetScalingConfigurationsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetScalingConfigurationsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetScalingConfigurationsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:autoscaling/getScalingConfigurations:getScalingConfigurations", nil, GetScalingConfigurationsResultOutput{}, options).(GetScalingConfigurationsResultOutput), nil
