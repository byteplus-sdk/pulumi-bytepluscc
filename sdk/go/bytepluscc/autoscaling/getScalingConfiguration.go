...
func LookupScalingConfiguration(ctx *pulumi.Context, args *LookupScalingConfigurationArgs, opts ...pulumi.InvokeOption) (*LookupScalingConfigurationResult, error) {
	...
	err := ctx.Invoke("bytepluscc:autoscaling/getScalingConfiguration:getScalingConfiguration", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScalingConfigurationOutput(ctx *pulumi.Context, args LookupScalingConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupScalingConfigurationResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScalingConfigurationResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:autoscaling/getScalingConfiguration:getScalingConfiguration", args, LookupScalingConfigurationResultOutput{}, options).(LookupScalingConfigurationResultOutput), nil
