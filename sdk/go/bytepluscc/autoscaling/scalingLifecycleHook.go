...
func NewScalingLifecycleHook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingLifecycleHook(ctx *pulumi.Context,
	...
	var resource ScalingLifecycleHook
	err := ctx.ReadResource("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
