...
func NewScalingConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScalingConfiguration(ctx *pulumi.Context,
	...
	var resource ScalingConfiguration
	err := ctx.ReadResource("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
