...
func NewBackupSchedule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:dns/backupSchedule:BackupSchedule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBackupSchedule(ctx *pulumi.Context,
	...
	var resource BackupSchedule
	err := ctx.ReadResource("bytepluscc:dns/backupSchedule:BackupSchedule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
