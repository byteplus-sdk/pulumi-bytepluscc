...
func GetZones(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetZonesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:dns/getZones:getZones", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetZonesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetZonesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetZonesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:dns/getZones:getZones", nil, GetZonesResultOutput{}, options).(GetZonesResultOutput), nil
