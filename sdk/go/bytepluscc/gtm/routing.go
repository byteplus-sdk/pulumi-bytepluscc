...
func NewRouting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:gtm/routing:Routing", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouting(ctx *pulumi.Context,
	...
	var resource Routing
	err := ctx.ReadResource("bytepluscc:gtm/routing:Routing", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
