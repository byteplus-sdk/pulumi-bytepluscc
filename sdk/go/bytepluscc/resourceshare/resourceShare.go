...
func NewResourceShare(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:resourceshare/resourceShare:ResourceShare", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResourceShare(ctx *pulumi.Context,
	...
	var resource ResourceShare
	err := ctx.ReadResource("bytepluscc:resourceshare/resourceShare:ResourceShare", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
