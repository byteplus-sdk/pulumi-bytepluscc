...
func GetResourceShares(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetResourceSharesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:resourceshare/getResourceShares:getResourceShares", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetResourceSharesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetResourceSharesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetResourceSharesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:resourceshare/getResourceShares:getResourceShares", nil, GetResourceSharesResultOutput{}, options).(GetResourceSharesResultOutput), nil
