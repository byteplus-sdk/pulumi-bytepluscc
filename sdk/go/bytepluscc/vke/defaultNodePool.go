...
func NewDefaultNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultNodePool(ctx *pulumi.Context,
	...
	var resource DefaultNodePool
	err := ctx.ReadResource("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
