...
func NewNodePool(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vke/nodePool:NodePool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodePool(ctx *pulumi.Context,
	...
	var resource NodePool
	err := ctx.ReadResource("bytepluscc:vke/nodePool:NodePool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
