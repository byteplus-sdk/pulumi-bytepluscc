...
func NewKubeconfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vke/kubeconfig:Kubeconfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetKubeconfig(ctx *pulumi.Context,
	...
	var resource Kubeconfig
	err := ctx.ReadResource("bytepluscc:vke/kubeconfig:Kubeconfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
