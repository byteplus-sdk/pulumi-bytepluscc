...
func NewPermission(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vke/permission:Permission", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPermission(ctx *pulumi.Context,
	...
	var resource Permission
	err := ctx.ReadResource("bytepluscc:vke/permission:Permission", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
