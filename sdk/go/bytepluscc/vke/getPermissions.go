...
func GetPermissions(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetPermissionsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vke/getPermissions:getPermissions", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPermissionsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetPermissionsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetPermissionsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vke/getPermissions:getPermissions", nil, GetPermissionsResultOutput{}, options).(GetPermissionsResultOutput), nil
