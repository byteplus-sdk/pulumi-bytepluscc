...
func NewUpstream(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:apig/upstream:Upstream", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpstream(ctx *pulumi.Context,
	...
	var resource Upstream
	err := ctx.ReadResource("bytepluscc:apig/upstream:Upstream", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
