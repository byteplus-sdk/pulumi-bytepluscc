...
func LookupUpstream(ctx *pulumi.Context, args *LookupUpstreamArgs, opts ...pulumi.InvokeOption) (*LookupUpstreamResult, error) {
	...
	err := ctx.Invoke("bytepluscc:apig/getUpstream:getUpstream", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUpstreamOutput(ctx *pulumi.Context, args LookupUpstreamOutputArgs, opts ...pulumi.InvokeOption) LookupUpstreamResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUpstreamResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:apig/getUpstream:getUpstream", args, LookupUpstreamResultOutput{}, options).(LookupUpstreamResultOutput), nil
