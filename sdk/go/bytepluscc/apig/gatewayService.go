...
func NewGatewayService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:apig/gatewayService:GatewayService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayService(ctx *pulumi.Context,
	...
	var resource GatewayService
	err := ctx.ReadResource("bytepluscc:apig/gatewayService:GatewayService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
