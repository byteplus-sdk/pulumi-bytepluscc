...
func GetCustomDomains(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetCustomDomainsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:apig/getCustomDomains:getCustomDomains", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCustomDomainsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCustomDomainsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCustomDomainsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:apig/getCustomDomains:getCustomDomains", nil, GetCustomDomainsResultOutput{}, options).(GetCustomDomainsResultOutput), nil
