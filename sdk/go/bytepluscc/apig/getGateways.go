...
func GetGateways(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetGatewaysResult, error) {
	...
	err := ctx.Invoke("bytepluscc:apig/getGateways:getGateways", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetGatewaysOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetGatewaysResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetGatewaysResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:apig/getGateways:getGateways", nil, GetGatewaysResultOutput{}, options).(GetGatewaysResultOutput), nil
