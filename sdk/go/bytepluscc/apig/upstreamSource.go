...
func NewUpstreamSource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:apig/upstreamSource:UpstreamSource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUpstreamSource(ctx *pulumi.Context,
	...
	var resource UpstreamSource
	err := ctx.ReadResource("bytepluscc:apig/upstreamSource:UpstreamSource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
