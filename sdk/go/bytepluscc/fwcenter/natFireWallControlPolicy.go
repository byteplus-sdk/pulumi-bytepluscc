...
func NewNatFireWallControlPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatFireWallControlPolicy(ctx *pulumi.Context,
	...
	var resource NatFireWallControlPolicy
	err := ctx.ReadResource("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
