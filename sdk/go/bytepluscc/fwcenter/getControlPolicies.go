...
func GetControlPolicies(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetControlPoliciesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:fwcenter/getControlPolicies:getControlPolicies", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetControlPoliciesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetControlPoliciesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetControlPoliciesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:fwcenter/getControlPolicies:getControlPolicies", nil, GetControlPoliciesResultOutput{}, options).(GetControlPoliciesResultOutput), nil
