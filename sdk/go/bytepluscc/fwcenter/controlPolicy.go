...
func NewControlPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:fwcenter/controlPolicy:ControlPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetControlPolicy(ctx *pulumi.Context,
	...
	var resource ControlPolicy
	err := ctx.ReadResource("bytepluscc:fwcenter/controlPolicy:ControlPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
