...
func NewAddressBook(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:fwcenter/addressBook:AddressBook", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAddressBook(ctx *pulumi.Context,
	...
	var resource AddressBook
	err := ctx.ReadResource("bytepluscc:fwcenter/addressBook:AddressBook", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
