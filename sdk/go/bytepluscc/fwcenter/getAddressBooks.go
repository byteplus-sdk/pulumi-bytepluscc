...
func GetAddressBooks(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetAddressBooksResult, error) {
	...
	err := ctx.Invoke("bytepluscc:fwcenter/getAddressBooks:getAddressBooks", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAddressBooksOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAddressBooksResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetAddressBooksResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:fwcenter/getAddressBooks:getAddressBooks", nil, GetAddressBooksResultOutput{}, options).(GetAddressBooksResultOutput), nil
