...
func NewAlertingRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vmp/alertingRule:AlertingRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlertingRule(ctx *pulumi.Context,
	...
	var resource AlertingRule
	err := ctx.ReadResource("bytepluscc:vmp/alertingRule:AlertingRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
