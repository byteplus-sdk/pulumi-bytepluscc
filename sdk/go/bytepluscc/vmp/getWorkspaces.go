...
func GetWorkspaces(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetWorkspacesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vmp/getWorkspaces:getWorkspaces", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetWorkspacesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetWorkspacesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetWorkspacesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vmp/getWorkspaces:getWorkspaces", nil, GetWorkspacesResultOutput{}, options).(GetWorkspacesResultOutput), nil
