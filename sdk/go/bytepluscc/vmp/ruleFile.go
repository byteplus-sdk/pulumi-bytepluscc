...
func NewRuleFile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vmp/ruleFile:RuleFile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRuleFile(ctx *pulumi.Context,
	...
	var resource RuleFile
	err := ctx.ReadResource("bytepluscc:vmp/ruleFile:RuleFile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
