...
func NewGatewayEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGatewayEndpoint(ctx *pulumi.Context,
	...
	var resource GatewayEndpoint
	err := ctx.ReadResource("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
