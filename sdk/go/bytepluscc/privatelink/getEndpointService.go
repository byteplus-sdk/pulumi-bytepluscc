...
func LookupEndpointService(ctx *pulumi.Context, args *LookupEndpointServiceArgs, opts ...pulumi.InvokeOption) (*LookupEndpointServiceResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatelink/getEndpointService:getEndpointService", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupEndpointServiceOutput(ctx *pulumi.Context, args LookupEndpointServiceOutputArgs, opts ...pulumi.InvokeOption) LookupEndpointServiceResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupEndpointServiceResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:privatelink/getEndpointService:getEndpointService", args, LookupEndpointServiceResultOutput{}, options).(LookupEndpointServiceResultOutput), nil
