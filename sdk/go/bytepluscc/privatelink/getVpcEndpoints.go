...
func GetVpcEndpoints(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpcEndpointsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatelink/getVpcEndpoints:getVpcEndpoints", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpcEndpointsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpcEndpointsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpcEndpointsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatelink/getVpcEndpoints:getVpcEndpoints", nil, GetVpcEndpointsResultOutput{}, options).(GetVpcEndpointsResultOutput), nil
