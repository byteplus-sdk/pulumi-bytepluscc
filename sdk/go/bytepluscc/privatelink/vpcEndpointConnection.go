...
func NewVpcEndpointConnection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatelink/vpcEndpointConnection:VpcEndpointConnection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcEndpointConnection(ctx *pulumi.Context,
	...
	var resource VpcEndpointConnection
	err := ctx.ReadResource("bytepluscc:privatelink/vpcEndpointConnection:VpcEndpointConnection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
