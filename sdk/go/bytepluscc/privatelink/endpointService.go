...
func NewEndpointService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatelink/endpointService:EndpointService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointService(ctx *pulumi.Context,
	...
	var resource EndpointService
	err := ctx.ReadResource("bytepluscc:privatelink/endpointService:EndpointService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
