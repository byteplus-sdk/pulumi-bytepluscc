...
func GetVpcEndpointConnections(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpcEndpointConnectionsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatelink/getVpcEndpointConnections:getVpcEndpointConnections", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpcEndpointConnectionsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpcEndpointConnectionsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpcEndpointConnectionsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatelink/getVpcEndpointConnections:getVpcEndpointConnections", nil, GetVpcEndpointConnectionsResultOutput{}, options).(GetVpcEndpointConnectionsResultOutput), nil
