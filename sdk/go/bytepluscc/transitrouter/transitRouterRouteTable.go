...
func NewTransitRouterRouteTable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransitRouterRouteTable(ctx *pulumi.Context,
	...
	var resource TransitRouterRouteTable
	err := ctx.ReadResource("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
