...
func NewRouteTablePropagation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteTablePropagation(ctx *pulumi.Context,
	...
	var resource RouteTablePropagation
	err := ctx.ReadResource("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
