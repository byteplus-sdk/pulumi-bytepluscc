...
func GetPeerAttachments(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetPeerAttachmentsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:transitrouter/getPeerAttachments:getPeerAttachments", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPeerAttachmentsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetPeerAttachmentsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetPeerAttachmentsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:transitrouter/getPeerAttachments:getPeerAttachments", nil, GetPeerAttachmentsResultOutput{}, options).(GetPeerAttachmentsResultOutput), nil
