...
func GetTransitRouterRouteEntries(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetTransitRouterRouteEntriesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:transitrouter/getTransitRouterRouteEntries:getTransitRouterRouteEntries", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTransitRouterRouteEntriesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetTransitRouterRouteEntriesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetTransitRouterRouteEntriesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:transitrouter/getTransitRouterRouteEntries:getTransitRouterRouteEntries", nil, GetTransitRouterRouteEntriesResultOutput{}, options).(GetTransitRouterRouteEntriesResultOutput), nil
