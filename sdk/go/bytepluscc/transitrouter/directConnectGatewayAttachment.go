...
func NewDirectConnectGatewayAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDirectConnectGatewayAttachment(ctx *pulumi.Context,
	...
	var resource DirectConnectGatewayAttachment
	err := ctx.ReadResource("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
