...
func GetVpnAttachments(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpnAttachmentsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:transitrouter/getVpnAttachments:getVpnAttachments", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpnAttachmentsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpnAttachmentsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpnAttachmentsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:transitrouter/getVpnAttachments:getVpnAttachments", nil, GetVpnAttachmentsResultOutput{}, options).(GetVpnAttachmentsResultOutput), nil
