...
func NewTransitRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/transitRouter:TransitRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransitRouter(ctx *pulumi.Context,
	...
	var resource TransitRouter
	err := ctx.ReadResource("bytepluscc:transitrouter/transitRouter:TransitRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
