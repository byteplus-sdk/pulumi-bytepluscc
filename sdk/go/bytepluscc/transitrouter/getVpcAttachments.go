...
func GetVpcAttachments(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpcAttachmentsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:transitrouter/getVpcAttachments:getVpcAttachments", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpcAttachmentsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpcAttachmentsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpcAttachmentsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:transitrouter/getVpcAttachments:getVpcAttachments", nil, GetVpcAttachmentsResultOutput{}, options).(GetVpcAttachmentsResultOutput), nil
