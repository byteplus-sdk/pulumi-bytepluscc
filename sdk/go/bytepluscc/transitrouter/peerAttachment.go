...
func NewPeerAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPeerAttachment(ctx *pulumi.Context,
	...
	var resource PeerAttachment
	err := ctx.ReadResource("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
