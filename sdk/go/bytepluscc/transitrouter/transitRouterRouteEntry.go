...
func NewTransitRouterRouteEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransitRouterRouteEntry(ctx *pulumi.Context,
	...
	var resource TransitRouterRouteEntry
	err := ctx.ReadResource("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
