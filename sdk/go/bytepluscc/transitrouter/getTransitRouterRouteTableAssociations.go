...
func GetTransitRouterRouteTableAssociations(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetTransitRouterRouteTableAssociationsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:transitrouter/getTransitRouterRouteTableAssociations:getTransitRouterRouteTableAssociations", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTransitRouterRouteTableAssociationsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetTransitRouterRouteTableAssociationsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetTransitRouterRouteTableAssociationsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:transitrouter/getTransitRouterRouteTableAssociations:getTransitRouterRouteTableAssociations", nil, GetTransitRouterRouteTableAssociationsResultOutput{}, options).(GetTransitRouterRouteTableAssociationsResultOutput), nil
