...
func NewTransitRouterRouteTableAssociation(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTransitRouterRouteTableAssociation(ctx *pulumi.Context,
	...
	var resource TransitRouterRouteTableAssociation
	err := ctx.ReadResource("bytepluscc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
