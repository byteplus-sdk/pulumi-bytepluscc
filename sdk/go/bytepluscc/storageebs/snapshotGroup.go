...
func NewSnapshotGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnapshotGroup(ctx *pulumi.Context,
	...
	var resource SnapshotGroup
	err := ctx.ReadResource("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
