...
func GetVolumes(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVolumesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:storageebs/getVolumes:getVolumes", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVolumesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVolumesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVolumesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:storageebs/getVolumes:getVolumes", nil, GetVolumesResultOutput{}, options).(GetVolumesResultOutput), nil
