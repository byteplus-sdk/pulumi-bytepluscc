...
func GetSnapshotPolicies(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSnapshotPoliciesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:storageebs/getSnapshotPolicies:getSnapshotPolicies", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSnapshotPoliciesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSnapshotPoliciesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSnapshotPoliciesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:storageebs/getSnapshotPolicies:getSnapshotPolicies", nil, GetSnapshotPoliciesResultOutput{}, options).(GetSnapshotPoliciesResultOutput), nil
