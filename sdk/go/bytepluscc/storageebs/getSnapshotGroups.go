...
func GetSnapshotGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSnapshotGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:storageebs/getSnapshotGroups:getSnapshotGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSnapshotGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSnapshotGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSnapshotGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:storageebs/getSnapshotGroups:getSnapshotGroups", nil, GetSnapshotGroupsResultOutput{}, options).(GetSnapshotGroupsResultOutput), nil
