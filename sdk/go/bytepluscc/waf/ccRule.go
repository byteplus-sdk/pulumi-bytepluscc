...
func NewCcRule(ctx *pulumi.Context,
	...
	var resource CcRule
	err := ctx.RegisterResource("bytepluscc:waf/ccRule:CcRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCcRule(ctx *pulumi.Context,
	...
	var resource CcRule
	err := ctx.ReadResource("bytepluscc:waf/ccRule:CcRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
