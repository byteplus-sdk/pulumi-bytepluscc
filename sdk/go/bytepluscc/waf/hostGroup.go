...
func NewHostGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:waf/hostGroup:HostGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHostGroup(ctx *pulumi.Context,
	...
	var resource HostGroup
	err := ctx.ReadResource("bytepluscc:waf/hostGroup:HostGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
