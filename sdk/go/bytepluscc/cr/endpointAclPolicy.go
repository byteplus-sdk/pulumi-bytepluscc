...
func NewEndpointAclPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointAclPolicy(ctx *pulumi.Context,
	...
	var resource EndpointAclPolicy
	err := ctx.ReadResource("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
