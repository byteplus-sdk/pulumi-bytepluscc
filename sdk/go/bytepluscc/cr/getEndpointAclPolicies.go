...
func GetEndpointAclPolicies(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetEndpointAclPoliciesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cr/getEndpointAclPolicies:getEndpointAclPolicies", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEndpointAclPoliciesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetEndpointAclPoliciesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetEndpointAclPoliciesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cr/getEndpointAclPolicies:getEndpointAclPolicies", nil, GetEndpointAclPoliciesResultOutput{}, options).(GetEndpointAclPoliciesResultOutput), nil
