...
func NewRepository(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cr/repository:Repository", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRepository(ctx *pulumi.Context,
	...
	var resource Repository
	err := ctx.ReadResource("bytepluscc:cr/repository:Repository", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
