...
func NewNameSpace(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cr/nameSpace:NameSpace", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNameSpace(ctx *pulumi.Context,
	...
	var resource NameSpace
	err := ctx.ReadResource("bytepluscc:cr/nameSpace:NameSpace", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
