...
func NewVpcEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcEndpoint(ctx *pulumi.Context,
	...
	var resource VpcEndpoint
	err := ctx.ReadResource("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
