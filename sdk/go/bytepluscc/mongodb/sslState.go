...
func NewSslState(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:mongodb/sslState:SslState", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSslState(ctx *pulumi.Context,
	...
	var resource SslState
	err := ctx.ReadResource("bytepluscc:mongodb/sslState:SslState", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
