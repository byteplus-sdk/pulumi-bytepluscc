...
func NewHaVip(ctx *pulumi.Context,
	...
	var resource HaVip
	err := ctx.RegisterResource("bytepluscc:vpc/haVip:HaVip", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHaVip(ctx *pulumi.Context,
	...
	var resource HaVip
	err := ctx.ReadResource("bytepluscc:vpc/haVip:HaVip", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
