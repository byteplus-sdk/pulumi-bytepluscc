...
func GetRouteTables(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetRouteTablesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getRouteTables:getRouteTables", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRouteTablesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetRouteTablesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetRouteTablesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getRouteTables:getRouteTables", nil, GetRouteTablesResultOutput{}, options).(GetRouteTablesResultOutput), nil
