...
func GetVpcs(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetVpcsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getVpcs:getVpcs", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetVpcsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetVpcsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetVpcsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getVpcs:getVpcs", nil, GetVpcsResultOutput{}, options).(GetVpcsResultOutput), nil
	}).(GetVpcsResultOutput)
}
