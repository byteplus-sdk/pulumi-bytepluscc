...
func NewIpPool(ctx *pulumi.Context,
	...
	var resource IpPool
	err := ctx.RegisterResource("bytepluscc:vpc/ipPool:IpPool", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpPool(ctx *pulumi.Context,
	...
	var resource IpPool
	err := ctx.ReadResource("bytepluscc:vpc/ipPool:IpPool", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
