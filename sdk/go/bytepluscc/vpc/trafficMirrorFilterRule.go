...
func NewTrafficMirrorFilterRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/trafficMirrorFilterRule:TrafficMirrorFilterRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficMirrorFilterRule(ctx *pulumi.Context,
	...
	var resource TrafficMirrorFilterRule
	err := ctx.ReadResource("bytepluscc:vpc/trafficMirrorFilterRule:TrafficMirrorFilterRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
