...
func NewIpv6AddressBandwidth(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv6AddressBandwidth(ctx *pulumi.Context,
	...
	var resource Ipv6AddressBandwidth
	err := ctx.ReadResource("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
