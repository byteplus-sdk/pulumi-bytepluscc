...
func GetEips(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetEipsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getEips:getEips", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEipsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetEipsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetEipsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getEips:getEips", nil, GetEipsResultOutput{}, options).(GetEipsResultOutput), nil
	}).(GetEipsResultOutput)
}
