...
func NewTrafficMirrorFilter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/trafficMirrorFilter:TrafficMirrorFilter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficMirrorFilter(ctx *pulumi.Context,
	...
	var resource TrafficMirrorFilter
	err := ctx.ReadResource("bytepluscc:vpc/trafficMirrorFilter:TrafficMirrorFilter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
