...
func NewTrafficMirrorTarget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficMirrorTarget(ctx *pulumi.Context,
	...
	var resource TrafficMirrorTarget
	err := ctx.ReadResource("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
