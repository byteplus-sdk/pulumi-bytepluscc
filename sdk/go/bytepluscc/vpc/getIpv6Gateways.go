...
func GetIpv6Gateways(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetIpv6GatewaysResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getIpv6Gateways:getIpv6Gateways", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetIpv6GatewaysOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetIpv6GatewaysResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetIpv6GatewaysResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getIpv6Gateways:getIpv6Gateways", nil, GetIpv6GatewaysResultOutput{}, options).(GetIpv6GatewaysResultOutput), nil
