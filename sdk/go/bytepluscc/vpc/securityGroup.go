...
func NewSecurityGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/securityGroup:SecurityGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSecurityGroup(ctx *pulumi.Context,
	...
	var resource SecurityGroup
	err := ctx.ReadResource("bytepluscc:vpc/securityGroup:SecurityGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
