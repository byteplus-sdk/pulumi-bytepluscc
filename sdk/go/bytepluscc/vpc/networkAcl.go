...
func NewNetworkAcl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/networkAcl:NetworkAcl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkAcl(ctx *pulumi.Context,
	...
	var resource NetworkAcl
	err := ctx.ReadResource("bytepluscc:vpc/networkAcl:NetworkAcl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
