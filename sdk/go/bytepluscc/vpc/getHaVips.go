...
func GetHaVips(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetHaVipsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getHaVips:getHaVips", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetHaVipsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetHaVipsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetHaVipsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getHaVips:getHaVips", nil, GetHaVipsResultOutput{}, options).(GetHaVipsResultOutput), nil
