...
func GetFlowLogs(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetFlowLogsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getFlowLogs:getFlowLogs", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetFlowLogsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetFlowLogsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetFlowLogsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getFlowLogs:getFlowLogs", nil, GetFlowLogsResultOutput{}, options).(GetFlowLogsResultOutput), nil
