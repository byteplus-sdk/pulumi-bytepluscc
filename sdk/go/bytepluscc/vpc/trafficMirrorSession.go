...
func NewTrafficMirrorSession(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTrafficMirrorSession(ctx *pulumi.Context,
	...
	var resource TrafficMirrorSession
	err := ctx.ReadResource("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
