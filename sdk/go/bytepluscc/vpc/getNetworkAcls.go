...
func GetNetworkAcls(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetNetworkAclsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getNetworkAcls:getNetworkAcls", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetNetworkAclsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetNetworkAclsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetNetworkAclsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getNetworkAcls:getNetworkAcls", nil, GetNetworkAclsResultOutput{}, options).(GetNetworkAclsResultOutput), nil
