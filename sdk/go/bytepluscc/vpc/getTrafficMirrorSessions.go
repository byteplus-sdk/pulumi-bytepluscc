...
func GetTrafficMirrorSessions(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetTrafficMirrorSessionsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getTrafficMirrorSessions:getTrafficMirrorSessions", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetTrafficMirrorSessionsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetTrafficMirrorSessionsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetTrafficMirrorSessionsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getTrafficMirrorSessions:getTrafficMirrorSessions", nil, GetTrafficMirrorSessionsResultOutput{}, options).(GetTrafficMirrorSessionsResultOutput), nil
