...
func GetSecurityGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSecurityGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vpc/getSecurityGroups:getSecurityGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSecurityGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSecurityGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSecurityGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vpc/getSecurityGroups:getSecurityGroups", nil, GetSecurityGroupsResultOutput{}, options).(GetSecurityGroupsResultOutput), nil
