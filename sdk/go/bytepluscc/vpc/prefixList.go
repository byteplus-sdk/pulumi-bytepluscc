...
func NewPrefixList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/prefixList:PrefixList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefixList(ctx *pulumi.Context,
	...
	var resource PrefixList
	err := ctx.ReadResource("bytepluscc:vpc/prefixList:PrefixList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
