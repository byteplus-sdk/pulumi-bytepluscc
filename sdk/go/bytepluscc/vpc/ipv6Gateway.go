...
func NewIpv6Gateway(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv6Gateway(ctx *pulumi.Context,
	...
	var resource Ipv6Gateway
	err := ctx.ReadResource("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
