...
func GetResolverRules(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetResolverRulesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatezone/getResolverRules:getResolverRules", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetResolverRulesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetResolverRulesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetResolverRulesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatezone/getResolverRules:getResolverRules", nil, GetResolverRulesResultOutput{}, options).(GetResolverRulesResultOutput), nil
