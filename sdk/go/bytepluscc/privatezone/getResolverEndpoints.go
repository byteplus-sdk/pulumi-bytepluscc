...
func GetResolverEndpoints(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetResolverEndpointsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatezone/getResolverEndpoints:getResolverEndpoints", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetResolverEndpointsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetResolverEndpointsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetResolverEndpointsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatezone/getResolverEndpoints:getResolverEndpoints", nil, GetResolverEndpointsResultOutput{}, options).(GetResolverEndpointsResultOutput), nil
