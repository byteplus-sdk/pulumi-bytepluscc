...
func GetRecords(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetRecordsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatezone/getRecords:getRecords", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRecordsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetRecordsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetRecordsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatezone/getRecords:getRecords", nil, GetRecordsResultOutput{}, options).(GetRecordsResultOutput), nil
