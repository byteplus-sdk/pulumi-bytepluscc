...
func NewResolverRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatezone/resolverRule:ResolverRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResolverRule(ctx *pulumi.Context,
	...
	var resource ResolverRule
	err := ctx.ReadResource("bytepluscc:privatezone/resolverRule:ResolverRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
