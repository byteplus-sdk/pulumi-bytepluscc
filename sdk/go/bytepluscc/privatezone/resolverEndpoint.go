...
func NewResolverEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResolverEndpoint(ctx *pulumi.Context,
	...
	var resource ResolverEndpoint
	err := ctx.ReadResource("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
