...
func GetPrivateZones(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetPrivateZonesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:privatezone/getPrivateZones:getPrivateZones", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPrivateZonesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetPrivateZonesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetPrivateZonesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:privatezone/getPrivateZones:getPrivateZones", nil, GetPrivateZonesResultOutput{}, options).(GetPrivateZonesResultOutput), nil
