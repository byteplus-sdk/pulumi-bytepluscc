...
func NewUserVpcAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserVpcAuthorization(ctx *pulumi.Context,
	...
	var resource UserVpcAuthorization
	err := ctx.ReadResource("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
