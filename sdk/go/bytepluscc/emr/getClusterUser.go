...
func LookupClusterUser(ctx *pulumi.Context, args *LookupClusterUserArgs, opts ...pulumi.InvokeOption) (*LookupClusterUserResult, error) {
	...
	err := ctx.Invoke("bytepluscc:emr/getClusterUser:getClusterUser", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupClusterUserOutput(ctx *pulumi.Context, args LookupClusterUserOutputArgs, opts ...pulumi.InvokeOption) LookupClusterUserResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupClusterUserResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:emr/getClusterUser:getClusterUser", args, LookupClusterUserResultOutput{}, options).(LookupClusterUserResultOutput), nil
