...
func NewNodeGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:emr/nodeGroup:NodeGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNodeGroup(ctx *pulumi.Context,
	...
	var resource NodeGroup
	err := ctx.ReadResource("bytepluscc:emr/nodeGroup:NodeGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
