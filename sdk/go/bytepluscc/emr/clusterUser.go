...
func NewClusterUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:emr/clusterUser:ClusterUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterUser(ctx *pulumi.Context,
	...
	var resource ClusterUser
	err := ctx.ReadResource("bytepluscc:emr/clusterUser:ClusterUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
