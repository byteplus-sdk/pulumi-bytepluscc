...
func LookupHealthCheckTemplate(ctx *pulumi.Context, args *LookupHealthCheckTemplateArgs, opts ...pulumi.InvokeOption) (*LookupHealthCheckTemplateResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getHealthCheckTemplate:getHealthCheckTemplate", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupHealthCheckTemplateOutput(ctx *pulumi.Context, args LookupHealthCheckTemplateOutputArgs, opts ...pulumi.InvokeOption) LookupHealthCheckTemplateResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupHealthCheckTemplateResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:alb/getHealthCheckTemplate:getHealthCheckTemplate", args, LookupHealthCheckTemplateResultOutput{}, options).(LookupHealthCheckTemplateResultOutput), nil
