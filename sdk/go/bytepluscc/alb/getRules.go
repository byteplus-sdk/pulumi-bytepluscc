...
func GetRules(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetRulesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getRules:getRules", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRulesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetRulesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetRulesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:alb/getRules:getRules", nil, GetRulesResultOutput{}, options).(GetRulesResultOutput), nil
