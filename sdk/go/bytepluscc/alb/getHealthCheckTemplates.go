...
func GetHealthCheckTemplates(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetHealthCheckTemplatesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getHealthCheckTemplates:getHealthCheckTemplates", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetHealthCheckTemplatesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetHealthCheckTemplatesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetHealthCheckTemplatesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:alb/getHealthCheckTemplates:getHealthCheckTemplates", nil, GetHealthCheckTemplatesResultOutput{}, options).(GetHealthCheckTemplatesResultOutput), nil
