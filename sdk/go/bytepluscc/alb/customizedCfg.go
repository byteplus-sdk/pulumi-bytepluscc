...
func NewCustomizedCfg(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:alb/customizedCfg:CustomizedCfg", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustomizedCfg(ctx *pulumi.Context,
	...
	var resource CustomizedCfg
	err := ctx.ReadResource("bytepluscc:alb/customizedCfg:CustomizedCfg", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
