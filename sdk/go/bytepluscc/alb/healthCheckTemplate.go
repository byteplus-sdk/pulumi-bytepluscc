...
func NewHealthCheckTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHealthCheckTemplate(ctx *pulumi.Context,
	...
	var resource HealthCheckTemplate
	err := ctx.ReadResource("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
