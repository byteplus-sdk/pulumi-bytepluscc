...
func GetLoadBalancers(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetLoadBalancersResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getLoadBalancers:getLoadBalancers", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetLoadBalancersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetLoadBalancersResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetLoadBalancersResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:alb/getLoadBalancers:getLoadBalancers", nil, GetLoadBalancersResultOutput{}, options).(GetLoadBalancersResultOutput), nil
