...
func LookupCustomizedCfg(ctx *pulumi.Context, args *LookupCustomizedCfgArgs, opts ...pulumi.InvokeOption) (*LookupCustomizedCfgResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getCustomizedCfg:getCustomizedCfg", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupCustomizedCfgOutput(ctx *pulumi.Context, args LookupCustomizedCfgOutputArgs, opts ...pulumi.InvokeOption) LookupCustomizedCfgResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupCustomizedCfgResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:alb/getCustomizedCfg:getCustomizedCfg", args, LookupCustomizedCfgResultOutput{}, options).(LookupCustomizedCfgResultOutput), nil
