...
func GetListeners(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetListenersResult, error) {
	...
	err := ctx.Invoke("bytepluscc:alb/getListeners:getListeners", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetListenersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetListenersResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetListenersResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:alb/getListeners:getListeners", nil, GetListenersResultOutput{}, options).(GetListenersResultOutput), nil
