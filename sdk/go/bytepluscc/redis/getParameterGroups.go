...
func GetParameterGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetParameterGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:redis/getParameterGroups:getParameterGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetParameterGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetParameterGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetParameterGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:redis/getParameterGroups:getParameterGroups", nil, GetParameterGroupsResultOutput{}, options).(GetParameterGroupsResultOutput), nil
