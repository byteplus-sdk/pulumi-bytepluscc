...
func GetDomains(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetDomainsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cdn/getDomains:getDomains", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDomainsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetDomainsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetDomainsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cdn/getDomains:getDomains", nil, GetDomainsResultOutput{}, options).(GetDomainsResultOutput), nil
