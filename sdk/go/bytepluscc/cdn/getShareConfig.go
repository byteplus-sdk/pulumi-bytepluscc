...
func LookupShareConfig(ctx *pulumi.Context, args *LookupShareConfigArgs, opts ...pulumi.InvokeOption) (*LookupShareConfigResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cdn/getShareConfig:getShareConfig", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupShareConfigOutput(ctx *pulumi.Context, args LookupShareConfigOutputArgs, opts ...pulumi.InvokeOption) LookupShareConfigResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupShareConfigResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:cdn/getShareConfig:getShareConfig", args, LookupShareConfigResultOutput{}, options).(LookupShareConfigResultOutput), nil
