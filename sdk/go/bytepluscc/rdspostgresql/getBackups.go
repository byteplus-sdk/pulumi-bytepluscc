...
func GetBackups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetBackupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:rdspostgresql/getBackups:getBackups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBackupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetBackupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetBackupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:rdspostgresql/getBackups:getBackups", nil, GetBackupsResultOutput{}, options).(GetBackupsResultOutput), nil
