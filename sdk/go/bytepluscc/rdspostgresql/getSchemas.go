...
func GetSchemas(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSchemasResult, error) {
	...
	err := ctx.Invoke("bytepluscc:rdspostgresql/getSchemas:getSchemas", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSchemasOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSchemasResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSchemasResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:rdspostgresql/getSchemas:getSchemas", nil, GetSchemasResultOutput{}, options).(GetSchemasResultOutput), nil
