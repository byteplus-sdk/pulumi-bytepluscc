...
func NewSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.RegisterResource("bytepluscc:rdspostgresql/schema:Schema", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSchema(ctx *pulumi.Context,
	...
	var resource Schema
	err := ctx.ReadResource("bytepluscc:rdspostgresql/schema:Schema", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
