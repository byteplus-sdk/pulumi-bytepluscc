...
func NewInstanceSsl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceSsl(ctx *pulumi.Context,
	...
	var resource InstanceSsl
	err := ctx.ReadResource("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
