...
func GetContacts(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetContactsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cloudmonitor/getContacts:getContacts", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetContactsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetContactsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetContactsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cloudmonitor/getContacts:getContacts", nil, GetContactsResultOutput{}, options).(GetContactsResultOutput), nil
