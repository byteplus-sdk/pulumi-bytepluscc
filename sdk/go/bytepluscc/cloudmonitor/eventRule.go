...
func NewEventRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudmonitor/eventRule:EventRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEventRule(ctx *pulumi.Context,
	...
	var resource EventRule
	err := ctx.ReadResource("bytepluscc:cloudmonitor/eventRule:EventRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
