...
func GetContactGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetContactGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cloudmonitor/getContactGroups:getContactGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetContactGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetContactGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetContactGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cloudmonitor/getContactGroups:getContactGroups", nil, GetContactGroupsResultOutput{}, options).(GetContactGroupsResultOutput), nil
