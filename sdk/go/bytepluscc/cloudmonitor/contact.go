...
func NewContact(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudmonitor/contact:Contact", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContact(ctx *pulumi.Context,
	...
	var resource Contact
	err := ctx.ReadResource("bytepluscc:cloudmonitor/contact:Contact", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
