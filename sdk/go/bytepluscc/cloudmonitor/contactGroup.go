...
func NewContactGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetContactGroup(ctx *pulumi.Context,
	...
	var resource ContactGroup
	err := ctx.ReadResource("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
