...
func GetEventRules(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetEventRulesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cloudmonitor/getEventRules:getEventRules", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEventRulesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetEventRulesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetEventRulesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cloudmonitor/getEventRules:getEventRules", nil, GetEventRulesResultOutput{}, options).(GetEventRulesResultOutput), nil
