...
// import (
//
//	"github.com/byteplus-sdk/pulumi-bytepluscc/sdk/go/bytepluscc/rdsmssql"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func NewAllowList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdsmssql/allowList:AllowList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowList(ctx *pulumi.Context,
	...
	var resource AllowList
	err := ctx.ReadResource("bytepluscc:rdsmssql/allowList:AllowList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
