...
// import (
//
//	"github.com/byteplus-sdk/pulumi-bytepluscc/sdk/go/bytepluscc/escloud"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func NewIpAllowList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:escloud/ipAllowList:IpAllowList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpAllowList(ctx *pulumi.Context,
	...
	var resource IpAllowList
	err := ctx.ReadResource("bytepluscc:escloud/ipAllowList:IpAllowList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
