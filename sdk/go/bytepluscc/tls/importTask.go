...
func NewImportTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:tls/importTask:ImportTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetImportTask(ctx *pulumi.Context,
	...
	var resource ImportTask
	err := ctx.ReadResource("bytepluscc:tls/importTask:ImportTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
