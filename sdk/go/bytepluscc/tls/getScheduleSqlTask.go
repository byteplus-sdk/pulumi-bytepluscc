...
func LookupScheduleSqlTask(ctx *pulumi.Context, args *LookupScheduleSqlTaskArgs, opts ...pulumi.InvokeOption) (*LookupScheduleSqlTaskResult, error) {
	...
	err := ctx.Invoke("bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupScheduleSqlTaskOutput(ctx *pulumi.Context, args LookupScheduleSqlTaskOutputArgs, opts ...pulumi.InvokeOption) LookupScheduleSqlTaskResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduleSqlTaskResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask", args, LookupScheduleSqlTaskResultOutput{}, options).(LookupScheduleSqlTaskResultOutput), nil
