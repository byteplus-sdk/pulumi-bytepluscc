...
func GetHostGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetHostGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:tls/getHostGroups:getHostGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetHostGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetHostGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetHostGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:tls/getHostGroups:getHostGroups", nil, GetHostGroupsResultOutput{}, options).(GetHostGroupsResultOutput), nil
