...
func NewAlarmNotifyGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlarmNotifyGroup(ctx *pulumi.Context,
	...
	var resource AlarmNotifyGroup
	err := ctx.ReadResource("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
