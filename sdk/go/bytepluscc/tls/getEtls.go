...
func GetEtls(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetEtlsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:tls/getEtls:getEtls", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEtlsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetEtlsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetEtlsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:tls/getEtls:getEtls", nil, GetEtlsResultOutput{}, options).(GetEtlsResultOutput), nil
	}).(GetEtlsResultOutput)
}
