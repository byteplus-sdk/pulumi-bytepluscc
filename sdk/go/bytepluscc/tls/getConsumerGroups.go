...
func GetConsumerGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetConsumerGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:tls/getConsumerGroups:getConsumerGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetConsumerGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetConsumerGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetConsumerGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:tls/getConsumerGroups:getConsumerGroups", nil, GetConsumerGroupsResultOutput{}, options).(GetConsumerGroupsResultOutput), nil
