...
func NewAlarm(ctx *pulumi.Context,
	...
	var resource Alarm
	err := ctx.RegisterResource("bytepluscc:tls/alarm:Alarm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAlarm(ctx *pulumi.Context,
	...
	var resource Alarm
	err := ctx.ReadResource("bytepluscc:tls/alarm:Alarm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
