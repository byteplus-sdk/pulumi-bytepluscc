...
func NewScheduleSqlTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetScheduleSqlTask(ctx *pulumi.Context,
	...
	var resource ScheduleSqlTask
	err := ctx.ReadResource("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
