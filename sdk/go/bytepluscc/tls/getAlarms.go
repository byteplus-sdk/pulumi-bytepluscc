...
func GetAlarms(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetAlarmsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:tls/getAlarms:getAlarms", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAlarmsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAlarmsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetAlarmsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:tls/getAlarms:getAlarms", nil, GetAlarmsResultOutput{}, options).(GetAlarmsResultOutput), nil
