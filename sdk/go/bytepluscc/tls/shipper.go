...
func NewShipper(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:tls/shipper:Shipper", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetShipper(ctx *pulumi.Context,
	...
	var resource Shipper
	err := ctx.ReadResource("bytepluscc:tls/shipper:Shipper", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
