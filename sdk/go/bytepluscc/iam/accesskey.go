...
func NewAccesskey(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:iam/accesskey:Accesskey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccesskey(ctx *pulumi.Context,
	...
	var resource Accesskey
	err := ctx.ReadResource("bytepluscc:iam/accesskey:Accesskey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
