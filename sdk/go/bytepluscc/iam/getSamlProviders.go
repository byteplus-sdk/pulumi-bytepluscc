...
func GetSamlProviders(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSamlProvidersResult, error) {
	...
	err := ctx.Invoke("bytepluscc:iam/getSamlProviders:getSamlProviders", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSamlProvidersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSamlProvidersResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSamlProvidersResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:iam/getSamlProviders:getSamlProviders", nil, GetSamlProvidersResultOutput{}, options).(GetSamlProvidersResultOutput), nil
