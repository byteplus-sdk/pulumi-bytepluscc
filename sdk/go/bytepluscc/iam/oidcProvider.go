...
func NewOidcProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:iam/oidcProvider:OidcProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOidcProvider(ctx *pulumi.Context,
	...
	var resource OidcProvider
	err := ctx.ReadResource("bytepluscc:iam/oidcProvider:OidcProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
