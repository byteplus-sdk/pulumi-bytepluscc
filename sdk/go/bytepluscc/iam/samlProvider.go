...
func NewSamlProvider(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:iam/samlProvider:SamlProvider", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSamlProvider(ctx *pulumi.Context,
	...
	var resource SamlProvider
	err := ctx.ReadResource("bytepluscc:iam/samlProvider:SamlProvider", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
