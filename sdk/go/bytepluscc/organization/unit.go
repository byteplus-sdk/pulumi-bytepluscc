...
func NewUnit(ctx *pulumi.Context,
	...
	var resource Unit
	err := ctx.RegisterResource("bytepluscc:organization/unit:Unit", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUnit(ctx *pulumi.Context,
	...
	var resource Unit
	err := ctx.ReadResource("bytepluscc:organization/unit:Unit", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
