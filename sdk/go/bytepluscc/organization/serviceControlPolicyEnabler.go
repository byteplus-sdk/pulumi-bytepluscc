...
func NewServiceControlPolicyEnabler(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:organization/serviceControlPolicyEnabler:ServiceControlPolicyEnabler", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceControlPolicyEnabler(ctx *pulumi.Context,
	...
	var resource ServiceControlPolicyEnabler
	err := ctx.ReadResource("bytepluscc:organization/serviceControlPolicyEnabler:ServiceControlPolicyEnabler", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
