...
func NewServiceControlPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:organization/serviceControlPolicy:ServiceControlPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceControlPolicy(ctx *pulumi.Context,
	...
	var resource ServiceControlPolicy
	err := ctx.ReadResource("bytepluscc:organization/serviceControlPolicy:ServiceControlPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
