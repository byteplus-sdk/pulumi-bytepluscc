...
func LookupUnit(ctx *pulumi.Context, args *LookupUnitArgs, opts ...pulumi.InvokeOption) (*LookupUnitResult, error) {
	...
	err := ctx.Invoke("bytepluscc:organization/getUnit:getUnit", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUnitOutput(ctx *pulumi.Context, args LookupUnitOutputArgs, opts ...pulumi.InvokeOption) LookupUnitResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUnitResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:organization/getUnit:getUnit", args, LookupUnitResultOutput{}, options).(LookupUnitResultOutput), nil
