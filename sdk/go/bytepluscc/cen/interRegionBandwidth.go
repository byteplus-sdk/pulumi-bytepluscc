...
func NewInterRegionBandwidth(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterRegionBandwidth(ctx *pulumi.Context,
	...
	var resource InterRegionBandwidth
	err := ctx.ReadResource("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
