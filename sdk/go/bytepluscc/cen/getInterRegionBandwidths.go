...
func GetInterRegionBandwidths(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetInterRegionBandwidthsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cen/getInterRegionBandwidths:getInterRegionBandwidths", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetInterRegionBandwidthsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetInterRegionBandwidthsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetInterRegionBandwidthsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cen/getInterRegionBandwidths:getInterRegionBandwidths", nil, GetInterRegionBandwidthsResultOutput{}, options).(GetInterRegionBandwidthsResultOutput), nil
