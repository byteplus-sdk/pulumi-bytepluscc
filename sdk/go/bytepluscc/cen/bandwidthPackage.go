...
func NewBandwidthPackage(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBandwidthPackage(ctx *pulumi.Context,
	...
	var resource BandwidthPackage
	err := ctx.ReadResource("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
