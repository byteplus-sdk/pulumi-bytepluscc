...
func NewGrantInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cen/grantInstance:GrantInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGrantInstance(ctx *pulumi.Context,
	...
	var resource GrantInstance
	err := ctx.ReadResource("bytepluscc:cen/grantInstance:GrantInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
