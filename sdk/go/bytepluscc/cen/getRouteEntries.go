...
func GetRouteEntries(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetRouteEntriesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cen/getRouteEntries:getRouteEntries", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetRouteEntriesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetRouteEntriesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetRouteEntriesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cen/getRouteEntries:getRouteEntries", nil, GetRouteEntriesResultOutput{}, options).(GetRouteEntriesResultOutput), nil
