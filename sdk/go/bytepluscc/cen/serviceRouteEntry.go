...
func NewServiceRouteEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceRouteEntry(ctx *pulumi.Context,
	...
	var resource ServiceRouteEntry
	err := ctx.ReadResource("bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
