...
func GetBandwidthPackages(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetBandwidthPackagesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cen/getBandwidthPackages:getBandwidthPackages", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetBandwidthPackagesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetBandwidthPackagesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetBandwidthPackagesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cen/getBandwidthPackages:getBandwidthPackages", nil, GetBandwidthPackagesResultOutput{}, options).(GetBandwidthPackagesResultOutput), nil
