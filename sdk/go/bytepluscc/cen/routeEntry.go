...
func NewRouteEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cen/routeEntry:RouteEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteEntry(ctx *pulumi.Context,
	...
	var resource RouteEntry
	err := ctx.ReadResource("bytepluscc:cen/routeEntry:RouteEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
