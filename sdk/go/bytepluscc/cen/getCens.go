...
func GetCens(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetCensResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cen/getCens:getCens", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCensOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCensResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCensResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cen/getCens:getCens", nil, GetCensResultOutput{}, options).(GetCensResultOutput), nil
	}).(GetCensResultOutput)
}
