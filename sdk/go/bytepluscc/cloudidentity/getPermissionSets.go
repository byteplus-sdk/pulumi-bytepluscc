...
func GetPermissionSets(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetPermissionSetsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cloudidentity/getPermissionSets:getPermissionSets", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetPermissionSetsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetPermissionSetsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetPermissionSetsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:cloudidentity/getPermissionSets:getPermissionSets", nil, GetPermissionSetsResultOutput{}, options).(GetPermissionSetsResultOutput), nil
