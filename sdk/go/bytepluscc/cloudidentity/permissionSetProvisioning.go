...
func NewPermissionSetProvisioning(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPermissionSetProvisioning(ctx *pulumi.Context,
	...
	var resource PermissionSetProvisioning
	err := ctx.ReadResource("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
