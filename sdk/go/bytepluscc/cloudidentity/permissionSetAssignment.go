...
func NewPermissionSetAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPermissionSetAssignment(ctx *pulumi.Context,
	...
	var resource PermissionSetAssignment
	err := ctx.ReadResource("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
