...
func NewUserProvisioning(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserProvisioning(ctx *pulumi.Context,
	...
	var resource UserProvisioning
	err := ctx.ReadResource("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
