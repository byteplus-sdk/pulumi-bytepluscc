...
func NewPermissionSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPermissionSet(ctx *pulumi.Context,
	...
	var resource PermissionSet
	err := ctx.ReadResource("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
