...
func LookupUserProvisioning(ctx *pulumi.Context, args *LookupUserProvisioningArgs, opts ...pulumi.InvokeOption) (*LookupUserProvisioningResult, error) {
	...
	err := ctx.Invoke("bytepluscc:cloudidentity/getUserProvisioning:getUserProvisioning", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupUserProvisioningOutput(ctx *pulumi.Context, args LookupUserProvisioningOutputArgs, opts ...pulumi.InvokeOption) LookupUserProvisioningResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupUserProvisioningResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:cloudidentity/getUserProvisioning:getUserProvisioning", args, LookupUserProvisioningResultOutput{}, options).(LookupUserProvisioningResultOutput), nil
