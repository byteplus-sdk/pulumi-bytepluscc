...
func NewAllowList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdsmysql/allowList:AllowList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAllowList(ctx *pulumi.Context,
	...
	var resource AllowList
	err := ctx.ReadResource("bytepluscc:rdsmysql/allowList:AllowList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
