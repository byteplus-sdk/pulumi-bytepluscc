...
func GetEndpoints(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetEndpointsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:rdsmysql/getEndpoints:getEndpoints", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetEndpointsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetEndpointsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetEndpointsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:rdsmysql/getEndpoints:getEndpoints", nil, GetEndpointsResultOutput{}, options).(GetEndpointsResultOutput), nil
