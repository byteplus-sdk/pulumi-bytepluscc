...
func NewParameterTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetParameterTemplate(ctx *pulumi.Context,
	...
	var resource ParameterTemplate
	err := ctx.ReadResource("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
