...
func NewEndpointPublicAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpointPublicAddress(ctx *pulumi.Context,
	...
	var resource EndpointPublicAddress
	err := ctx.ReadResource("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
