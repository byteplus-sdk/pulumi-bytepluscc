...
func GetParameterTemplates(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetParameterTemplatesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:rdsmysql/getParameterTemplates:getParameterTemplates", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetParameterTemplatesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetParameterTemplatesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetParameterTemplatesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:rdsmysql/getParameterTemplates:getParameterTemplates", nil, GetParameterTemplatesResultOutput{}, options).(GetParameterTemplatesResultOutput), nil
