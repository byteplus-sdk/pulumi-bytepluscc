...
func NewInstanceReadonlyNode(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstanceReadonlyNode(ctx *pulumi.Context,
	...
	var resource InstanceReadonlyNode
	err := ctx.ReadResource("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
