...
func GetServerGroups(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetServerGroupsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:clb/getServerGroups:getServerGroups", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetServerGroupsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetServerGroupsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetServerGroupsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:clb/getServerGroups:getServerGroups", nil, GetServerGroupsResultOutput{}, options).(GetServerGroupsResultOutput), nil
