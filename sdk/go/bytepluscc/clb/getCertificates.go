...
func GetCertificates(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetCertificatesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:clb/getCertificates:getCertificates", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetCertificatesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetCertificatesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetCertificatesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:clb/getCertificates:getCertificates", nil, GetCertificatesResultOutput{}, options).(GetCertificatesResultOutput), nil
