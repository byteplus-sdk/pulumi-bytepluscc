...
func NewNlbServerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:clb/nlbServerGroup:NlbServerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNlbServerGroup(ctx *pulumi.Context,
	...
	var resource NlbServerGroup
	err := ctx.ReadResource("bytepluscc:clb/nlbServerGroup:NlbServerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
