...
func LookupNlbSecurityPolicy(ctx *pulumi.Context, args *LookupNlbSecurityPolicyArgs, opts ...pulumi.InvokeOption) (*LookupNlbSecurityPolicyResult, error) {
	...
	err := ctx.Invoke("bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupNlbSecurityPolicyOutput(ctx *pulumi.Context, args LookupNlbSecurityPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupNlbSecurityPolicyResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupNlbSecurityPolicyResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy", args, LookupNlbSecurityPolicyResultOutput{}, options).(LookupNlbSecurityPolicyResultOutput), nil
