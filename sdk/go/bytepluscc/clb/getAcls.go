...
func GetAcls(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetAclsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:clb/getAcls:getAcls", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetAclsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetAclsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetAclsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:clb/getAcls:getAcls", nil, GetAclsResultOutput{}, options).(GetAclsResultOutput), nil
	}).(GetAclsResultOutput)
}
