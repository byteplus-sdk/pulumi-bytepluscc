...
func NewServerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:clb/serverGroup:ServerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServerGroup(ctx *pulumi.Context,
	...
	var resource ServerGroup
	err := ctx.ReadResource("bytepluscc:clb/serverGroup:ServerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
