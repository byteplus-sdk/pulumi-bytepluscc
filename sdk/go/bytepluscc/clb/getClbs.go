...
func GetClbs(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetClbsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:clb/getClbs:getClbs", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetClbsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetClbsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetClbsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:clb/getClbs:getClbs", nil, GetClbsResultOutput{}, options).(GetClbsResultOutput), nil
	}).(GetClbsResultOutput)
}
