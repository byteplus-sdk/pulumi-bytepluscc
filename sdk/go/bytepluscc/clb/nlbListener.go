...
func NewNlbListener(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:clb/nlbListener:NlbListener", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNlbListener(ctx *pulumi.Context,
	...
	var resource NlbListener
	err := ctx.ReadResource("bytepluscc:clb/nlbListener:NlbListener", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
