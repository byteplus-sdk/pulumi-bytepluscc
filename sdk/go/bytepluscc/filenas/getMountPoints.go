...
func GetMountPoints(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetMountPointsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:filenas/getMountPoints:getMountPoints", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetMountPointsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetMountPointsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetMountPointsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:filenas/getMountPoints:getMountPoints", nil, GetMountPointsResultOutput{}, options).(GetMountPointsResultOutput), nil
