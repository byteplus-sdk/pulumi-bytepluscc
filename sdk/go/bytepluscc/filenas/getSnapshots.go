...
func GetSnapshots(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSnapshotsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:filenas/getSnapshots:getSnapshots", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSnapshotsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSnapshotsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSnapshotsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:filenas/getSnapshots:getSnapshots", nil, GetSnapshotsResultOutput{}, options).(GetSnapshotsResultOutput), nil
