...
func NewMountPoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:filenas/mountPoint:MountPoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMountPoint(ctx *pulumi.Context,
	...
	var resource MountPoint
	err := ctx.ReadResource("bytepluscc:filenas/mountPoint:MountPoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
