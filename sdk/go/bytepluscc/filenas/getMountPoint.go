...
func LookupMountPoint(ctx *pulumi.Context, args *LookupMountPointArgs, opts ...pulumi.InvokeOption) (*LookupMountPointResult, error) {
	...
	err := ctx.Invoke("bytepluscc:filenas/getMountPoint:getMountPoint", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupMountPointOutput(ctx *pulumi.Context, args LookupMountPointOutputArgs, opts ...pulumi.InvokeOption) LookupMountPointResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupMountPointResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:filenas/getMountPoint:getMountPoint", args, LookupMountPointResultOutput{}, options).(LookupMountPointResultOutput), nil
