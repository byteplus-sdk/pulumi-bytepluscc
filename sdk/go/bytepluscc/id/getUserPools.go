...
func GetUserPools(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetUserPoolsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:id/getUserPools:getUserPools", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetUserPoolsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetUserPoolsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetUserPoolsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:id/getUserPools:getUserPools", nil, GetUserPoolsResultOutput{}, options).(GetUserPoolsResultOutput), nil
