...
func NewAuthConfig(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:id/authConfig:AuthConfig", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthConfig(ctx *pulumi.Context,
	...
	var resource AuthConfig
	err := ctx.ReadResource("bytepluscc:id/authConfig:AuthConfig", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
