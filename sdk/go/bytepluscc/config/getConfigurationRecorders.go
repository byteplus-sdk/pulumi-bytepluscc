...
func GetConfigurationRecorders(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetConfigurationRecordersResult, error) {
	...
	err := ctx.Invoke("bytepluscc:config/getConfigurationRecorders:getConfigurationRecorders", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetConfigurationRecordersOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetConfigurationRecordersResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetConfigurationRecordersResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:config/getConfigurationRecorders:getConfigurationRecorders", nil, GetConfigurationRecordersResultOutput{}, options).(GetConfigurationRecordersResultOutput), nil
