...
func NewGroupRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:config/groupRule:GroupRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupRule(ctx *pulumi.Context,
	...
	var resource GroupRule
	err := ctx.ReadResource("bytepluscc:config/groupRule:GroupRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
