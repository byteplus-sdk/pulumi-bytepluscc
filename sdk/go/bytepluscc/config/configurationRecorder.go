...
// import (
//
//	"github.com/byteplus-sdk/pulumi-bytepluscc/sdk/go/bytepluscc/config"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
//					pulumi.String("Byteplus::ALB::ACL"),
//				},
//			})
//			if err != nil {
//				return err
...
func NewConfigurationRecorder(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:config/configurationRecorder:ConfigurationRecorder", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigurationRecorder(ctx *pulumi.Context,
	...
	var resource ConfigurationRecorder
	err := ctx.ReadResource("bytepluscc:config/configurationRecorder:ConfigurationRecorder", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
