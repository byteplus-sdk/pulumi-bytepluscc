...
func NewSnatentry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:natgateway/snatentry:Snatentry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnatentry(ctx *pulumi.Context,
	...
	var resource Snatentry
	err := ctx.ReadResource("bytepluscc:natgateway/snatentry:Snatentry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
