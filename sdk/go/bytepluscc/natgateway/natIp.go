...
func NewNatIp(ctx *pulumi.Context,
	...
	var resource NatIp
	err := ctx.RegisterResource("bytepluscc:natgateway/natIp:NatIp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNatIp(ctx *pulumi.Context,
	...
	var resource NatIp
	err := ctx.ReadResource("bytepluscc:natgateway/natIp:NatIp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
