...
func GetNatIps(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetNatIpsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:natgateway/getNatIps:getNatIps", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetNatIpsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetNatIpsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetNatIpsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:natgateway/getNatIps:getNatIps", nil, GetNatIpsResultOutput{}, options).(GetNatIpsResultOutput), nil
