...
func GetDnatentries(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetDnatentriesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:natgateway/getDnatentries:getDnatentries", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetDnatentriesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetDnatentriesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetDnatentriesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:natgateway/getDnatentries:getDnatentries", nil, GetDnatentriesResultOutput{}, options).(GetDnatentriesResultOutput), nil
