...
func LookupSnatentry(ctx *pulumi.Context, args *LookupSnatentryArgs, opts ...pulumi.InvokeOption) (*LookupSnatentryResult, error) {
	...
	err := ctx.Invoke("bytepluscc:natgateway/getSnatentry:getSnatentry", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func LookupSnatentryOutput(ctx *pulumi.Context, args LookupSnatentryOutputArgs, opts ...pulumi.InvokeOption) LookupSnatentryResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupSnatentryResultOutput, error) {
			...
			return ctx.InvokeOutput("bytepluscc:natgateway/getSnatentry:getSnatentry", args, LookupSnatentryResultOutput{}, options).(LookupSnatentryResultOutput), nil
