...
func GetSnatentries(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetSnatentriesResult, error) {
	...
	err := ctx.Invoke("bytepluscc:natgateway/getSnatentries:getSnatentries", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSnatentriesOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetSnatentriesResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetSnatentriesResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:natgateway/getSnatentries:getSnatentries", nil, GetSnatentriesResultOutput{}, options).(GetSnatentriesResultOutput), nil
