...
func NewDnatentry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:natgateway/dnatentry:Dnatentry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDnatentry(ctx *pulumi.Context,
	...
	var resource Dnatentry
	err := ctx.ReadResource("bytepluscc:natgateway/dnatentry:Dnatentry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
