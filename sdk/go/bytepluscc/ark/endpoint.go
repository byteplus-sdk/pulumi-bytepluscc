...
// import (
//
//	"github.com/byteplus-sdk/pulumi-bytepluscc/sdk/go/bytepluscc/ark"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func NewEndpoint(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:ark/endpoint:Endpoint", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEndpoint(ctx *pulumi.Context,
	...
	var resource Endpoint
	err := ctx.ReadResource("bytepluscc:ark/endpoint:Endpoint", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
