...
func GetFilesets(ctx *pulumi.Context, opts ...pulumi.InvokeOption) (*GetFilesetsResult, error) {
	...
	err := ctx.Invoke("bytepluscc:vepfs/getFilesets:getFilesets", nil, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetFilesetsOutput(ctx *pulumi.Context, opts ...pulumi.InvokeOption) GetFilesetsResultOutput {
	return pulumi.ToOutput(0).ApplyT(func(int) (GetFilesetsResultOutput, error) {
		...
		return ctx.InvokeOutput("bytepluscc:vepfs/getFilesets:getFilesets", nil, GetFilesetsResultOutput{}, options).(GetFilesetsResultOutput), nil
