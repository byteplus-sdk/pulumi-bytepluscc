...
func NewFileset(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vepfs/fileset:Fileset", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFileset(ctx *pulumi.Context,
	...
	var resource Fileset
	err := ctx.ReadResource("bytepluscc:vepfs/fileset:Fileset", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
