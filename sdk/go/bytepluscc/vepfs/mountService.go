...
func NewMountService(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("bytepluscc:vepfs/mountService:MountService", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMountService(ctx *pulumi.Context,
	...
	var resource MountService
	err := ctx.ReadResource("bytepluscc:vepfs/mountService:MountService", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
