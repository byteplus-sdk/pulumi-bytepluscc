...
import com.byteplus.bytepluscc.vedbm.DatabaseArgs;
import com.byteplus.bytepluscc.vedbm.inputs.DatabaseState;
import com.byteplus.bytepluscc.vedbm.outputs.DatabaseDatabasesPrivilege;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vedbm.Database;
 * import com.byteplus.bytepluscc.vedbm.DatabaseArgs;
 * import com.pulumi.bytepluscc.vedbm.inputs.DatabaseDatabasesPrivilegeArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vedbm/database:Database")
public class Database extends com.pulumi.resources.CustomResource {
    ...
    public Database(java.lang.String name, DatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/database:Database", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Database(java.lang.String name, Output<java.lang.String> id, @Nullable DatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/database:Database", name, state, makeResourceOptions(options, id), false);
    }
