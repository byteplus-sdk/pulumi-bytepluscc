...
import com.byteplus.bytepluscc.gtm.RoutingArgs;
import com.byteplus.bytepluscc.gtm.inputs.RoutingState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.gtm.Routing;
 * import com.byteplus.bytepluscc.gtm.RoutingArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:gtm/routing:Routing example &#34;gtm_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:gtm/routing:Routing")
public class Routing extends com.pulumi.resources.CustomResource {
    ...
    public Routing(java.lang.String name, @Nullable RoutingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/routing:Routing", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Routing(java.lang.String name, Output<java.lang.String> id, @Nullable RoutingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/routing:Routing", name, state, makeResourceOptions(options, id), false);
    }
