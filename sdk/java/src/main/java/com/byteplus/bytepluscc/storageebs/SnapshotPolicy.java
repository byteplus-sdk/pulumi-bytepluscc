...
import com.byteplus.bytepluscc.storageebs.inputs.SnapshotPolicyState;
import com.byteplus.bytepluscc.storageebs.outputs.SnapshotPolicyTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy")
public class SnapshotPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SnapshotPolicy(java.lang.String name, SnapshotPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SnapshotPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy", name, state, makeResourceOptions(options, id), false);
    }
