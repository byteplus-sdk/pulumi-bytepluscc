...
import com.byteplus.bytepluscc.cloudmonitor.inputs.RuleState;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleCondition;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleDimensionConditions;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleLevelCondition;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleNoData;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleNotifyTemplate;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleOriginalDimensions;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleRecoveryNotify;
import com.byteplus.bytepluscc.cloudmonitor.outputs.RuleTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cloudmonitor/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
