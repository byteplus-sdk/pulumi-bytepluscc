...
import com.byteplus.bytepluscc.vpc.inputs.FlowLogState;
import com.byteplus.bytepluscc.vpc.outputs.FlowLogTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/flowLog:FlowLog")
public class FlowLog extends com.pulumi.resources.CustomResource {
    ...
    public FlowLog(java.lang.String name, FlowLogArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/flowLog:FlowLog", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private FlowLog(java.lang.String name, Output<java.lang.String> id, @Nullable FlowLogState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/flowLog:FlowLog", name, state, makeResourceOptions(options, id), false);
    }
