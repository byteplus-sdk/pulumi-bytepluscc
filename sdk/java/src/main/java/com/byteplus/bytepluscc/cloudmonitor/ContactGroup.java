...
import com.byteplus.bytepluscc.cloudmonitor.inputs.ContactGroupState;
import com.byteplus.bytepluscc.cloudmonitor.outputs.ContactGroupContact;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cloudmonitor/contactGroup:ContactGroup")
public class ContactGroup extends com.pulumi.resources.CustomResource {
    ...
    public ContactGroup(java.lang.String name, ContactGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ContactGroup(java.lang.String name, Output<java.lang.String> id, @Nullable ContactGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, state, makeResourceOptions(options, id), false);
    }
