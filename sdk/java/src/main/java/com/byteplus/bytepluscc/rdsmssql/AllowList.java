...
import com.byteplus.bytepluscc.rdsmssql.AllowListArgs;
import com.byteplus.bytepluscc.rdsmssql.inputs.AllowListState;
import com.byteplus.bytepluscc.rdsmssql.outputs.AllowListAssociatedInstance;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmssql.AllowList;
 * import com.byteplus.bytepluscc.rdsmssql.AllowListArgs;
 * import com.pulumi.bytepluscc.rdsmssql.inputs.AllowListAssociatedInstanceArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmssql/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
