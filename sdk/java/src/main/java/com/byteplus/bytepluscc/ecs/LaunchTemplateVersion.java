...
import com.byteplus.bytepluscc.ecs.LaunchTemplateVersionArgs;
import com.byteplus.bytepluscc.ecs.inputs.LaunchTemplateVersionState;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateVersionEip;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateVersionNetworkInterface;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateVersionScheduledInstance;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateVersionTag;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateVersionVolume;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.ecs.LaunchTemplateVersion;
 * import com.byteplus.bytepluscc.ecs.LaunchTemplateVersionArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateVersionEipArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateVersionNetworkInterfaceArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateVersionScheduledInstanceArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateVersionTagArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateVersionVolumeArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion")
public class LaunchTemplateVersion extends com.pulumi.resources.CustomResource {
    ...
    public LaunchTemplateVersion(java.lang.String name, @Nullable LaunchTemplateVersionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LaunchTemplateVersion(java.lang.String name, Output<java.lang.String> id, @Nullable LaunchTemplateVersionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, state, makeResourceOptions(options, id), false);
    }
