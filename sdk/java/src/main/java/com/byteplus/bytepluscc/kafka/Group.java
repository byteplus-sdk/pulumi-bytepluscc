...
import com.byteplus.bytepluscc.kafka.GroupArgs;
import com.byteplus.bytepluscc.kafka.inputs.GroupState;
import com.byteplus.bytepluscc.kafka.outputs.GroupTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.kafka.Group;
 * import com.byteplus.bytepluscc.kafka.GroupArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.GroupTagArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:kafka/group:Group example &#34;instance_id|group_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:kafka/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(java.lang.String name, GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/group:Group", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Group(java.lang.String name, Output<java.lang.String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/group:Group", name, state, makeResourceOptions(options, id), false);
    }
