...
import com.byteplus.bytepluscc.transitrouter.inputs.DirectConnectGatewayAttachmentState;
import com.byteplus.bytepluscc.transitrouter.outputs.DirectConnectGatewayAttachmentTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment")
public class DirectConnectGatewayAttachment extends com.pulumi.resources.CustomResource {
    ...
    public DirectConnectGatewayAttachment(java.lang.String name, DirectConnectGatewayAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DirectConnectGatewayAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable DirectConnectGatewayAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, state, makeResourceOptions(options, id), false);
    }
