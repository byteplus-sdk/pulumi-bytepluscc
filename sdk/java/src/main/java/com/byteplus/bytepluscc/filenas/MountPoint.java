...
import com.byteplus.bytepluscc.filenas.inputs.MountPointState;
import com.byteplus.bytepluscc.filenas.outputs.MountPointClient;
import com.byteplus.bytepluscc.filenas.outputs.MountPointPermissionGroup;
 ...
 * 
 */
@ResourceType(type="bytepluscc:filenas/mountPoint:MountPoint")
public class MountPoint extends com.pulumi.resources.CustomResource {
    ...
    public MountPoint(java.lang.String name, MountPointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:filenas/mountPoint:MountPoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private MountPoint(java.lang.String name, Output<java.lang.String> id, @Nullable MountPointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:filenas/mountPoint:MountPoint", name, state, makeResourceOptions(options, id), false);
    }
