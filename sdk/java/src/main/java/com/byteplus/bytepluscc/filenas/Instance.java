...
import com.byteplus.bytepluscc.filenas.inputs.InstanceState;
import com.byteplus.bytepluscc.filenas.outputs.InstanceCachePerformance;
import com.byteplus.bytepluscc.filenas.outputs.InstanceCapacity;
import com.byteplus.bytepluscc.filenas.outputs.InstanceTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:filenas/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:filenas/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:filenas/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
