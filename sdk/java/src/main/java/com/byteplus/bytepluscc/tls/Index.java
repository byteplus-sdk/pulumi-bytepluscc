...
import com.byteplus.bytepluscc.tls.IndexArgs;
import com.byteplus.bytepluscc.tls.inputs.IndexState;
import com.byteplus.bytepluscc.tls.outputs.IndexFullText;
import com.byteplus.bytepluscc.tls.outputs.IndexKeyValue;
import com.byteplus.bytepluscc.tls.outputs.IndexUserInnerKeyValue;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.Index;
 * import com.byteplus.bytepluscc.tls.IndexArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexFullTextArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexKeyValueArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexKeyValueValueArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexKeyValueValueJsonKeyArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexKeyValueValueJsonKeyValueArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexUserInnerKeyValueArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexUserInnerKeyValueValueArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexUserInnerKeyValueValueJsonKeyArgs;
 * import com.pulumi.bytepluscc.tls.inputs.IndexUserInnerKeyValueValueJsonKeyValueArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/index:Index")
public class Index extends com.pulumi.resources.CustomResource {
    ...
    public Index(java.lang.String name, IndexArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/index:Index", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Index(java.lang.String name, Output<java.lang.String> id, @Nullable IndexState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/index:Index", name, state, makeResourceOptions(options, id), false);
    }
