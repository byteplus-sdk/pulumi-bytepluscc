...
import com.byteplus.bytepluscc.iam.SamlProviderArgs;
import com.byteplus.bytepluscc.iam.inputs.SamlProviderState;
import com.byteplus.bytepluscc.iam.outputs.SamlProviderCertificate;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.iam.SamlProvider;
 * import com.byteplus.bytepluscc.iam.SamlProviderArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:iam/samlProvider:SamlProvider")
public class SamlProvider extends com.pulumi.resources.CustomResource {
    ...
    public SamlProvider(java.lang.String name, SamlProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/samlProvider:SamlProvider", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SamlProvider(java.lang.String name, Output<java.lang.String> id, @Nullable SamlProviderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/samlProvider:SamlProvider", name, state, makeResourceOptions(options, id), false);
    }
