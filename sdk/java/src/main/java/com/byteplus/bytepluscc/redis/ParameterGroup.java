...
import com.byteplus.bytepluscc.redis.ParameterGroupArgs;
import com.byteplus.bytepluscc.redis.inputs.ParameterGroupState;
import com.byteplus.bytepluscc.redis.outputs.ParameterGroupParamValue;
import com.byteplus.bytepluscc.redis.outputs.ParameterGroupParameter;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.redis.ParameterGroup;
 * import com.byteplus.bytepluscc.redis.ParameterGroupArgs;
 * import com.pulumi.bytepluscc.redis.inputs.ParameterGroupParamValueArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:redis/parameterGroup:ParameterGroup")
public class ParameterGroup extends com.pulumi.resources.CustomResource {
    ...
    public ParameterGroup(java.lang.String name, ParameterGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/parameterGroup:ParameterGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ParameterGroup(java.lang.String name, Output<java.lang.String> id, @Nullable ParameterGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/parameterGroup:ParameterGroup", name, state, makeResourceOptions(options, id), false);
    }
