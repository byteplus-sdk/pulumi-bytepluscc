...
import com.byteplus.bytepluscc.vke.KubeconfigArgs;
import com.byteplus.bytepluscc.vke.inputs.KubeconfigState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vke.Kubeconfig;
 * import com.byteplus.bytepluscc.vke.KubeconfigArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vke/kubeconfig:Kubeconfig")
public class Kubeconfig extends com.pulumi.resources.CustomResource {
    ...
    public Kubeconfig(java.lang.String name, KubeconfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/kubeconfig:Kubeconfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Kubeconfig(java.lang.String name, Output<java.lang.String> id, @Nullable KubeconfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/kubeconfig:Kubeconfig", name, state, makeResourceOptions(options, id), false);
    }
