...
import com.byteplus.bytepluscc.rdspostgresql.inputs.InstanceSslState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdspostgresql/instanceSsl:InstanceSsl")
public class InstanceSsl extends com.pulumi.resources.CustomResource {
    ...
    public InstanceSsl(java.lang.String name, InstanceSslArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstanceSsl(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceSslState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, state, makeResourceOptions(options, id), false);
    }
