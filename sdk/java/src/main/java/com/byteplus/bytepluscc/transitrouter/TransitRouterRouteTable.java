...
import com.byteplus.bytepluscc.transitrouter.inputs.TransitRouterRouteTableState;
import com.byteplus.bytepluscc.transitrouter.outputs.TransitRouterRouteTableTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable")
public class TransitRouterRouteTable extends com.pulumi.resources.CustomResource {
    ...
    public TransitRouterRouteTable(java.lang.String name, TransitRouterRouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TransitRouterRouteTable(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterRouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, state, makeResourceOptions(options, id), false);
    }
