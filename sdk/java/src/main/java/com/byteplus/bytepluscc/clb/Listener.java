 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.clb.Listener;
 * import com.byteplus.bytepluscc.clb.ListenerArgs;
 * import com.pulumi.bytepluscc.clb.inputs.ListenerHealthCheckArgs;
 * import com.pulumi.bytepluscc.clb.inputs.ListenerTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:clb/listener:Listener")
public class Listener extends com.pulumi.resources.CustomResource {
    ...
    public Listener(java.lang.String name, ListenerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/listener:Listener", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Listener(java.lang.String name, Output<java.lang.String> id, @Nullable ListenerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/listener:Listener", name, state, makeResourceOptions(options, id), false);
    }
