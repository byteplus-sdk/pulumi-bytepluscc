...
import com.byteplus.bytepluscc.vpc.RouteTableArgs;
import com.byteplus.bytepluscc.vpc.inputs.RouteTableState;
import com.byteplus.bytepluscc.vpc.outputs.RouteTableCustomRouteEntry;
import com.byteplus.bytepluscc.vpc.outputs.RouteTableSystemRouteEntry;
import com.byteplus.bytepluscc.vpc.outputs.RouteTableTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpc.RouteTable;
 * import com.byteplus.bytepluscc.vpc.RouteTableArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.RouteTableCustomRouteEntryArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.RouteTableTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/routeTable:RouteTable")
public class RouteTable extends com.pulumi.resources.CustomResource {
    ...
    public RouteTable(java.lang.String name, RouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/routeTable:RouteTable", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RouteTable(java.lang.String name, Output<java.lang.String> id, @Nullable RouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/routeTable:RouteTable", name, state, makeResourceOptions(options, id), false);
    }
