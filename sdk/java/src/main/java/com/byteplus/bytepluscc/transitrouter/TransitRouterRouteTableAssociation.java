...
import com.byteplus.bytepluscc.transitrouter.inputs.TransitRouterRouteTableAssociationState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation")
public class TransitRouterRouteTableAssociation extends com.pulumi.resources.CustomResource {
    ...
    public TransitRouterRouteTableAssociation(java.lang.String name, TransitRouterRouteTableAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TransitRouterRouteTableAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterRouteTableAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteTableAssociation:TransitRouterRouteTableAssociation", name, state, makeResourceOptions(options, id), false);
    }
