...
import com.byteplus.bytepluscc.rdsmysql.DatabaseArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.DatabaseState;
import com.byteplus.bytepluscc.rdsmysql.outputs.DatabaseDatabasePrivilege;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.Database;
 * import com.byteplus.bytepluscc.rdsmysql.DatabaseArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.DatabaseDatabasePrivilegeArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdsmysql/database:Database")
public class Database extends com.pulumi.resources.CustomResource {
    ...
    public Database(java.lang.String name, DatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/database:Database", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Database(java.lang.String name, Output<java.lang.String> id, @Nullable DatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/database:Database", name, state, makeResourceOptions(options, id), false);
    }
