...
import com.byteplus.bytepluscc.transitrouter.inputs.PeerAttachmentState;
import com.byteplus.bytepluscc.transitrouter.outputs.PeerAttachmentTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/peerAttachment:PeerAttachment")
public class PeerAttachment extends com.pulumi.resources.CustomResource {
    ...
    public PeerAttachment(java.lang.String name, PeerAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PeerAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable PeerAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, state, makeResourceOptions(options, id), false);
    }
