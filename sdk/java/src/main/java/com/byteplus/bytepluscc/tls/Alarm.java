...
import com.byteplus.bytepluscc.tls.AlarmArgs;
import com.byteplus.bytepluscc.tls.inputs.AlarmState;
import com.byteplus.bytepluscc.tls.outputs.AlarmAlarmNotifyGroup;
import com.byteplus.bytepluscc.tls.outputs.AlarmAlarmPeriodDetail;
import com.byteplus.bytepluscc.tls.outputs.AlarmJoinConfiguration;
import com.byteplus.bytepluscc.tls.outputs.AlarmQueryRequest;
import com.byteplus.bytepluscc.tls.outputs.AlarmRequestCycle;
import com.byteplus.bytepluscc.tls.outputs.AlarmTriggerCondition;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.Alarm;
 * import com.byteplus.bytepluscc.tls.AlarmArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmQueryRequestArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmRequestCycleArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmAlarmPeriodDetailArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmAlarmNotifyGroupArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmJoinConfigurationArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmTriggerConditionArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/alarm:Alarm")
public class Alarm extends com.pulumi.resources.CustomResource {
    ...
    public Alarm(java.lang.String name, AlarmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/alarm:Alarm", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Alarm(java.lang.String name, Output<java.lang.String> id, @Nullable AlarmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/alarm:Alarm", name, state, makeResourceOptions(options, id), false);
    }
