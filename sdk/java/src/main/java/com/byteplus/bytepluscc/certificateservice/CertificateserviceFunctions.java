...
public final class CertificateserviceFunctions {
    /**
     * Data Source schema for Byteplus::CertificateService::ChildCertInstance
     * 
     */
    ...
    public static Output<GetChildCertInstanceResult> getChildCertInstance(GetChildCertInstanceArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:certificateservice/getChildCertInstance:getChildCertInstance", TypeShape.of(GetChildCertInstanceResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Data Source schema for Byteplus::CertificateService::ChildCertInstance
     * 
    ...
    public static CompletableFuture<GetChildCertInstanceResult> getChildCertInstancePlain(GetChildCertInstancePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("bytepluscc:certificateservice/getChildCertInstance:getChildCertInstance", TypeShape.of(GetChildCertInstanceResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Plural Data Source schema for Byteplus::CertificateService::ChildCertInstance
     * 
     */
    ...
    public static Output<GetChildCertInstancesResult> getChildCertInstances(InvokeArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:certificateservice/getChildCertInstances:getChildCertInstances", TypeShape.of(GetChildCertInstancesResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Plural Data Source schema for Byteplus::CertificateService::ChildCertInstance
     * 
