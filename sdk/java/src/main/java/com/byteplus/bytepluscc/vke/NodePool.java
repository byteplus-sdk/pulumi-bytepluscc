...
import com.byteplus.bytepluscc.vke.NodePoolArgs;
import com.byteplus.bytepluscc.vke.inputs.NodePoolState;
import com.byteplus.bytepluscc.vke.outputs.NodePoolAutoScaling;
import com.byteplus.bytepluscc.vke.outputs.NodePoolKubernetesConfig;
import com.byteplus.bytepluscc.vke.outputs.NodePoolManagement;
import com.byteplus.bytepluscc.vke.outputs.NodePoolNodeConfig;
import com.byteplus.bytepluscc.vke.outputs.NodePoolNodeStatistics;
import com.byteplus.bytepluscc.vke.outputs.NodePoolStatus;
import com.byteplus.bytepluscc.vke.outputs.NodePoolTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vke.NodePool;
 * import com.byteplus.bytepluscc.vke.NodePoolArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolAutoScalingArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolKubernetesConfigArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolKubernetesConfigLabelArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolKubernetesConfigTaintArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolManagementArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolNodeConfigArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolNodeConfigSecurityArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolNodeConfigSecurityLoginArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolNodeConfigTagArgs;
 * import com.pulumi.bytepluscc.vke.inputs.NodePoolTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vke/nodePool:NodePool")
public class NodePool extends com.pulumi.resources.CustomResource {
    ...
    public NodePool(java.lang.String name, NodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/nodePool:NodePool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NodePool(java.lang.String name, Output<java.lang.String> id, @Nullable NodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/nodePool:NodePool", name, state, makeResourceOptions(options, id), false);
    }
