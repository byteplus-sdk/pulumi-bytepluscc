...
import com.byteplus.bytepluscc.tls.ScheduleSqlTaskArgs;
import com.byteplus.bytepluscc.tls.inputs.ScheduleSqlTaskState;
import com.byteplus.bytepluscc.tls.outputs.ScheduleSqlTaskRequestCycle;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.ScheduleSqlTask;
 * import com.byteplus.bytepluscc.tls.ScheduleSqlTaskArgs;
 * import com.pulumi.bytepluscc.tls.inputs.ScheduleSqlTaskRequestCycleArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask")
public class ScheduleSqlTask extends com.pulumi.resources.CustomResource {
    ...
    public ScheduleSqlTask(java.lang.String name, ScheduleSqlTaskArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScheduleSqlTask(java.lang.String name, Output<java.lang.String> id, @Nullable ScheduleSqlTaskState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, state, makeResourceOptions(options, id), false);
    }
