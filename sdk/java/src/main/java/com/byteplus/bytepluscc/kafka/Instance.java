...
import com.byteplus.bytepluscc.kafka.InstanceArgs;
import com.byteplus.bytepluscc.kafka.inputs.InstanceState;
import com.byteplus.bytepluscc.kafka.outputs.InstanceChargeInfo;
import com.byteplus.bytepluscc.kafka.outputs.InstanceConnectionInfo;
import com.byteplus.bytepluscc.kafka.outputs.InstanceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.kafka.Instance;
 * import com.byteplus.bytepluscc.kafka.InstanceArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.InstanceChargeInfoArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.InstanceTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:kafka/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
