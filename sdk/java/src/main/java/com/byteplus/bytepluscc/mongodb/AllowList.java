...
import com.byteplus.bytepluscc.mongodb.AllowListArgs;
import com.byteplus.bytepluscc.mongodb.inputs.AllowListState;
import com.byteplus.bytepluscc.mongodb.outputs.AllowListAssociatedInstance;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.mongodb.AllowList;
 * import com.byteplus.bytepluscc.mongodb.AllowListArgs;
 * import com.pulumi.bytepluscc.mongodb.inputs.AllowListAssociatedInstanceArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:mongodb/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
