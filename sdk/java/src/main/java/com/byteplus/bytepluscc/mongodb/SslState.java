...
import com.byteplus.bytepluscc.mongodb.SslStateArgs;
import com.byteplus.bytepluscc.mongodb.inputs.SslStateState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.mongodb.SslState;
 * import com.byteplus.bytepluscc.mongodb.SslStateArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:mongodb/sslState:SslState")
public class SslState extends com.pulumi.resources.CustomResource {
    ...
    public SslState(java.lang.String name, SslStateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/sslState:SslState", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SslState(java.lang.String name, Output<java.lang.String> id, @Nullable SslStateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/sslState:SslState", name, state, makeResourceOptions(options, id), false);
    }
