...
import com.byteplus.bytepluscc.alb.inputs.AclState;
import com.byteplus.bytepluscc.alb.outputs.AclAclEntry;
import com.byteplus.bytepluscc.alb.outputs.AclListener;
import com.byteplus.bytepluscc.alb.outputs.AclTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:alb/acl:Acl")
public class Acl extends com.pulumi.resources.CustomResource {
    ...
    public Acl(java.lang.String name, @Nullable AclArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/acl:Acl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Acl(java.lang.String name, Output<java.lang.String> id, @Nullable AclState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/acl:Acl", name, state, makeResourceOptions(options, id), false);
    }
