...
import com.byteplus.bytepluscc.apig.inputs.GatewayServiceState;
import com.byteplus.bytepluscc.apig.outputs.GatewayServiceAuthSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayServiceCustomDomain;
import com.byteplus.bytepluscc.apig.outputs.GatewayServiceDomain;
import com.byteplus.bytepluscc.apig.outputs.GatewayServiceDomainSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayServiceServiceNetworkSpec;
 ...
 * import com.pulumi.bytepluscc.apig.inputs.GatewayServiceServiceNetworkSpecArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:apig/gatewayService:GatewayService")
public class GatewayService extends com.pulumi.resources.CustomResource {
    ...
    public GatewayService(java.lang.String name, GatewayServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/gatewayService:GatewayService", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private GatewayService(java.lang.String name, Output<java.lang.String> id, @Nullable GatewayServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/gatewayService:GatewayService", name, state, makeResourceOptions(options, id), false);
    }
