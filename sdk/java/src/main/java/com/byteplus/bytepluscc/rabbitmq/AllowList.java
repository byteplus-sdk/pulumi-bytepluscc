...
import com.byteplus.bytepluscc.rabbitmq.AllowListArgs;
import com.byteplus.bytepluscc.rabbitmq.inputs.AllowListState;
import com.byteplus.bytepluscc.rabbitmq.outputs.AllowListAssociatedInstance;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rabbitmq.AllowList;
 * import com.byteplus.bytepluscc.rabbitmq.AllowListArgs;
 * import com.pulumi.bytepluscc.rabbitmq.inputs.AllowListAssociatedInstanceArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rabbitmq/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
