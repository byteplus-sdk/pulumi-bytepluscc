...
import com.byteplus.bytepluscc.rdspostgresql.inputs.AllowListState;
import com.byteplus.bytepluscc.rdspostgresql.outputs.AllowListAssociatedInstance;
import com.byteplus.bytepluscc.rdspostgresql.outputs.AllowListSecurityGroupBindInfo;
 ...
 * import com.byteplus.bytepluscc.rdspostgresql.AllowListArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.AllowListSecurityGroupBindInfoArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.AllowListAssociatedInstanceArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdspostgresql/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, @Nullable AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
