...
import com.byteplus.bytepluscc.vpc.inputs.SecurityGroupState;
import com.byteplus.bytepluscc.vpc.outputs.SecurityGroupEgressPermission;
import com.byteplus.bytepluscc.vpc.outputs.SecurityGroupIngressPermission;
import com.byteplus.bytepluscc.vpc.outputs.SecurityGroupTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/securityGroup:SecurityGroup")
public class SecurityGroup extends com.pulumi.resources.CustomResource {
    ...
    public SecurityGroup(java.lang.String name, SecurityGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/securityGroup:SecurityGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SecurityGroup(java.lang.String name, Output<java.lang.String> id, @Nullable SecurityGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/securityGroup:SecurityGroup", name, state, makeResourceOptions(options, id), false);
    }
