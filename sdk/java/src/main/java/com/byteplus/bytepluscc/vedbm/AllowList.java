...
import com.byteplus.bytepluscc.vedbm.AllowListArgs;
import com.byteplus.bytepluscc.vedbm.inputs.AllowListState;
import com.byteplus.bytepluscc.vedbm.outputs.AllowListAssociatedInstance;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vedbm.AllowList;
 * import com.byteplus.bytepluscc.vedbm.AllowListArgs;
 * import com.pulumi.bytepluscc.vedbm.inputs.AllowListAssociatedInstanceArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vedbm/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
