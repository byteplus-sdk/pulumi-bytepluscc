...
import com.byteplus.bytepluscc.ecs.LaunchTemplateArgs;
import com.byteplus.bytepluscc.ecs.inputs.LaunchTemplateState;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateLaunchTemplateTag;
import com.byteplus.bytepluscc.ecs.outputs.LaunchTemplateLaunchTemplateVersion;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.ecs.LaunchTemplate;
 * import com.byteplus.bytepluscc.ecs.LaunchTemplateArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateLaunchTemplateVersionArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateLaunchTemplateVersionEipArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateLaunchTemplateVersionTagArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateLaunchTemplateVersionVolumeArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.LaunchTemplateLaunchTemplateTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/launchTemplate:LaunchTemplate")
public class LaunchTemplate extends com.pulumi.resources.CustomResource {
    ...
    public LaunchTemplate(java.lang.String name, LaunchTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LaunchTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable LaunchTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, state, makeResourceOptions(options, id), false);
    }
