...
import com.byteplus.bytepluscc.vefaas.ReleaseArgs;
import com.byteplus.bytepluscc.vefaas.inputs.ReleaseState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vefaas.Release;
 * import com.byteplus.bytepluscc.vefaas.ReleaseArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:vefaas/release:Release example &#34;function_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:vefaas/release:Release")
public class Release extends com.pulumi.resources.CustomResource {
    ...
    public Release(java.lang.String name, ReleaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/release:Release", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Release(java.lang.String name, Output<java.lang.String> id, @Nullable ReleaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/release:Release", name, state, makeResourceOptions(options, id), false);
    }
