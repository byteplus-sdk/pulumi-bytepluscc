...
import com.byteplus.bytepluscc.iam.inputs.UserState;
import com.byteplus.bytepluscc.iam.outputs.UserAccessKey;
import com.byteplus.bytepluscc.iam.outputs.UserLoginProfile;
import com.byteplus.bytepluscc.iam.outputs.UserPolicy;
import com.byteplus.bytepluscc.iam.outputs.UserSecurityConfig;
import com.byteplus.bytepluscc.iam.outputs.UserTag;
 ...
 * import com.byteplus.bytepluscc.iam.UserArgs;
 * import com.pulumi.bytepluscc.iam.inputs.UserPolicyArgs;
 * import com.pulumi.bytepluscc.iam.inputs.UserTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:iam/user:User")
public class User extends com.pulumi.resources.CustomResource {
    ...
    public User(java.lang.String name, UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/user:User", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private User(java.lang.String name, Output<java.lang.String> id, @Nullable UserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/user:User", name, state, makeResourceOptions(options, id), false);
    }
