...
import com.byteplus.bytepluscc.rdsmysql.inputs.EndpointPublicAddressState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress")
public class EndpointPublicAddress extends com.pulumi.resources.CustomResource {
    ...
    public EndpointPublicAddress(java.lang.String name, EndpointPublicAddressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EndpointPublicAddress(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointPublicAddressState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, state, makeResourceOptions(options, id), false);
    }
