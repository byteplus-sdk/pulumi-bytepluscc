...
import com.byteplus.bytepluscc.transitrouter.TransitRouterRouteEntryArgs;
import com.byteplus.bytepluscc.transitrouter.inputs.TransitRouterRouteEntryState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.transitrouter.TransitRouterRouteEntry;
 * import com.byteplus.bytepluscc.transitrouter.TransitRouterRouteEntryArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry")
public class TransitRouterRouteEntry extends com.pulumi.resources.CustomResource {
    ...
    public TransitRouterRouteEntry(java.lang.String name, TransitRouterRouteEntryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TransitRouterRouteEntry(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterRouteEntryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, state, makeResourceOptions(options, id), false);
    }
