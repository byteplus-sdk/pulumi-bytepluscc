...
import com.byteplus.bytepluscc.cen.GrantInstanceArgs;
import com.byteplus.bytepluscc.cen.inputs.GrantInstanceState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cen.GrantInstance;
 * import com.byteplus.bytepluscc.cen.GrantInstanceArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:cen/grantInstance:GrantInstance example &#34;instance_id|cen_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:cen/grantInstance:GrantInstance")
public class GrantInstance extends com.pulumi.resources.CustomResource {
    ...
    public GrantInstance(java.lang.String name, GrantInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/grantInstance:GrantInstance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private GrantInstance(java.lang.String name, Output<java.lang.String> id, @Nullable GrantInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/grantInstance:GrantInstance", name, state, makeResourceOptions(options, id), false);
    }
