...
import com.byteplus.bytepluscc.vpn.SslVpnClientCertArgs;
import com.byteplus.bytepluscc.vpn.inputs.SslVpnClientCertState;
import com.byteplus.bytepluscc.vpn.outputs.SslVpnClientCertTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpn.SslVpnClientCert;
 * import com.byteplus.bytepluscc.vpn.SslVpnClientCertArgs;
 * import com.pulumi.bytepluscc.vpn.inputs.SslVpnClientCertTagArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert")
public class SslVpnClientCert extends com.pulumi.resources.CustomResource {
    ...
    public SslVpnClientCert(java.lang.String name, SslVpnClientCertArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SslVpnClientCert(java.lang.String name, Output<java.lang.String> id, @Nullable SslVpnClientCertState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, state, makeResourceOptions(options, id), false);
    }
