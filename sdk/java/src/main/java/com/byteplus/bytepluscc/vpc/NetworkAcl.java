...
import com.byteplus.bytepluscc.vpc.inputs.NetworkAclState;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclDefaultEgressAclEntry;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclDefaultIngressAclEntry;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclEgressAclEntry;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclIngressAclEntry;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclResource;
import com.byteplus.bytepluscc.vpc.outputs.NetworkAclTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/networkAcl:NetworkAcl")
public class NetworkAcl extends com.pulumi.resources.CustomResource {
    ...
    public NetworkAcl(java.lang.String name, NetworkAclArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/networkAcl:NetworkAcl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NetworkAcl(java.lang.String name, Output<java.lang.String> id, @Nullable NetworkAclState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/networkAcl:NetworkAcl", name, state, makeResourceOptions(options, id), false);
    }
