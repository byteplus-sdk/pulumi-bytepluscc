...
import com.byteplus.bytepluscc.fwcenter.DnsControlPolicyArgs;
import com.byteplus.bytepluscc.fwcenter.inputs.DnsControlPolicyState;
import com.byteplus.bytepluscc.fwcenter.outputs.DnsControlPolicyDomainListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.DnsControlPolicySource;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.fwcenter.DnsControlPolicy;
 * import com.byteplus.bytepluscc.fwcenter.DnsControlPolicyArgs;
 * import com.pulumi.bytepluscc.fwcenter.inputs.DnsControlPolicySourceArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy")
public class DnsControlPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DnsControlPolicy(java.lang.String name, DnsControlPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DnsControlPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable DnsControlPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy", name, state, makeResourceOptions(options, id), false);
    }
