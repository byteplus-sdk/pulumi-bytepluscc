...
import com.byteplus.bytepluscc.rabbitmq.inputs.InstancePluginState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rabbitmq/instancePlugin:InstancePlugin")
public class InstancePlugin extends com.pulumi.resources.CustomResource {
    ...
    public InstancePlugin(java.lang.String name, InstancePluginArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstancePlugin(java.lang.String name, Output<java.lang.String> id, @Nullable InstancePluginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, state, makeResourceOptions(options, id), false);
    }
