...
import com.byteplus.bytepluscc.privatezone.PrivateZoneArgs;
import com.byteplus.bytepluscc.privatezone.inputs.PrivateZoneState;
import com.byteplus.bytepluscc.privatezone.outputs.PrivateZoneTag;
import com.byteplus.bytepluscc.privatezone.outputs.PrivateZoneVpc;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.privatezone.PrivateZone;
 * import com.byteplus.bytepluscc.privatezone.PrivateZoneArgs;
 * import com.pulumi.bytepluscc.privatezone.inputs.PrivateZoneVpcArgs;
 * import com.pulumi.bytepluscc.privatezone.inputs.PrivateZoneTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:privatezone/privateZone:PrivateZone")
public class PrivateZone extends com.pulumi.resources.CustomResource {
    ...
    public PrivateZone(java.lang.String name, PrivateZoneArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/privateZone:PrivateZone", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PrivateZone(java.lang.String name, Output<java.lang.String> id, @Nullable PrivateZoneState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/privateZone:PrivateZone", name, state, makeResourceOptions(options, id), false);
    }
