...
import com.byteplus.bytepluscc.fwcenter.NatFireWallControlPolicyArgs;
import com.byteplus.bytepluscc.fwcenter.inputs.NatFireWallControlPolicyState;
import com.byteplus.bytepluscc.fwcenter.outputs.NatFireWallControlPolicyDestPortListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.NatFireWallControlPolicyDestinationCidrListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.NatFireWallControlPolicySourceCidrListV1;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.fwcenter.NatFireWallControlPolicy;
 * import com.byteplus.bytepluscc.fwcenter.NatFireWallControlPolicyArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy")
public class NatFireWallControlPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NatFireWallControlPolicy(java.lang.String name, NatFireWallControlPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NatFireWallControlPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable NatFireWallControlPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, state, makeResourceOptions(options, id), false);
    }
