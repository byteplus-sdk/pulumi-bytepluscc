 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.clb.Nlb;
 * import com.byteplus.bytepluscc.clb.NlbArgs;
 * import com.pulumi.bytepluscc.clb.inputs.NlbZoneMappingArgs;
 * import com.pulumi.bytepluscc.clb.inputs.NlbTagArgs;
...
public class Nlb extends com.pulumi.resources.CustomResource {
    ...
    public Nlb(java.lang.String name, NlbArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlb:Nlb", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Nlb(java.lang.String name, Output<java.lang.String> id, @Nullable NlbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlb:Nlb", name, state, makeResourceOptions(options, id), false);
    }
