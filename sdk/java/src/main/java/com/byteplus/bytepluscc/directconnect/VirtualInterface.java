...
import com.byteplus.bytepluscc.directconnect.inputs.VirtualInterfaceState;
import com.byteplus.bytepluscc.directconnect.outputs.VirtualInterfaceTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:directconnect/virtualInterface:VirtualInterface")
public class VirtualInterface extends com.pulumi.resources.CustomResource {
    ...
    public VirtualInterface(java.lang.String name, VirtualInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VirtualInterface(java.lang.String name, Output<java.lang.String> id, @Nullable VirtualInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, state, makeResourceOptions(options, id), false);
    }
