...
import com.byteplus.bytepluscc.organization.AccountArgs;
import com.byteplus.bytepluscc.organization.inputs.AccountState;
import com.byteplus.bytepluscc.organization.outputs.AccountSecureContactInfo;
import com.byteplus.bytepluscc.organization.outputs.AccountTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.organization.Account;
 * import com.byteplus.bytepluscc.organization.AccountArgs;
 * import com.pulumi.bytepluscc.organization.inputs.AccountSecureContactInfoArgs;
 * import com.pulumi.bytepluscc.organization.inputs.AccountTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:organization/account:Account")
public class Account extends com.pulumi.resources.CustomResource {
    ...
    public Account(java.lang.String name, AccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:organization/account:Account", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Account(java.lang.String name, Output<java.lang.String> id, @Nullable AccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:organization/account:Account", name, state, makeResourceOptions(options, id), false);
    }
