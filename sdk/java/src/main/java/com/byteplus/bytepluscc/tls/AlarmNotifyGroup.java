...
import com.byteplus.bytepluscc.tls.AlarmNotifyGroupArgs;
import com.byteplus.bytepluscc.tls.inputs.AlarmNotifyGroupState;
import com.byteplus.bytepluscc.tls.outputs.AlarmNotifyGroupNoticeRule;
import com.byteplus.bytepluscc.tls.outputs.AlarmNotifyGroupReceiver;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.AlarmNotifyGroup;
 * import com.byteplus.bytepluscc.tls.AlarmNotifyGroupArgs;
 * import com.pulumi.bytepluscc.tls.inputs.AlarmNotifyGroupNoticeRuleArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup example &#34;alarm_notify_group_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup")
public class AlarmNotifyGroup extends com.pulumi.resources.CustomResource {
    ...
    public AlarmNotifyGroup(java.lang.String name, AlarmNotifyGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AlarmNotifyGroup(java.lang.String name, Output<java.lang.String> id, @Nullable AlarmNotifyGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, state, makeResourceOptions(options, id), false);
    }
