...
import com.byteplus.bytepluscc.autoscaling.ScalingConfigurationArgs;
import com.byteplus.bytepluscc.autoscaling.inputs.ScalingConfigurationState;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingConfigurationEip;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingConfigurationInstanceTypeOverride;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingConfigurationTag;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingConfigurationVolume;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.autoscaling.ScalingConfiguration;
 * import com.byteplus.bytepluscc.autoscaling.ScalingConfigurationArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingConfigurationEipArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingConfigurationInstanceTypeOverrideArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingConfigurationVolumeArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingConfigurationTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration")
public class ScalingConfiguration extends com.pulumi.resources.CustomResource {
    ...
    public ScalingConfiguration(java.lang.String name, @Nullable ScalingConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScalingConfiguration(java.lang.String name, Output<java.lang.String> id, @Nullable ScalingConfigurationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, state, makeResourceOptions(options, id), false);
    }
