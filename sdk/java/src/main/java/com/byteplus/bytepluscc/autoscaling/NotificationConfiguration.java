...
import com.byteplus.bytepluscc.autoscaling.inputs.NotificationConfigurationState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration")
public class NotificationConfiguration extends com.pulumi.resources.CustomResource {
    ...
    public NotificationConfiguration(java.lang.String name, NotificationConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NotificationConfiguration(java.lang.String name, Output<java.lang.String> id, @Nullable NotificationConfigurationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, state, makeResourceOptions(options, id), false);
    }
