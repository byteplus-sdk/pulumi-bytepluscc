...
import com.byteplus.bytepluscc.waf.inputs.CcRuleState;
import com.byteplus.bytepluscc.waf.outputs.CcRuleAccurateGroup;
import com.byteplus.bytepluscc.waf.outputs.CcRuleCronConf;
 ...
 * 
 */
@ResourceType(type="bytepluscc:waf/ccRule:CcRule")
public class CcRule extends com.pulumi.resources.CustomResource {
    ...
    public CcRule(java.lang.String name, CcRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:waf/ccRule:CcRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CcRule(java.lang.String name, Output<java.lang.String> id, @Nullable CcRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:waf/ccRule:CcRule", name, state, makeResourceOptions(options, id), false);
    }
