...
import com.byteplus.bytepluscc.directconnect.inputs.GatewayRouteState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:directconnect/gatewayRoute:GatewayRoute")
public class GatewayRoute extends com.pulumi.resources.CustomResource {
    ...
    public GatewayRoute(java.lang.String name, GatewayRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/gatewayRoute:GatewayRoute", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private GatewayRoute(java.lang.String name, Output<java.lang.String> id, @Nullable GatewayRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/gatewayRoute:GatewayRoute", name, state, makeResourceOptions(options, id), false);
    }
