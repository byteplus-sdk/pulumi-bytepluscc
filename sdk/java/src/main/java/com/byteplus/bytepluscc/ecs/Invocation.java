...
import com.byteplus.bytepluscc.ecs.inputs.InvocationState;
import com.byteplus.bytepluscc.ecs.outputs.InvocationInvocationResult;
import com.byteplus.bytepluscc.ecs.outputs.InvocationParameterDefinition;
import com.byteplus.bytepluscc.ecs.outputs.InvocationTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/invocation:Invocation")
public class Invocation extends com.pulumi.resources.CustomResource {
    ...
    public Invocation(java.lang.String name, InvocationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/invocation:Invocation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Invocation(java.lang.String name, Output<java.lang.String> id, @Nullable InvocationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/invocation:Invocation", name, state, makeResourceOptions(options, id), false);
    }
