...
import com.byteplus.bytepluscc.rdspostgresql.inputs.DbAccountState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdspostgresql/dbAccount:DbAccount")
public class DbAccount extends com.pulumi.resources.CustomResource {
    ...
    public DbAccount(java.lang.String name, DbAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/dbAccount:DbAccount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DbAccount(java.lang.String name, Output<java.lang.String> id, @Nullable DbAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/dbAccount:DbAccount", name, state, makeResourceOptions(options, id), false);
    }
