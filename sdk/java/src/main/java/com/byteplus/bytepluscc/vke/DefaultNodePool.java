...
import com.byteplus.bytepluscc.vke.DefaultNodePoolArgs;
import com.byteplus.bytepluscc.vke.inputs.DefaultNodePoolState;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolAutoScaling;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolKubernetesConfig;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolManagement;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolNodeConfig;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolNodeStatistics;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolStatus;
import com.byteplus.bytepluscc.vke.outputs.DefaultNodePoolTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vke.DefaultNodePool;
 * import com.byteplus.bytepluscc.vke.DefaultNodePoolArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolKubernetesConfigArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolKubernetesConfigLabelArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolKubernetesConfigTaintArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolNodeConfigArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolNodeConfigSecurityArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolNodeConfigSecurityLoginArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolNodeConfigTagArgs;
 * import com.pulumi.bytepluscc.vke.inputs.DefaultNodePoolTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vke/defaultNodePool:DefaultNodePool")
public class DefaultNodePool extends com.pulumi.resources.CustomResource {
    ...
    public DefaultNodePool(java.lang.String name, DefaultNodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DefaultNodePool(java.lang.String name, Output<java.lang.String> id, @Nullable DefaultNodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, state, makeResourceOptions(options, id), false);
    }
