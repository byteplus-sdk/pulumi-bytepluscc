...
import com.byteplus.bytepluscc.rdsmssql.InstanceArgs;
import com.byteplus.bytepluscc.rdsmssql.inputs.InstanceState;
import com.byteplus.bytepluscc.rdsmssql.outputs.InstanceChargeInfo;
import com.byteplus.bytepluscc.rdsmssql.outputs.InstanceConnectionInfo;
import com.byteplus.bytepluscc.rdsmssql.outputs.InstanceNodeDetailInfo;
import com.byteplus.bytepluscc.rdsmssql.outputs.InstanceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmssql.Instance;
 * import com.byteplus.bytepluscc.rdsmssql.InstanceArgs;
 * import com.pulumi.bytepluscc.rdsmssql.inputs.InstanceChargeInfoArgs;
 * import com.pulumi.bytepluscc.rdsmssql.inputs.InstanceTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmssql/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
