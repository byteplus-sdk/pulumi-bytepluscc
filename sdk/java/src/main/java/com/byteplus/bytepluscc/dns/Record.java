...
import com.byteplus.bytepluscc.dns.RecordArgs;
import com.byteplus.bytepluscc.dns.inputs.RecordState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.dns.Record;
 * import com.byteplus.bytepluscc.dns.RecordArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:dns/record:Record")
public class Record extends com.pulumi.resources.CustomResource {
    ...
    public Record(java.lang.String name, RecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:dns/record:Record", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Record(java.lang.String name, Output<java.lang.String> id, @Nullable RecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:dns/record:Record", name, state, makeResourceOptions(options, id), false);
    }
