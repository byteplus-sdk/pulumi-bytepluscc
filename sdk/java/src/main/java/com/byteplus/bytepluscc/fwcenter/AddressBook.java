...
import com.byteplus.bytepluscc.fwcenter.AddressBookArgs;
import com.byteplus.bytepluscc.fwcenter.inputs.AddressBookState;
import com.byteplus.bytepluscc.fwcenter.outputs.AddressBookAddressDetailList;
import com.byteplus.bytepluscc.fwcenter.outputs.AddressBookTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.fwcenter.AddressBook;
 * import com.byteplus.bytepluscc.fwcenter.AddressBookArgs;
 * import com.pulumi.bytepluscc.fwcenter.inputs.AddressBookAddressDetailListArgs;
 * import java.util.List;
 ...
 * 
 */
@ResourceType(type="bytepluscc:fwcenter/addressBook:AddressBook")
public class AddressBook extends com.pulumi.resources.CustomResource {
    ...
    public AddressBook(java.lang.String name, AddressBookArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/addressBook:AddressBook", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AddressBook(java.lang.String name, Output<java.lang.String> id, @Nullable AddressBookState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/addressBook:AddressBook", name, state, makeResourceOptions(options, id), false);
    }
