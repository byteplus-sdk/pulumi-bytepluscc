...
import com.byteplus.bytepluscc.directconnect.BgpPeerArgs;
import com.byteplus.bytepluscc.directconnect.inputs.BgpPeerState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.directconnect.BgpPeer;
 * import com.byteplus.bytepluscc.directconnect.BgpPeerArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:directconnect/bgpPeer:BgpPeer example &#34;bgp_peer_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:directconnect/bgpPeer:BgpPeer")
public class BgpPeer extends com.pulumi.resources.CustomResource {
    ...
    public BgpPeer(java.lang.String name, BgpPeerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/bgpPeer:BgpPeer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private BgpPeer(java.lang.String name, Output<java.lang.String> id, @Nullable BgpPeerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/bgpPeer:BgpPeer", name, state, makeResourceOptions(options, id), false);
    }
