...
import com.byteplus.bytepluscc.privatelink.VpcEndpointArgs;
import com.byteplus.bytepluscc.privatelink.inputs.VpcEndpointState;
import com.byteplus.bytepluscc.privatelink.outputs.VpcEndpointTag;
import com.byteplus.bytepluscc.privatelink.outputs.VpcEndpointZone;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.privatelink.VpcEndpoint;
 * import com.byteplus.bytepluscc.privatelink.VpcEndpointArgs;
 * import com.pulumi.bytepluscc.privatelink.inputs.VpcEndpointTagArgs;
 * import com.pulumi.bytepluscc.privatelink.inputs.VpcEndpointZoneArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:privatelink/vpcEndpoint:VpcEndpoint")
public class VpcEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public VpcEndpoint(java.lang.String name, @Nullable VpcEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpcEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint", name, state, makeResourceOptions(options, id), false);
    }
