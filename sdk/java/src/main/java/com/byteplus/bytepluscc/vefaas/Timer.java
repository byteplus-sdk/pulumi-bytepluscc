...
import com.byteplus.bytepluscc.vefaas.TimerArgs;
import com.byteplus.bytepluscc.vefaas.inputs.TimerState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vefaas.Timer;
 * import com.byteplus.bytepluscc.vefaas.TimerArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vefaas/timer:Timer")
public class Timer extends com.pulumi.resources.CustomResource {
    ...
    public Timer(java.lang.String name, @Nullable TimerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/timer:Timer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Timer(java.lang.String name, Output<java.lang.String> id, @Nullable TimerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/timer:Timer", name, state, makeResourceOptions(options, id), false);
    }
