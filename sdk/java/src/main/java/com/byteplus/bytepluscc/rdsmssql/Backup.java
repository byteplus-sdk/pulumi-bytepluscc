...
import com.byteplus.bytepluscc.rdsmssql.BackupArgs;
import com.byteplus.bytepluscc.rdsmssql.inputs.BackupState;
import com.byteplus.bytepluscc.rdsmssql.outputs.BackupBackupDatabaseDetail;
import com.byteplus.bytepluscc.rdsmssql.outputs.BackupBackupMeta;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmssql.Backup;
 * import com.byteplus.bytepluscc.rdsmssql.BackupArgs;
 * import com.pulumi.bytepluscc.rdsmssql.inputs.BackupBackupMetaArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmssql/backup:Backup")
public class Backup extends com.pulumi.resources.CustomResource {
    ...
    public Backup(java.lang.String name, BackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/backup:Backup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Backup(java.lang.String name, Output<java.lang.String> id, @Nullable BackupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmssql/backup:Backup", name, state, makeResourceOptions(options, id), false);
    }
