...
import com.byteplus.bytepluscc.vepfs.MountServiceArgs;
import com.byteplus.bytepluscc.vepfs.inputs.MountServiceState;
import com.byteplus.bytepluscc.vepfs.outputs.MountServiceAttachFileSystem;
import com.byteplus.bytepluscc.vepfs.outputs.MountServiceNode;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vepfs.MountService;
 * import com.byteplus.bytepluscc.vepfs.MountServiceArgs;
 * import com.pulumi.bytepluscc.vepfs.inputs.MountServiceAttachFileSystemArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vepfs/mountService:MountService")
public class MountService extends com.pulumi.resources.CustomResource {
    ...
    public MountService(java.lang.String name, MountServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vepfs/mountService:MountService", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private MountService(java.lang.String name, Output<java.lang.String> id, @Nullable MountServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vepfs/mountService:MountService", name, state, makeResourceOptions(options, id), false);
    }
