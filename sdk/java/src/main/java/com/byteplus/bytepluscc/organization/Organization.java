...
import com.byteplus.bytepluscc.organization.OrganizationArgs;
import com.byteplus.bytepluscc.organization.inputs.OrganizationState;
import com.byteplus.bytepluscc.organization.outputs.OrganizationOrganization;
import com.byteplus.bytepluscc.organization.outputs.OrganizationOwner;
 ...
 * 
 */
@ResourceType(type="bytepluscc:organization/organization:Organization")
public class Organization extends com.pulumi.resources.CustomResource {
    ...
    public Organization(java.lang.String name, @Nullable OrganizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:organization/organization:Organization", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Organization(java.lang.String name, Output<java.lang.String> id, @Nullable OrganizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:organization/organization:Organization", name, state, makeResourceOptions(options, id), false);
    }
