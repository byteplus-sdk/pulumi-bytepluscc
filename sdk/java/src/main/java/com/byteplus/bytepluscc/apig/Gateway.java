...
import com.byteplus.bytepluscc.apig.GatewayArgs;
import com.byteplus.bytepluscc.apig.inputs.GatewayState;
import com.byteplus.bytepluscc.apig.outputs.GatewayBackendSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayCustomLog;
import com.byteplus.bytepluscc.apig.outputs.GatewayEvent;
import com.byteplus.bytepluscc.apig.outputs.GatewayLogSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayMonitorSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayNetworkSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayResourceSpec;
import com.byteplus.bytepluscc.apig.outputs.GatewayTraceSpec;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.apig.Gateway;
 * import com.byteplus.bytepluscc.apig.GatewayArgs;
 * import com.pulumi.bytepluscc.apig.inputs.GatewayResourceSpecArgs;
 * import com.pulumi.bytepluscc.apig.inputs.GatewayMonitorSpecArgs;
 * import com.pulumi.bytepluscc.apig.inputs.GatewayLogSpecArgs;
 * import com.pulumi.bytepluscc.apig.inputs.GatewayTraceSpecArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:apig/gateway:Gateway")
public class Gateway extends com.pulumi.resources.CustomResource {
    ...
    public Gateway(java.lang.String name, GatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/gateway:Gateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Gateway(java.lang.String name, Output<java.lang.String> id, @Nullable GatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/gateway:Gateway", name, state, makeResourceOptions(options, id), false);
    }
