...
import com.byteplus.bytepluscc.directconnect.inputs.DirectConnectGatewayState;
import com.byteplus.bytepluscc.directconnect.outputs.DirectConnectGatewayAssociateCen;
import com.byteplus.bytepluscc.directconnect.outputs.DirectConnectGatewayAssociateEic;
import com.byteplus.bytepluscc.directconnect.outputs.DirectConnectGatewayTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:directconnect/directConnectGateway:DirectConnectGateway")
public class DirectConnectGateway extends com.pulumi.resources.CustomResource {
    ...
    public DirectConnectGateway(java.lang.String name, @Nullable DirectConnectGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/directConnectGateway:DirectConnectGateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DirectConnectGateway(java.lang.String name, Output<java.lang.String> id, @Nullable DirectConnectGatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/directConnectGateway:DirectConnectGateway", name, state, makeResourceOptions(options, id), false);
    }
