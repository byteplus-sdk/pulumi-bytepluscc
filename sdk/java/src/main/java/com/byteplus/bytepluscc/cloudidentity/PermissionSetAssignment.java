...
import com.byteplus.bytepluscc.cloudidentity.inputs.PermissionSetAssignmentState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment")
public class PermissionSetAssignment extends com.pulumi.resources.CustomResource {
    ...
    public PermissionSetAssignment(java.lang.String name, PermissionSetAssignmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PermissionSetAssignment(java.lang.String name, Output<java.lang.String> id, @Nullable PermissionSetAssignmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, state, makeResourceOptions(options, id), false);
    }
