...
import com.byteplus.bytepluscc.rdsmysql.inputs.InstanceReadonlyNodeState;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode")
public class InstanceReadonlyNode extends com.pulumi.resources.CustomResource {
    ...
    public InstanceReadonlyNode(java.lang.String name, InstanceReadonlyNodeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InstanceReadonlyNode(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceReadonlyNodeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, state, makeResourceOptions(options, id), false);
    }
