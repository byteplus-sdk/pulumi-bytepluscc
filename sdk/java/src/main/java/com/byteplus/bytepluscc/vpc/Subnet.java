...
import com.byteplus.bytepluscc.vpc.inputs.SubnetState;
import com.byteplus.bytepluscc.vpc.outputs.SubnetRouteTable;
import com.byteplus.bytepluscc.vpc.outputs.SubnetTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/subnet:Subnet")
public class Subnet extends com.pulumi.resources.CustomResource {
    ...
    public Subnet(java.lang.String name, SubnetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/subnet:Subnet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Subnet(java.lang.String name, Output<java.lang.String> id, @Nullable SubnetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/subnet:Subnet", name, state, makeResourceOptions(options, id), false);
    }
