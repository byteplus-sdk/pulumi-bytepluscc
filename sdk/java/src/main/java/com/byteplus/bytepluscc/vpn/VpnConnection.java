...
import com.byteplus.bytepluscc.vpn.VpnConnectionArgs;
import com.byteplus.bytepluscc.vpn.inputs.VpnConnectionState;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionBgpInfo;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionHealthChecker;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionIkeConfig;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionIpsecConfig;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionTag;
import com.byteplus.bytepluscc.vpn.outputs.VpnConnectionTunnelOption;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpn.VpnConnection;
 * import com.byteplus.bytepluscc.vpn.VpnConnectionArgs;
 * import com.pulumi.bytepluscc.vpn.inputs.VpnConnectionIkeConfigArgs;
 * import com.pulumi.bytepluscc.vpn.inputs.VpnConnectionIpsecConfigArgs;
 * import com.pulumi.bytepluscc.vpn.inputs.VpnConnectionBgpInfoArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/vpnConnection:VpnConnection")
public class VpnConnection extends com.pulumi.resources.CustomResource {
    ...
    public VpnConnection(java.lang.String name, VpnConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnConnection:VpnConnection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpnConnection(java.lang.String name, Output<java.lang.String> id, @Nullable VpnConnectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnConnection:VpnConnection", name, state, makeResourceOptions(options, id), false);
    }
