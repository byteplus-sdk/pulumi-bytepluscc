...
public final class KmsFunctions {
    ...
    public static Output<GetKeyResult> getKey(GetKeyArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:kms/getKey:getKey", TypeShape.of(GetKeyResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Data Source schema for Byteplus::KMS::Key
     * 
    ...
    public static Output<GetKeysResult> getKeys(InvokeArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:kms/getKeys:getKeys", TypeShape.of(GetKeysResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Plural Data Source schema for Byteplus::KMS::Key
     * 
