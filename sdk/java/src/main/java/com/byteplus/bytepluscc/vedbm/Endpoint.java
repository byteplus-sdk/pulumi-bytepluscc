...
import com.byteplus.bytepluscc.vedbm.EndpointArgs;
import com.byteplus.bytepluscc.vedbm.inputs.EndpointState;
import com.byteplus.bytepluscc.vedbm.outputs.EndpointPrivateAddresses;
import com.byteplus.bytepluscc.vedbm.outputs.EndpointPublicAddresses;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vedbm.Endpoint;
 * import com.byteplus.bytepluscc.vedbm.EndpointArgs;
 * import com.pulumi.bytepluscc.vedbm.inputs.EndpointPublicAddressesArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vedbm/endpoint:Endpoint")
public class Endpoint extends com.pulumi.resources.CustomResource {
    ...
    public Endpoint(java.lang.String name, EndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/endpoint:Endpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Endpoint(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/endpoint:Endpoint", name, state, makeResourceOptions(options, id), false);
    }
