...
import com.byteplus.bytepluscc.vefaas.FunctionArgs;
import com.byteplus.bytepluscc.vefaas.inputs.FunctionState;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionAsyncTaskConfig;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionDependencyInstallStatus;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionEnv;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionNasStorage;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionSourceAccessConfig;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionTag;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionTlsConfig;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionTosMountConfig;
import com.byteplus.bytepluscc.vefaas.outputs.FunctionVpcConfig;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vefaas.Function;
 * import com.byteplus.bytepluscc.vefaas.FunctionArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionVpcConfigArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionNasStorageArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionTosMountConfigArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionTosMountConfigCredentialsArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionEnvArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionAsyncTaskConfigArgs;
 * import com.pulumi.bytepluscc.vefaas.inputs.FunctionTlsConfigArgs;
 ...
 *
 * ```sh
 * $ pulumi import bytepluscc:vefaas/function:Function example &#34;function_id&#34;
 * ```
 *
 */
@ResourceType(type="bytepluscc:vefaas/function:Function")
public class Function extends com.pulumi.resources.CustomResource {
    ...
    public Function(java.lang.String name, @Nullable FunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/function:Function", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Function(java.lang.String name, Output<java.lang.String> id, @Nullable FunctionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/function:Function", name, state, makeResourceOptions(options, id), false);
    }
