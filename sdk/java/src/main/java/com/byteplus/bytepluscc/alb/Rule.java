...
import com.byteplus.bytepluscc.alb.RuleArgs;
import com.byteplus.bytepluscc.alb.inputs.RuleState;
import com.byteplus.bytepluscc.alb.outputs.RuleForwardGroupConfig;
import com.byteplus.bytepluscc.alb.outputs.RuleRedirectConfig;
import com.byteplus.bytepluscc.alb.outputs.RuleRewriteConfig;
import com.byteplus.bytepluscc.alb.outputs.RuleRuleAction;
import com.byteplus.bytepluscc.alb.outputs.RuleRuleCondition;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.alb.Rule;
 * import com.byteplus.bytepluscc.alb.RuleArgs;
 * import com.pulumi.bytepluscc.alb.inputs.RuleRewriteConfigArgs;
 * import com.pulumi.bytepluscc.alb.inputs.RuleForwardGroupConfigArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:alb/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
