...
import com.byteplus.bytepluscc.redis.AllowListArgs;
import com.byteplus.bytepluscc.redis.inputs.AllowListState;
import com.byteplus.bytepluscc.redis.outputs.AllowListAssociatedInstance;
import com.byteplus.bytepluscc.redis.outputs.AllowListSecurityGroupBindInfo;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.redis.AllowList;
 * import com.byteplus.bytepluscc.redis.AllowListArgs;
 * import com.pulumi.bytepluscc.redis.inputs.AllowListSecurityGroupBindInfoArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:redis/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
