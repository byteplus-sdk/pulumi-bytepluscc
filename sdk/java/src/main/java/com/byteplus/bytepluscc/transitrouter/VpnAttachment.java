...
import com.byteplus.bytepluscc.transitrouter.inputs.VpnAttachmentState;
import com.byteplus.bytepluscc.transitrouter.outputs.VpnAttachmentTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/vpnAttachment:VpnAttachment")
public class VpnAttachment extends com.pulumi.resources.CustomResource {
    ...
    public VpnAttachment(java.lang.String name, VpnAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/vpnAttachment:VpnAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpnAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable VpnAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/vpnAttachment:VpnAttachment", name, state, makeResourceOptions(options, id), false);
    }
