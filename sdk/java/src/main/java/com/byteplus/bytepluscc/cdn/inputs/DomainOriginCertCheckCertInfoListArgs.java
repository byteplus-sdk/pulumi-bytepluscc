...
import com.byteplus.bytepluscc.cdn.inputs.DomainOriginCertCheckCertInfoListCertificateArgs;
...
public final class DomainOriginCertCheckCertInfoListArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainOriginCertCheckCertInfoListArgs Empty = new DomainOriginCertCheckCertInfoListArgs();
    ...
    private @Nullable Output<DomainOriginCertCheckCertInfoListCertificateArgs> certificate;

    /**
     * @return Indicates a CA certificate to be uploaded. The uploaded certificate is hosted on the content delivery network.
     * 
     */
    public Optional<Output<DomainOriginCertCheckCertInfoListCertificateArgs>> certificate() {
    ...
    private DomainOriginCertCheckCertInfoListArgs() {}

    private DomainOriginCertCheckCertInfoListArgs(DomainOriginCertCheckCertInfoListArgs $) {
        this.certId = $.certId;
    ...
    public static Builder builder(DomainOriginCertCheckCertInfoListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainOriginCertCheckCertInfoListArgs();
        }

        public Builder(DomainOriginCertCheckCertInfoListArgs defaults) {
            $ = new DomainOriginCertCheckCertInfoListArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder certificate(@Nullable Output<DomainOriginCertCheckCertInfoListCertificateArgs> certificate) {
         ...
         * 
         */
        public Builder certificate(DomainOriginCertCheckCertInfoListCertificateArgs certificate) {
        ...
        public DomainOriginCertCheckCertInfoListArgs build() {
            return $;
        }
    }
