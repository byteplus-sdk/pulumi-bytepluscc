...
import com.byteplus.bytepluscc.emr.NodeGroupArgs;
import com.byteplus.bytepluscc.emr.inputs.NodeGroupState;
import com.byteplus.bytepluscc.emr.outputs.NodeGroupApplicationLayout;
import com.byteplus.bytepluscc.emr.outputs.NodeGroupChargePreConfig;
import com.byteplus.bytepluscc.emr.outputs.NodeGroupDataDisk;
import com.byteplus.bytepluscc.emr.outputs.NodeGroupNode;
import com.byteplus.bytepluscc.emr.outputs.NodeGroupSystemDisk;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.emr.NodeGroup;
 * import com.byteplus.bytepluscc.emr.NodeGroupArgs;
 * import com.pulumi.bytepluscc.emr.inputs.NodeGroupSystemDiskArgs;
 * import com.pulumi.bytepluscc.emr.inputs.NodeGroupDataDiskArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:emr/nodeGroup:NodeGroup")
public class NodeGroup extends com.pulumi.resources.CustomResource {
    ...
    public NodeGroup(java.lang.String name, NodeGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:emr/nodeGroup:NodeGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NodeGroup(java.lang.String name, Output<java.lang.String> id, @Nullable NodeGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:emr/nodeGroup:NodeGroup", name, state, makeResourceOptions(options, id), false);
    }
