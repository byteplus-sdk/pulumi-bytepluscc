...
import com.byteplus.bytepluscc.vedbm.InstanceArgs;
import com.byteplus.bytepluscc.vedbm.inputs.InstanceState;
import com.byteplus.bytepluscc.vedbm.outputs.InstanceChargeDetail;
import com.byteplus.bytepluscc.vedbm.outputs.InstanceEndpoint;
import com.byteplus.bytepluscc.vedbm.outputs.InstanceMaintenanceWindow;
import com.byteplus.bytepluscc.vedbm.outputs.InstanceNode;
import com.byteplus.bytepluscc.vedbm.outputs.InstanceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vedbm.Instance;
 * import com.byteplus.bytepluscc.vedbm.InstanceArgs;
 * import com.pulumi.bytepluscc.vedbm.inputs.InstanceTagArgs;
 * import com.pulumi.bytepluscc.vedbm.inputs.InstanceChargeDetailArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vedbm/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vedbm/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
