...
import com.byteplus.bytepluscc.vpn.inputs.CustomerGatewayState;
import com.byteplus.bytepluscc.vpn.outputs.CustomerGatewayTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/customerGateway:CustomerGateway")
public class CustomerGateway extends com.pulumi.resources.CustomResource {
    ...
    public CustomerGateway(java.lang.String name, CustomerGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/customerGateway:CustomerGateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CustomerGateway(java.lang.String name, Output<java.lang.String> id, @Nullable CustomerGatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/customerGateway:CustomerGateway", name, state, makeResourceOptions(options, id), false);
    }
