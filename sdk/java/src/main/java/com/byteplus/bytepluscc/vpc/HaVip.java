...
import com.byteplus.bytepluscc.vpc.inputs.HaVipState;
import com.byteplus.bytepluscc.vpc.outputs.HaVipTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/haVip:HaVip")
public class HaVip extends com.pulumi.resources.CustomResource {
    ...
    public HaVip(java.lang.String name, HaVipArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/haVip:HaVip", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private HaVip(java.lang.String name, Output<java.lang.String> id, @Nullable HaVipState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/haVip:HaVip", name, state, makeResourceOptions(options, id), false);
    }
