...
import com.byteplus.bytepluscc.iam.GroupArgs;
import com.byteplus.bytepluscc.iam.inputs.GroupState;
import com.byteplus.bytepluscc.iam.outputs.GroupAttachedPolicy;
import com.byteplus.bytepluscc.iam.outputs.GroupUser;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.iam.Group;
 * import com.byteplus.bytepluscc.iam.GroupArgs;
 * import com.pulumi.bytepluscc.iam.inputs.GroupUserArgs;
 * import com.pulumi.bytepluscc.iam.inputs.GroupAttachedPolicyArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:iam/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(java.lang.String name, GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/group:Group", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Group(java.lang.String name, Output<java.lang.String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/group:Group", name, state, makeResourceOptions(options, id), false);
    }
