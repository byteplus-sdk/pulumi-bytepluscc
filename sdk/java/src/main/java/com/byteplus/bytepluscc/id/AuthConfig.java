...
import com.byteplus.bytepluscc.id.inputs.AuthConfigState;
import com.byteplus.bytepluscc.id.outputs.AuthConfigApiKeyAuthConfig;
import com.byteplus.bytepluscc.id.outputs.AuthConfigJwtAuthConfig;
 ...
 * 
 */
@ResourceType(type="bytepluscc:id/authConfig:AuthConfig")
public class AuthConfig extends com.pulumi.resources.CustomResource {
    ...
    public AuthConfig(java.lang.String name, AuthConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/authConfig:AuthConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AuthConfig(java.lang.String name, Output<java.lang.String> id, @Nullable AuthConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/authConfig:AuthConfig", name, state, makeResourceOptions(options, id), false);
    }
