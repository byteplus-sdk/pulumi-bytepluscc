...
import com.byteplus.bytepluscc.clb.inputs.RuleState;
import com.byteplus.bytepluscc.clb.outputs.RuleRedirectConfig;
import com.byteplus.bytepluscc.clb.outputs.RuleTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:clb/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
