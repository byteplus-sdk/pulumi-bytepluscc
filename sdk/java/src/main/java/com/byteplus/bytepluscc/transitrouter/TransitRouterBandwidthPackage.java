...
import com.byteplus.bytepluscc.transitrouter.inputs.TransitRouterBandwidthPackageState;
import com.byteplus.bytepluscc.transitrouter.outputs.TransitRouterBandwidthPackageAllocation;
import com.byteplus.bytepluscc.transitrouter.outputs.TransitRouterBandwidthPackageTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage")
public class TransitRouterBandwidthPackage extends com.pulumi.resources.CustomResource {
    ...
    public TransitRouterBandwidthPackage(java.lang.String name, TransitRouterBandwidthPackageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TransitRouterBandwidthPackage(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterBandwidthPackageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage", name, state, makeResourceOptions(options, id), false);
    }
