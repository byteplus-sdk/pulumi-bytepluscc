...
import com.byteplus.bytepluscc.iam.inputs.PolicyState;
import com.byteplus.bytepluscc.iam.outputs.PolicyPolicyRole;
import com.byteplus.bytepluscc.iam.outputs.PolicyPolicyUser;
import com.byteplus.bytepluscc.iam.outputs.PolicyPolicyUserGroup;
 ...
 * 
 */
@ResourceType(type="bytepluscc:iam/policy:Policy")
public class Policy extends com.pulumi.resources.CustomResource {
    ...
    public Policy(java.lang.String name, PolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/policy:Policy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Policy(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/policy:Policy", name, state, makeResourceOptions(options, id), false);
    }
