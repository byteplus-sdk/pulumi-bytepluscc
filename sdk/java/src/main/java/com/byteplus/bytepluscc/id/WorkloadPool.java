...
import com.byteplus.bytepluscc.id.inputs.WorkloadPoolState;
import com.byteplus.bytepluscc.id.outputs.WorkloadPoolTag;
 ...
 *
 */
@ResourceType(type="bytepluscc:id/workloadPool:WorkloadPool")
public class WorkloadPool extends com.pulumi.resources.CustomResource {
    ...
    public WorkloadPool(java.lang.String name, WorkloadPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/workloadPool:WorkloadPool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private WorkloadPool(java.lang.String name, Output<java.lang.String> id, @Nullable WorkloadPoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/workloadPool:WorkloadPool", name, state, makeResourceOptions(options, id), false);
    }
