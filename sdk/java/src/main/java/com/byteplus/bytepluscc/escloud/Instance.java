...
package com.byteplus.bytepluscc.escloud;

import com.byteplus.bytepluscc.Utilities;
import com.byteplus.bytepluscc.escloud.InstanceArgs;
import com.byteplus.bytepluscc.escloud.inputs.InstanceState;
import com.byteplus.bytepluscc.escloud.outputs.InstanceInstanceConfiguration;
import com.byteplus.bytepluscc.escloud.outputs.InstanceKibanaConfig;
import com.byteplus.bytepluscc.escloud.outputs.InstanceSubInstance;
import com.byteplus.bytepluscc.escloud.outputs.InstanceTransferInfo;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.escloud.Instance;
 * import com.byteplus.bytepluscc.escloud.InstanceArgs;
 * import com.pulumi.bytepluscc.escloud.inputs.InstanceInstanceConfigurationArgs;
 * import com.pulumi.bytepluscc.escloud.inputs.InstanceInstanceConfigurationVpcArgs;
 * import com.pulumi.bytepluscc.escloud.inputs.InstanceInstanceConfigurationSubnetArgs;
 * import com.pulumi.bytepluscc.escloud.inputs.InstanceInstanceConfigurationTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:escloud/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:escloud/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:escloud/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
