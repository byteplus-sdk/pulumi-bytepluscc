...
import com.byteplus.bytepluscc.ecs.inputs.KeypairState;
import com.byteplus.bytepluscc.ecs.outputs.KeypairTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/keypair:Keypair")
public class Keypair extends com.pulumi.resources.CustomResource {
    ...
    public Keypair(java.lang.String name, KeypairArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/keypair:Keypair", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Keypair(java.lang.String name, Output<java.lang.String> id, @Nullable KeypairState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/keypair:Keypair", name, state, makeResourceOptions(options, id), false);
    }
