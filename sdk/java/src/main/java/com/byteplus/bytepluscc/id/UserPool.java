...
import com.byteplus.bytepluscc.id.inputs.UserPoolState;
import com.byteplus.bytepluscc.id.outputs.UserPoolBrand;
import com.byteplus.bytepluscc.id.outputs.UserPoolTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:id/userPool:UserPool")
public class UserPool extends com.pulumi.resources.CustomResource {
    ...
    public UserPool(java.lang.String name, UserPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/userPool:UserPool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UserPool(java.lang.String name, Output<java.lang.String> id, @Nullable UserPoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/userPool:UserPool", name, state, makeResourceOptions(options, id), false);
    }
