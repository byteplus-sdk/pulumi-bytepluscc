...
import com.byteplus.bytepluscc.clb.inputs.ClbState;
import com.byteplus.bytepluscc.clb.outputs.ClbAccessLog;
 ...
 * 
 */
@ResourceType(type="bytepluscc:clb/clb:Clb")
public class Clb extends com.pulumi.resources.CustomResource {
    ...
    public Clb(java.lang.String name, @Nullable ClbArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/clb:Clb", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Clb(java.lang.String name, Output<java.lang.String> id, @Nullable ClbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/clb:Clb", name, state, makeResourceOptions(options, id), false);
    }
