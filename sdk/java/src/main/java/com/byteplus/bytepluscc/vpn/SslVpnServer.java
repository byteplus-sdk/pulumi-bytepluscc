...
import com.byteplus.bytepluscc.vpn.inputs.SslVpnServerState;
import com.byteplus.bytepluscc.vpn.outputs.SslVpnServerTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/sslVpnServer:SslVpnServer")
public class SslVpnServer extends com.pulumi.resources.CustomResource {
    ...
    public SslVpnServer(java.lang.String name, SslVpnServerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SslVpnServer(java.lang.String name, Output<java.lang.String> id, @Nullable SslVpnServerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, state, makeResourceOptions(options, id), false);
    }
