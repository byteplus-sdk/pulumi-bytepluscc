...
import com.byteplus.bytepluscc.apig.UpstreamSourceArgs;
import com.byteplus.bytepluscc.apig.inputs.UpstreamSourceState;
import com.byteplus.bytepluscc.apig.outputs.UpstreamSourceIngressSettings;
import com.byteplus.bytepluscc.apig.outputs.UpstreamSourceSourceSpec;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.apig.UpstreamSource;
 * import com.byteplus.bytepluscc.apig.UpstreamSourceArgs;
 * import com.pulumi.bytepluscc.apig.inputs.UpstreamSourceSourceSpecArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:apig/upstreamSource:UpstreamSource")
public class UpstreamSource extends com.pulumi.resources.CustomResource {
    ...
    public UpstreamSource(java.lang.String name, UpstreamSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/upstreamSource:UpstreamSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UpstreamSource(java.lang.String name, Output<java.lang.String> id, @Nullable UpstreamSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/upstreamSource:UpstreamSource", name, state, makeResourceOptions(options, id), false);
    }
