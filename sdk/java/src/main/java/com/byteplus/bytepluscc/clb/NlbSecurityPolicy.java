...
import com.byteplus.bytepluscc.clb.inputs.NlbSecurityPolicyState;
import com.byteplus.bytepluscc.clb.outputs.NlbSecurityPolicyTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy")
public class NlbSecurityPolicy extends com.pulumi.resources.CustomResource {
    ...
    public NlbSecurityPolicy(java.lang.String name, NlbSecurityPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NlbSecurityPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable NlbSecurityPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy", name, state, makeResourceOptions(options, id), false);
    }
