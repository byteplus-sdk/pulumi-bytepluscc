...
import com.byteplus.bytepluscc.gtm.GtmArgs;
import com.byteplus.bytepluscc.gtm.inputs.GtmState;
import com.byteplus.bytepluscc.gtm.outputs.GtmPolicy;
import com.byteplus.bytepluscc.gtm.outputs.GtmProbe;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.gtm.Gtm;
 * import com.byteplus.bytepluscc.gtm.GtmArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:gtm/gtm:Gtm example &#34;gtm_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:gtm/gtm:Gtm")
public class Gtm extends com.pulumi.resources.CustomResource {
    ...
    public Gtm(java.lang.String name, GtmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/gtm:Gtm", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Gtm(java.lang.String name, Output<java.lang.String> id, @Nullable GtmState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/gtm:Gtm", name, state, makeResourceOptions(options, id), false);
    }
