...
import com.byteplus.bytepluscc.vpc.inputs.TrafficMirrorTargetState;
import com.byteplus.bytepluscc.vpc.outputs.TrafficMirrorTargetTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget")
public class TrafficMirrorTarget extends com.pulumi.resources.CustomResource {
    ...
    public TrafficMirrorTarget(java.lang.String name, TrafficMirrorTargetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TrafficMirrorTarget(java.lang.String name, Output<java.lang.String> id, @Nullable TrafficMirrorTargetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, state, makeResourceOptions(options, id), false);
    }
