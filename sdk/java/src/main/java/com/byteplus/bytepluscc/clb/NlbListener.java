...
import com.byteplus.bytepluscc.clb.inputs.NlbListenerState;
import com.byteplus.bytepluscc.clb.outputs.NlbListenerHealth;
import com.byteplus.bytepluscc.clb.outputs.NlbListenerTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:clb/nlbListener:NlbListener")
public class NlbListener extends com.pulumi.resources.CustomResource {
    ...
    public NlbListener(java.lang.String name, NlbListenerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlbListener:NlbListener", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private NlbListener(java.lang.String name, Output<java.lang.String> id, @Nullable NlbListenerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/nlbListener:NlbListener", name, state, makeResourceOptions(options, id), false);
    }
