...
import com.byteplus.bytepluscc.kafka.TopicArgs;
import com.byteplus.bytepluscc.kafka.inputs.TopicState;
import com.byteplus.bytepluscc.kafka.outputs.TopicAccessPolicy;
import com.byteplus.bytepluscc.kafka.outputs.TopicTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.kafka.Topic;
 * import com.byteplus.bytepluscc.kafka.TopicArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.TopicAccessPolicyArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.TopicTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:kafka/topic:Topic")
public class Topic extends com.pulumi.resources.CustomResource {
    ...
    public Topic(java.lang.String name, TopicArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/topic:Topic", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Topic(java.lang.String name, Output<java.lang.String> id, @Nullable TopicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/topic:Topic", name, state, makeResourceOptions(options, id), false);
    }
