...
import com.byteplus.bytepluscc.cen.RouteEntryArgs;
import com.byteplus.bytepluscc.cen.inputs.RouteEntryState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cen.RouteEntry;
 * import com.byteplus.bytepluscc.cen.RouteEntryArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:cen/routeEntry:RouteEntry example &#34;cen_id|destination_cidr_block|instance_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:cen/routeEntry:RouteEntry")
public class RouteEntry extends com.pulumi.resources.CustomResource {
    ...
    public RouteEntry(java.lang.String name, RouteEntryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/routeEntry:RouteEntry", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RouteEntry(java.lang.String name, Output<java.lang.String> id, @Nullable RouteEntryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/routeEntry:RouteEntry", name, state, makeResourceOptions(options, id), false);
    }
