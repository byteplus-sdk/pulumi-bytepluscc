...
import com.byteplus.bytepluscc.escloud.IpAllowListArgs;
import com.byteplus.bytepluscc.escloud.inputs.IpAllowListState;
import com.byteplus.bytepluscc.escloud.outputs.IpAllowListGroup;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.escloud.IpAllowList;
 * import com.byteplus.bytepluscc.escloud.IpAllowListArgs;
 * import com.pulumi.bytepluscc.escloud.inputs.IpAllowListGroupArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:escloud/ipAllowList:IpAllowList example &#34;instance_id|type&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:escloud/ipAllowList:IpAllowList")
public class IpAllowList extends com.pulumi.resources.CustomResource {
    ...
    public IpAllowList(java.lang.String name, IpAllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:escloud/ipAllowList:IpAllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IpAllowList(java.lang.String name, Output<java.lang.String> id, @Nullable IpAllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:escloud/ipAllowList:IpAllowList", name, state, makeResourceOptions(options, id), false);
    }
