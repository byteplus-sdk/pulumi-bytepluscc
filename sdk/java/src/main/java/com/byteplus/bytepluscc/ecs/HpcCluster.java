...
import com.byteplus.bytepluscc.ecs.inputs.HpcClusterState;
import com.byteplus.bytepluscc.ecs.outputs.HpcClusterTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/hpcCluster:HpcCluster")
public class HpcCluster extends com.pulumi.resources.CustomResource {
    ...
    public HpcCluster(java.lang.String name, HpcClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/hpcCluster:HpcCluster", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private HpcCluster(java.lang.String name, Output<java.lang.String> id, @Nullable HpcClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/hpcCluster:HpcCluster", name, state, makeResourceOptions(options, id), false);
    }
