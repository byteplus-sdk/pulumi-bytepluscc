...
import com.byteplus.bytepluscc.emr.ClusterArgs;
import com.byteplus.bytepluscc.emr.inputs.ClusterState;
import com.byteplus.bytepluscc.emr.outputs.ClusterApplication;
import com.byteplus.bytepluscc.emr.outputs.ClusterApplicationExtra;
import com.byteplus.bytepluscc.emr.outputs.ClusterBootstrapScript;
import com.byteplus.bytepluscc.emr.outputs.ClusterChargePreConfig;
import com.byteplus.bytepluscc.emr.outputs.ClusterNodeAttribute;
import com.byteplus.bytepluscc.emr.outputs.ClusterNodeGroupAttribute;
import com.byteplus.bytepluscc.emr.outputs.ClusterStateChangeReason;
import com.byteplus.bytepluscc.emr.outputs.ClusterTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.emr.Cluster;
 * import com.byteplus.bytepluscc.emr.ClusterArgs;
 * import com.pulumi.bytepluscc.emr.inputs.ClusterNodeAttributeArgs;
 * import com.pulumi.bytepluscc.emr.inputs.ClusterNodeGroupAttributeArgs;
 * import com.pulumi.bytepluscc.emr.inputs.ClusterApplicationExtraArgs;
 * import com.pulumi.bytepluscc.emr.inputs.ClusterBootstrapScriptArgs;
 * import com.pulumi.bytepluscc.emr.inputs.ClusterTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:emr/cluster:Cluster")
public class Cluster extends com.pulumi.resources.CustomResource {
    ...
    public Cluster(java.lang.String name, ClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:emr/cluster:Cluster", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Cluster(java.lang.String name, Output<java.lang.String> id, @Nullable ClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:emr/cluster:Cluster", name, state, makeResourceOptions(options, id), false);
    }
