...
import com.byteplus.bytepluscc.vke.inputs.PermissionState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vke/permission:Permission")
public class Permission extends com.pulumi.resources.CustomResource {
    ...
    public Permission(java.lang.String name, @Nullable PermissionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/permission:Permission", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Permission(java.lang.String name, Output<java.lang.String> id, @Nullable PermissionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/permission:Permission", name, state, makeResourceOptions(options, id), false);
    }
