...
import com.byteplus.bytepluscc.waf.DomainArgs;
import com.byteplus.bytepluscc.waf.inputs.DomainState;
import com.byteplus.bytepluscc.waf.outputs.DomainBackendGroup;
import com.byteplus.bytepluscc.waf.outputs.DomainCloudAccessConfig;
import com.byteplus.bytepluscc.waf.outputs.DomainProtocolPorts;
import com.byteplus.bytepluscc.waf.outputs.DomainTcpListenerConfig;
import com.byteplus.bytepluscc.waf.outputs.DomainTlsFieldsConfig;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.waf.Domain;
 * import com.byteplus.bytepluscc.waf.DomainArgs;
 * import com.pulumi.bytepluscc.waf.inputs.DomainProtocolPortsArgs;
 * import com.pulumi.bytepluscc.waf.inputs.DomainBackendGroupArgs;
 * import com.pulumi.bytepluscc.waf.inputs.DomainBackendGroupBackendArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:waf/domain:Domain")
public class Domain extends com.pulumi.resources.CustomResource {
    ...
    public Domain(java.lang.String name, DomainArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:waf/domain:Domain", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Domain(java.lang.String name, Output<java.lang.String> id, @Nullable DomainState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:waf/domain:Domain", name, state, makeResourceOptions(options, id), false);
    }
