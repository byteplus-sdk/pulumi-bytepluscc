...
import com.byteplus.bytepluscc.vpc.inputs.Ipv6AddressBandwidthState;
import com.byteplus.bytepluscc.vpc.outputs.Ipv6AddressBandwidthTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth")
public class Ipv6AddressBandwidth extends com.pulumi.resources.CustomResource {
    ...
    public Ipv6AddressBandwidth(java.lang.String name, Ipv6AddressBandwidthArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ipv6AddressBandwidth(java.lang.String name, Output<java.lang.String> id, @Nullable Ipv6AddressBandwidthState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, state, makeResourceOptions(options, id), false);
    }
