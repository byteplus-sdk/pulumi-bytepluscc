...
import com.byteplus.bytepluscc.vefaas.inputs.KafkaTriggerState;
import com.byteplus.bytepluscc.vefaas.outputs.KafkaTriggerKafkaCredentials;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vefaas/kafkaTrigger:KafkaTrigger")
public class KafkaTrigger extends com.pulumi.resources.CustomResource {
    ...
    public KafkaTrigger(java.lang.String name, KafkaTriggerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private KafkaTrigger(java.lang.String name, Output<java.lang.String> id, @Nullable KafkaTriggerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, state, makeResourceOptions(options, id), false);
    }
