...
import com.byteplus.bytepluscc.tls.inputs.ProjectState;
import com.byteplus.bytepluscc.tls.outputs.ProjectTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/project:Project")
public class Project extends com.pulumi.resources.CustomResource {
    ...
    public Project(java.lang.String name, ProjectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/project:Project", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Project(java.lang.String name, Output<java.lang.String> id, @Nullable ProjectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/project:Project", name, state, makeResourceOptions(options, id), false);
    }
