...
import com.byteplus.bytepluscc.ecs.CommandArgs;
import com.byteplus.bytepluscc.ecs.inputs.CommandState;
import com.byteplus.bytepluscc.ecs.outputs.CommandParameterDefinition;
import com.byteplus.bytepluscc.ecs.outputs.CommandTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.ecs.Command;
 * import com.byteplus.bytepluscc.ecs.CommandArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.CommandParameterDefinitionArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.CommandTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:ecs/command:Command")
public class Command extends com.pulumi.resources.CustomResource {
    ...
    public Command(java.lang.String name, CommandArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/command:Command", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Command(java.lang.String name, Output<java.lang.String> id, @Nullable CommandState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/command:Command", name, state, makeResourceOptions(options, id), false);
    }
