...
import com.byteplus.bytepluscc.cr.inputs.VpcEndpointState;
import com.byteplus.bytepluscc.cr.outputs.VpcEndpointVpc;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cr/vpcEndpoint:VpcEndpoint")
public class VpcEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public VpcEndpoint(java.lang.String name, VpcEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpcEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, state, makeResourceOptions(options, id), false);
    }
