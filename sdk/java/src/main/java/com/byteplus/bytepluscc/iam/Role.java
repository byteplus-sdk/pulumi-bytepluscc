...
import com.byteplus.bytepluscc.iam.inputs.RoleState;
import com.byteplus.bytepluscc.iam.outputs.RolePolicy;
import com.byteplus.bytepluscc.iam.outputs.RoleTag;
 ...
 * import com.byteplus.bytepluscc.iam.RoleArgs;
 * import com.pulumi.bytepluscc.iam.inputs.RolePolicyArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:iam/role:Role")
public class Role extends com.pulumi.resources.CustomResource {
    ...
    public Role(java.lang.String name, @Nullable RoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/role:Role", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Role(java.lang.String name, Output<java.lang.String> id, @Nullable RoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/role:Role", name, state, makeResourceOptions(options, id), false);
    }
