...
import com.byteplus.bytepluscc.rabbitmq.inputs.PublicAddressState;
import com.byteplus.bytepluscc.rabbitmq.outputs.PublicAddressChargeDetail;
import com.byteplus.bytepluscc.rabbitmq.outputs.PublicAddressEndpoint;
import com.byteplus.bytepluscc.rabbitmq.outputs.PublicAddressTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rabbitmq/publicAddress:PublicAddress")
public class PublicAddress extends com.pulumi.resources.CustomResource {
    ...
    public PublicAddress(java.lang.String name, PublicAddressArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PublicAddress(java.lang.String name, Output<java.lang.String> id, @Nullable PublicAddressState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, state, makeResourceOptions(options, id), false);
    }
