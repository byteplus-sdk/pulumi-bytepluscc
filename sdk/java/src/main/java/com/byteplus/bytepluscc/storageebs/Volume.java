...
import com.byteplus.bytepluscc.storageebs.inputs.VolumeState;
import com.byteplus.bytepluscc.storageebs.outputs.VolumeBaselinePerformance;
import com.byteplus.bytepluscc.storageebs.outputs.VolumeExtraPerformance;
import com.byteplus.bytepluscc.storageebs.outputs.VolumeTag;
import com.byteplus.bytepluscc.storageebs.outputs.VolumeTotalPerformance;
 ...
 * 
 */
@ResourceType(type="bytepluscc:storageebs/volume:Volume")
public class Volume extends com.pulumi.resources.CustomResource {
    ...
    public Volume(java.lang.String name, VolumeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/volume:Volume", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Volume(java.lang.String name, Output<java.lang.String> id, @Nullable VolumeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/volume:Volume", name, state, makeResourceOptions(options, id), false);
    }
