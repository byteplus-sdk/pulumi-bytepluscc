...
import com.byteplus.bytepluscc.vpc.VpcArgs;
import com.byteplus.bytepluscc.vpc.inputs.VpcState;
import com.byteplus.bytepluscc.vpc.outputs.VpcAssociateCen;
import com.byteplus.bytepluscc.vpc.outputs.VpcTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpc.Vpc;
 * import com.byteplus.bytepluscc.vpc.VpcArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.VpcTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vpc/vpc:Vpc")
public class Vpc extends com.pulumi.resources.CustomResource {
    ...
    public Vpc(java.lang.String name, @Nullable VpcArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/vpc:Vpc", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Vpc(java.lang.String name, Output<java.lang.String> id, @Nullable VpcState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/vpc:Vpc", name, state, makeResourceOptions(options, id), false);
    }
