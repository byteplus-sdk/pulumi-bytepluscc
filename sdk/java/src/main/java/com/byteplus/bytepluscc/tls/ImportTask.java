...
import com.byteplus.bytepluscc.tls.ImportTaskArgs;
import com.byteplus.bytepluscc.tls.inputs.ImportTaskState;
import com.byteplus.bytepluscc.tls.outputs.ImportTaskImportSourceInfo;
import com.byteplus.bytepluscc.tls.outputs.ImportTaskTargetInfo;
import com.byteplus.bytepluscc.tls.outputs.ImportTaskTaskStatistics;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.ImportTask;
 * import com.byteplus.bytepluscc.tls.ImportTaskArgs;
 * import com.pulumi.bytepluscc.tls.inputs.ImportTaskImportSourceInfoArgs;
 * import com.pulumi.bytepluscc.tls.inputs.ImportTaskTargetInfoArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/importTask:ImportTask")
public class ImportTask extends com.pulumi.resources.CustomResource {
    ...
    public ImportTask(java.lang.String name, ImportTaskArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/importTask:ImportTask", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ImportTask(java.lang.String name, Output<java.lang.String> id, @Nullable ImportTaskState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/importTask:ImportTask", name, state, makeResourceOptions(options, id), false);
    }
