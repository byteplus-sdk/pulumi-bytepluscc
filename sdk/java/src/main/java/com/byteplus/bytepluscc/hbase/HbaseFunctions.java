...
package com.byteplus.bytepluscc.hbase;

import com.byteplus.bytepluscc.Utilities;
import com.byteplus.bytepluscc.hbase.inputs.GetInstanceArgs;
import com.byteplus.bytepluscc.hbase.inputs.GetInstancePlainArgs;
import com.byteplus.bytepluscc.hbase.outputs.GetInstanceResult;
import com.byteplus.bytepluscc.hbase.outputs.GetInstancesResult;
...
public final class HbaseFunctions {
    ...
    public static Output<GetInstanceResult> getInstance(GetInstanceArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:hbase/getInstance:getInstance", TypeShape.of(GetInstanceResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Data Source schema for Byteplus::HBase::Instance
     * 
    ...
    public static CompletableFuture<GetInstanceResult> getInstancePlain(GetInstancePlainArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("bytepluscc:hbase/getInstance:getInstance", TypeShape.of(GetInstanceResult.class), args, Utilities.withVersion(options));
    }
    /**
    ...
    public static Output<GetInstancesResult> getInstances(InvokeArgs args, InvokeOptions options) {
        return Deployment.getInstance().invoke("bytepluscc:hbase/getInstances:getInstances", TypeShape.of(GetInstancesResult.class), args, Utilities.withVersion(options));
    }
    /**
     * Plural Data Source schema for Byteplus::HBase::Instance
     * 
    ...
    public static CompletableFuture<GetInstancesResult> getInstancesPlain(InvokeArgs args, InvokeOptions options) {
        return Deployment.getInstance().invokeAsync("bytepluscc:hbase/getInstances:getInstances", TypeShape.of(GetInstancesResult.class), args, Utilities.withVersion(options));
    }
}
