...
import com.byteplus.bytepluscc.ecs.inputs.DeploymentSetState;
import com.byteplus.bytepluscc.ecs.outputs.DeploymentSetCapacity;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/deploymentSet:DeploymentSet")
public class DeploymentSet extends com.pulumi.resources.CustomResource {
    ...
    public DeploymentSet(java.lang.String name, DeploymentSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/deploymentSet:DeploymentSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DeploymentSet(java.lang.String name, Output<java.lang.String> id, @Nullable DeploymentSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/deploymentSet:DeploymentSet", name, state, makeResourceOptions(options, id), false);
    }
