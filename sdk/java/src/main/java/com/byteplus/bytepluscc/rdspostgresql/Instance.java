...
import com.byteplus.bytepluscc.rdspostgresql.InstanceArgs;
import com.byteplus.bytepluscc.rdspostgresql.inputs.InstanceState;
import com.byteplus.bytepluscc.rdspostgresql.outputs.InstanceChargeDetail;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdspostgresql.Instance;
 * import com.byteplus.bytepluscc.rdspostgresql.InstanceArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.InstanceNodeInfoArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.InstanceChargeDetailArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdspostgresql/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
