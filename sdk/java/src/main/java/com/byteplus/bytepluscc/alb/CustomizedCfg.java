...
import com.byteplus.bytepluscc.alb.inputs.CustomizedCfgState;
import com.byteplus.bytepluscc.alb.outputs.CustomizedCfgListener;
import com.byteplus.bytepluscc.alb.outputs.CustomizedCfgTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:alb/customizedCfg:CustomizedCfg")
public class CustomizedCfg extends com.pulumi.resources.CustomResource {
    ...
    public CustomizedCfg(java.lang.String name, CustomizedCfgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/customizedCfg:CustomizedCfg", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CustomizedCfg(java.lang.String name, Output<java.lang.String> id, @Nullable CustomizedCfgState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/customizedCfg:CustomizedCfg", name, state, makeResourceOptions(options, id), false);
    }
