...
import com.byteplus.bytepluscc.fwcenter.inputs.ControlPolicyState;
import com.byteplus.bytepluscc.fwcenter.outputs.ControlPolicyDestPortListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.ControlPolicyDestinationCidrListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.ControlPolicySourceCidrListV1;
 ...
 * 
 */
@ResourceType(type="bytepluscc:fwcenter/controlPolicy:ControlPolicy")
public class ControlPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ControlPolicy(java.lang.String name, ControlPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/controlPolicy:ControlPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ControlPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ControlPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/controlPolicy:ControlPolicy", name, state, makeResourceOptions(options, id), false);
    }
