...
import com.byteplus.bytepluscc.cloudidentity.inputs.PermissionSetProvisioningState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning")
public class PermissionSetProvisioning extends com.pulumi.resources.CustomResource {
    ...
    public PermissionSetProvisioning(java.lang.String name, PermissionSetProvisioningArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PermissionSetProvisioning(java.lang.String name, Output<java.lang.String> id, @Nullable PermissionSetProvisioningState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, state, makeResourceOptions(options, id), false);
    }
