...
import com.byteplus.bytepluscc.apig.UpstreamArgs;
...
import com.byteplus.bytepluscc.apig.outputs.UpstreamVersionDetail;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.apig.Upstream;
 * import com.byteplus.bytepluscc.apig.UpstreamArgs;
 * import com.pulumi.bytepluscc.apig.inputs.UpstreamCircuitBreakingSettingsArgs;
 * import com.pulumi.bytepluscc.apig.inputs.UpstreamConnectionPoolSettingsArgs;
 * import com.pulumi.bytepluscc.apig.inputs.UpstreamLoadBalancerSettingsArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:apig/upstream:Upstream")
public class Upstream extends com.pulumi.resources.CustomResource {
    ...
    public Upstream(java.lang.String name, UpstreamArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/upstream:Upstream", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Upstream(java.lang.String name, Output<java.lang.String> id, @Nullable UpstreamState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:apig/upstream:Upstream", name, state, makeResourceOptions(options, id), false);
    }
