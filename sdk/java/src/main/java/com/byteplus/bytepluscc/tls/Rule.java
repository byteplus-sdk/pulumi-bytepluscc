...
import com.byteplus.bytepluscc.tls.RuleArgs;
import com.byteplus.bytepluscc.tls.inputs.RuleState;
import com.byteplus.bytepluscc.tls.outputs.RuleContainerRule;
import com.byteplus.bytepluscc.tls.outputs.RuleExcludePath;
import com.byteplus.bytepluscc.tls.outputs.RuleExtractRule;
import com.byteplus.bytepluscc.tls.outputs.RuleHostGroupInfo;
import com.byteplus.bytepluscc.tls.outputs.RuleUserDefineRule;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.Rule;
 * import com.byteplus.bytepluscc.tls.RuleArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleContainerRuleArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleExcludePathArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleExtractRuleArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleHostGroupInfoArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleUserDefineRuleArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleUserDefineRuleAdvancedArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleUserDefineRuleFieldArgs;
 * import com.pulumi.bytepluscc.tls.inputs.RuleUserDefineRulePluginArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:tls/rule:Rule example &#34;rule_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:tls/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
