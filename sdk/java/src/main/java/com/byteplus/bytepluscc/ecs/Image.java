...
import com.byteplus.bytepluscc.ecs.inputs.ImageState;
import com.byteplus.bytepluscc.ecs.outputs.ImageDetectionResults;
import com.byteplus.bytepluscc.ecs.outputs.ImageImportImage;
import com.byteplus.bytepluscc.ecs.outputs.ImageSnapshot;
import com.byteplus.bytepluscc.ecs.outputs.ImageTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:ecs/image:Image")
public class Image extends com.pulumi.resources.CustomResource {
    ...
    public Image(java.lang.String name, ImageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/image:Image", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Image(java.lang.String name, Output<java.lang.String> id, @Nullable ImageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/image:Image", name, state, makeResourceOptions(options, id), false);
    }
