...
import com.byteplus.bytepluscc.vpc.inputs.Ipv6GatewayState;
import com.byteplus.bytepluscc.vpc.outputs.Ipv6GatewayTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/ipv6Gateway:Ipv6Gateway")
public class Ipv6Gateway extends com.pulumi.resources.CustomResource {
    ...
    public Ipv6Gateway(java.lang.String name, Ipv6GatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ipv6Gateway(java.lang.String name, Output<java.lang.String> id, @Nullable Ipv6GatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, state, makeResourceOptions(options, id), false);
    }
