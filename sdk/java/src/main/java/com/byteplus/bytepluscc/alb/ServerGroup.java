...
import com.byteplus.bytepluscc.alb.ServerGroupArgs;
import com.byteplus.bytepluscc.alb.inputs.ServerGroupState;
import com.byteplus.bytepluscc.alb.outputs.ServerGroupHealthCheck;
import com.byteplus.bytepluscc.alb.outputs.ServerGroupListener;
import com.byteplus.bytepluscc.alb.outputs.ServerGroupServer;
import com.byteplus.bytepluscc.alb.outputs.ServerGroupStickySessionConfig;
import com.byteplus.bytepluscc.alb.outputs.ServerGroupTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.alb.ServerGroup;
 * import com.byteplus.bytepluscc.alb.ServerGroupArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ServerGroupHealthCheckArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ServerGroupStickySessionConfigArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ServerGroupServerArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ServerGroupTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:alb/serverGroup:ServerGroup")
public class ServerGroup extends com.pulumi.resources.CustomResource {
    ...
    public ServerGroup(java.lang.String name, ServerGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/serverGroup:ServerGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ServerGroup(java.lang.String name, Output<java.lang.String> id, @Nullable ServerGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/serverGroup:ServerGroup", name, state, makeResourceOptions(options, id), false);
    }
