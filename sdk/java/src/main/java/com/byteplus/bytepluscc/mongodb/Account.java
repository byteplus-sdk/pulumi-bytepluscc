...
import com.byteplus.bytepluscc.mongodb.AccountArgs;
import com.byteplus.bytepluscc.mongodb.inputs.AccountState;
import com.byteplus.bytepluscc.mongodb.outputs.AccountAccountPrivilege;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.mongodb.Account;
 * import com.byteplus.bytepluscc.mongodb.AccountArgs;
 * import com.pulumi.bytepluscc.mongodb.inputs.AccountAccountPrivilegeArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:mongodb/account:Account")
public class Account extends com.pulumi.resources.CustomResource {
    ...
    public Account(java.lang.String name, AccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/account:Account", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Account(java.lang.String name, Output<java.lang.String> id, @Nullable AccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/account:Account", name, state, makeResourceOptions(options, id), false);
    }
