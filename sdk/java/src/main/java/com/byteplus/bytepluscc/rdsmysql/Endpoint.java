...
import com.byteplus.bytepluscc.rdsmysql.EndpointArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.EndpointState;
import com.byteplus.bytepluscc.rdsmysql.outputs.EndpointAddress;
import com.byteplus.bytepluscc.rdsmysql.outputs.EndpointCustomRouteStrategy;
import com.byteplus.bytepluscc.rdsmysql.outputs.EndpointReadOnlyNodeWeight;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.Endpoint;
 * import com.byteplus.bytepluscc.rdsmysql.EndpointArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.EndpointReadOnlyNodeWeightArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdsmysql/endpoint:Endpoint")
public class Endpoint extends com.pulumi.resources.CustomResource {
    ...
    public Endpoint(java.lang.String name, @Nullable EndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/endpoint:Endpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Endpoint(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/endpoint:Endpoint", name, state, makeResourceOptions(options, id), false);
    }
