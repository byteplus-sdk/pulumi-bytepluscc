...
import com.byteplus.bytepluscc.privatelink.inputs.GatewayEndpointState;
import com.byteplus.bytepluscc.privatelink.outputs.GatewayEndpointTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint")
public class GatewayEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public GatewayEndpoint(java.lang.String name, GatewayEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private GatewayEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable GatewayEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, state, makeResourceOptions(options, id), false);
    }
