...
import com.byteplus.bytepluscc.rdspostgresql.inputs.DbEndpointState;
import com.byteplus.bytepluscc.rdspostgresql.outputs.DbEndpointInnerAddresses;
import com.byteplus.bytepluscc.rdspostgresql.outputs.DbEndpointPrivateAddresses;
import com.byteplus.bytepluscc.rdspostgresql.outputs.DbEndpointPublicAddresses;
import com.byteplus.bytepluscc.rdspostgresql.outputs.DbEndpointReadOnlyNodeWeight;
 ...
 * import com.byteplus.bytepluscc.rdspostgresql.DbEndpointArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.DbEndpointPublicAddressesArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint")
public class DbEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public DbEndpoint(java.lang.String name, @Nullable DbEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DbEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable DbEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint", name, state, makeResourceOptions(options, id), false);
    }
