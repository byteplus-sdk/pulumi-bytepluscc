...
import com.byteplus.bytepluscc.rdspostgresql.BackupArgs;
import com.byteplus.bytepluscc.rdspostgresql.inputs.BackupState;
import com.byteplus.bytepluscc.rdspostgresql.outputs.BackupBackupMeta;
import com.byteplus.bytepluscc.rdspostgresql.outputs.BackupBackupPolicy;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdspostgresql.Backup;
 * import com.byteplus.bytepluscc.rdspostgresql.BackupArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.BackupBackupMetaArgs;
 * import com.pulumi.bytepluscc.rdspostgresql.inputs.BackupBackupPolicyArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdspostgresql/backup:Backup")
public class Backup extends com.pulumi.resources.CustomResource {
    ...
    public Backup(java.lang.String name, BackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/backup:Backup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Backup(java.lang.String name, Output<java.lang.String> id, @Nullable BackupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/backup:Backup", name, state, makeResourceOptions(options, id), false);
    }
