...
import com.byteplus.bytepluscc.privatelink.VpcEndpointConnectionArgs;
import com.byteplus.bytepluscc.privatelink.inputs.VpcEndpointConnectionState;
import com.byteplus.bytepluscc.privatelink.outputs.VpcEndpointConnectionResourcesAllocate;
import com.byteplus.bytepluscc.privatelink.outputs.VpcEndpointConnectionZone;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.privatelink.VpcEndpointConnection;
 * import com.byteplus.bytepluscc.privatelink.VpcEndpointConnectionArgs;
 * import com.pulumi.bytepluscc.privatelink.inputs.VpcEndpointConnectionResourcesAllocateArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:privatelink/vpcEndpointConnection:VpcEndpointConnection")
public class VpcEndpointConnection extends com.pulumi.resources.CustomResource {
    ...
    public VpcEndpointConnection(java.lang.String name, VpcEndpointConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/vpcEndpointConnection:VpcEndpointConnection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpcEndpointConnection(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEndpointConnectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/vpcEndpointConnection:VpcEndpointConnection", name, state, makeResourceOptions(options, id), false);
    }
