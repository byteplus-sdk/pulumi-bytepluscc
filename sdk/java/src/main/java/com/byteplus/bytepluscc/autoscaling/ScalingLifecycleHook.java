...
import com.byteplus.bytepluscc.autoscaling.ScalingLifecycleHookArgs;
import com.byteplus.bytepluscc.autoscaling.inputs.ScalingLifecycleHookState;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingLifecycleHookLifecycleCommand;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.autoscaling.ScalingLifecycleHook;
 * import com.byteplus.bytepluscc.autoscaling.ScalingLifecycleHookArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingLifecycleHookLifecycleCommandArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook")
public class ScalingLifecycleHook extends com.pulumi.resources.CustomResource {
    ...
    public ScalingLifecycleHook(java.lang.String name, ScalingLifecycleHookArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScalingLifecycleHook(java.lang.String name, Output<java.lang.String> id, @Nullable ScalingLifecycleHookState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, state, makeResourceOptions(options, id), false);
    }
