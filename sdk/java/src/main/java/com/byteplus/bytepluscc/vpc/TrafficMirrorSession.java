...
import com.byteplus.bytepluscc.vpc.inputs.TrafficMirrorSessionState;
import com.byteplus.bytepluscc.vpc.outputs.TrafficMirrorSessionTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession")
public class TrafficMirrorSession extends com.pulumi.resources.CustomResource {
    ...
    public TrafficMirrorSession(java.lang.String name, TrafficMirrorSessionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TrafficMirrorSession(java.lang.String name, Output<java.lang.String> id, @Nullable TrafficMirrorSessionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, state, makeResourceOptions(options, id), false);
    }
