...
import com.byteplus.bytepluscc.transitrouter.inputs.TransitRouterState;
import com.byteplus.bytepluscc.transitrouter.outputs.TransitRouterAttachment;
import com.byteplus.bytepluscc.transitrouter.outputs.TransitRouterTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/transitRouter:TransitRouter")
public class TransitRouter extends com.pulumi.resources.CustomResource {
    ...
    public TransitRouter(java.lang.String name, @Nullable TransitRouterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouter:TransitRouter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TransitRouter(java.lang.String name, Output<java.lang.String> id, @Nullable TransitRouterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/transitRouter:TransitRouter", name, state, makeResourceOptions(options, id), false);
    }
