...
import com.byteplus.bytepluscc.id.inputs.PermissionNamespaceState;
import com.byteplus.bytepluscc.id.outputs.PermissionNamespaceTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:id/permissionNamespace:PermissionNamespace")
public class PermissionNamespace extends com.pulumi.resources.CustomResource {
    ...
    public PermissionNamespace(java.lang.String name, PermissionNamespaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/permissionNamespace:PermissionNamespace", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PermissionNamespace(java.lang.String name, Output<java.lang.String> id, @Nullable PermissionNamespaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:id/permissionNamespace:PermissionNamespace", name, state, makeResourceOptions(options, id), false);
    }
