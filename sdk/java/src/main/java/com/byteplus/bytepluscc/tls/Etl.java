...
import com.byteplus.bytepluscc.tls.inputs.EtlState;
import com.byteplus.bytepluscc.tls.outputs.EtlTargetResource;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/etl:Etl")
public class Etl extends com.pulumi.resources.CustomResource {
    ...
    public Etl(java.lang.String name, EtlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/etl:Etl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Etl(java.lang.String name, Output<java.lang.String> id, @Nullable EtlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/etl:Etl", name, state, makeResourceOptions(options, id), false);
    }
