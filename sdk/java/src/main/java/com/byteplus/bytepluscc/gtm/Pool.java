...
import com.byteplus.bytepluscc.gtm.PoolArgs;
import com.byteplus.bytepluscc.gtm.inputs.PoolState;
import com.byteplus.bytepluscc.gtm.outputs.PoolAddress;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.gtm.Pool;
 * import com.byteplus.bytepluscc.gtm.PoolArgs;
 * import com.pulumi.bytepluscc.gtm.inputs.PoolAddressArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:gtm/pool:Pool")
public class Pool extends com.pulumi.resources.CustomResource {
    ...
    public Pool(java.lang.String name, PoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/pool:Pool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Pool(java.lang.String name, Output<java.lang.String> id, @Nullable PoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/pool:Pool", name, state, makeResourceOptions(options, id), false);
    }
