...
import com.byteplus.bytepluscc.rdspostgresql.inputs.DatabaseState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdspostgresql/database:Database")
public class Database extends com.pulumi.resources.CustomResource {
    ...
    public Database(java.lang.String name, DatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/database:Database", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Database(java.lang.String name, Output<java.lang.String> id, @Nullable DatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/database:Database", name, state, makeResourceOptions(options, id), false);
    }
