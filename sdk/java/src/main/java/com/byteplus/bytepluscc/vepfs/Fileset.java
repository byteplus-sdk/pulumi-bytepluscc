...
import com.byteplus.bytepluscc.vepfs.FilesetArgs;
import com.byteplus.bytepluscc.vepfs.inputs.FilesetState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vepfs.Fileset;
 * import com.byteplus.bytepluscc.vepfs.FilesetArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vepfs/fileset:Fileset")
public class Fileset extends com.pulumi.resources.CustomResource {
    ...
    public Fileset(java.lang.String name, FilesetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vepfs/fileset:Fileset", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Fileset(java.lang.String name, Output<java.lang.String> id, @Nullable FilesetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vepfs/fileset:Fileset", name, state, makeResourceOptions(options, id), false);
    }
