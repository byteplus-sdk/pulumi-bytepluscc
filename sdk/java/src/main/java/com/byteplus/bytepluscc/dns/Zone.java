...
import com.byteplus.bytepluscc.dns.inputs.ZoneState;
import com.byteplus.bytepluscc.dns.outputs.ZoneTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:dns/zone:Zone")
public class Zone extends com.pulumi.resources.CustomResource {
    ...
    public Zone(java.lang.String name, ZoneArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:dns/zone:Zone", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Zone(java.lang.String name, Output<java.lang.String> id, @Nullable ZoneState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:dns/zone:Zone", name, state, makeResourceOptions(options, id), false);
    }
