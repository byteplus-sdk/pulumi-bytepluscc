...
import com.byteplus.bytepluscc.gtm.inputs.PolicyState;
import com.byteplus.bytepluscc.gtm.outputs.PolicyStatistics;
import com.byteplus.bytepluscc.gtm.outputs.PolicyTarget;
 ...
 * 
 */
@ResourceType(type="bytepluscc:gtm/policy:Policy")
public class Policy extends com.pulumi.resources.CustomResource {
    ...
    public Policy(java.lang.String name, PolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/policy:Policy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Policy(java.lang.String name, Output<java.lang.String> id, @Nullable PolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/policy:Policy", name, state, makeResourceOptions(options, id), false);
    }
