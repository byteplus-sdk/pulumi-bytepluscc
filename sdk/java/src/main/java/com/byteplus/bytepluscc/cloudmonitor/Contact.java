...
import com.byteplus.bytepluscc.cloudmonitor.ContactArgs;
import com.byteplus.bytepluscc.cloudmonitor.inputs.ContactState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cloudmonitor.Contact;
 * import com.byteplus.bytepluscc.cloudmonitor.ContactArgs;
 ...
 *
 * ```sh
 * $ pulumi import bytepluscc:cloudmonitor/contact:Contact example &#34;contact_id&#34;
 * ```
 *
 */
@ResourceType(type="bytepluscc:cloudmonitor/contact:Contact")
public class Contact extends com.pulumi.resources.CustomResource {
    ...
    public Contact(java.lang.String name, ContactArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/contact:Contact", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Contact(java.lang.String name, Output<java.lang.String> id, @Nullable ContactState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudmonitor/contact:Contact", name, state, makeResourceOptions(options, id), false);
    }
