...
import com.byteplus.bytepluscc.cr.inputs.RegistryState;
import com.byteplus.bytepluscc.cr.outputs.RegistryEndpoint;
import com.byteplus.bytepluscc.cr.outputs.RegistryProxyCache;
import com.byteplus.bytepluscc.cr.outputs.RegistryStatus;
import com.byteplus.bytepluscc.cr.outputs.RegistryTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cr/registry:Registry")
public class Registry extends com.pulumi.resources.CustomResource {
    ...
    public Registry(java.lang.String name, RegistryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cr/registry:Registry", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Registry(java.lang.String name, Output<java.lang.String> id, @Nullable RegistryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cr/registry:Registry", name, state, makeResourceOptions(options, id), false);
    }
