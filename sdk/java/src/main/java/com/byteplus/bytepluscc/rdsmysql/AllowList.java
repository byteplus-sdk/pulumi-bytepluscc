...
import com.byteplus.bytepluscc.rdsmysql.AllowListArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.AllowListState;
import com.byteplus.bytepluscc.rdsmysql.outputs.AllowListAssociatedInstance;
import com.byteplus.bytepluscc.rdsmysql.outputs.AllowListSecurityGroupBindInfo;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.AllowList;
 * import com.byteplus.bytepluscc.rdsmysql.AllowListArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.AllowListSecurityGroupBindInfoArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmysql/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, @Nullable AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
