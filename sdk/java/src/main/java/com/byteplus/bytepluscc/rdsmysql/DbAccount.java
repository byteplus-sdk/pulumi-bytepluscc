...
import com.byteplus.bytepluscc.rdsmysql.DbAccountArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.DbAccountState;
import com.byteplus.bytepluscc.rdsmysql.outputs.DbAccountAccountPrivilege;
import com.byteplus.bytepluscc.rdsmysql.outputs.DbAccountTableColumnPrivilege;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.DbAccount;
 * import com.byteplus.bytepluscc.rdsmysql.DbAccountArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.DbAccountAccountPrivilegeArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdsmysql/dbAccount:DbAccount")
public class DbAccount extends com.pulumi.resources.CustomResource {
    ...
    public DbAccount(java.lang.String name, DbAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/dbAccount:DbAccount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DbAccount(java.lang.String name, Output<java.lang.String> id, @Nullable DbAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/dbAccount:DbAccount", name, state, makeResourceOptions(options, id), false);
    }
