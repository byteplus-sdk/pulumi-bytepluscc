 ...
 * 
 */
@ResourceType(type="bytepluscc:cen/cen:Cen")
public class Cen extends com.pulumi.resources.CustomResource {
    ...
    public Cen(java.lang.String name, @Nullable CenArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/cen:Cen", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Cen(java.lang.String name, Output<java.lang.String> id, @Nullable CenState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/cen:Cen", name, state, makeResourceOptions(options, id), false);
    }
