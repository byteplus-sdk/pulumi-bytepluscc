...
import com.byteplus.bytepluscc.privatelink.EndpointServiceArgs;
import com.byteplus.bytepluscc.privatelink.inputs.EndpointServiceState;
import com.byteplus.bytepluscc.privatelink.outputs.EndpointServicePrivateDnsNameConfiguration;
import com.byteplus.bytepluscc.privatelink.outputs.EndpointServiceResource;
import com.byteplus.bytepluscc.privatelink.outputs.EndpointServiceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.privatelink.EndpointService;
 * import com.byteplus.bytepluscc.privatelink.EndpointServiceArgs;
 * import com.pulumi.bytepluscc.privatelink.inputs.EndpointServiceResourceArgs;
 * import com.pulumi.bytepluscc.privatelink.inputs.EndpointServiceTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:privatelink/endpointService:EndpointService")
public class EndpointService extends com.pulumi.resources.CustomResource {
    ...
    public EndpointService(java.lang.String name, @Nullable EndpointServiceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/endpointService:EndpointService", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EndpointService(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointServiceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatelink/endpointService:EndpointService", name, state, makeResourceOptions(options, id), false);
    }
