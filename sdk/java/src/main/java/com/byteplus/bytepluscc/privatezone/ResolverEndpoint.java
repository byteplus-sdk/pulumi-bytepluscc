...
import com.byteplus.bytepluscc.privatezone.ResolverEndpointArgs;
import com.byteplus.bytepluscc.privatezone.inputs.ResolverEndpointState;
import com.byteplus.bytepluscc.privatezone.outputs.ResolverEndpointIpConfig;
import com.byteplus.bytepluscc.privatezone.outputs.ResolverEndpointTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.privatezone.ResolverEndpoint;
 * import com.byteplus.bytepluscc.privatezone.ResolverEndpointArgs;
 * import com.pulumi.bytepluscc.privatezone.inputs.ResolverEndpointIpConfigArgs;
 * import com.pulumi.bytepluscc.privatezone.inputs.ResolverEndpointTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint")
public class ResolverEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public ResolverEndpoint(java.lang.String name, ResolverEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResolverEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable ResolverEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, state, makeResourceOptions(options, id), false);
    }
