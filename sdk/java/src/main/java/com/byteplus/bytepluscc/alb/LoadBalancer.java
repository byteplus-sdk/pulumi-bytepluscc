...
import com.byteplus.bytepluscc.alb.LoadBalancerArgs;
import com.byteplus.bytepluscc.alb.inputs.LoadBalancerState;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerEipBillingConfig;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerGlobalAccelerator;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerHealthLog;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerIpv6EipBillingConfig;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerTag;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerTlsAccessLog;
import com.byteplus.bytepluscc.alb.outputs.LoadBalancerZoneMapping;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.alb.LoadBalancer;
 * import com.byteplus.bytepluscc.alb.LoadBalancerArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerEipBillingConfigArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerZoneMappingArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerIpv6EipBillingConfigArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerTagArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerTlsAccessLogArgs;
 * import com.pulumi.bytepluscc.alb.inputs.LoadBalancerHealthLogArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:alb/loadBalancer:LoadBalancer")
public class LoadBalancer extends com.pulumi.resources.CustomResource {
    ...
    public LoadBalancer(java.lang.String name, LoadBalancerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/loadBalancer:LoadBalancer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LoadBalancer(java.lang.String name, Output<java.lang.String> id, @Nullable LoadBalancerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/loadBalancer:LoadBalancer", name, state, makeResourceOptions(options, id), false);
    }
