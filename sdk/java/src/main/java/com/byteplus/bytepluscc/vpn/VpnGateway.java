...
import com.byteplus.bytepluscc.vpn.inputs.VpnGatewayState;
import com.byteplus.bytepluscc.vpn.outputs.VpnGatewayTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/vpnGateway:VpnGateway")
public class VpnGateway extends com.pulumi.resources.CustomResource {
    ...
    public VpnGateway(java.lang.String name, VpnGatewayArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnGateway:VpnGateway", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpnGateway(java.lang.String name, Output<java.lang.String> id, @Nullable VpnGatewayState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnGateway:VpnGateway", name, state, makeResourceOptions(options, id), false);
    }
