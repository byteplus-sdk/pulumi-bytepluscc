...
import com.byteplus.bytepluscc.tls.ShipperArgs;
import com.byteplus.bytepluscc.tls.inputs.ShipperState;
import com.byteplus.bytepluscc.tls.outputs.ShipperContentInfo;
import com.byteplus.bytepluscc.tls.outputs.ShipperKafkaShipperInfo;
import com.byteplus.bytepluscc.tls.outputs.ShipperTosShipperInfo;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.tls.Shipper;
 * import com.byteplus.bytepluscc.tls.ShipperArgs;
 * import com.pulumi.bytepluscc.tls.inputs.ShipperContentInfoArgs;
 * import com.pulumi.bytepluscc.tls.inputs.ShipperKafkaShipperInfoArgs;
 ...
 *
 * ```sh
 * $ pulumi import bytepluscc:tls/shipper:Shipper example &#34;shipper_id&#34;
 * ```
 *
 */
@ResourceType(type="bytepluscc:tls/shipper:Shipper")
public class Shipper extends com.pulumi.resources.CustomResource {
    ...
    public Shipper(java.lang.String name, ShipperArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/shipper:Shipper", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Shipper(java.lang.String name, Output<java.lang.String> id, @Nullable ShipperState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/shipper:Shipper", name, state, makeResourceOptions(options, id), false);
    }
