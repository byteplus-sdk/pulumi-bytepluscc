...
import com.byteplus.bytepluscc.gtm.RuleArgs;
import com.byteplus.bytepluscc.gtm.inputs.RuleState;
import com.byteplus.bytepluscc.gtm.outputs.RulePoolSet;
import com.byteplus.bytepluscc.gtm.outputs.RuleProbe;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.gtm.Rule;
 * import com.byteplus.bytepluscc.gtm.RuleArgs;
 * import com.pulumi.bytepluscc.gtm.inputs.RulePoolSetArgs;
 * import com.pulumi.bytepluscc.gtm.inputs.RulePoolSetPoolArgs;
 * import com.pulumi.bytepluscc.gtm.inputs.RuleProbeArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:gtm/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:gtm/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
