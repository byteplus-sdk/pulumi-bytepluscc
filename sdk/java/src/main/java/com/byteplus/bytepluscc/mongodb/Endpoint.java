...
import com.byteplus.bytepluscc.mongodb.EndpointArgs;
import com.byteplus.bytepluscc.mongodb.inputs.EndpointState;
import com.byteplus.bytepluscc.mongodb.outputs.EndpointDbAddress;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.mongodb.Endpoint;
 * import com.byteplus.bytepluscc.mongodb.EndpointArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:mongodb/endpoint:Endpoint example &#34;instance_id|endpoint_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:mongodb/endpoint:Endpoint")
public class Endpoint extends com.pulumi.resources.CustomResource {
    ...
    public Endpoint(java.lang.String name, EndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/endpoint:Endpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Endpoint(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:mongodb/endpoint:Endpoint", name, state, makeResourceOptions(options, id), false);
    }
