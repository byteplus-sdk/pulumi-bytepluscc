...
import com.byteplus.bytepluscc.rdsmysql.ParameterTemplateArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.ParameterTemplateState;
import com.byteplus.bytepluscc.rdsmysql.outputs.ParameterTemplateTemplateParam;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.ParameterTemplate;
 * import com.byteplus.bytepluscc.rdsmysql.ParameterTemplateArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.ParameterTemplateTemplateParamArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate")
public class ParameterTemplate extends com.pulumi.resources.CustomResource {
    ...
    public ParameterTemplate(java.lang.String name, ParameterTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ParameterTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable ParameterTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, state, makeResourceOptions(options, id), false);
    }
