...
import com.byteplus.bytepluscc.directconnect.inputs.ConnectionState;
import com.byteplus.bytepluscc.directconnect.outputs.ConnectionTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:directconnect/connection:Connection")
public class Connection extends com.pulumi.resources.CustomResource {
    ...
    public Connection(java.lang.String name, ConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/connection:Connection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Connection(java.lang.String name, Output<java.lang.String> id, @Nullable ConnectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:directconnect/connection:Connection", name, state, makeResourceOptions(options, id), false);
    }
