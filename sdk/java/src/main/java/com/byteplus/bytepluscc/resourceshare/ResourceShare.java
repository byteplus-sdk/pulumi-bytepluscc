...
import com.byteplus.bytepluscc.resourceshare.inputs.ResourceShareState;
import com.byteplus.bytepluscc.resourceshare.outputs.ResourceShareTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:resourceshare/resourceShare:ResourceShare")
public class ResourceShare extends com.pulumi.resources.CustomResource {
    ...
    public ResourceShare(java.lang.String name, ResourceShareArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:resourceshare/resourceShare:ResourceShare", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ResourceShare(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceShareState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:resourceshare/resourceShare:ResourceShare", name, state, makeResourceOptions(options, id), false);
    }
