...
import com.byteplus.bytepluscc.alb.inputs.HealthCheckTemplateState;
import com.byteplus.bytepluscc.alb.outputs.HealthCheckTemplateTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate")
public class HealthCheckTemplate extends com.pulumi.resources.CustomResource {
    ...
    public HealthCheckTemplate(java.lang.String name, HealthCheckTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private HealthCheckTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable HealthCheckTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, state, makeResourceOptions(options, id), false);
    }
