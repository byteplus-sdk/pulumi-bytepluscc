...
import com.byteplus.bytepluscc.cen.BandwidthPackageArgs;
import com.byteplus.bytepluscc.cen.inputs.BandwidthPackageState;
import com.byteplus.bytepluscc.cen.outputs.BandwidthPackageTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cen.BandwidthPackage;
 * import com.byteplus.bytepluscc.cen.BandwidthPackageArgs;
 * import com.pulumi.bytepluscc.cen.inputs.BandwidthPackageTagArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:cen/bandwidthPackage:BandwidthPackage example &#34;cen_bandwidth_package_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:cen/bandwidthPackage:BandwidthPackage")
public class BandwidthPackage extends com.pulumi.resources.CustomResource {
    ...
    public BandwidthPackage(java.lang.String name, BandwidthPackageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private BandwidthPackage(java.lang.String name, Output<java.lang.String> id, @Nullable BandwidthPackageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, state, makeResourceOptions(options, id), false);
    }
