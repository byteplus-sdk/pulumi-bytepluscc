...
import com.byteplus.bytepluscc.vke.inputs.NodeState;
import com.byteplus.bytepluscc.vke.outputs.NodeKubernetesConfig;
import com.byteplus.bytepluscc.vke.outputs.NodeStatus;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vke/node:Node")
public class Node extends com.pulumi.resources.CustomResource {
    ...
    public Node(java.lang.String name, NodeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/node:Node", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Node(java.lang.String name, Output<java.lang.String> id, @Nullable NodeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/node:Node", name, state, makeResourceOptions(options, id), false);
    }
