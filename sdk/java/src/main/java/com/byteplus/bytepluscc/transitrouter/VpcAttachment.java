...
import com.byteplus.bytepluscc.transitrouter.VpcAttachmentArgs;
import com.byteplus.bytepluscc.transitrouter.inputs.VpcAttachmentState;
import com.byteplus.bytepluscc.transitrouter.outputs.VpcAttachmentAttachPoint;
import com.byteplus.bytepluscc.transitrouter.outputs.VpcAttachmentTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.transitrouter.VpcAttachment;
 * import com.byteplus.bytepluscc.transitrouter.VpcAttachmentArgs;
 * import com.pulumi.bytepluscc.transitrouter.inputs.VpcAttachmentAttachPointArgs;
 * import com.pulumi.bytepluscc.transitrouter.inputs.VpcAttachmentTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:transitrouter/vpcAttachment:VpcAttachment")
public class VpcAttachment extends com.pulumi.resources.CustomResource {
    ...
    public VpcAttachment(java.lang.String name, VpcAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/vpcAttachment:VpcAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpcAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable VpcAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:transitrouter/vpcAttachment:VpcAttachment", name, state, makeResourceOptions(options, id), false);
    }
