...
import com.byteplus.bytepluscc.ecs.outputs.InstanceKeyPair;
import com.byteplus.bytepluscc.ecs.outputs.InstanceLocalVolume;
import com.byteplus.bytepluscc.ecs.outputs.InstanceOperationSystem;
import com.byteplus.bytepluscc.ecs.outputs.InstancePlacement;
import com.byteplus.bytepluscc.ecs.outputs.InstancePrimaryNetworkInterface;
import com.byteplus.bytepluscc.ecs.outputs.InstanceRdmaNetworkInterfaceDetail;
import com.byteplus.bytepluscc.ecs.outputs.InstanceRenewInfo;
import com.byteplus.bytepluscc.ecs.outputs.InstanceSecondaryNetworkInterface;
import com.byteplus.bytepluscc.ecs.outputs.InstanceSystemVolume;
import com.byteplus.bytepluscc.ecs.outputs.InstanceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.ecs.Instance;
 * import com.byteplus.bytepluscc.ecs.InstanceArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.InstanceImageArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.InstanceEipAddressArgs;
 * import com.pulumi.bytepluscc.ecs.inputs.InstancePrimaryNetworkInterfaceArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:ecs/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ecs/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
