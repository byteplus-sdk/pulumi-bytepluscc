...
import com.byteplus.bytepluscc.autoscaling.ScalingPolicyArgs;
import com.byteplus.bytepluscc.autoscaling.inputs.ScalingPolicyState;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingPolicyAlarmPolicy;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingPolicyScheduledPolicy;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.autoscaling.ScalingPolicy;
 * import com.byteplus.bytepluscc.autoscaling.ScalingPolicyArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingPolicyScheduledPolicyArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:autoscaling/scalingPolicy:ScalingPolicy")
public class ScalingPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ScalingPolicy(java.lang.String name, ScalingPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingPolicy:ScalingPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScalingPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ScalingPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingPolicy:ScalingPolicy", name, state, makeResourceOptions(options, id), false);
    }
