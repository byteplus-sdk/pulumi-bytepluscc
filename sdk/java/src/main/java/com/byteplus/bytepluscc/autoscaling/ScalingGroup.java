...
import com.byteplus.bytepluscc.autoscaling.ScalingGroupArgs;
import com.byteplus.bytepluscc.autoscaling.inputs.ScalingGroupState;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupInstance;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupInstanceRemovePolicy;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupInstancesDistribution;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupLaunchTemplateOverride;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupServerGroupAttribute;
import com.byteplus.bytepluscc.autoscaling.outputs.ScalingGroupTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.autoscaling.ScalingGroup;
 * import com.byteplus.bytepluscc.autoscaling.ScalingGroupArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingGroupInstancesDistributionArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingGroupTagArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingGroupLaunchTemplateOverrideArgs;
 * import com.pulumi.bytepluscc.autoscaling.inputs.ScalingGroupServerGroupAttributeArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:autoscaling/scalingGroup:ScalingGroup")
public class ScalingGroup extends com.pulumi.resources.CustomResource {
    ...
    public ScalingGroup(java.lang.String name, ScalingGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingGroup:ScalingGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ScalingGroup(java.lang.String name, Output<java.lang.String> id, @Nullable ScalingGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:autoscaling/scalingGroup:ScalingGroup", name, state, makeResourceOptions(options, id), false);
    }
