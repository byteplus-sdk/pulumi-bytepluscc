...
import com.byteplus.bytepluscc.clb.ServerGroupArgs;
import com.byteplus.bytepluscc.clb.inputs.ServerGroupState;
import com.byteplus.bytepluscc.clb.outputs.ServerGroupListener;
import com.byteplus.bytepluscc.clb.outputs.ServerGroupServer;
import com.byteplus.bytepluscc.clb.outputs.ServerGroupTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.clb.ServerGroup;
 * import com.byteplus.bytepluscc.clb.ServerGroupArgs;
 * import com.pulumi.bytepluscc.clb.inputs.ServerGroupTagArgs;
 * import com.pulumi.bytepluscc.clb.inputs.ServerGroupServerArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:clb/serverGroup:ServerGroup")
public class ServerGroup extends com.pulumi.resources.CustomResource {
    ...
    public ServerGroup(java.lang.String name, ServerGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/serverGroup:ServerGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ServerGroup(java.lang.String name, Output<java.lang.String> id, @Nullable ServerGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:clb/serverGroup:ServerGroup", name, state, makeResourceOptions(options, id), false);
    }
