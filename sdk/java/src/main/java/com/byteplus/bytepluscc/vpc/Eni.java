...
import com.byteplus.bytepluscc.vpc.EniArgs;
import com.byteplus.bytepluscc.vpc.inputs.EniState;
import com.byteplus.bytepluscc.vpc.outputs.EniPrimaryIpAddress;
import com.byteplus.bytepluscc.vpc.outputs.EniPrivateIpSet;
import com.byteplus.bytepluscc.vpc.outputs.EniTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpc.Eni;
 * import com.byteplus.bytepluscc.vpc.EniArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.EniPrimaryIpAddressArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.EniTagArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:vpc/eni:Eni")
public class Eni extends com.pulumi.resources.CustomResource {
    ...
    public Eni(java.lang.String name, @Nullable EniArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/eni:Eni", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Eni(java.lang.String name, Output<java.lang.String> id, @Nullable EniState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/eni:Eni", name, state, makeResourceOptions(options, id), false);
    }
