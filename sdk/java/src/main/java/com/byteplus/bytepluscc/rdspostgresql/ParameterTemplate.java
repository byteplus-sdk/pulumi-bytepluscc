...
import com.byteplus.bytepluscc.rdspostgresql.inputs.ParameterTemplateState;
import com.byteplus.bytepluscc.rdspostgresql.outputs.ParameterTemplateTemplateParam;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate")
public class ParameterTemplate extends com.pulumi.resources.CustomResource {
    ...
    public ParameterTemplate(java.lang.String name, ParameterTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ParameterTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable ParameterTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate", name, state, makeResourceOptions(options, id), false);
    }
