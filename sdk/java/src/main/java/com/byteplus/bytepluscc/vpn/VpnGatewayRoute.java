...
import com.byteplus.bytepluscc.vpn.inputs.VpnGatewayRouteState;
import com.byteplus.bytepluscc.vpn.outputs.VpnGatewayRouteAsPath;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute")
public class VpnGatewayRoute extends com.pulumi.resources.CustomResource {
    ...
    public VpnGatewayRoute(java.lang.String name, VpnGatewayRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpnGatewayRoute(java.lang.String name, Output<java.lang.String> id, @Nullable VpnGatewayRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute", name, state, makeResourceOptions(options, id), false);
    }
