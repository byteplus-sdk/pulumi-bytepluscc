...
import com.byteplus.bytepluscc.hbase.inputs.InstanceState;
import com.byteplus.bytepluscc.hbase.outputs.InstanceEndpoint;
import com.byteplus.bytepluscc.hbase.outputs.InstanceTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:hbase/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:hbase/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:hbase/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
