...
import com.byteplus.bytepluscc.firewallcenter.DnsControlPolicyArgs;
import com.byteplus.bytepluscc.firewallcenter.inputs.DnsControlPolicyState;
import com.byteplus.bytepluscc.firewallcenter.outputs.DnsControlPolicyDomainListV1;
import com.byteplus.bytepluscc.firewallcenter.outputs.DnsControlPolicySource;
 ...
 * 
 */
@ResourceType(type="bytepluscc:firewallcenter/dnsControlPolicy:DnsControlPolicy")
public class DnsControlPolicy extends com.pulumi.resources.CustomResource {
    ...
    public DnsControlPolicy(java.lang.String name, DnsControlPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:firewallcenter/dnsControlPolicy:DnsControlPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private DnsControlPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable DnsControlPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:firewallcenter/dnsControlPolicy:DnsControlPolicy", name, state, makeResourceOptions(options, id), false);
    }
