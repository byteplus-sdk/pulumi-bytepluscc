...
import com.byteplus.bytepluscc.vpc.BandwidthPackageArgs;
import com.byteplus.bytepluscc.vpc.inputs.BandwidthPackageState;
import com.byteplus.bytepluscc.vpc.outputs.BandwidthPackageEipAddress;
import com.byteplus.bytepluscc.vpc.outputs.BandwidthPackageTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vpc.BandwidthPackage;
 * import com.byteplus.bytepluscc.vpc.BandwidthPackageArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.BandwidthPackageTagArgs;
 * import com.pulumi.bytepluscc.vpc.inputs.BandwidthPackageEipAddressArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/bandwidthPackage:BandwidthPackage")
public class BandwidthPackage extends com.pulumi.resources.CustomResource {
    ...
    public BandwidthPackage(java.lang.String name, BandwidthPackageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/bandwidthPackage:BandwidthPackage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private BandwidthPackage(java.lang.String name, Output<java.lang.String> id, @Nullable BandwidthPackageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/bandwidthPackage:BandwidthPackage", name, state, makeResourceOptions(options, id), false);
    }
