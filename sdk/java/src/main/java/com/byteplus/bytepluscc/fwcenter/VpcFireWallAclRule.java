...
import com.byteplus.bytepluscc.fwcenter.inputs.VpcFireWallAclRuleState;
import com.byteplus.bytepluscc.fwcenter.outputs.VpcFireWallAclRuleDestPortListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.VpcFireWallAclRuleDestinationCidrListV1;
import com.byteplus.bytepluscc.fwcenter.outputs.VpcFireWallAclRuleSourceCidrListV1;
 ...
 * 
 */
@ResourceType(type="bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule")
public class VpcFireWallAclRule extends com.pulumi.resources.CustomResource {
    ...
    public VpcFireWallAclRule(java.lang.String name, VpcFireWallAclRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VpcFireWallAclRule(java.lang.String name, Output<java.lang.String> id, @Nullable VpcFireWallAclRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule", name, state, makeResourceOptions(options, id), false);
    }
