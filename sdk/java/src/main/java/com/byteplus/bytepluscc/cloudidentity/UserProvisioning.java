...
import com.byteplus.bytepluscc.cloudidentity.UserProvisioningArgs;
import com.byteplus.bytepluscc.cloudidentity.inputs.UserProvisioningState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cloudidentity.UserProvisioning;
 * import com.byteplus.bytepluscc.cloudidentity.UserProvisioningArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:cloudidentity/userProvisioning:UserProvisioning")
public class UserProvisioning extends com.pulumi.resources.CustomResource {
    ...
    public UserProvisioning(java.lang.String name, UserProvisioningArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UserProvisioning(java.lang.String name, Output<java.lang.String> id, @Nullable UserProvisioningState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, state, makeResourceOptions(options, id), false);
    }
