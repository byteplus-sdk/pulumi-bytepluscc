...
import com.byteplus.bytepluscc.tls.inputs.HostGroupState;
import com.byteplus.bytepluscc.tls.outputs.HostGroupRule;
 ...
 * 
 */
@ResourceType(type="bytepluscc:tls/hostGroup:HostGroup")
public class HostGroup extends com.pulumi.resources.CustomResource {
    ...
    public HostGroup(java.lang.String name, HostGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/hostGroup:HostGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private HostGroup(java.lang.String name, Output<java.lang.String> id, @Nullable HostGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:tls/hostGroup:HostGroup", name, state, makeResourceOptions(options, id), false);
    }
