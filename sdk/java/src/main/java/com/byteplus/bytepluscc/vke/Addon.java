...
import com.byteplus.bytepluscc.vke.inputs.AddonState;
import com.byteplus.bytepluscc.vke.outputs.AddonStatus;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vke/addon:Addon")
public class Addon extends com.pulumi.resources.CustomResource {
    ...
    public Addon(java.lang.String name, @Nullable AddonArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/addon:Addon", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Addon(java.lang.String name, Output<java.lang.String> id, @Nullable AddonState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vke/addon:Addon", name, state, makeResourceOptions(options, id), false);
    }
