...
import com.byteplus.bytepluscc.vmp.RuleFileArgs;
import com.byteplus.bytepluscc.vmp.inputs.RuleFileState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.vmp.RuleFile;
 * import com.byteplus.bytepluscc.vmp.RuleFileArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vmp/ruleFile:RuleFile")
public class RuleFile extends com.pulumi.resources.CustomResource {
    ...
    public RuleFile(java.lang.String name, RuleFileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vmp/ruleFile:RuleFile", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RuleFile(java.lang.String name, Output<java.lang.String> id, @Nullable RuleFileState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vmp/ruleFile:RuleFile", name, state, makeResourceOptions(options, id), false);
    }
