...
import com.byteplus.bytepluscc.storageebs.SnapshotGroupArgs;
import com.byteplus.bytepluscc.storageebs.inputs.SnapshotGroupState;
import com.byteplus.bytepluscc.storageebs.outputs.SnapshotGroupSnapshot;
import com.byteplus.bytepluscc.storageebs.outputs.SnapshotGroupTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.storageebs.SnapshotGroup;
 * import com.byteplus.bytepluscc.storageebs.SnapshotGroupArgs;
 * import com.pulumi.bytepluscc.storageebs.inputs.SnapshotGroupTagArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:storageebs/snapshotGroup:SnapshotGroup example &#34;snapshot_group_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:storageebs/snapshotGroup:SnapshotGroup")
public class SnapshotGroup extends com.pulumi.resources.CustomResource {
    ...
    public SnapshotGroup(java.lang.String name, SnapshotGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SnapshotGroup(java.lang.String name, Output<java.lang.String> id, @Nullable SnapshotGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, state, makeResourceOptions(options, id), false);
    }
