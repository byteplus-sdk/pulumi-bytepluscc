...
import com.byteplus.bytepluscc.vmp.inputs.WorkspaceState;
import com.byteplus.bytepluscc.vmp.outputs.WorkspaceInstanceType;
import com.byteplus.bytepluscc.vmp.outputs.WorkspaceQuota;
import com.byteplus.bytepluscc.vmp.outputs.WorkspaceTag;
import com.byteplus.bytepluscc.vmp.outputs.WorkspaceUsage;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vmp/workspace:Workspace")
public class Workspace extends com.pulumi.resources.CustomResource {
    ...
    public Workspace(java.lang.String name, WorkspaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vmp/workspace:Workspace", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Workspace(java.lang.String name, Output<java.lang.String> id, @Nullable WorkspaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vmp/workspace:Workspace", name, state, makeResourceOptions(options, id), false);
    }
