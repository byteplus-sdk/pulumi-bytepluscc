...
import com.byteplus.bytepluscc.cloudidentity.PermissionSetArgs;
import com.byteplus.bytepluscc.cloudidentity.inputs.PermissionSetState;
import com.byteplus.bytepluscc.cloudidentity.outputs.PermissionSetPermissionPolicy;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cloudidentity.PermissionSet;
 * import com.byteplus.bytepluscc.cloudidentity.PermissionSetArgs;
 * import com.pulumi.bytepluscc.cloudidentity.inputs.PermissionSetPermissionPolicyArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:cloudidentity/permissionSet:PermissionSet")
public class PermissionSet extends com.pulumi.resources.CustomResource {
    ...
    public PermissionSet(java.lang.String name, PermissionSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PermissionSet(java.lang.String name, Output<java.lang.String> id, @Nullable PermissionSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, state, makeResourceOptions(options, id), false);
    }
