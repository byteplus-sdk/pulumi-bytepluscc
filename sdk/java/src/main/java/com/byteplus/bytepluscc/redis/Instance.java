...
import com.byteplus.bytepluscc.redis.outputs.InstanceInstanceShard;
import com.byteplus.bytepluscc.redis.outputs.InstanceTag;
import com.byteplus.bytepluscc.redis.outputs.InstanceVisitAddr;
 ...
 * 
 */
@ResourceType(type="bytepluscc:redis/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:redis/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
