...
import com.byteplus.bytepluscc.cdn.ShareConfigArgs;
import com.byteplus.bytepluscc.cdn.inputs.ShareConfigState;
import com.byteplus.bytepluscc.cdn.outputs.ShareConfigAllowIpAccessRule;
import com.byteplus.bytepluscc.cdn.outputs.ShareConfigAllowRefererAccessRule;
import com.byteplus.bytepluscc.cdn.outputs.ShareConfigCommonMatchList;
import com.byteplus.bytepluscc.cdn.outputs.ShareConfigDenyIpAccessRule;
import com.byteplus.bytepluscc.cdn.outputs.ShareConfigDenyRefererAccessRule;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cdn.ShareConfig;
 * import com.byteplus.bytepluscc.cdn.ShareConfigArgs;
 * import com.pulumi.bytepluscc.cdn.inputs.ShareConfigAllowRefererAccessRuleArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:cdn/shareConfig:ShareConfig")
public class ShareConfig extends com.pulumi.resources.CustomResource {
    ...
    public ShareConfig(java.lang.String name, @Nullable ShareConfigArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cdn/shareConfig:ShareConfig", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ShareConfig(java.lang.String name, Output<java.lang.String> id, @Nullable ShareConfigState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cdn/shareConfig:ShareConfig", name, state, makeResourceOptions(options, id), false);
    }
