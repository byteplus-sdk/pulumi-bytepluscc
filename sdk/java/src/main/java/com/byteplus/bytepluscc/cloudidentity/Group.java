...
import com.byteplus.bytepluscc.cloudidentity.GroupArgs;
import com.byteplus.bytepluscc.cloudidentity.inputs.GroupState;
import com.byteplus.bytepluscc.cloudidentity.outputs.GroupMember;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.cloudidentity.Group;
 * import com.byteplus.bytepluscc.cloudidentity.GroupArgs;
 * import com.pulumi.bytepluscc.cloudidentity.inputs.GroupMemberArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:cloudidentity/group:Group")
public class Group extends com.pulumi.resources.CustomResource {
    ...
    public Group(java.lang.String name, GroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/group:Group", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Group(java.lang.String name, Output<java.lang.String> id, @Nullable GroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:cloudidentity/group:Group", name, state, makeResourceOptions(options, id), false);
    }
