...
import com.byteplus.bytepluscc.kafka.AllowListArgs;
import com.byteplus.bytepluscc.kafka.inputs.AllowListState;
import com.byteplus.bytepluscc.kafka.outputs.AllowListAssociatedInstance;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.kafka.AllowList;
 * import com.byteplus.bytepluscc.kafka.AllowListArgs;
 * import com.pulumi.bytepluscc.kafka.inputs.AllowListAssociatedInstanceArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:kafka/allowList:AllowList")
public class AllowList extends com.pulumi.resources.CustomResource {
    ...
    public AllowList(java.lang.String name, AllowListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/allowList:AllowList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AllowList(java.lang.String name, Output<java.lang.String> id, @Nullable AllowListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/allowList:AllowList", name, state, makeResourceOptions(options, id), false);
    }
