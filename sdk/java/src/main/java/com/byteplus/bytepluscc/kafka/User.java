...
import com.byteplus.bytepluscc.kafka.UserArgs;
import com.byteplus.bytepluscc.kafka.inputs.UserState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.kafka.User;
 * import com.byteplus.bytepluscc.kafka.UserArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:kafka/user:User")
public class User extends com.pulumi.resources.CustomResource {
    ...
    public User(java.lang.String name, UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/user:User", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private User(java.lang.String name, Output<java.lang.String> id, @Nullable UserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kafka/user:User", name, state, makeResourceOptions(options, id), false);
    }
