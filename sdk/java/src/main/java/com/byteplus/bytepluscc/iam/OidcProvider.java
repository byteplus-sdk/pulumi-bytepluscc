...
import com.byteplus.bytepluscc.iam.OidcProviderArgs;
import com.byteplus.bytepluscc.iam.inputs.OidcProviderState;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.iam.OidcProvider;
 * import com.byteplus.bytepluscc.iam.OidcProviderArgs;
 * import java.util.List;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:iam/oidcProvider:OidcProvider example &#34;oidc_provider_name&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:iam/oidcProvider:OidcProvider")
public class OidcProvider extends com.pulumi.resources.CustomResource {
    ...
    public OidcProvider(java.lang.String name, OidcProviderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/oidcProvider:OidcProvider", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private OidcProvider(java.lang.String name, Output<java.lang.String> id, @Nullable OidcProviderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:iam/oidcProvider:OidcProvider", name, state, makeResourceOptions(options, id), false);
    }
