...
import com.byteplus.bytepluscc.rdsmysql.InstanceArgs;
import com.byteplus.bytepluscc.rdsmysql.inputs.InstanceState;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceAddressObject;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceAutoStorageScalingConfig;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceBackupPolicy;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceChargeDetail;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceDisasterRecoveryInstance;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceEndpoint;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceMaintenanceWindow;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceNode;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceProxyDetail;
import com.byteplus.bytepluscc.rdsmysql.outputs.InstanceTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.rdsmysql.Instance;
 * import com.byteplus.bytepluscc.rdsmysql.InstanceArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.InstanceNodeArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.InstanceChargeDetailArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.InstanceMaintenanceWindowArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.InstanceAutoStorageScalingConfigArgs;
 * import com.pulumi.bytepluscc.rdsmysql.inputs.InstanceTagArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:rdsmysql/instance:Instance")
public class Instance extends com.pulumi.resources.CustomResource {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:rdsmysql/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
