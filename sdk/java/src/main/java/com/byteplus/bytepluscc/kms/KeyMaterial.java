...
import com.byteplus.bytepluscc.kms.inputs.KeyMaterialState;
 ...
 *
 */
@ResourceType(type="bytepluscc:kms/keyMaterial:KeyMaterial")
public class KeyMaterial extends com.pulumi.resources.CustomResource {
    ...
    public KeyMaterial(java.lang.String name, KeyMaterialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kms/keyMaterial:KeyMaterial", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private KeyMaterial(java.lang.String name, Output<java.lang.String> id, @Nullable KeyMaterialState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:kms/keyMaterial:KeyMaterial", name, state, makeResourceOptions(options, id), false);
    }
