...
import com.byteplus.bytepluscc.privatezone.inputs.UserVpcAuthorizationState;
 ...
 * 
 */
@ResourceType(type="bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization")
public class UserVpcAuthorization extends com.pulumi.resources.CustomResource {
    ...
    public UserVpcAuthorization(java.lang.String name, @Nullable UserVpcAuthorizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private UserVpcAuthorization(java.lang.String name, Output<java.lang.String> id, @Nullable UserVpcAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, state, makeResourceOptions(options, id), false);
    }
