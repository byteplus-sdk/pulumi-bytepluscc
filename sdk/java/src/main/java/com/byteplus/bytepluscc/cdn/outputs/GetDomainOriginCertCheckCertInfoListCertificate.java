...
@CustomType
public final class GetDomainOriginCertCheckCertInfoListCertificate {
    /**
    ...
    private GetDomainOriginCertCheckCertInfoListCertificate() {}
    /**
     * @return Indicates the content of the certificate file. Line breaks in the content must be replaced with \r\n. The certificate file extension is .crt or .pem, and the certificate file must include the complete certificate chain.
     * 
     */
    ...
    public static Builder builder(GetDomainOriginCertCheckCertInfoListCertificate defaults) {
    ...
    public static final class Builder {
        ...
        private String privateKey;
        public Builder() {}
        public Builder(GetDomainOriginCertCheckCertInfoListCertificate defaults) {
        ...
        public Builder certificate(String certificate) {
            if (certificate == null) {
              throw new MissingRequiredPropertyException("GetDomainOriginCertCheckCertInfoListCertificate", "certificate");
            }
        ...
        public Builder encryptionCert(String encryptionCert) {
            if (encryptionCert == null) {
              throw new MissingRequiredPropertyException("GetDomainOriginCertCheckCertInfoListCertificate", "encryptionCert");
            }
        ...
        public Builder encryptionKey(String encryptionKey) {
            if (encryptionKey == null) {
              throw new MissingRequiredPropertyException("GetDomainOriginCertCheckCertInfoListCertificate", "encryptionKey");
            }
        ...
        public Builder privateKey(String privateKey) {
            if (privateKey == null) {
              throw new MissingRequiredPropertyException("GetDomainOriginCertCheckCertInfoListCertificate", "privateKey");
            }
            this.privateKey = privateKey;
            return this;
        }
        public GetDomainOriginCertCheckCertInfoListCertificate build() {
            final var _resultValue = new GetDomainOriginCertCheckCertInfoListCertificate();
