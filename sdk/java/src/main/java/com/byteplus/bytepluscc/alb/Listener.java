...
import com.byteplus.bytepluscc.alb.ListenerArgs;
import com.byteplus.bytepluscc.alb.inputs.ListenerState;
import com.byteplus.bytepluscc.alb.outputs.ListenerDomainExtension;
import com.byteplus.bytepluscc.alb.outputs.ListenerServerGroup;
import com.byteplus.bytepluscc.alb.outputs.ListenerTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.alb.Listener;
 * import com.byteplus.bytepluscc.alb.ListenerArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ListenerTagArgs;
 * import com.pulumi.bytepluscc.alb.inputs.ListenerDomainExtensionArgs;
 ...
 * 
 */
@ResourceType(type="bytepluscc:alb/listener:Listener")
public class Listener extends com.pulumi.resources.CustomResource {
    ...
    public Listener(java.lang.String name, ListenerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/listener:Listener", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Listener(java.lang.String name, Output<java.lang.String> id, @Nullable ListenerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:alb/listener:Listener", name, state, makeResourceOptions(options, id), false);
    }
