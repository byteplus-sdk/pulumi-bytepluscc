...
import com.byteplus.bytepluscc.config.RuleArgs;
import com.byteplus.bytepluscc.config.inputs.RuleState;
import com.byteplus.bytepluscc.config.outputs.RuleScope;
import com.byteplus.bytepluscc.config.outputs.RuleTrigger;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.config.Rule;
 * import com.byteplus.bytepluscc.config.RuleArgs;
 * import com.pulumi.bytepluscc.config.inputs.RuleTriggerArgs;
 * import com.pulumi.bytepluscc.config.inputs.RuleScopeArgs;
 * import com.pulumi.bytepluscc.config.inputs.RuleScopeRegionsArgs;
 * import com.pulumi.bytepluscc.config.inputs.RuleScopeProjectsArgs;
 * import com.pulumi.bytepluscc.config.inputs.RuleScopeTagsArgs;
 ...
 * 
 * ```sh
 * $ pulumi import bytepluscc:config/rule:Rule example &#34;rule_id&#34;
 * ```
 * 
 */
@ResourceType(type="bytepluscc:config/rule:Rule")
public class Rule extends com.pulumi.resources.CustomResource {
    ...
    public Rule(java.lang.String name, RuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:config/rule:Rule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Rule(java.lang.String name, Output<java.lang.String> id, @Nullable RuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:config/rule:Rule", name, state, makeResourceOptions(options, id), false);
    }
