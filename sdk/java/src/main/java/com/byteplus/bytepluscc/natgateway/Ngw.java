...
import com.byteplus.bytepluscc.natgateway.inputs.NgwState;
import com.byteplus.bytepluscc.natgateway.outputs.NgwEipAddress;
import com.byteplus.bytepluscc.natgateway.outputs.NgwNatIpAddress;
import com.byteplus.bytepluscc.natgateway.outputs.NgwTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:natgateway/ngw:Ngw")
public class Ngw extends com.pulumi.resources.CustomResource {
    ...
    public Ngw(java.lang.String name, NgwArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:natgateway/ngw:Ngw", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Ngw(java.lang.String name, Output<java.lang.String> id, @Nullable NgwState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:natgateway/ngw:Ngw", name, state, makeResourceOptions(options, id), false);
    }
