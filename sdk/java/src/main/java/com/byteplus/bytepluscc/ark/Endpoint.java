...
import com.byteplus.bytepluscc.ark.EndpointArgs;
import com.byteplus.bytepluscc.ark.inputs.EndpointState;
import com.byteplus.bytepluscc.ark.outputs.EndpointCertificate;
import com.byteplus.bytepluscc.ark.outputs.EndpointModelReference;
import com.byteplus.bytepluscc.ark.outputs.EndpointModeration;
import com.byteplus.bytepluscc.ark.outputs.EndpointRateLimit;
import com.byteplus.bytepluscc.ark.outputs.EndpointTag;
 ...
 * import com.pulumi.core.Output;
 * import com.byteplus.bytepluscc.ark.Endpoint;
 * import com.byteplus.bytepluscc.ark.EndpointArgs;
 * import com.pulumi.bytepluscc.ark.inputs.EndpointModelReferenceArgs;
 * import com.pulumi.bytepluscc.ark.inputs.EndpointTagArgs;
 * import com.pulumi.bytepluscc.ark.inputs.EndpointRateLimitArgs;
 ...
 *
 */
@ResourceType(type="bytepluscc:ark/endpoint:Endpoint")
public class Endpoint extends com.pulumi.resources.CustomResource {
    ...
    public Endpoint(java.lang.String name, EndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ark/endpoint:Endpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Endpoint(java.lang.String name, Output<java.lang.String> id, @Nullable EndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:ark/endpoint:Endpoint", name, state, makeResourceOptions(options, id), false);
    }
