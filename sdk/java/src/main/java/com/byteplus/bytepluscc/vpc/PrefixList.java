...
import com.byteplus.bytepluscc.vpc.inputs.PrefixListState;
import com.byteplus.bytepluscc.vpc.outputs.PrefixListAssociationsRouteTable;
import com.byteplus.bytepluscc.vpc.outputs.PrefixListAssociationsSecurityGroup;
import com.byteplus.bytepluscc.vpc.outputs.PrefixListPrefixListEntry;
import com.byteplus.bytepluscc.vpc.outputs.PrefixListTag;
 ...
 * 
 */
@ResourceType(type="bytepluscc:vpc/prefixList:PrefixList")
public class PrefixList extends com.pulumi.resources.CustomResource {
    ...
    public PrefixList(java.lang.String name, PrefixListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/prefixList:PrefixList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private PrefixList(java.lang.String name, Output<java.lang.String> id, @Nullable PrefixListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("bytepluscc:vpc/prefixList:PrefixList", name, state, makeResourceOptions(options, id), false);
    }
