...
namespace Byteplus.Pulumi.Bytepluscc.Cdn
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cdn/shareConfig:ShareConfig")]
    public partial class ShareConfig : global::Pulumi.CustomResource
    {
        ...
        public ShareConfig(string name, ShareConfigArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cdn/shareConfig:ShareConfig", name, args ?? new ShareConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ShareConfig(string name, Input<string> id, ShareConfigState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cdn/shareConfig:ShareConfig", name, state, MakeResourceOptions(options, id))
        {
        }
