...
namespace Byteplus.Pulumi.Bytepluscc.Cdn
{
    ...
    /// {
    ///     var cDNDomainDemo = new Bytepluscc.Cdn.Domain("CDNDomainDemo", new()
    ///     {
    ...
    ///         Caches = new[]
    ///         {
    ///             new Bytepluscc.Cdn.Inputs.DomainCacheArgs
    ///             {
    ///                 Cache_action = 
    ///                 {
    ///                     { "action", "cache" },
    ...
    ///                     { "ttl", 2 },
    ///                 },
    ///                 Condition = new Bytepluscc.Cdn.Inputs.DomainCacheConditionArgs
    ///                 {
    ///                     ConditionRule = new[]
    ///                     {
    ///                         
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cdn/domain:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cdn/domain:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, DomainState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cdn/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
