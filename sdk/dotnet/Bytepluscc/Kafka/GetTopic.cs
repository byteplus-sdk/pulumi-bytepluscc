...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    public static class GetTopic
    {
        ...
        public static Task<GetTopicResult> InvokeAsync(GetTopicArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTopicResult>("bytepluscc:kafka/getTopic:getTopic", args ?? new GetTopicArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::Kafka::Topic
        /// </summary>
        public static Output<GetTopicResult> Invoke(GetTopicInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTopicResult>("bytepluscc:kafka/getTopic:getTopic", args ?? new GetTopicInvokeArgs(), options.WithDefaults());
