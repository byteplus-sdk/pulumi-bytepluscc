...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    ...
    ///         AccessPolicies = new[]
    ///         {
    ///             new Bytepluscc.Kafka.Inputs.TopicAccessPolicyArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Kafka.Inputs.TopicTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kafka/topic:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/topic:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, TopicState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/topic:Topic", name, state, MakeResourceOptions(options, id))
        {
        }
