...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kafka/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
