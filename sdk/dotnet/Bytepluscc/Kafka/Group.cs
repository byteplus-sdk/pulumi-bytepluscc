...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    ...
    /// {
    ///     var kafkaGroupDemo = new Bytepluscc.Kafka.Group("KafkaGroupDemo", new()
    ///     {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Kafka.Inputs.GroupTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kafka/group:Group")]
    public partial class Group : global::Pulumi.CustomResource
    {
        ...
        public Group(string name, GroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/group:Group", name, args ?? new GroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Group(string name, Input<string> id, GroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/group:Group", name, state, MakeResourceOptions(options, id))
        {
        }
