...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    ...
    /// {
    ///     var kafkaInstanceDemo = new Bytepluscc.Kafka.Instance("KafkaInstanceDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kafka/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
