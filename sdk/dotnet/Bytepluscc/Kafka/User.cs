...
namespace Byteplus.Pulumi.Bytepluscc.Kafka
{
    ...
    /// {
    ///     var kafkaUserDemo = new Bytepluscc.Kafka.User("KafkaUserDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kafka/user:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/user:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, UserState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kafka/user:User", name, state, MakeResourceOptions(options, id))
        {
        }
