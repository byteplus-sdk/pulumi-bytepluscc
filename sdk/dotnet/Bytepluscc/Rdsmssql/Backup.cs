...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmssql
{
    ...
    /// {
    ///     var rDSMsSQLBackupDemo = new Bytepluscc.Rdsmssql.Backup("RDSMsSQLBackupDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmssql/backup:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/backup:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, BackupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/backup:Backup", name, state, MakeResourceOptions(options, id))
        {
        }
