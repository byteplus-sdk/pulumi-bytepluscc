...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmssql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmssql/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
