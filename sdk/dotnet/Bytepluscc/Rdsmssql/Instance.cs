...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmssql
{
    /// <summary>
    ...
    ///         ChargeInfo = new Bytepluscc.Rdsmssql.Inputs.InstanceChargeInfoArgs
    ///         {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Rdsmssql.Inputs.InstanceTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmssql/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmssql/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
