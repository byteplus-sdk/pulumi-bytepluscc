...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/cen:Cen")]
    public partial class Cen : global::Pulumi.CustomResource
    {
        ...
        public Cen(string name, CenArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/cen:Cen", name, args ?? new CenArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cen(string name, Input<string> id, CenState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/cen:Cen", name, state, MakeResourceOptions(options, id))
        {
        }
