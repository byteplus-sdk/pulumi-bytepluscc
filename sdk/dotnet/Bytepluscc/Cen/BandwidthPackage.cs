...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    /// <summary>
    ...
    /// {
    ///     var cENBandwidthPackageDemo = new Bytepluscc.Cen.BandwidthPackage("CENBandwidthPackageDemo", new()
    ///     {
    ///         Bandwidth = 3,
    ///         BillingType = 4,
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Cen.Inputs.BandwidthPackageTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/bandwidthPackage:BandwidthPackage")]
    public partial class BandwidthPackage : global::Pulumi.CustomResource
    {
        ...
        public BandwidthPackage(string name, BandwidthPackageArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, args ?? new BandwidthPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthPackage(string name, Input<string> id, BandwidthPackageState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/bandwidthPackage:BandwidthPackage", name, state, MakeResourceOptions(options, id))
        {
        }
