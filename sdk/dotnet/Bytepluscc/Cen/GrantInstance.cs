...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    ...
    /// {
    ///     var cenGranInstanceDemo = new Bytepluscc.Cen.GrantInstance("CenGranInstanceDemo", new()
    ///     {
    ///         CenId = "cen-2v72wo******",
    ///         CenOwnerId = "210102***",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/grantInstance:GrantInstance")]
    public partial class GrantInstance : global::Pulumi.CustomResource
    {
        ...
        public GrantInstance(string name, GrantInstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/grantInstance:GrantInstance", name, args ?? new GrantInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GrantInstance(string name, Input<string> id, GrantInstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/grantInstance:GrantInstance", name, state, MakeResourceOptions(options, id))
        {
        }
