...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    ...
    /// {
    ///     var cENRouteEntryDemo = new Bytepluscc.Cen.RouteEntry("CENRouteEntryDemo", new()
    ///     {
    ///         InstanceType = "VPC",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/routeEntry:RouteEntry")]
    public partial class RouteEntry : global::Pulumi.CustomResource
    {
        ...
        public RouteEntry(string name, RouteEntryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/routeEntry:RouteEntry", name, args ?? new RouteEntryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteEntry(string name, Input<string> id, RouteEntryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/routeEntry:RouteEntry", name, state, MakeResourceOptions(options, id))
        {
        }
