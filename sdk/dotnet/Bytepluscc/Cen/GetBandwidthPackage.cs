...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    public static class GetBandwidthPackage
    {
        ...
        public static Task<GetBandwidthPackageResult> InvokeAsync(GetBandwidthPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthPackageResult>("bytepluscc:cen/getBandwidthPackage:getBandwidthPackage", args ?? new GetBandwidthPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CEN::BandwidthPackage
        /// </summary>
        public static Output<GetBandwidthPackageResult> Invoke(GetBandwidthPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBandwidthPackageResult>("bytepluscc:cen/getBandwidthPackage:getBandwidthPackage", args ?? new GetBandwidthPackageInvokeArgs(), options.WithDefaults());
