...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth")]
    public partial class InterRegionBandwidth : global::Pulumi.CustomResource
    {
        ...
        public InterRegionBandwidth(string name, InterRegionBandwidthArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth", name, args ?? new InterRegionBandwidthArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InterRegionBandwidth(string name, Input<string> id, InterRegionBandwidthState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/interRegionBandwidth:InterRegionBandwidth", name, state, MakeResourceOptions(options, id))
        {
        }
