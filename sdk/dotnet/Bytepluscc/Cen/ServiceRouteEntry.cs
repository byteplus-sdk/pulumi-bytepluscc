...
namespace Byteplus.Pulumi.Bytepluscc.Cen
{
    ...
    ///         {
    ///             new Bytepluscc.Cen.Inputs.ServiceRouteEntryPublishToInstanceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry")]
    public partial class ServiceRouteEntry : global::Pulumi.CustomResource
    {
        ...
        public ServiceRouteEntry(string name, ServiceRouteEntryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry", name, args ?? new ServiceRouteEntryArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ServiceRouteEntry(string name, Input<string> id, ServiceRouteEntryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cen/serviceRouteEntry:ServiceRouteEntry", name, state, MakeResourceOptions(options, id))
        {
        }
