...
namespace Byteplus.Pulumi.Bytepluscc.Vedbm
{
    ...
    /// {
    ///     var vEDBMDatabaseDemo = new Bytepluscc.Vedbm.Database("VEDBMDatabaseDemo", new()
    ///     {
    ///         DbName = "testdb-tf",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vedbm/database:Database")]
    public partial class Database : global::Pulumi.CustomResource
    {
        ...
        public Database(string name, DatabaseArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/database:Database", name, args ?? new DatabaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Database(string name, Input<string> id, DatabaseState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/database:Database", name, state, MakeResourceOptions(options, id))
        {
        }
