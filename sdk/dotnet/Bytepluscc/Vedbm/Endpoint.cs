...
namespace Byteplus.Pulumi.Bytepluscc.Vedbm
{
    ...
    ///     {
    ///         PublicAddresses = new Bytepluscc.Vedbm.Inputs.EndpointPublicAddressesArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vedbm/endpoint:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/endpoint:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, EndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/endpoint:Endpoint", name, state, MakeResourceOptions(options, id))
        {
        }
