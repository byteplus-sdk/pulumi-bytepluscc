...
namespace Byteplus.Pulumi.Bytepluscc.Vedbm
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vedbm/backup:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/backup:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, BackupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/backup:Backup", name, state, MakeResourceOptions(options, id))
        {
        }
