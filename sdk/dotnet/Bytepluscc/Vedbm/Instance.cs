...
namespace Byteplus.Pulumi.Bytepluscc.Vedbm
{
    ...
    /// {
    ///     var vEDBMInstanceDemo = new Bytepluscc.Vedbm.Instance("VEDBMInstanceDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vedbm/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vedbm/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
