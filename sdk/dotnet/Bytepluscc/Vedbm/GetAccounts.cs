...
namespace Byteplus.Pulumi.Bytepluscc.Vedbm
{
    public static class GetAccounts
    {
        ...
        public static Task<GetAccountsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountsResult>("bytepluscc:vedbm/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::VEDBM::Account
        /// </summary>
        public static Output<GetAccountsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountsResult>("bytepluscc:vedbm/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());
