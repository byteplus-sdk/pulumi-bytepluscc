...
namespace Byteplus.Pulumi.Bytepluscc.Resourceshare
{
    public static class GetResourceShare
    {
        ...
        public static Task<GetResourceShareResult> InvokeAsync(GetResourceShareArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResourceShareResult>("bytepluscc:resourceshare/getResourceShare:getResourceShare", args ?? new GetResourceShareArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ResourceShare::ResourceShare
        /// </summary>
        public static Output<GetResourceShareResult> Invoke(GetResourceShareInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResourceShareResult>("bytepluscc:resourceshare/getResourceShare:getResourceShare", args ?? new GetResourceShareInvokeArgs(), options.WithDefaults());
