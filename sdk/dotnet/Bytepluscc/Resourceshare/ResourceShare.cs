...
namespace Byteplus.Pulumi.Bytepluscc.Resourceshare
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:resourceshare/resourceShare:ResourceShare")]
    public partial class ResourceShare : global::Pulumi.CustomResource
    {
        ...
        public ResourceShare(string name, ResourceShareArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:resourceshare/resourceShare:ResourceShare", name, args ?? new ResourceShareArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceShare(string name, Input<string> id, ResourceShareState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:resourceshare/resourceShare:ResourceShare", name, state, MakeResourceOptions(options, id))
        {
        }
