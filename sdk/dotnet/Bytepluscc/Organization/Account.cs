...
namespace Byteplus.Pulumi.Bytepluscc.Organization
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:organization/account:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/account:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, AccountState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/account:Account", name, state, MakeResourceOptions(options, id))
        {
        }
