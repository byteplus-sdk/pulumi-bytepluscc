...
namespace Byteplus.Pulumi.Bytepluscc.Organization
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:organization/organization:Organization")]
    public partial class Organization : global::Pulumi.CustomResource
    {
        ...
        public Organization(string name, OrganizationArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/organization:Organization", name, args ?? new OrganizationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Organization(string name, Input<string> id, OrganizationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/organization:Organization", name, state, MakeResourceOptions(options, id))
        {
        }
