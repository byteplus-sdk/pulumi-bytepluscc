...
namespace Byteplus.Pulumi.Bytepluscc.Organization
{
    public static class GetOrganizations
    {
        ...
        public static Task<GetOrganizationsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrganizationsResult>("bytepluscc:organization/getOrganizations:getOrganizations", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::Organization::Organization
        /// </summary>
        public static Output<GetOrganizationsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrganizationsResult>("bytepluscc:organization/getOrganizations:getOrganizations", InvokeArgs.Empty, options.WithDefaults());
