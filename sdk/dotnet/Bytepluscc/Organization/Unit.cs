...
namespace Byteplus.Pulumi.Bytepluscc.Organization
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:organization/unit:Unit")]
    public partial class Unit : global::Pulumi.CustomResource
    {
        ...
        public Unit(string name, UnitArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/unit:Unit", name, args ?? new UnitArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Unit(string name, Input<string> id, UnitState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:organization/unit:Unit", name, state, MakeResourceOptions(options, id))
        {
        }
