...
namespace Byteplus.Pulumi.Bytepluscc.Vmp
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vmp/ruleFile:RuleFile")]
    public partial class RuleFile : global::Pulumi.CustomResource
    {
        ...
        public RuleFile(string name, RuleFileArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vmp/ruleFile:RuleFile", name, args ?? new RuleFileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RuleFile(string name, Input<string> id, RuleFileState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vmp/ruleFile:RuleFile", name, state, MakeResourceOptions(options, id))
        {
        }
