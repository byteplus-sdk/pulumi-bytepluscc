...
namespace Byteplus.Pulumi.Bytepluscc.Vmp
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vmp/alertingRule:AlertingRule")]
    public partial class AlertingRule : global::Pulumi.CustomResource
    {
        ...
        public AlertingRule(string name, AlertingRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vmp/alertingRule:AlertingRule", name, args ?? new AlertingRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertingRule(string name, Input<string> id, AlertingRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vmp/alertingRule:AlertingRule", name, state, MakeResourceOptions(options, id))
        {
        }
