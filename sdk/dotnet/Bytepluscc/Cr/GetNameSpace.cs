...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    public static class GetNameSpace
    {
        ...
        public static Task<GetNameSpaceResult> InvokeAsync(GetNameSpaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNameSpaceResult>("bytepluscc:cr/getNameSpace:getNameSpace", args ?? new GetNameSpaceArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CR::NameSpace
        /// </summary>
        public static Output<GetNameSpaceResult> Invoke(GetNameSpaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNameSpaceResult>("bytepluscc:cr/getNameSpace:getNameSpace", args ?? new GetNameSpaceInvokeArgs(), options.WithDefaults());
