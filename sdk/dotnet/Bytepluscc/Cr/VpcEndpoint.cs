...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cr/vpcEndpoint:VpcEndpoint")]
    public partial class VpcEndpoint : global::Pulumi.CustomResource
    {
        ...
        public VpcEndpoint(string name, VpcEndpointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, args ?? new VpcEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpcEndpoint(string name, Input<string> id, VpcEndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/vpcEndpoint:VpcEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
