...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    public static class GetRepositories
    {
        ...
        public static Task<GetRepositoriesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRepositoriesResult>("bytepluscc:cr/getRepositories:getRepositories", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::CR::Repository
        /// </summary>
        public static Output<GetRepositoriesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRepositoriesResult>("bytepluscc:cr/getRepositories:getRepositories", InvokeArgs.Empty, options.WithDefaults());
