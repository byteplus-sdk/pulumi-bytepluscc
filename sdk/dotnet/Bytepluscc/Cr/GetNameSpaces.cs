...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    public static class GetNameSpaces
    {
        ...
        public static Task<GetNameSpacesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNameSpacesResult>("bytepluscc:cr/getNameSpaces:getNameSpaces", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::CR::NameSpace
        /// </summary>
        public static Output<GetNameSpacesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNameSpacesResult>("bytepluscc:cr/getNameSpaces:getNameSpaces", InvokeArgs.Empty, options.WithDefaults());
