...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cr/nameSpace:NameSpace")]
    public partial class NameSpace : global::Pulumi.CustomResource
    {
        ...
        public NameSpace(string name, NameSpaceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/nameSpace:NameSpace", name, args ?? new NameSpaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NameSpace(string name, Input<string> id, NameSpaceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/nameSpace:NameSpace", name, state, MakeResourceOptions(options, id))
        {
        }
