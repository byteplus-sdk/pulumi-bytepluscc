...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cr/repository:Repository")]
    public partial class Repository : global::Pulumi.CustomResource
    {
        ...
        public Repository(string name, RepositoryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/repository:Repository", name, args ?? new RepositoryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Repository(string name, Input<string> id, RepositoryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/repository:Repository", name, state, MakeResourceOptions(options, id))
        {
        }
