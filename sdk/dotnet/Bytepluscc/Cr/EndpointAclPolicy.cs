...
namespace Byteplus.Pulumi.Bytepluscc.Cr
{
    ...
    /// {
    ///     var cREndpointAclPolicyDemo = new Bytepluscc.Cr.EndpointAclPolicy("CREndpointAclPolicyDemo", new()
    ///     {
    ///         Registry = "xxxxx",
    ///         Type = "Public",
    ///         Entry = "0.0.0.0/0",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy")]
    public partial class EndpointAclPolicy : global::Pulumi.CustomResource
    {
        ...
        public EndpointAclPolicy(string name, EndpointAclPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy", name, args ?? new EndpointAclPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EndpointAclPolicy(string name, Input<string> id, EndpointAclPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cr/endpointAclPolicy:EndpointAclPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
