...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment")]
    public partial class PermissionSetAssignment : global::Pulumi.CustomResource
    {
        ...
        public PermissionSetAssignment(string name, PermissionSetAssignmentArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, args ?? new PermissionSetAssignmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PermissionSetAssignment(string name, Input<string> id, PermissionSetAssignmentState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSetAssignment:PermissionSetAssignment", name, state, MakeResourceOptions(options, id))
        {
        }
