...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudidentity/user:User")]
    public partial class User : global::Pulumi.CustomResource
    {
        ...
        public User(string name, UserArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/user:User", name, args ?? new UserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private User(string name, Input<string> id, UserState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/user:User", name, state, MakeResourceOptions(options, id))
        {
        }
