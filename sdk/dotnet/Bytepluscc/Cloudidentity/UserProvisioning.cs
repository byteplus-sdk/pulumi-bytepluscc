...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudidentity/userProvisioning:UserProvisioning")]
    public partial class UserProvisioning : global::Pulumi.CustomResource
    {
        ...
        public UserProvisioning(string name, UserProvisioningArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, args ?? new UserProvisioningArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserProvisioning(string name, Input<string> id, UserProvisioningState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/userProvisioning:UserProvisioning", name, state, MakeResourceOptions(options, id))
        {
        }
