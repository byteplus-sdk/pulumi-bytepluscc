...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning")]
    public partial class PermissionSetProvisioning : global::Pulumi.CustomResource
    {
        ...
        public PermissionSetProvisioning(string name, PermissionSetProvisioningArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, args ?? new PermissionSetProvisioningArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private PermissionSetProvisioning(string name, Input<string> id, PermissionSetProvisioningState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSetProvisioning:PermissionSetProvisioning", name, state, MakeResourceOptions(options, id))
        {
        }
