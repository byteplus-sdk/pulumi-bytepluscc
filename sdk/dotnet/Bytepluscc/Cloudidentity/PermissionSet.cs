...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    ...
    /// {
    ///     var cloudIdentityPermissionSetDemo = new Bytepluscc.Cloudidentity.PermissionSet("CloudIdentityPermissionSetDemo", new()
    ///     {
    ///         Description = "cc-test",
    ///         Name = "cctest-test",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudidentity/permissionSet:PermissionSet")]
    public partial class PermissionSet : global::Pulumi.CustomResource
    {
        ...
        public PermissionSet(string name, PermissionSetArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, args ?? new PermissionSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PermissionSet(string name, Input<string> id, PermissionSetState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudidentity/permissionSet:PermissionSet", name, state, MakeResourceOptions(options, id))
        {
        }
