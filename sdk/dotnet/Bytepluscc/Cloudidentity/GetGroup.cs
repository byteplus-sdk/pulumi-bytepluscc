...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    public static class GetGroup
    {
        ...
        public static Task<GetGroupResult> InvokeAsync(GetGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGroupResult>("bytepluscc:cloudidentity/getGroup:getGroup", args ?? new GetGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CloudIdentity::Group
        /// </summary>
        public static Output<GetGroupResult> Invoke(GetGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGroupResult>("bytepluscc:cloudidentity/getGroup:getGroup", args ?? new GetGroupInvokeArgs(), options.WithDefaults());
