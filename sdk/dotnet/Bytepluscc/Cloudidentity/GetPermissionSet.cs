...
namespace Byteplus.Pulumi.Bytepluscc.Cloudidentity
{
    public static class GetPermissionSet
    {
        ...
        public static Task<GetPermissionSetResult> InvokeAsync(GetPermissionSetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPermissionSetResult>("bytepluscc:cloudidentity/getPermissionSet:getPermissionSet", args ?? new GetPermissionSetArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CloudIdentity::PermissionSet
        /// </summary>
        public static Output<GetPermissionSetResult> Invoke(GetPermissionSetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPermissionSetResult>("bytepluscc:cloudidentity/getPermissionSet:getPermissionSet", args ?? new GetPermissionSetInvokeArgs(), options.WithDefaults());
