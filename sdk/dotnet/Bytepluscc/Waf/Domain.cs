...
namespace Byteplus.Pulumi.Bytepluscc.Waf
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:waf/domain:Domain")]
    public partial class Domain : global::Pulumi.CustomResource
    {
        ...
        public Domain(string name, DomainArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/domain:Domain", name, args ?? new DomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Domain(string name, Input<string> id, DomainState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/domain:Domain", name, state, MakeResourceOptions(options, id))
        {
        }
