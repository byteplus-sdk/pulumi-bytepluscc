...
namespace Byteplus.Pulumi.Bytepluscc.Waf
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:waf/hostGroup:HostGroup")]
    public partial class HostGroup : global::Pulumi.CustomResource
    {
        ...
        public HostGroup(string name, HostGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/hostGroup:HostGroup", name, args ?? new HostGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HostGroup(string name, Input<string> id, HostGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/hostGroup:HostGroup", name, state, MakeResourceOptions(options, id))
        {
        }
