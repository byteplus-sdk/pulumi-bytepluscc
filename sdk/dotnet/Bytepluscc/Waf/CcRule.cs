...
namespace Byteplus.Pulumi.Bytepluscc.Waf
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:waf/ccRule:CcRule")]
    public partial class CcRule : global::Pulumi.CustomResource
    {
        ...
        public CcRule(string name, CcRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/ccRule:CcRule", name, args ?? new CcRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CcRule(string name, Input<string> id, CcRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:waf/ccRule:CcRule", name, state, MakeResourceOptions(options, id))
        {
        }
