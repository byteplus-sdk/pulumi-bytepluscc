...
namespace Byteplus.Pulumi.Bytepluscc.Waf
{
    public static class GetCcRule
    {
        ...
        public static Task<GetCcRuleResult> InvokeAsync(GetCcRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCcRuleResult>("bytepluscc:waf/getCcRule:getCcRule", args ?? new GetCcRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::WAF::CcRule
        /// </summary>
        public static Output<GetCcRuleResult> Invoke(GetCcRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCcRuleResult>("bytepluscc:waf/getCcRule:getCcRule", args ?? new GetCcRuleInvokeArgs(), options.WithDefaults());
