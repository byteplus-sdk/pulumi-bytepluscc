...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rabbitmq/publicAddress:PublicAddress")]
    public partial class PublicAddress : global::Pulumi.CustomResource
    {
        ...
        public PublicAddress(string name, PublicAddressArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, args ?? new PublicAddressArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicAddress(string name, Input<string> id, PublicAddressState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/publicAddress:PublicAddress", name, state, MakeResourceOptions(options, id))
        {
        }
