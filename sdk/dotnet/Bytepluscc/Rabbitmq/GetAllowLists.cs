...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    public static class GetAllowLists
    {
        ...
        public static Task<GetAllowListsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListsResult>("bytepluscc:rabbitmq/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::RabbitMQ::AllowList
        /// </summary>
        public static Output<GetAllowListsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListsResult>("bytepluscc:rabbitmq/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());
