...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rabbitmq/instancePlugin:InstancePlugin")]
    public partial class InstancePlugin : global::Pulumi.CustomResource
    {
        ...
        public InstancePlugin(string name, InstancePluginArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, args ?? new InstancePluginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstancePlugin(string name, Input<string> id, InstancePluginState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/instancePlugin:InstancePlugin", name, state, MakeResourceOptions(options, id))
        {
        }
