...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    public static class GetAllowList
    {
        ...
        public static Task<GetAllowListResult> InvokeAsync(GetAllowListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListResult>("bytepluscc:rabbitmq/getAllowList:getAllowList", args ?? new GetAllowListArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::RabbitMQ::AllowList
        /// </summary>
        public static Output<GetAllowListResult> Invoke(GetAllowListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListResult>("bytepluscc:rabbitmq/getAllowList:getAllowList", args ?? new GetAllowListInvokeArgs(), options.WithDefaults());
