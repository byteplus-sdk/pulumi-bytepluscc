...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    ...
    ///         {
    ///             new Bytepluscc.Rabbitmq.Inputs.AllowListAssociatedInstanceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rabbitmq/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
