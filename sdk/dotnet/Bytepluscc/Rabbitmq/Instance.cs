...
namespace Byteplus.Pulumi.Bytepluscc.Rabbitmq
{
    ...
    ///         ChargeDetail = new Bytepluscc.Rabbitmq.Inputs.InstanceChargeDetailArgs
    ///         {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Rabbitmq.Inputs.InstanceTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rabbitmq/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rabbitmq/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
