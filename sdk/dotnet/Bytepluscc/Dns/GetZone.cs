...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    public static class GetZone
    {
        ...
        public static Task<GetZoneResult> InvokeAsync(GetZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetZoneResult>("bytepluscc:dns/getZone:getZone", args ?? new GetZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DNS::Zone
        /// </summary>
        public static Output<GetZoneResult> Invoke(GetZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetZoneResult>("bytepluscc:dns/getZone:getZone", args ?? new GetZoneInvokeArgs(), options.WithDefaults());
