...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:dns/backupSchedule:BackupSchedule")]
    public partial class BackupSchedule : global::Pulumi.CustomResource
    {
        ...
        public BackupSchedule(string name, BackupScheduleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/backupSchedule:BackupSchedule", name, args ?? new BackupScheduleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BackupSchedule(string name, Input<string> id, BackupScheduleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/backupSchedule:BackupSchedule", name, state, MakeResourceOptions(options, id))
        {
        }
