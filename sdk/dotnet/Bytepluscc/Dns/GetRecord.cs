...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    public static class GetRecord
    {
        ...
        public static Task<GetRecordResult> InvokeAsync(GetRecordArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRecordResult>("bytepluscc:dns/getRecord:getRecord", args ?? new GetRecordArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DNS::Record
        /// </summary>
        public static Output<GetRecordResult> Invoke(GetRecordInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRecordResult>("bytepluscc:dns/getRecord:getRecord", args ?? new GetRecordInvokeArgs(), options.WithDefaults());
