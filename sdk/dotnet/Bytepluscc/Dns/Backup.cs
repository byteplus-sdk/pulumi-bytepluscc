...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:dns/backup:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/backup:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, BackupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/backup:Backup", name, state, MakeResourceOptions(options, id))
        {
        }
