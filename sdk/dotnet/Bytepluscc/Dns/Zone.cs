...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:dns/zone:Zone")]
    public partial class Zone : global::Pulumi.CustomResource
    {
        ...
        public Zone(string name, ZoneArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/zone:Zone", name, args ?? new ZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Zone(string name, Input<string> id, ZoneState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:dns/zone:Zone", name, state, MakeResourceOptions(options, id))
        {
        }
