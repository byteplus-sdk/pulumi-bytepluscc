...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    public static class GetBackup
    {
        ...
        public static Task<GetBackupResult> InvokeAsync(GetBackupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupResult>("bytepluscc:dns/getBackup:getBackup", args ?? new GetBackupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DNS::Backup
        /// </summary>
        public static Output<GetBackupResult> Invoke(GetBackupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupResult>("bytepluscc:dns/getBackup:getBackup", args ?? new GetBackupInvokeArgs(), options.WithDefaults());
