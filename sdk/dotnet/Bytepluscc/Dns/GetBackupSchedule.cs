...
namespace Byteplus.Pulumi.Bytepluscc.Dns
{
    public static class GetBackupSchedule
    {
        ...
        public static Task<GetBackupScheduleResult> InvokeAsync(GetBackupScheduleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBackupScheduleResult>("bytepluscc:dns/getBackupSchedule:getBackupSchedule", args ?? new GetBackupScheduleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DNS::BackupSchedule
        /// </summary>
        public static Output<GetBackupScheduleResult> Invoke(GetBackupScheduleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBackupScheduleResult>("bytepluscc:dns/getBackupSchedule:getBackupSchedule", args ?? new GetBackupScheduleInvokeArgs(), options.WithDefaults());
