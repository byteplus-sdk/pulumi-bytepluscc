...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession")]
    public partial class TrafficMirrorSession : global::Pulumi.CustomResource
    {
        ...
        public TrafficMirrorSession(string name, TrafficMirrorSessionArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, args ?? new TrafficMirrorSessionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TrafficMirrorSession(string name, Input<string> id, TrafficMirrorSessionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorSession:TrafficMirrorSession", name, state, MakeResourceOptions(options, id))
        {
        }
