...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetTrafficMirrorTarget
    {
        ...
        public static Task<GetTrafficMirrorTargetResult> InvokeAsync(GetTrafficMirrorTargetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficMirrorTargetResult>("bytepluscc:vpc/getTrafficMirrorTarget:getTrafficMirrorTarget", args ?? new GetTrafficMirrorTargetArgs(), options.WithDefaults());
        ...
        public static Output<GetTrafficMirrorTargetResult> Invoke(GetTrafficMirrorTargetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrafficMirrorTargetResult>("bytepluscc:vpc/getTrafficMirrorTarget:getTrafficMirrorTarget", args ?? new GetTrafficMirrorTargetInvokeArgs(), options.WithDefaults());
