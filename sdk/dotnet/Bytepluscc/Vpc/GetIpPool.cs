...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetIpPool
    {
        ...
        public static Task<GetIpPoolResult> InvokeAsync(GetIpPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetIpPoolResult>("bytepluscc:vpc/getIpPool:getIpPool", args ?? new GetIpPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::IpPool
        /// </summary>
        public static Output<GetIpPoolResult> Invoke(GetIpPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetIpPoolResult>("bytepluscc:vpc/getIpPool:getIpPool", args ?? new GetIpPoolInvokeArgs(), options.WithDefaults());
