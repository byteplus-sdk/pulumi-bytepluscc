...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget")]
    public partial class TrafficMirrorTarget : global::Pulumi.CustomResource
    {
        ...
        public TrafficMirrorTarget(string name, TrafficMirrorTargetArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, args ?? new TrafficMirrorTargetArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TrafficMirrorTarget(string name, Input<string> id, TrafficMirrorTargetState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorTarget:TrafficMirrorTarget", name, state, MakeResourceOptions(options, id))
        {
        }
