...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetEni
    {
        ...
        public static Task<GetEniResult> InvokeAsync(GetEniArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEniResult>("bytepluscc:vpc/getEni:getEni", args ?? new GetEniArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::ENI
        /// </summary>
        public static Output<GetEniResult> Invoke(GetEniInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEniResult>("bytepluscc:vpc/getEni:getEni", args ?? new GetEniInvokeArgs(), options.WithDefaults());
