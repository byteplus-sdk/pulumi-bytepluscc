...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// {
    ///     var example = new Bytepluscc.Vpc.IpPool("example", new()
    ///     {
    ///         Isp = "BGP",
    ///         CidrMask = 28,
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.IpPoolTagArgs
    ///             {
    ///                 Key = "k1",
    ///                 Value = "v1",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/ipPool:IpPool")]
    public partial class IpPool : global::Pulumi.CustomResource
    {
        ...
        public IpPool(string name, IpPoolArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipPool:IpPool", name, args ?? new IpPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpPool(string name, Input<string> id, IpPoolState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipPool:IpPool", name, state, MakeResourceOptions(options, id))
        {
        }
