...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetTrafficMirrorSession
    {
        ...
        public static Task<GetTrafficMirrorSessionResult> InvokeAsync(GetTrafficMirrorSessionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTrafficMirrorSessionResult>("bytepluscc:vpc/getTrafficMirrorSession:getTrafficMirrorSession", args ?? new GetTrafficMirrorSessionArgs(), options.WithDefaults());
        ...
        public static Output<GetTrafficMirrorSessionResult> Invoke(GetTrafficMirrorSessionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTrafficMirrorSessionResult>("bytepluscc:vpc/getTrafficMirrorSession:getTrafficMirrorSession", args ?? new GetTrafficMirrorSessionInvokeArgs(), options.WithDefaults());
