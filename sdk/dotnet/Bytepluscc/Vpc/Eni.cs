...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// {
    ///     var eniDemo = new Bytepluscc.Vpc.Eni("EniDemo", new()
    ///     {
    ...
    ///         ProjectName = "default",
    ///         PrimaryIpAddress = new Bytepluscc.Vpc.Inputs.EniPrimaryIpAddressArgs
    ///         {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.EniTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/eni:Eni")]
    public partial class Eni : global::Pulumi.CustomResource
    {
        ...
        public Eni(string name, EniArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/eni:Eni", name, args ?? new EniArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Eni(string name, Input<string> id, EniState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/eni:Eni", name, state, MakeResourceOptions(options, id))
        {
        }
