...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetSubnet
    {
        ...
        public static Task<GetSubnetResult> InvokeAsync(GetSubnetArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSubnetResult>("bytepluscc:vpc/getSubnet:getSubnet", args ?? new GetSubnetArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::Subnet
        /// </summary>
        public static Output<GetSubnetResult> Invoke(GetSubnetInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSubnetResult>("bytepluscc:vpc/getSubnet:getSubnet", args ?? new GetSubnetInvokeArgs(), options.WithDefaults());
