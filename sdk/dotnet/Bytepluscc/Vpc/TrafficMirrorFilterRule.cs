...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/trafficMirrorFilterRule:TrafficMirrorFilterRule")]
    public partial class TrafficMirrorFilterRule : global::Pulumi.CustomResource
    {
        ...
        public TrafficMirrorFilterRule(string name, TrafficMirrorFilterRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorFilterRule:TrafficMirrorFilterRule", name, args ?? new TrafficMirrorFilterRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TrafficMirrorFilterRule(string name, Input<string> id, TrafficMirrorFilterRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/trafficMirrorFilterRule:TrafficMirrorFilterRule", name, state, MakeResourceOptions(options, id))
        {
        }
