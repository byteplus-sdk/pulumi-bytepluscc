...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/eip:Eip")]
    public partial class Eip : global::Pulumi.CustomResource
    {
        ...
        public Eip(string name, EipArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/eip:Eip", name, args ?? new EipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Eip(string name, Input<string> id, EipState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/eip:Eip", name, state, MakeResourceOptions(options, id))
        {
        }
