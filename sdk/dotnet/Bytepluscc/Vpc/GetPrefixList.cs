...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetPrefixList
    {
        ...
        public static Task<GetPrefixListResult> InvokeAsync(GetPrefixListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrefixListResult>("bytepluscc:vpc/getPrefixList:getPrefixList", args ?? new GetPrefixListArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::PrefixList
        /// </summary>
        public static Output<GetPrefixListResult> Invoke(GetPrefixListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrefixListResult>("bytepluscc:vpc/getPrefixList:getPrefixList", args ?? new GetPrefixListInvokeArgs(), options.WithDefaults());
