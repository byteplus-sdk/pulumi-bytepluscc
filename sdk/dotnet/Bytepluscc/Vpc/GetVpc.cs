...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetVpc
    {
        ...
        public static Task<GetVpcResult> InvokeAsync(GetVpcArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpcResult>("bytepluscc:vpc/getVpc:getVpc", args ?? new GetVpcArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::VPC
        /// </summary>
        public static Output<GetVpcResult> Invoke(GetVpcInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpcResult>("bytepluscc:vpc/getVpc:getVpc", args ?? new GetVpcInvokeArgs(), options.WithDefaults());
