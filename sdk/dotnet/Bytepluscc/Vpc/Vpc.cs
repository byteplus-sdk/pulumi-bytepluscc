...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// {
    ///     var vPCDemo = new Bytepluscc.Vpc.Vpc("VPCDemo", new()
    ///     {
    ...
    ///         AssociateCens = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.VpcAssociateCenArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.VpcTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/vpc:Vpc")]
    public partial class Vpc : global::Pulumi.CustomResource
    {
        ...
        public Vpc(string name, VpcArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/vpc:Vpc", name, args ?? new VpcArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Vpc(string name, Input<string> id, VpcState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/vpc:Vpc", name, state, MakeResourceOptions(options, id))
        {
        }
