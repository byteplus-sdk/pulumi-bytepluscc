...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetBandwidthPackage
    {
        ...
        public static Task<GetBandwidthPackageResult> InvokeAsync(GetBandwidthPackageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBandwidthPackageResult>("bytepluscc:vpc/getBandwidthPackage:getBandwidthPackage", args ?? new GetBandwidthPackageArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::BandwidthPackage
        /// </summary>
        public static Output<GetBandwidthPackageResult> Invoke(GetBandwidthPackageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBandwidthPackageResult>("bytepluscc:vpc/getBandwidthPackage:getBandwidthPackage", args ?? new GetBandwidthPackageInvokeArgs(), options.WithDefaults());
