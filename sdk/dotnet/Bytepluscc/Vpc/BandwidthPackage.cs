...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.BandwidthPackageTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    ///         EipAddresses = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.BandwidthPackageEipAddressArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/bandwidthPackage:BandwidthPackage")]
    public partial class BandwidthPackage : global::Pulumi.CustomResource
    {
        ...
        public BandwidthPackage(string name, BandwidthPackageArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/bandwidthPackage:BandwidthPackage", name, args ?? new BandwidthPackageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BandwidthPackage(string name, Input<string> id, BandwidthPackageState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/bandwidthPackage:BandwidthPackage", name, state, MakeResourceOptions(options, id))
        {
        }
