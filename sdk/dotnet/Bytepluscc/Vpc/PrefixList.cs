...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/prefixList:PrefixList")]
    public partial class PrefixList : global::Pulumi.CustomResource
    {
        ...
        public PrefixList(string name, PrefixListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/prefixList:PrefixList", name, args ?? new PrefixListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrefixList(string name, Input<string> id, PrefixListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/prefixList:PrefixList", name, state, MakeResourceOptions(options, id))
        {
        }
