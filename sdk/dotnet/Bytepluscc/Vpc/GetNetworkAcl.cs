...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetNetworkAcl
    {
        ...
        public static Task<GetNetworkAclResult> InvokeAsync(GetNetworkAclArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNetworkAclResult>("bytepluscc:vpc/getNetworkAcl:getNetworkAcl", args ?? new GetNetworkAclArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::NetworkAcl
        /// </summary>
        public static Output<GetNetworkAclResult> Invoke(GetNetworkAclInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNetworkAclResult>("bytepluscc:vpc/getNetworkAcl:getNetworkAcl", args ?? new GetNetworkAclInvokeArgs(), options.WithDefaults());
