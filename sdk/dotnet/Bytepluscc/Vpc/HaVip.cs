...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/haVip:HaVip")]
    public partial class HaVip : global::Pulumi.CustomResource
    {
        ...
        public HaVip(string name, HaVipArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/haVip:HaVip", name, args ?? new HaVipArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HaVip(string name, Input<string> id, HaVipState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/haVip:HaVip", name, state, MakeResourceOptions(options, id))
        {
        }
