...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth")]
    public partial class Ipv6AddressBandwidth : global::Pulumi.CustomResource
    {
        ...
        public Ipv6AddressBandwidth(string name, Ipv6AddressBandwidthArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, args ?? new Ipv6AddressBandwidthArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private Ipv6AddressBandwidth(string name, Input<string> id, Ipv6AddressBandwidthState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipv6AddressBandwidth:Ipv6AddressBandwidth", name, state, MakeResourceOptions(options, id))
        {
        }
