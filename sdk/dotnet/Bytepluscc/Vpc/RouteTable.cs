...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.RouteTableCustomRouteEntryArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpc.Inputs.RouteTableTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/routeTable:RouteTable")]
    public partial class RouteTable : global::Pulumi.CustomResource
    {
        ...
        public RouteTable(string name, RouteTableArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/routeTable:RouteTable", name, args ?? new RouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RouteTable(string name, Input<string> id, RouteTableState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/routeTable:RouteTable", name, state, MakeResourceOptions(options, id))
        {
        }
