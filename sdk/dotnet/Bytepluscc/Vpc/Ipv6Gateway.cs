...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway")]
    public partial class Ipv6Gateway : global::Pulumi.CustomResource
    {
        ...
        public Ipv6Gateway(string name, Ipv6GatewayArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, args ?? new Ipv6GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ipv6Gateway(string name, Input<string> id, Ipv6GatewayState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpc/ipv6Gateway:Ipv6Gateway", name, state, MakeResourceOptions(options, id))
        {
        }
