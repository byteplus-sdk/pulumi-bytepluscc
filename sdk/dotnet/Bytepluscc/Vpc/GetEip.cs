...
namespace Byteplus.Pulumi.Bytepluscc.Vpc
{
    public static class GetEip
    {
        ...
        public static Task<GetEipResult> InvokeAsync(GetEipArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEipResult>("bytepluscc:vpc/getEip:getEip", args ?? new GetEipArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPC::EIP
        /// </summary>
        public static Output<GetEipResult> Invoke(GetEipInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEipResult>("bytepluscc:vpc/getEip:getEip", args ?? new GetEipInvokeArgs(), options.WithDefaults());
