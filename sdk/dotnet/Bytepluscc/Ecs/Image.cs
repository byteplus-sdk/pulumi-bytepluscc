...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/image:Image")]
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/image:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, ImageState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/image:Image", name, state, MakeResourceOptions(options, id))
        {
        }
