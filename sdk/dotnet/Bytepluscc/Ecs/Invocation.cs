...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/invocation:Invocation")]
    public partial class Invocation : global::Pulumi.CustomResource
    {
        ...
        public Invocation(string name, InvocationArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/invocation:Invocation", name, args ?? new InvocationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Invocation(string name, Input<string> id, InvocationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/invocation:Invocation", name, state, MakeResourceOptions(options, id))
        {
        }
