...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/deploymentSet:DeploymentSet")]
    public partial class DeploymentSet : global::Pulumi.CustomResource
    {
        ...
        public DeploymentSet(string name, DeploymentSetArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/deploymentSet:DeploymentSet", name, args ?? new DeploymentSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DeploymentSet(string name, Input<string> id, DeploymentSetState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/deploymentSet:DeploymentSet", name, state, MakeResourceOptions(options, id))
        {
        }
