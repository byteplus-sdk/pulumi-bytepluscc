...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    public static class GetInvocation
    {
        ...
        public static Task<GetInvocationResult> InvokeAsync(GetInvocationArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInvocationResult>("bytepluscc:ecs/getInvocation:getInvocation", args ?? new GetInvocationArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ECS::Invocation
        /// </summary>
        public static Output<GetInvocationResult> Invoke(GetInvocationInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInvocationResult>("bytepluscc:ecs/getInvocation:getInvocation", args ?? new GetInvocationInvokeArgs(), options.WithDefaults());
