...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// {
    ///     var ecsLaunchTemplateVersionDemo = new Bytepluscc.Ecs.LaunchTemplateVersion("EcsLaunchTemplateVersionDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion")]
    public partial class LaunchTemplateVersion : global::Pulumi.CustomResource
    {
        ...
        public LaunchTemplateVersion(string name, LaunchTemplateVersionArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, args ?? new LaunchTemplateVersionArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LaunchTemplateVersion(string name, Input<string> id, LaunchTemplateVersionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/launchTemplateVersion:LaunchTemplateVersion", name, state, MakeResourceOptions(options, id))
        {
        }
