...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/hpcCluster:HpcCluster")]
    public partial class HpcCluster : global::Pulumi.CustomResource
    {
        ...
        public HpcCluster(string name, HpcClusterArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/hpcCluster:HpcCluster", name, args ?? new HpcClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private HpcCluster(string name, Input<string> id, HpcClusterState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/hpcCluster:HpcCluster", name, state, MakeResourceOptions(options, id))
        {
        }
