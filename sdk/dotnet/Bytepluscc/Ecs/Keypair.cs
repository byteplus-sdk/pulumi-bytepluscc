...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/keypair:Keypair")]
    public partial class Keypair : global::Pulumi.CustomResource
    {
        ...
        public Keypair(string name, KeypairArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/keypair:Keypair", name, args ?? new KeypairArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Keypair(string name, Input<string> id, KeypairState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/keypair:Keypair", name, state, MakeResourceOptions(options, id))
        {
        }
