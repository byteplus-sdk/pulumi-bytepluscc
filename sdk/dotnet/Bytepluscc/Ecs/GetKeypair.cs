...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    public static class GetKeypair
    {
        ...
        public static Task<GetKeypairResult> InvokeAsync(GetKeypairArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeypairResult>("bytepluscc:ecs/getKeypair:getKeypair", args ?? new GetKeypairArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ECS::Keypair
        /// </summary>
        public static Output<GetKeypairResult> Invoke(GetKeypairInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeypairResult>("bytepluscc:ecs/getKeypair:getKeypair", args ?? new GetKeypairInvokeArgs(), options.WithDefaults());
