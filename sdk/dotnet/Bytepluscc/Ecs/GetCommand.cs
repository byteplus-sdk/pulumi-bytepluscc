...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    public static class GetCommand
    {
        ...
        public static Task<GetCommandResult> InvokeAsync(GetCommandArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCommandResult>("bytepluscc:ecs/getCommand:getCommand", args ?? new GetCommandArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ECS::Command
        /// </summary>
        public static Output<GetCommandResult> Invoke(GetCommandInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCommandResult>("bytepluscc:ecs/getCommand:getCommand", args ?? new GetCommandInvokeArgs(), options.WithDefaults());
