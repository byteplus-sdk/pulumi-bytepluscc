...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    ///         {
    ///             new Bytepluscc.Ecs.Inputs.CommandParameterDefinitionArgs
    ///             {
    ///                 Type = "Digit",
    ///                 Name = "dirname",
    ///                 Required = true,
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Ecs.Inputs.CommandTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/command:Command")]
    public partial class Command : global::Pulumi.CustomResource
    {
        ...
        public Command(string name, CommandArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/command:Command", name, args ?? new CommandArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Command(string name, Input<string> id, CommandState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/command:Command", name, state, MakeResourceOptions(options, id))
        {
        }
