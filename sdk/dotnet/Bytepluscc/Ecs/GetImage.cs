...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    public static class GetImage
    {
        ...
        public static Task<GetImageResult> InvokeAsync(GetImageArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetImageResult>("bytepluscc:ecs/getImage:getImage", args ?? new GetImageArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ECS::Image
        /// </summary>
        public static Output<GetImageResult> Invoke(GetImageInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetImageResult>("bytepluscc:ecs/getImage:getImage", args ?? new GetImageInvokeArgs(), options.WithDefaults());
