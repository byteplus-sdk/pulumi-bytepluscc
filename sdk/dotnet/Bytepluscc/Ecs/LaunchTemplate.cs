...
namespace Byteplus.Pulumi.Bytepluscc.Ecs
{
    ...
    /// {
    ///     var ecsLaunchTemplateDemo = new Bytepluscc.Ecs.LaunchTemplate("EcsLaunchTemplateDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ecs/launchTemplate:LaunchTemplate")]
    public partial class LaunchTemplate : global::Pulumi.CustomResource
    {
        ...
        public LaunchTemplate(string name, LaunchTemplateArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, args ?? new LaunchTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LaunchTemplate(string name, Input<string> id, LaunchTemplateState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ecs/launchTemplate:LaunchTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
