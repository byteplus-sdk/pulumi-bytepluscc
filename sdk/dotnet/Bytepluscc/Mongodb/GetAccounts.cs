...
namespace Byteplus.Pulumi.Bytepluscc.Mongodb
{
    public static class GetAccounts
    {
        ...
        public static Task<GetAccountsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountsResult>("bytepluscc:mongodb/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::MongoDB::Account
        /// </summary>
        public static Output<GetAccountsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountsResult>("bytepluscc:mongodb/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());
