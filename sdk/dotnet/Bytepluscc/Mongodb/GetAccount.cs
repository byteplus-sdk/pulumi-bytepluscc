...
namespace Byteplus.Pulumi.Bytepluscc.Mongodb
{
    public static class GetAccount
    {
        ...
        public static Task<GetAccountResult> InvokeAsync(GetAccountArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountResult>("bytepluscc:mongodb/getAccount:getAccount", args ?? new GetAccountArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::MongoDB::Account
        /// </summary>
        public static Output<GetAccountResult> Invoke(GetAccountInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountResult>("bytepluscc:mongodb/getAccount:getAccount", args ?? new GetAccountInvokeArgs(), options.WithDefaults());
