...
namespace Byteplus.Pulumi.Bytepluscc.Mongodb
{
    ...
    ///         {
    ///             new Bytepluscc.Mongodb.Inputs.AccountAccountPrivilegeArgs
    ///             {
    ///                 Db_name = "admin",
    ///                 Role_name = "read",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:mongodb/account:Account")]
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:mongodb/account:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, AccountState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:mongodb/account:Account", name, state, MakeResourceOptions(options, id))
        {
        }
