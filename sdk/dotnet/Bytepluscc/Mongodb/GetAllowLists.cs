...
namespace Byteplus.Pulumi.Bytepluscc.Mongodb
{
    public static class GetAllowLists
    {
        ...
        public static Task<GetAllowListsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListsResult>("bytepluscc:mongodb/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::MongoDB::AllowList
        /// </summary>
        public static Output<GetAllowListsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListsResult>("bytepluscc:mongodb/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());
