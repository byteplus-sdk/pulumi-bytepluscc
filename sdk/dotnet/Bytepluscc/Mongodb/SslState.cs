...
namespace Byteplus.Pulumi.Bytepluscc.Mongodb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:mongodb/sslState:SslState")]
    public partial class SslState : global::Pulumi.CustomResource
    {
        ...
        public SslState(string name, SslStateArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:mongodb/sslState:SslState", name, args ?? new SslStateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslState(string name, Input<string> id, SslStateState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:mongodb/sslState:SslState", name, state, MakeResourceOptions(options, id))
        {
        }
