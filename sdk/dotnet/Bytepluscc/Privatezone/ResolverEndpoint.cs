...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint")]
    public partial class ResolverEndpoint : global::Pulumi.CustomResource
    {
        ...
        public ResolverEndpoint(string name, ResolverEndpointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, args ?? new ResolverEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResolverEndpoint(string name, Input<string> id, ResolverEndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/resolverEndpoint:ResolverEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
