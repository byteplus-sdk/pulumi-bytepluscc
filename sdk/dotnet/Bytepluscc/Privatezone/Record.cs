...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatezone/record:Record")]
    public partial class Record : global::Pulumi.CustomResource
    {
        ...
        public Record(string name, RecordArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/record:Record", name, args ?? new RecordArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Record(string name, Input<string> id, RecordState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/record:Record", name, state, MakeResourceOptions(options, id))
        {
        }
