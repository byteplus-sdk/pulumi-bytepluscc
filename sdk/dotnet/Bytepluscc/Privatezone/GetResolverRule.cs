...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    public static class GetResolverRule
    {
        ...
        public static Task<GetResolverRuleResult> InvokeAsync(GetResolverRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetResolverRuleResult>("bytepluscc:privatezone/getResolverRule:getResolverRule", args ?? new GetResolverRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::PrivateZone::ResolverRule
        /// </summary>
        public static Output<GetResolverRuleResult> Invoke(GetResolverRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetResolverRuleResult>("bytepluscc:privatezone/getResolverRule:getResolverRule", args ?? new GetResolverRuleInvokeArgs(), options.WithDefaults());
