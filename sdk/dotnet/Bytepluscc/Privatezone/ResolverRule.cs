...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatezone/resolverRule:ResolverRule")]
    public partial class ResolverRule : global::Pulumi.CustomResource
    {
        ...
        public ResolverRule(string name, ResolverRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/resolverRule:ResolverRule", name, args ?? new ResolverRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResolverRule(string name, Input<string> id, ResolverRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/resolverRule:ResolverRule", name, state, MakeResourceOptions(options, id))
        {
        }
