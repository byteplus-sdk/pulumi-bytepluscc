...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    public static class GetPrivateZone
    {
        ...
        public static Task<GetPrivateZoneResult> InvokeAsync(GetPrivateZoneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPrivateZoneResult>("bytepluscc:privatezone/getPrivateZone:getPrivateZone", args ?? new GetPrivateZoneArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::PrivateZone::PrivateZone
        /// </summary>
        public static Output<GetPrivateZoneResult> Invoke(GetPrivateZoneInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPrivateZoneResult>("bytepluscc:privatezone/getPrivateZone:getPrivateZone", args ?? new GetPrivateZoneInvokeArgs(), options.WithDefaults());
