...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    /// <summary>
    ...
    /// {
    ///     var privateZoneDemo = new Bytepluscc.Privatezone.PrivateZone("PrivateZoneDemo", new()
    ///     {
    ///         ZoneName = "new.example.com",
    ///         Vpcs = new[]
    ///         {
    ///             new Bytepluscc.Privatezone.Inputs.PrivateZoneVpcArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Privatezone.Inputs.PrivateZoneTagArgs
    ///             {
    ///                 Value = "test",
    ///                 Key = "env",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatezone/privateZone:PrivateZone")]
    public partial class PrivateZone : global::Pulumi.CustomResource
    {
        ...
        public PrivateZone(string name, PrivateZoneArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/privateZone:PrivateZone", name, args ?? new PrivateZoneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PrivateZone(string name, Input<string> id, PrivateZoneState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/privateZone:PrivateZone", name, state, MakeResourceOptions(options, id))
        {
        }
