...
namespace Byteplus.Pulumi.Bytepluscc.Privatezone
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization")]
    public partial class UserVpcAuthorization : global::Pulumi.CustomResource
    {
        ...
        public UserVpcAuthorization(string name, UserVpcAuthorizationArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, args ?? new UserVpcAuthorizationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private UserVpcAuthorization(string name, Input<string> id, UserVpcAuthorizationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatezone/userVpcAuthorization:UserVpcAuthorization", name, state, MakeResourceOptions(options, id))
        {
        }
