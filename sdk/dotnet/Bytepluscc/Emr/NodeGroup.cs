...
namespace Byteplus.Pulumi.Bytepluscc.Emr
{
    ...
    /// {
    ///     var eMRNodeGroupDemo = new Bytepluscc.Emr.NodeGroup("EMRNodeGroupDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:emr/nodeGroup:NodeGroup")]
    public partial class NodeGroup : global::Pulumi.CustomResource
    {
        ...
        public NodeGroup(string name, NodeGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/nodeGroup:NodeGroup", name, args ?? new NodeGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodeGroup(string name, Input<string> id, NodeGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/nodeGroup:NodeGroup", name, state, MakeResourceOptions(options, id))
        {
        }
