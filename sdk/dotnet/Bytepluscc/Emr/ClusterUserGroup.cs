...
namespace Byteplus.Pulumi.Bytepluscc.Emr
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:emr/clusterUserGroup:ClusterUserGroup")]
    public partial class ClusterUserGroup : global::Pulumi.CustomResource
    {
        ...
        public ClusterUserGroup(string name, ClusterUserGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/clusterUserGroup:ClusterUserGroup", name, args ?? new ClusterUserGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterUserGroup(string name, Input<string> id, ClusterUserGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/clusterUserGroup:ClusterUserGroup", name, state, MakeResourceOptions(options, id))
        {
        }
