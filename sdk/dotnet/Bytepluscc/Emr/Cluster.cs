...
namespace Byteplus.Pulumi.Bytepluscc.Emr
{
    ...
    /// {
    ///     var eMRClusterDemo = new Bytepluscc.Emr.Cluster("EMRClusterDemo", new()
    ///     {
    ///         ProjectName = "default",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:emr/cluster:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/cluster:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, ClusterState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/cluster:Cluster", name, state, MakeResourceOptions(options, id))
        {
        }
