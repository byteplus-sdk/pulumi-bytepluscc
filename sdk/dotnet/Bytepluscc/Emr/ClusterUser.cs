...
namespace Byteplus.Pulumi.Bytepluscc.Emr
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:emr/clusterUser:ClusterUser")]
    public partial class ClusterUser : global::Pulumi.CustomResource
    {
        ...
        public ClusterUser(string name, ClusterUserArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/clusterUser:ClusterUser", name, args ?? new ClusterUserArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ClusterUser(string name, Input<string> id, ClusterUserState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:emr/clusterUser:ClusterUser", name, state, MakeResourceOptions(options, id))
        {
        }
