...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:alb/customizedCfg:CustomizedCfg")]
    public partial class CustomizedCfg : global::Pulumi.CustomResource
    {
        ...
        public CustomizedCfg(string name, CustomizedCfgArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/customizedCfg:CustomizedCfg", name, args ?? new CustomizedCfgArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomizedCfg(string name, Input<string> id, CustomizedCfgState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/customizedCfg:CustomizedCfg", name, state, MakeResourceOptions(options, id))
        {
        }
