...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    public static class GetServerGroup
    {
        ...
        public static Task<GetServerGroupResult> InvokeAsync(GetServerGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetServerGroupResult>("bytepluscc:alb/getServerGroup:getServerGroup", args ?? new GetServerGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ALB::ServerGroup
        /// </summary>
        public static Output<GetServerGroupResult> Invoke(GetServerGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetServerGroupResult>("bytepluscc:alb/getServerGroup:getServerGroup", args ?? new GetServerGroupInvokeArgs(), options.WithDefaults());
