...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate")]
    public partial class HealthCheckTemplate : global::Pulumi.CustomResource
    {
        ...
        public HealthCheckTemplate(string name, HealthCheckTemplateArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, args ?? new HealthCheckTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private HealthCheckTemplate(string name, Input<string> id, HealthCheckTemplateState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/healthCheckTemplate:HealthCheckTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
