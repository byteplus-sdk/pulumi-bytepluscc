...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    ...
    /// {
    ///     var albServergroupDemo = new Bytepluscc.Alb.ServerGroup("AlbServergroupDemo", new()
    ///     {
    ///         VpcId = "vpc-13f8***",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:alb/serverGroup:ServerGroup")]
    public partial class ServerGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerGroup(string name, ServerGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/serverGroup:ServerGroup", name, args ?? new ServerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroup(string name, Input<string> id, ServerGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/serverGroup:ServerGroup", name, state, MakeResourceOptions(options, id))
        {
        }
