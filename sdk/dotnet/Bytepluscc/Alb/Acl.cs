...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:alb/acl:Acl")]
    public partial class Acl : global::Pulumi.CustomResource
    {
        ...
        public Acl(string name, AclArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/acl:Acl", name, args ?? new AclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Acl(string name, Input<string> id, AclState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/acl:Acl", name, state, MakeResourceOptions(options, id))
        {
        }
