...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:alb/listener:Listener")]
    public partial class Listener : global::Pulumi.CustomResource
    {
        ...
        public Listener(string name, ListenerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/listener:Listener", name, args ?? new ListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Listener(string name, Input<string> id, ListenerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:alb/listener:Listener", name, state, MakeResourceOptions(options, id))
        {
        }
