...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    public static class GetAcl
    {
        ...
        public static Task<GetAclResult> InvokeAsync(GetAclArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAclResult>("bytepluscc:alb/getAcl:getAcl", args ?? new GetAclArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ALB::ACL
        /// </summary>
        public static Output<GetAclResult> Invoke(GetAclInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAclResult>("bytepluscc:alb/getAcl:getAcl", args ?? new GetAclInvokeArgs(), options.WithDefaults());
