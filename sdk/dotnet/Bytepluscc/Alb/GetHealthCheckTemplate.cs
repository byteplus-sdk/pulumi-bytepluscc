...
namespace Byteplus.Pulumi.Bytepluscc.Alb
{
    public static class GetHealthCheckTemplate
    {
        ...
        public static Task<GetHealthCheckTemplateResult> InvokeAsync(GetHealthCheckTemplateArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHealthCheckTemplateResult>("bytepluscc:alb/getHealthCheckTemplate:getHealthCheckTemplate", args ?? new GetHealthCheckTemplateArgs(), options.WithDefaults());
        ...
        public static Output<GetHealthCheckTemplateResult> Invoke(GetHealthCheckTemplateInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHealthCheckTemplateResult>("bytepluscc:alb/getHealthCheckTemplate:getHealthCheckTemplate", args ?? new GetHealthCheckTemplateInvokeArgs(), options.WithDefaults());
