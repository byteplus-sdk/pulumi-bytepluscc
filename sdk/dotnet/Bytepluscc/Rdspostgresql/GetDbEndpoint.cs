...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    public static class GetDbEndpoint
    {
        ...
        public static Task<GetDbEndpointResult> InvokeAsync(GetDbEndpointArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDbEndpointResult>("bytepluscc:rdspostgresql/getDbEndpoint:getDbEndpoint", args ?? new GetDbEndpointArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::RDSPostgreSQL::DBEndpoint
        /// </summary>
        public static Output<GetDbEndpointResult> Invoke(GetDbEndpointInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDbEndpointResult>("bytepluscc:rdspostgresql/getDbEndpoint:getDbEndpoint", args ?? new GetDbEndpointInvokeArgs(), options.WithDefaults());
