...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/dbAccount:DbAccount")]
    public partial class DbAccount : global::Pulumi.CustomResource
    {
        ...
        public DbAccount(string name, DbAccountArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/dbAccount:DbAccount", name, args ?? new DbAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DbAccount(string name, Input<string> id, DbAccountState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/dbAccount:DbAccount", name, state, MakeResourceOptions(options, id))
        {
        }
