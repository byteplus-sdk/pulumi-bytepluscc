...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    ///         {
    ///             new Bytepluscc.Rdspostgresql.Inputs.AllowListAssociatedInstanceArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
