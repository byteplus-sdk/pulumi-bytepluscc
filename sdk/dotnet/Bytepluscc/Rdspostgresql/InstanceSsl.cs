...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl")]
    public partial class InstanceSsl : global::Pulumi.CustomResource
    {
        ...
        public InstanceSsl(string name, InstanceSslArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, args ?? new InstanceSslArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InstanceSsl(string name, Input<string> id, InstanceSslState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/instanceSsl:InstanceSsl", name, state, MakeResourceOptions(options, id))
        {
        }
