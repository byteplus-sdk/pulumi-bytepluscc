...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint")]
    public partial class DbEndpoint : global::Pulumi.CustomResource
    {
        ...
        public DbEndpoint(string name, DbEndpointArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint", name, args ?? new DbEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DbEndpoint(string name, Input<string> id, DbEndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/dbEndpoint:DbEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
