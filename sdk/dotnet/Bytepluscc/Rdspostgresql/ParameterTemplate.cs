...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate")]
    public partial class ParameterTemplate : global::Pulumi.CustomResource
    {
        ...
        public ParameterTemplate(string name, ParameterTemplateArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate", name, args ?? new ParameterTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ParameterTemplate(string name, Input<string> id, ParameterTemplateState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/parameterTemplate:ParameterTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
