...
namespace Byteplus.Pulumi.Bytepluscc.Rdspostgresql
{
    ...
    ///         BackupMetas = new[]
    ///         {
    ///             new Bytepluscc.Rdspostgresql.Inputs.BackupBackupMetaArgs
    ///             {
    ///                 Db_name = "test_db",
    ///             },
    ///         },
    ///         BackupDescription = "逻辑增量库级备份并下载测试",
    ///         BackupPolicy = new Bytepluscc.Rdspostgresql.Inputs.BackupBackupPolicyArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdspostgresql/backup:Backup")]
    public partial class Backup : global::Pulumi.CustomResource
    {
        ...
        public Backup(string name, BackupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/backup:Backup", name, args ?? new BackupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Backup(string name, Input<string> id, BackupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdspostgresql/backup:Backup", name, state, MakeResourceOptions(options, id))
        {
        }
