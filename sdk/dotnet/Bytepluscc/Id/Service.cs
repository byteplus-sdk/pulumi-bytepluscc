...
namespace Byteplus.Pulumi.Bytepluscc.Id
{
    ...
    /// {
    ///     var iDServiceDemo = new Bytepluscc.Id.Service("IDServiceDemo", new()
    ///     {
    ///         PermissionSpaceId = "fd46c764-e94e-4c94-ba69-6bfxxxxxxxx",
    ///         Backend = new Bytepluscc.Id.Inputs.ServiceBackendArgs
    ///         {
    ///             Timeout_seconds = 60,
    ///             Enable_tls = false,
    ///             Backend_port = 80,
    ...
    ///         Routes = new[]
    ///         {
    ///             new Bytepluscc.Id.Inputs.ServiceRouteArgs
    ///             {
    ///                 Path = "/api/v1/orders",
    ///                 Priority = 20,
    ///                 Api_spec =
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Id.Inputs.ServiceTagArgs
    ///             {
    ///                 Value = "env",
    ///                 Key = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:id/service:Service")]
    public partial class Service : global::Pulumi.CustomResource
    {
        ...
        public Service(string name, ServiceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:id/service:Service", name, args ?? new ServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Service(string name, Input<string> id, ServiceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:id/service:Service", name, state, MakeResourceOptions(options, id))
        {
        }
