...
namespace Byteplus.Pulumi.Bytepluscc.Id
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:id/authConfig:AuthConfig")]
    public partial class AuthConfig : global::Pulumi.CustomResource
    {
        ...
        public AuthConfig(string name, AuthConfigArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:id/authConfig:AuthConfig", name, args ?? new AuthConfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AuthConfig(string name, Input<string> id, AuthConfigState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:id/authConfig:AuthConfig", name, state, MakeResourceOptions(options, id))
        {
        }
