...
namespace Byteplus.Pulumi.Bytepluscc.Id
{
    public static class GetUserPool
    {
        ...
        public static Task<GetUserPoolResult> InvokeAsync(GetUserPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUserPoolResult>("bytepluscc:id/getUserPool:getUserPool", args ?? new GetUserPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ID::UserPool
        /// </summary>
        public static Output<GetUserPoolResult> Invoke(GetUserPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUserPoolResult>("bytepluscc:id/getUserPool:getUserPool", args ?? new GetUserPoolInvokeArgs(), options.WithDefaults());
