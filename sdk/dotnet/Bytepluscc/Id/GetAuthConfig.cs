...
namespace Byteplus.Pulumi.Bytepluscc.Id
{
    public static class GetAuthConfig
    {
        ...
        public static Task<GetAuthConfigResult> InvokeAsync(GetAuthConfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAuthConfigResult>("bytepluscc:id/getAuthConfig:getAuthConfig", args ?? new GetAuthConfigArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::ID::AuthConfig
        /// </summary>
        public static Output<GetAuthConfigResult> Invoke(GetAuthConfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAuthConfigResult>("bytepluscc:id/getAuthConfig:getAuthConfig", args ?? new GetAuthConfigInvokeArgs(), options.WithDefaults());
