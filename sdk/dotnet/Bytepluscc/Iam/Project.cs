...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:iam/project:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/project:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, ProjectState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/project:Project", name, state, MakeResourceOptions(options, id))
        {
        }
