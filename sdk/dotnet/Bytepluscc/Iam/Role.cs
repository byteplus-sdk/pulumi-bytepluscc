...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    ...
    ///         Policies = new[]
    ///         {
    ///             new Bytepluscc.Iam.Inputs.RolePolicyArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:iam/role:Role")]
    public partial class Role : global::Pulumi.CustomResource
    {
        ...
        public Role(string name, RoleArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/role:Role", name, args ?? new RoleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Role(string name, Input<string> id, RoleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/role:Role", name, state, MakeResourceOptions(options, id))
        {
        }
