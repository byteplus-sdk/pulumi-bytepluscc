...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    public static class GetSamlProvider
    {
        ...
        public static Task<GetSamlProviderResult> InvokeAsync(GetSamlProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSamlProviderResult>("bytepluscc:iam/getSamlProvider:getSamlProvider", args ?? new GetSamlProviderArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::IAM::SamlProvider
        /// </summary>
        public static Output<GetSamlProviderResult> Invoke(GetSamlProviderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSamlProviderResult>("bytepluscc:iam/getSamlProvider:getSamlProvider", args ?? new GetSamlProviderInvokeArgs(), options.WithDefaults());
