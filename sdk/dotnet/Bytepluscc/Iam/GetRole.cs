...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    public static class GetRole
    {
        ...
        public static Task<GetRoleResult> InvokeAsync(GetRoleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRoleResult>("bytepluscc:iam/getRole:getRole", args ?? new GetRoleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::IAM::Role
        /// </summary>
        public static Output<GetRoleResult> Invoke(GetRoleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRoleResult>("bytepluscc:iam/getRole:getRole", args ?? new GetRoleInvokeArgs(), options.WithDefaults());
