...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    public static class GetOidcProvider
    {
        ...
        public static Task<GetOidcProviderResult> InvokeAsync(GetOidcProviderArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOidcProviderResult>("bytepluscc:iam/getOidcProvider:getOidcProvider", args ?? new GetOidcProviderArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::IAM::OidcProvider
        /// </summary>
        public static Output<GetOidcProviderResult> Invoke(GetOidcProviderInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOidcProviderResult>("bytepluscc:iam/getOidcProvider:getOidcProvider", args ?? new GetOidcProviderInvokeArgs(), options.WithDefaults());
