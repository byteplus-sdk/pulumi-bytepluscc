...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    ...
    /// {
    ///     var iAMOidcProviderDemo = new Bytepluscc.Iam.OidcProvider("IAMOidcProviderDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:iam/oidcProvider:OidcProvider")]
    public partial class OidcProvider : global::Pulumi.CustomResource
    {
        ...
        public OidcProvider(string name, OidcProviderArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/oidcProvider:OidcProvider", name, args ?? new OidcProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private OidcProvider(string name, Input<string> id, OidcProviderState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/oidcProvider:OidcProvider", name, state, MakeResourceOptions(options, id))
        {
        }
