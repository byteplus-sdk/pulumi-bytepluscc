...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:iam/accesskey:Accesskey")]
    public partial class Accesskey : global::Pulumi.CustomResource
    {
        ...
        public Accesskey(string name, AccesskeyArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/accesskey:Accesskey", name, args ?? new AccesskeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Accesskey(string name, Input<string> id, AccesskeyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/accesskey:Accesskey", name, state, MakeResourceOptions(options, id))
        {
        }
