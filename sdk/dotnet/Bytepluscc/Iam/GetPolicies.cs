...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    public static class GetPolicies
    {
        ...
        public static Task<GetPoliciesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoliciesResult>("bytepluscc:iam/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::IAM::Policy
        /// </summary>
        public static Output<GetPoliciesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoliciesResult>("bytepluscc:iam/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());
