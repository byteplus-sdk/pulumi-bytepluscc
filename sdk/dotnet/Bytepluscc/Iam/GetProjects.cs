...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    public static class GetProjects
    {
        ...
        public static Task<GetProjectsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetProjectsResult>("bytepluscc:iam/getProjects:getProjects", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::IAM::Project
        /// </summary>
        public static Output<GetProjectsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetProjectsResult>("bytepluscc:iam/getProjects:getProjects", InvokeArgs.Empty, options.WithDefaults());
