...
namespace Byteplus.Pulumi.Bytepluscc.Iam
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:iam/samlProvider:SamlProvider")]
    public partial class SamlProvider : global::Pulumi.CustomResource
    {
        ...
        public SamlProvider(string name, SamlProviderArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/samlProvider:SamlProvider", name, args ?? new SamlProviderArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SamlProvider(string name, Input<string> id, SamlProviderState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:iam/samlProvider:SamlProvider", name, state, MakeResourceOptions(options, id))
        {
        }
