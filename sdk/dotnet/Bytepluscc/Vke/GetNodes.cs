...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    public static class GetNodes
    {
        ...
        public static Task<GetNodesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNodesResult>("bytepluscc:vke/getNodes:getNodes", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::VKE::Node
        /// </summary>
        public static Output<GetNodesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNodesResult>("bytepluscc:vke/getNodes:getNodes", InvokeArgs.Empty, options.WithDefaults());
