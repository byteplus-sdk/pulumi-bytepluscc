...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// {
    ///     var vKEClusterDemo = new Bytepluscc.Vke.Cluster("VKEClusterDemo", new()
    ///     {
    ///         ProjectName = "default",
    ///         Name = "VKEClusterDemo",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/cluster:Cluster")]
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Cluster(string name, ClusterArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/cluster:Cluster", name, args ?? new ClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Cluster(string name, Input<string> id, ClusterState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/cluster:Cluster", name, state, MakeResourceOptions(options, id))
        {
        }
