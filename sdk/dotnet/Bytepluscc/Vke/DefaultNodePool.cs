...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// {
    ///     var vkeDefaultNodePoolDemo = new Bytepluscc.Vke.DefaultNodePool("VkeDefaultNodePoolDemo", new()
    ///     {
    ///         ClusterId = "cd60pbhxxxxxxc4f31a0",
    ///         KubernetesConfig = new Bytepluscc.Vke.Inputs.DefaultNodePoolKubernetesConfigArgs
    ///         {
    ///             Auto_sync_disabled = false,
    ///             Cordon = false,
    ///             Labels = new[]
    ///             {
    ///                 new Bytepluscc.Vke.Inputs.DefaultNodePoolKubernetesConfigLabelArgs
    ///                 {
    ///                     Key = "env",
    ///                     Value = "test",
    ///                 },
    ...
    ///             Taints = new[]
    ///             {
    ///                 new Bytepluscc.Vke.Inputs.DefaultNodePoolKubernetesConfigTaintArgs
    ///                 {
    ///                     Key = "taint-key",
    ///                     Value = "taint-value",
    ///                     Effect = "NoSchedule",
    ...
    ///             },
    ///         },
    ///         NodeConfig = new Bytepluscc.Vke.Inputs.DefaultNodePoolNodeConfigArgs
    ///         {
    ///             Initialize_script = "YmFzaCBteV9maWxlLnNo",
    ///             Name_prefix = "name-prefix",
    ///             Security = new Bytepluscc.Vke.Inputs.DefaultNodePoolNodeConfigSecurityArgs
    ///             {
    ///                 Login = new Bytepluscc.Vke.Inputs.DefaultNodePoolNodeConfigSecurityLoginArgs
    ///                 {
    ...
    ///             Tags = new[]
    ///             {
    ///                 new Bytepluscc.Vke.Inputs.DefaultNodePoolNodeConfigTagArgs
    ///                 {
    ///                     Key = "env",
    ///                     Value = "test",
    ///                 },
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vke.Inputs.DefaultNodePoolTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/defaultNodePool:DefaultNodePool")]
    public partial class DefaultNodePool : global::Pulumi.CustomResource
    {
        ...
        public DefaultNodePool(string name, DefaultNodePoolArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, args ?? new DefaultNodePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DefaultNodePool(string name, Input<string> id, DefaultNodePoolState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/defaultNodePool:DefaultNodePool", name, state, MakeResourceOptions(options, id))
        {
        }
