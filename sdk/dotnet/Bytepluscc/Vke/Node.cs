...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/node:Node")]
    public partial class Node : global::Pulumi.CustomResource
    {
        ...
        public Node(string name, NodeArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/node:Node", name, args ?? new NodeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Node(string name, Input<string> id, NodeState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/node:Node", name, state, MakeResourceOptions(options, id))
        {
        }
