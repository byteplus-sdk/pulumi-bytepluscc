...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    public static class GetKubeconfig
    {
        ...
        public static Task<GetKubeconfigResult> InvokeAsync(GetKubeconfigArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKubeconfigResult>("bytepluscc:vke/getKubeconfig:getKubeconfig", args ?? new GetKubeconfigArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VKE::Kubeconfig
        /// </summary>
        public static Output<GetKubeconfigResult> Invoke(GetKubeconfigInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKubeconfigResult>("bytepluscc:vke/getKubeconfig:getKubeconfig", args ?? new GetKubeconfigInvokeArgs(), options.WithDefaults());
