...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// {
    ///     var vKENodePoolDemo = new Bytepluscc.Vke.NodePool("VKENodePoolDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/nodePool:NodePool")]
    public partial class NodePool : global::Pulumi.CustomResource
    {
        ...
        public NodePool(string name, NodePoolArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/nodePool:NodePool", name, args ?? new NodePoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NodePool(string name, Input<string> id, NodePoolState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/nodePool:NodePool", name, state, MakeResourceOptions(options, id))
        {
        }
