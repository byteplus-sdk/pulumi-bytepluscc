...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    public static class GetAddon
    {
        ...
        public static Task<GetAddonResult> InvokeAsync(GetAddonArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddonResult>("bytepluscc:vke/getAddon:getAddon", args ?? new GetAddonArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VKE::Addon
        /// </summary>
        public static Output<GetAddonResult> Invoke(GetAddonInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddonResult>("bytepluscc:vke/getAddon:getAddon", args ?? new GetAddonInvokeArgs(), options.WithDefaults());
