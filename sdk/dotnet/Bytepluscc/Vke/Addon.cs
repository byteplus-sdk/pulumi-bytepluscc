...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/addon:Addon")]
    public partial class Addon : global::Pulumi.CustomResource
    {
        ...
        public Addon(string name, AddonArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/addon:Addon", name, args ?? new AddonArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Addon(string name, Input<string> id, AddonState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/addon:Addon", name, state, MakeResourceOptions(options, id))
        {
        }
