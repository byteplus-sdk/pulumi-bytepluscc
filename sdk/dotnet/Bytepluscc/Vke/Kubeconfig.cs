...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/kubeconfig:Kubeconfig")]
    public partial class Kubeconfig : global::Pulumi.CustomResource
    {
        ...
        public Kubeconfig(string name, KubeconfigArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/kubeconfig:Kubeconfig", name, args ?? new KubeconfigArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Kubeconfig(string name, Input<string> id, KubeconfigState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/kubeconfig:Kubeconfig", name, state, MakeResourceOptions(options, id))
        {
        }
