...
namespace Byteplus.Pulumi.Bytepluscc.Vke
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vke/permission:Permission")]
    public partial class Permission : global::Pulumi.CustomResource
    {
        ...
        public Permission(string name, PermissionArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/permission:Permission", name, args ?? new PermissionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Permission(string name, Input<string> id, PermissionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vke/permission:Permission", name, state, MakeResourceOptions(options, id))
        {
        }
