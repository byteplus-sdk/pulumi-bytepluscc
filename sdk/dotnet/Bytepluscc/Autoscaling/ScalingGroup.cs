...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    ...
    /// {
    ///     var autoScalingScalingGroupDemo = new Bytepluscc.Autoscaling.ScalingGroup("AutoScalingScalingGroupDemo", new()
    ///     {
    ///         HealthCheckType = "ECS",
    ///         ScalingMode = "release",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:autoscaling/scalingGroup:ScalingGroup")]
    public partial class ScalingGroup : global::Pulumi.CustomResource
    {
        ...
        public ScalingGroup(string name, ScalingGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingGroup:ScalingGroup", name, args ?? new ScalingGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingGroup(string name, Input<string> id, ScalingGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingGroup:ScalingGroup", name, state, MakeResourceOptions(options, id))
        {
        }
