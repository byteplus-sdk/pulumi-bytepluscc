...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    ...
    ///         },
    ///         Eip = new Bytepluscc.Autoscaling.Inputs.ScalingConfigurationEipArgs
    ///         {
    ///             Bandwidth = 1,
    ...
    ///         {
    ///             new Bytepluscc.Autoscaling.Inputs.ScalingConfigurationInstanceTypeOverrideArgs
    ///             {
    ...
    ///         Volumes = new[]
    ///         {
    ///             new Bytepluscc.Autoscaling.Inputs.ScalingConfigurationVolumeArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Autoscaling.Inputs.ScalingConfigurationTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration")]
    public partial class ScalingConfiguration : global::Pulumi.CustomResource
    {
        ...
        public ScalingConfiguration(string name, ScalingConfigurationArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, args ?? new ScalingConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ScalingConfiguration(string name, Input<string> id, ScalingConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingConfiguration:ScalingConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
