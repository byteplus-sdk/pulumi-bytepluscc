...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook")]
    public partial class ScalingLifecycleHook : global::Pulumi.CustomResource
    {
        ...
        public ScalingLifecycleHook(string name, ScalingLifecycleHookArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, args ?? new ScalingLifecycleHookArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ScalingLifecycleHook(string name, Input<string> id, ScalingLifecycleHookState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingLifecycleHook:ScalingLifecycleHook", name, state, MakeResourceOptions(options, id))
        {
        }
