...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    public static class GetScalingPolicy
    {
        ...
        public static Task<GetScalingPolicyResult> InvokeAsync(GetScalingPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingPolicyResult>("bytepluscc:autoscaling/getScalingPolicy:getScalingPolicy", args ?? new GetScalingPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::AutoScaling::ScalingPolicy
        /// </summary>
        public static Output<GetScalingPolicyResult> Invoke(GetScalingPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScalingPolicyResult>("bytepluscc:autoscaling/getScalingPolicy:getScalingPolicy", args ?? new GetScalingPolicyInvokeArgs(), options.WithDefaults());
