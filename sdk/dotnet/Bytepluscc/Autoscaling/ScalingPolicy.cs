...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    ...
    /// {
    ///     var autoScalingScalingPolicyDemo = new Bytepluscc.Autoscaling.ScalingPolicy("AutoScalingScalingPolicyDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:autoscaling/scalingPolicy:ScalingPolicy")]
    public partial class ScalingPolicy : global::Pulumi.CustomResource
    {
        ...
        public ScalingPolicy(string name, ScalingPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingPolicy:ScalingPolicy", name, args ?? new ScalingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScalingPolicy(string name, Input<string> id, ScalingPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/scalingPolicy:ScalingPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
