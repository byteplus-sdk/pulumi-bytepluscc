...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration")]
    public partial class NotificationConfiguration : global::Pulumi.CustomResource
    {
        ...
        public NotificationConfiguration(string name, NotificationConfigurationArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, args ?? new NotificationConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NotificationConfiguration(string name, Input<string> id, NotificationConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:autoscaling/notificationConfiguration:NotificationConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
