...
namespace Byteplus.Pulumi.Bytepluscc.Autoscaling
{
    public static class GetScalingGroup
    {
        ...
        public static Task<GetScalingGroupResult> InvokeAsync(GetScalingGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScalingGroupResult>("bytepluscc:autoscaling/getScalingGroup:getScalingGroup", args ?? new GetScalingGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::AutoScaling::ScalingGroup
        /// </summary>
        public static Output<GetScalingGroupResult> Invoke(GetScalingGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScalingGroupResult>("bytepluscc:autoscaling/getScalingGroup:getScalingGroup", args ?? new GetScalingGroupInvokeArgs(), options.WithDefaults());
