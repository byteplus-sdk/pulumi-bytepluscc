...
namespace Byteplus.Pulumi.Bytepluscc.Filenas
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:filenas/snapshot:Snapshot")]
    public partial class Snapshot : global::Pulumi.CustomResource
    {
        ...
        public Snapshot(string name, SnapshotArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:filenas/snapshot:Snapshot", name, args ?? new SnapshotArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snapshot(string name, Input<string> id, SnapshotState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:filenas/snapshot:Snapshot", name, state, MakeResourceOptions(options, id))
        {
        }
