...
namespace Byteplus.Pulumi.Bytepluscc.Filenas
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:filenas/mountPoint:MountPoint")]
    public partial class MountPoint : global::Pulumi.CustomResource
    {
        ...
        public MountPoint(string name, MountPointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:filenas/mountPoint:MountPoint", name, args ?? new MountPointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MountPoint(string name, Input<string> id, MountPointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:filenas/mountPoint:MountPoint", name, state, MakeResourceOptions(options, id))
        {
        }
