...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    ...
    /// {
    ///     var fWCenterDnsControlPolicyDemo = new Bytepluscc.Fwcenter.DnsControlPolicy("FWCenterDnsControlPolicyDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy")]
    public partial class DnsControlPolicy : global::Pulumi.CustomResource
    {
        ...
        public DnsControlPolicy(string name, DnsControlPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy", name, args ?? new DnsControlPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DnsControlPolicy(string name, Input<string> id, DnsControlPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/dnsControlPolicy:DnsControlPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
