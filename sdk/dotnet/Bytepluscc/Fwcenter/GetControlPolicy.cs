...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    public static class GetControlPolicy
    {
        ...
        public static Task<GetControlPolicyResult> InvokeAsync(GetControlPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetControlPolicyResult>("bytepluscc:fwcenter/getControlPolicy:getControlPolicy", args ?? new GetControlPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::FWCenter::ControlPolicy
        /// </summary>
        public static Output<GetControlPolicyResult> Invoke(GetControlPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetControlPolicyResult>("bytepluscc:fwcenter/getControlPolicy:getControlPolicy", args ?? new GetControlPolicyInvokeArgs(), options.WithDefaults());
