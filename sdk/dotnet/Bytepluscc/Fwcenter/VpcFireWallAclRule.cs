...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule")]
    public partial class VpcFireWallAclRule : global::Pulumi.CustomResource
    {
        ...
        public VpcFireWallAclRule(string name, VpcFireWallAclRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule", name, args ?? new VpcFireWallAclRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private VpcFireWallAclRule(string name, Input<string> id, VpcFireWallAclRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/vpcFireWallAclRule:VpcFireWallAclRule", name, state, MakeResourceOptions(options, id))
        {
        }
