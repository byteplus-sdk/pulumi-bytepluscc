...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    public static class GetAddressBook
    {
        ...
        public static Task<GetAddressBookResult> InvokeAsync(GetAddressBookArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAddressBookResult>("bytepluscc:fwcenter/getAddressBook:getAddressBook", args ?? new GetAddressBookArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::FWCenter::AddressBook
        /// </summary>
        public static Output<GetAddressBookResult> Invoke(GetAddressBookInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAddressBookResult>("bytepluscc:fwcenter/getAddressBook:getAddressBook", args ?? new GetAddressBookInvokeArgs(), options.WithDefaults());
