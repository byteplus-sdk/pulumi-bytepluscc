...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy")]
    public partial class NatFireWallControlPolicy : global::Pulumi.CustomResource
    {
        ...
        public NatFireWallControlPolicy(string name, NatFireWallControlPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, args ?? new NatFireWallControlPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NatFireWallControlPolicy(string name, Input<string> id, NatFireWallControlPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/natFireWallControlPolicy:NatFireWallControlPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
