...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    ...
    ///         {
    ///             new Bytepluscc.Fwcenter.Inputs.AddressBookAddressDetailListArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:fwcenter/addressBook:AddressBook")]
    public partial class AddressBook : global::Pulumi.CustomResource
    {
        ...
        public AddressBook(string name, AddressBookArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/addressBook:AddressBook", name, args ?? new AddressBookArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AddressBook(string name, Input<string> id, AddressBookState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:fwcenter/addressBook:AddressBook", name, state, MakeResourceOptions(options, id))
        {
        }
