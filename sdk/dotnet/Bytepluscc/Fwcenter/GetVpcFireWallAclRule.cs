...
namespace Byteplus.Pulumi.Bytepluscc.Fwcenter
{
    public static class GetVpcFireWallAclRule
    {
        ...
        public static Task<GetVpcFireWallAclRuleResult> InvokeAsync(GetVpcFireWallAclRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpcFireWallAclRuleResult>("bytepluscc:fwcenter/getVpcFireWallAclRule:getVpcFireWallAclRule", args ?? new GetVpcFireWallAclRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::FWCenter::VpcFirewallAclRule
        /// </summary>
        public static Output<GetVpcFireWallAclRuleResult> Invoke(GetVpcFireWallAclRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpcFireWallAclRuleResult>("bytepluscc:fwcenter/getVpcFireWallAclRule:getVpcFireWallAclRule", args ?? new GetVpcFireWallAclRuleInvokeArgs(), options.WithDefaults());
