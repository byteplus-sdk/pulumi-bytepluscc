...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    public static class GetSecret
    {
        ...
        public static Task<GetSecretResult> InvokeAsync(GetSecretArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSecretResult>("bytepluscc:kms/getSecret:getSecret", args ?? new GetSecretArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::KMS::Secret
        /// </summary>
        public static Output<GetSecretResult> Invoke(GetSecretInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSecretResult>("bytepluscc:kms/getSecret:getSecret", args ?? new GetSecretInvokeArgs(), options.WithDefaults());
