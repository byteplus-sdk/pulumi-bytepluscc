...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    ...
    ///             },
    ///         },
    ///         Ciphertext = new Bytepluscc.Kms.Inputs.KeyCiphertextArgs
    ///         {
    ...
    ///             }),
    ///         },
    ///         ReEncrypt = new Bytepluscc.Kms.Inputs.KeyReEncryptArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kms/key:Key")]
    public partial class Key : global::Pulumi.CustomResource
    {
        ...
        public Key(string name, KeyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/key:Key", name, args ?? new KeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Key(string name, Input<string> id, KeyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/key:Key", name, state, MakeResourceOptions(options, id))
        {
        }
