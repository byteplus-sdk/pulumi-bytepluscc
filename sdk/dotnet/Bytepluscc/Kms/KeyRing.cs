...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kms/keyRing:KeyRing")]
    public partial class KeyRing : global::Pulumi.CustomResource
    {
        ...
        public KeyRing(string name, KeyRingArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/keyRing:KeyRing", name, args ?? new KeyRingArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyRing(string name, Input<string> id, KeyRingState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/keyRing:KeyRing", name, state, MakeResourceOptions(options, id))
        {
        }
