...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:kms/keyMaterial:KeyMaterial")]
    public partial class KeyMaterial : global::Pulumi.CustomResource
    {
        ...
        public KeyMaterial(string name, KeyMaterialArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/keyMaterial:KeyMaterial", name, args ?? new KeyMaterialArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KeyMaterial(string name, Input<string> id, KeyMaterialState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:kms/keyMaterial:KeyMaterial", name, state, MakeResourceOptions(options, id))
        {
        }
