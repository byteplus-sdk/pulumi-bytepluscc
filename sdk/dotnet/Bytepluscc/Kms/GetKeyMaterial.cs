...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    public static class GetKeyMaterial
    {
        ...
        public static Task<GetKeyMaterialResult> InvokeAsync(GetKeyMaterialArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyMaterialResult>("bytepluscc:kms/getKeyMaterial:getKeyMaterial", args ?? new GetKeyMaterialArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::KMS::KeyMaterial
        /// </summary>
        public static Output<GetKeyMaterialResult> Invoke(GetKeyMaterialInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyMaterialResult>("bytepluscc:kms/getKeyMaterial:getKeyMaterial", args ?? new GetKeyMaterialInvokeArgs(), options.WithDefaults());
