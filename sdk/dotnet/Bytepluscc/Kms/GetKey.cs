...
namespace Byteplus.Pulumi.Bytepluscc.Kms
{
    public static class GetKey
    {
        ...
        public static Task<GetKeyResult> InvokeAsync(GetKeyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetKeyResult>("bytepluscc:kms/getKey:getKey", args ?? new GetKeyArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::KMS::Key
        /// </summary>
        public static Output<GetKeyResult> Invoke(GetKeyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetKeyResult>("bytepluscc:kms/getKey:getKey", args ?? new GetKeyInvokeArgs(), options.WithDefaults());
