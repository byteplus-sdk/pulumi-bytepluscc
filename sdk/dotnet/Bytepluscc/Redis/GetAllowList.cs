...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    public static class GetAllowList
    {
        ...
        public static Task<GetAllowListResult> InvokeAsync(GetAllowListArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListResult>("bytepluscc:redis/getAllowList:getAllowList", args ?? new GetAllowListArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::Redis::AllowList
        /// </summary>
        public static Output<GetAllowListResult> Invoke(GetAllowListInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListResult>("bytepluscc:redis/getAllowList:getAllowList", args ?? new GetAllowListInvokeArgs(), options.WithDefaults());
