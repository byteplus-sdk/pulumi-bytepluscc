...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:redis/parameterGroup:ParameterGroup")]
    public partial class ParameterGroup : global::Pulumi.CustomResource
    {
        ...
        public ParameterGroup(string name, ParameterGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/parameterGroup:ParameterGroup", name, args ?? new ParameterGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ParameterGroup(string name, Input<string> id, ParameterGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/parameterGroup:ParameterGroup", name, state, MakeResourceOptions(options, id))
        {
        }
