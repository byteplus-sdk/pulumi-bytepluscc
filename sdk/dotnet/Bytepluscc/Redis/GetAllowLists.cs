...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    public static class GetAllowLists
    {
        ...
        public static Task<GetAllowListsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListsResult>("bytepluscc:redis/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::Redis::AllowList
        /// </summary>
        public static Output<GetAllowListsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListsResult>("bytepluscc:redis/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());
