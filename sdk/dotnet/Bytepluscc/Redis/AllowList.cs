...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    ...
    ///         {
    ///             new Bytepluscc.Redis.Inputs.AllowListSecurityGroupBindInfoArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:redis/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
