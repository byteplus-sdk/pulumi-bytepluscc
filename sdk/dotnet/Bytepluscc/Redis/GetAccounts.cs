...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    public static class GetAccounts
    {
        ...
        public static Task<GetAccountsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAccountsResult>("bytepluscc:redis/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::Redis::Account
        /// </summary>
        public static Output<GetAccountsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAccountsResult>("bytepluscc:redis/getAccounts:getAccounts", InvokeArgs.Empty, options.WithDefaults());
