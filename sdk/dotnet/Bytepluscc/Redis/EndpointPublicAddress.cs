...
namespace Byteplus.Pulumi.Bytepluscc.Redis
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:redis/endpointPublicAddress:EndpointPublicAddress")]
    public partial class EndpointPublicAddress : global::Pulumi.CustomResource
    {
        ...
        public EndpointPublicAddress(string name, EndpointPublicAddressArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/endpointPublicAddress:EndpointPublicAddress", name, args ?? new EndpointPublicAddressArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EndpointPublicAddress(string name, Input<string> id, EndpointPublicAddressState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:redis/endpointPublicAddress:EndpointPublicAddress", name, state, MakeResourceOptions(options, id))
        {
        }
