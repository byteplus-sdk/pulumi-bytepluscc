...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudmonitor/contactGroup:ContactGroup")]
    public partial class ContactGroup : global::Pulumi.CustomResource
    {
        ...
        public ContactGroup(string name, ContactGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, args ?? new ContactGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContactGroup(string name, Input<string> id, ContactGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/contactGroup:ContactGroup", name, state, MakeResourceOptions(options, id))
        {
        }
