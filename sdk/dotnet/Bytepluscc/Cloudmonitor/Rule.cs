...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudmonitor/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
