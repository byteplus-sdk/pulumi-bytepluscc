...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    public static class GetRule
    {
        ...
        public static Task<GetRuleResult> InvokeAsync(GetRuleArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetRuleResult>("bytepluscc:cloudmonitor/getRule:getRule", args ?? new GetRuleArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CloudMonitor::Rule
        /// </summary>
        public static Output<GetRuleResult> Invoke(GetRuleInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetRuleResult>("bytepluscc:cloudmonitor/getRule:getRule", args ?? new GetRuleInvokeArgs(), options.WithDefaults());
