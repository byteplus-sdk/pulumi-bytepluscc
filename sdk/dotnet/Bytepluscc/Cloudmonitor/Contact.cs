...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    ...
    /// {
    ///     var example = new Bytepluscc.Cloudmonitor.Contact("Example", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudmonitor/contact:Contact")]
    public partial class Contact : global::Pulumi.CustomResource
    {
        ...
        public Contact(string name, ContactArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/contact:Contact", name, args ?? new ContactArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Contact(string name, Input<string> id, ContactState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/contact:Contact", name, state, MakeResourceOptions(options, id))
        {
        }
