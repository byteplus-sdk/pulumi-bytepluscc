...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:cloudmonitor/eventRule:EventRule")]
    public partial class EventRule : global::Pulumi.CustomResource
    {
        ...
        public EventRule(string name, EventRuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/eventRule:EventRule", name, args ?? new EventRuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EventRule(string name, Input<string> id, EventRuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:cloudmonitor/eventRule:EventRule", name, state, MakeResourceOptions(options, id))
        {
        }
