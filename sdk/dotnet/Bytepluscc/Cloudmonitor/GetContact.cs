...
namespace Byteplus.Pulumi.Bytepluscc.Cloudmonitor
{
    public static class GetContact
    {
        ...
        public static Task<GetContactResult> InvokeAsync(GetContactArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetContactResult>("bytepluscc:cloudmonitor/getContact:getContact", args ?? new GetContactArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CloudMonitor::Contact
        /// </summary>
        public static Output<GetContactResult> Invoke(GetContactInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetContactResult>("bytepluscc:cloudmonitor/getContact:getContact", args ?? new GetContactInvokeArgs(), options.WithDefaults());
