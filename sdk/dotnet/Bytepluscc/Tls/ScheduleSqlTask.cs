...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// {
    ///     var tLSScheduleSqlTaskDemo = new Bytepluscc.Tls.ScheduleSqlTask("TLSScheduleSqlTaskDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask")]
    public partial class ScheduleSqlTask : global::Pulumi.CustomResource
    {
        ...
        public ScheduleSqlTask(string name, ScheduleSqlTaskArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, args ?? new ScheduleSqlTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ScheduleSqlTask(string name, Input<string> id, ScheduleSqlTaskState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/scheduleSqlTask:ScheduleSqlTask", name, state, MakeResourceOptions(options, id))
        {
        }
