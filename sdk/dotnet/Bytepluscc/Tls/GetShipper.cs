...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetShipper
    {
        ...
        public static Task<GetShipperResult> InvokeAsync(GetShipperArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetShipperResult>("bytepluscc:tls/getShipper:getShipper", args ?? new GetShipperArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::Shipper
        /// </summary>
        public static Output<GetShipperResult> Invoke(GetShipperInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetShipperResult>("bytepluscc:tls/getShipper:getShipper", args ?? new GetShipperInvokeArgs(), options.WithDefaults());
