...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetScheduleSqlTask
    {
        ...
        public static Task<GetScheduleSqlTaskResult> InvokeAsync(GetScheduleSqlTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetScheduleSqlTaskResult>("bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask", args ?? new GetScheduleSqlTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::ScheduleSqlTask
        /// </summary>
        public static Output<GetScheduleSqlTaskResult> Invoke(GetScheduleSqlTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetScheduleSqlTaskResult>("bytepluscc:tls/getScheduleSqlTask:getScheduleSqlTask", args ?? new GetScheduleSqlTaskInvokeArgs(), options.WithDefaults());
