...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetDownloadTask
    {
        ...
        public static Task<GetDownloadTaskResult> InvokeAsync(GetDownloadTaskArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDownloadTaskResult>("bytepluscc:tls/getDownloadTask:getDownloadTask", args ?? new GetDownloadTaskArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::DownloadTask
        /// </summary>
        public static Output<GetDownloadTaskResult> Invoke(GetDownloadTaskInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetDownloadTaskResult>("bytepluscc:tls/getDownloadTask:getDownloadTask", args ?? new GetDownloadTaskInvokeArgs(), options.WithDefaults());
