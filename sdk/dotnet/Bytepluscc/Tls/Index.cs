...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/index:Index")]
    public partial class Index : global::Pulumi.CustomResource
    {
        ...
        public Index(string name, IndexArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/index:Index", name, args ?? new IndexArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Index(string name, Input<string> id, IndexState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/index:Index", name, state, MakeResourceOptions(options, id))
        {
        }
