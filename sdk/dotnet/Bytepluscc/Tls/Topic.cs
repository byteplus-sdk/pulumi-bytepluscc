...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/topic:Topic")]
    public partial class Topic : global::Pulumi.CustomResource
    {
        ...
        public Topic(string name, TopicArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/topic:Topic", name, args ?? new TopicArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Topic(string name, Input<string> id, TopicState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/topic:Topic", name, state, MakeResourceOptions(options, id))
        {
        }
