...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    ///         SourceType = "kafka",
    ///         TargetInfo = new Bytepluscc.Tls.Inputs.ImportTaskTargetInfoArgs
    ///         {
    ///             Region = "cn-beijing",
    ///             Log_type = "json_log",
    ///             Log_sample = "",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/importTask:ImportTask")]
    public partial class ImportTask : global::Pulumi.CustomResource
    {
        ...
        public ImportTask(string name, ImportTaskArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/importTask:ImportTask", name, args ?? new ImportTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ImportTask(string name, Input<string> id, ImportTaskState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/importTask:ImportTask", name, state, MakeResourceOptions(options, id))
        {
        }
