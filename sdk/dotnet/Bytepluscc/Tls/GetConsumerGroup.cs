...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetConsumerGroup
    {
        ...
        public static Task<GetConsumerGroupResult> InvokeAsync(GetConsumerGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetConsumerGroupResult>("bytepluscc:tls/getConsumerGroup:getConsumerGroup", args ?? new GetConsumerGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::ConsumerGroup
        /// </summary>
        public static Output<GetConsumerGroupResult> Invoke(GetConsumerGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetConsumerGroupResult>("bytepluscc:tls/getConsumerGroup:getConsumerGroup", args ?? new GetConsumerGroupInvokeArgs(), options.WithDefaults());
