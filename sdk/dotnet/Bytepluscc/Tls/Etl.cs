...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/etl:Etl")]
    public partial class Etl : global::Pulumi.CustomResource
    {
        ...
        public Etl(string name, EtlArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/etl:Etl", name, args ?? new EtlArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Etl(string name, Input<string> id, EtlState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/etl:Etl", name, state, MakeResourceOptions(options, id))
        {
        }
