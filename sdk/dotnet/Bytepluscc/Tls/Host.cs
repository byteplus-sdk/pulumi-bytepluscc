...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/host:Host")]
    public partial class Host : global::Pulumi.CustomResource
    {
        ...
        public Host(string name, HostArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/host:Host", name, args ?? new HostArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Host(string name, Input<string> id, HostState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/host:Host", name, state, MakeResourceOptions(options, id))
        {
        }
