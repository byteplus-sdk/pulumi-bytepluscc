...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    ///         WebhookHeaders = new[]
    ///         {
    ///             new Bytepluscc.Tls.Inputs.AlarmWebhookIntegrationTypeWebhookHeaderArgs
    ///             {
    ///                 Key = "Content-Type",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/alarmWebhookIntegrationType:AlarmWebhookIntegrationType")]
    public partial class AlarmWebhookIntegrationType : global::Pulumi.CustomResource
    {
        ...
        public AlarmWebhookIntegrationType(string name, AlarmWebhookIntegrationTypeArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarmWebhookIntegrationType:AlarmWebhookIntegrationType", name, args ?? new AlarmWebhookIntegrationTypeArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AlarmWebhookIntegrationType(string name, Input<string> id, AlarmWebhookIntegrationTypeState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarmWebhookIntegrationType:AlarmWebhookIntegrationType", name, state, MakeResourceOptions(options, id))
        {
        }
