...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetEtl
    {
        ...
        public static Task<GetEtlResult> InvokeAsync(GetEtlArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetEtlResult>("bytepluscc:tls/getEtl:getEtl", args ?? new GetEtlArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::Etl
        /// </summary>
        public static Output<GetEtlResult> Invoke(GetEtlInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetEtlResult>("bytepluscc:tls/getEtl:getEtl", args ?? new GetEtlInvokeArgs(), options.WithDefaults());
