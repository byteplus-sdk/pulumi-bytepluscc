...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// {
    ///     var tLSShipperDemo = new Bytepluscc.Tls.Shipper("TLSShipperDemo", new()
    ///     {
    ///         ContentInfo = new Bytepluscc.Tls.Inputs.ShipperContentInfoArgs
    ///         {
    ///             Format = "json",
    ///             Json_info = 
    ///             {
    ...
    ///             },
    ///         },
    ///         KafkaShipperInfo = new Bytepluscc.Tls.Inputs.ShipperKafkaShipperInfoArgs
    ///         {
    ///             Compress = "gzip",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/shipper:Shipper")]
    public partial class Shipper : global::Pulumi.CustomResource
    {
        ...
        public Shipper(string name, ShipperArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/shipper:Shipper", name, args ?? new ShipperArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Shipper(string name, Input<string> id, ShipperState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/shipper:Shipper", name, state, MakeResourceOptions(options, id))
        {
        }
