...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/alarm:Alarm")]
    public partial class Alarm : global::Pulumi.CustomResource
    {
        ...
        public Alarm(string name, AlarmArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarm:Alarm", name, args ?? new AlarmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Alarm(string name, Input<string> id, AlarmState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarm:Alarm", name, state, MakeResourceOptions(options, id))
        {
        }
