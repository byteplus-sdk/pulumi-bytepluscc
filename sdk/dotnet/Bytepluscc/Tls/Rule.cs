...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// {
    ///     var tLSRuleDemo = new Bytepluscc.Tls.Rule("TLSRuleDemo", new()
    ///     {
    ///         ContainerRule = new Bytepluscc.Tls.Inputs.RuleContainerRuleArgs
    ///         {
    ...
    ///         ExcludePaths = new[]
    ///         {
    ///             new Bytepluscc.Tls.Inputs.RuleExcludePathArgs
    ///             {
    ///                 Type = "Path",
    ///                 Value = "/test",
    ///             },
    ///         },
    ///         ExtractRule = new Bytepluscc.Tls.Inputs.RuleExtractRuleArgs
    ///         {
    ///             Begin_regex = "",
    ///             Delimiter = " ",
    ...
    ///         HostGroupInfos = new[]
    ///         {
    ///             new Bytepluscc.Tls.Inputs.RuleHostGroupInfoArgs
    ///             {
    ...
    ///         UserDefineRule = new Bytepluscc.Tls.Inputs.RuleUserDefineRuleArgs
    ///         {
    ///             Advanced = new Bytepluscc.Tls.Inputs.RuleUserDefineRuleAdvancedArgs
    ///             {
    ///                 CloseEof = false,
    ///                 CloseInactive = 10,
    ///                 CloseRemoved = false,
    ...
    ///             Fields = new[]
    ///             {
    ///                 new Bytepluscc.Tls.Inputs.RuleUserDefineRuleFieldArgs
    ///                 {
    ///                     Key = "k1",
    ///                     Val = "v1",
    ///                 },
    ...
    ///             },
    ///             Plugin = new Bytepluscc.Tls.Inputs.RuleUserDefineRulePluginArgs
    ///             {
    ///                 Processors = "{}",
    ///             },
    ///             Raw_log_key = "raw",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
