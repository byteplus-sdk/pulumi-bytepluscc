...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// {
    ///     var example = new Bytepluscc.Tls.DownloadTask("Example", new()
    ///     {
    ...
    ///         LogContextInfos = new Bytepluscc.Tls.Inputs.DownloadTaskLogContextInfosArgs
    ///         {
    ///             Source = "",
    ///             Context_flow = "",
    ///             Package_offset = 0,
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/downloadTask:DownloadTask")]
    public partial class DownloadTask : global::Pulumi.CustomResource
    {
        ...
        public DownloadTask(string name, DownloadTaskArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/downloadTask:DownloadTask", name, args ?? new DownloadTaskArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DownloadTask(string name, Input<string> id, DownloadTaskState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/downloadTask:DownloadTask", name, state, MakeResourceOptions(options, id))
        {
        }
