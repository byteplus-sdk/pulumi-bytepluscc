...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    ...
    /// {
    ///     var tLSAlarmNotifyGroupDemo = new Bytepluscc.Tls.AlarmNotifyGroup("TLSAlarmNotifyGroupDemo", new()
    ///     {
    ///         AlarmNotifyGroupName = "ccapi-test",
    ///         IamProjectName = "default",
    ///         NoticeRules = new[]
    ///         {
    ///             new Bytepluscc.Tls.Inputs.AlarmNotifyGroupNoticeRuleArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup")]
    public partial class AlarmNotifyGroup : global::Pulumi.CustomResource
    {
        ...
        public AlarmNotifyGroup(string name, AlarmNotifyGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, args ?? new AlarmNotifyGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlarmNotifyGroup(string name, Input<string> id, AlarmNotifyGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:tls/alarmNotifyGroup:AlarmNotifyGroup", name, state, MakeResourceOptions(options, id))
        {
        }
