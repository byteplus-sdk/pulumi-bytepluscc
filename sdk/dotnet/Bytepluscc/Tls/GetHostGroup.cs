...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetHostGroup
    {
        ...
        public static Task<GetHostGroupResult> InvokeAsync(GetHostGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetHostGroupResult>("bytepluscc:tls/getHostGroup:getHostGroup", args ?? new GetHostGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::HostGroup
        /// </summary>
        public static Output<GetHostGroupResult> Invoke(GetHostGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetHostGroupResult>("bytepluscc:tls/getHostGroup:getHostGroup", args ?? new GetHostGroupInvokeArgs(), options.WithDefaults());
