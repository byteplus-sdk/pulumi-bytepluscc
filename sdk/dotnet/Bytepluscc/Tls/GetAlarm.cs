...
namespace Byteplus.Pulumi.Bytepluscc.Tls
{
    public static class GetAlarm
    {
        ...
        public static Task<GetAlarmResult> InvokeAsync(GetAlarmArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAlarmResult>("bytepluscc:tls/getAlarm:getAlarm", args ?? new GetAlarmArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TLS::Alarm
        /// </summary>
        public static Output<GetAlarmResult> Invoke(GetAlarmInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAlarmResult>("bytepluscc:tls/getAlarm:getAlarm", args ?? new GetAlarmInvokeArgs(), options.WithDefaults());
