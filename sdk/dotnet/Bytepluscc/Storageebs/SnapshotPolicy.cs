...
namespace Byteplus.Pulumi.Bytepluscc.Storageebs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy")]
    public partial class SnapshotPolicy : global::Pulumi.CustomResource
    {
        ...
        public SnapshotPolicy(string name, SnapshotPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy", name, args ?? new SnapshotPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotPolicy(string name, Input<string> id, SnapshotPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/snapshotPolicy:SnapshotPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
