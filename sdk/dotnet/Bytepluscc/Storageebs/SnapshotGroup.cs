...
namespace Byteplus.Pulumi.Bytepluscc.Storageebs
{
    ...
    /// {
    ///     var storageEBSSnapshotGroupDemo = new Bytepluscc.Storageebs.SnapshotGroup("StorageEBSSnapshotGroupDemo", new()
    ///     {
    ///         Name = "ccapi-test",
    ///         ProjectName = "default",
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Storageebs.Inputs.SnapshotGroupTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:storageebs/snapshotGroup:SnapshotGroup")]
    public partial class SnapshotGroup : global::Pulumi.CustomResource
    {
        ...
        public SnapshotGroup(string name, SnapshotGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, args ?? new SnapshotGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SnapshotGroup(string name, Input<string> id, SnapshotGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/snapshotGroup:SnapshotGroup", name, state, MakeResourceOptions(options, id))
        {
        }
