...
namespace Byteplus.Pulumi.Bytepluscc.Storageebs
{
    public static class GetVolume
    {
        ...
        public static Task<GetVolumeResult> InvokeAsync(GetVolumeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVolumeResult>("bytepluscc:storageebs/getVolume:getVolume", args ?? new GetVolumeArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::StorageEBS::Volume
        /// </summary>
        public static Output<GetVolumeResult> Invoke(GetVolumeInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVolumeResult>("bytepluscc:storageebs/getVolume:getVolume", args ?? new GetVolumeInvokeArgs(), options.WithDefaults());
