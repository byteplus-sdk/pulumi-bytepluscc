...
namespace Byteplus.Pulumi.Bytepluscc.Storageebs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:storageebs/volume:Volume")]
    public partial class Volume : global::Pulumi.CustomResource
    {
        ...
        public Volume(string name, VolumeArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/volume:Volume", name, args ?? new VolumeArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Volume(string name, Input<string> id, VolumeState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:storageebs/volume:Volume", name, state, MakeResourceOptions(options, id))
        {
        }
