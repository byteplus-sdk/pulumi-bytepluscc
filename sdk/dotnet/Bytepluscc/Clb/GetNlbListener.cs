...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetNlbListener
    {
        ...
        public static Task<GetNlbListenerResult> InvokeAsync(GetNlbListenerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNlbListenerResult>("bytepluscc:clb/getNlbListener:getNlbListener", args ?? new GetNlbListenerArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::NLBListener
        /// </summary>
        public static Output<GetNlbListenerResult> Invoke(GetNlbListenerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNlbListenerResult>("bytepluscc:clb/getNlbListener:getNlbListener", args ?? new GetNlbListenerInvokeArgs(), options.WithDefaults());
