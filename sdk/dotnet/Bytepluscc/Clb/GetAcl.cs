...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetAcl
    {
        ...
        public static Task<GetAclResult> InvokeAsync(GetAclArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAclResult>("bytepluscc:clb/getAcl:getAcl", args ?? new GetAclArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::ACL
        /// </summary>
        public static Output<GetAclResult> Invoke(GetAclInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAclResult>("bytepluscc:clb/getAcl:getAcl", args ?? new GetAclInvokeArgs(), options.WithDefaults());
