...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy")]
    public partial class NlbSecurityPolicy : global::Pulumi.CustomResource
    {
        ...
        public NlbSecurityPolicy(string name, NlbSecurityPolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy", name, args ?? new NlbSecurityPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NlbSecurityPolicy(string name, Input<string> id, NlbSecurityPolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbSecurityPolicy:NlbSecurityPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
