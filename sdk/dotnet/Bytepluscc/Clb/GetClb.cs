...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetClb
    {
        ...
        public static Task<GetClbResult> InvokeAsync(GetClbArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetClbResult>("bytepluscc:clb/getClb:getClb", args ?? new GetClbArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::CLB
        /// </summary>
        public static Output<GetClbResult> Invoke(GetClbInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetClbResult>("bytepluscc:clb/getClb:getClb", args ?? new GetClbInvokeArgs(), options.WithDefaults());
