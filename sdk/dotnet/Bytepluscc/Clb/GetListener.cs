...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetListener
    {
        ...
        public static Task<GetListenerResult> InvokeAsync(GetListenerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetListenerResult>("bytepluscc:clb/getListener:getListener", args ?? new GetListenerArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::Listener
        /// </summary>
        public static Output<GetListenerResult> Invoke(GetListenerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetListenerResult>("bytepluscc:clb/getListener:getListener", args ?? new GetListenerInvokeArgs(), options.WithDefaults());
