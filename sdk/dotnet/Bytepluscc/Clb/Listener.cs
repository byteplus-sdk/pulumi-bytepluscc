...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// {
    ///     var clbListenerDemo = new Bytepluscc.Clb.Listener("ClbListenerDemo", new()
    ///     {
    ///         AclIds = new[]
    ///         {
    ...
    ///         HealthCheck = new Bytepluscc.Clb.Inputs.ListenerHealthCheckArgs
    ///         {
    ///             Enabled = "on",
    ///             Healthy_threshold = 3,
    ///             Interval = 5,
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Clb.Inputs.ListenerTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/listener:Listener")]
    public partial class Listener : global::Pulumi.CustomResource
    {
        ...
        public Listener(string name, ListenerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/listener:Listener", name, args ?? new ListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Listener(string name, Input<string> id, ListenerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/listener:Listener", name, state, MakeResourceOptions(options, id))
        {
        }
