...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetNlbSecurityPolicy
    {
        ...
        public static Task<GetNlbSecurityPolicyResult> InvokeAsync(GetNlbSecurityPolicyArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNlbSecurityPolicyResult>("bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy", args ?? new GetNlbSecurityPolicyArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::NLBSecurityPolicy
        /// </summary>
        public static Output<GetNlbSecurityPolicyResult> Invoke(GetNlbSecurityPolicyInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNlbSecurityPolicyResult>("bytepluscc:clb/getNlbSecurityPolicy:getNlbSecurityPolicy", args ?? new GetNlbSecurityPolicyInvokeArgs(), options.WithDefaults());
