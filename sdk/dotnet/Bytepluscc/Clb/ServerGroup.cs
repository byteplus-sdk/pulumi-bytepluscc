...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Clb.Inputs.ServerGroupTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    ///         Servers = new[]
    ///         {
    ///             new Bytepluscc.Clb.Inputs.ServerGroupServerArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/serverGroup:ServerGroup")]
    public partial class ServerGroup : global::Pulumi.CustomResource
    {
        ...
        public ServerGroup(string name, ServerGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/serverGroup:ServerGroup", name, args ?? new ServerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ServerGroup(string name, Input<string> id, ServerGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/serverGroup:ServerGroup", name, state, MakeResourceOptions(options, id))
        {
        }
