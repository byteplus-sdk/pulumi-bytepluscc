...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// {
    ///     var nLBServerGroupDemo = new Bytepluscc.Clb.NlbServerGroup("NLBServerGroupDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/nlbServerGroup:NlbServerGroup")]
    public partial class NlbServerGroup : global::Pulumi.CustomResource
    {
        ...
        public NlbServerGroup(string name, NlbServerGroupArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbServerGroup:NlbServerGroup", name, args ?? new NlbServerGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NlbServerGroup(string name, Input<string> id, NlbServerGroupState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbServerGroup:NlbServerGroup", name, state, MakeResourceOptions(options, id))
        {
        }
