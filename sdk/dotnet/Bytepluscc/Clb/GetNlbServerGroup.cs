...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetNlbServerGroup
    {
        ...
        public static Task<GetNlbServerGroupResult> InvokeAsync(GetNlbServerGroupArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNlbServerGroupResult>("bytepluscc:clb/getNlbServerGroup:getNlbServerGroup", args ?? new GetNlbServerGroupArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::NLBServerGroup
        /// </summary>
        public static Output<GetNlbServerGroupResult> Invoke(GetNlbServerGroupInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNlbServerGroupResult>("bytepluscc:clb/getNlbServerGroup:getNlbServerGroup", args ?? new GetNlbServerGroupInvokeArgs(), options.WithDefaults());
