...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    public static class GetNlb
    {
        ...
        public static Task<GetNlbResult> InvokeAsync(GetNlbArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetNlbResult>("bytepluscc:clb/getNlb:getNlb", args ?? new GetNlbArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::CLB::NLB
        /// </summary>
        public static Output<GetNlbResult> Invoke(GetNlbInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetNlbResult>("bytepluscc:clb/getNlb:getNlb", args ?? new GetNlbInvokeArgs(), options.WithDefaults());
