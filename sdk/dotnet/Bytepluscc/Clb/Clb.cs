...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/clb:Clb")]
    public partial class Clb : global::Pulumi.CustomResource
    {
        ...
        public Clb(string name, ClbArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/clb:Clb", name, args ?? new ClbArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Clb(string name, Input<string> id, ClbState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/clb:Clb", name, state, MakeResourceOptions(options, id))
        {
        }
