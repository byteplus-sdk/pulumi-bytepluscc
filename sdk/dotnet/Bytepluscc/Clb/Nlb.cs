...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// {
    ///     var nLBDemo = new Bytepluscc.Clb.Nlb("NLBDemo", new()
    ///     {
    ...
    ///         ZoneMappings = new[]
    ///         {
    ///             new Bytepluscc.Clb.Inputs.NlbZoneMappingArgs
    ///             {
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Clb.Inputs.NlbTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/nlb:Nlb")]
    public partial class Nlb : global::Pulumi.CustomResource
    {
        ...
        public Nlb(string name, NlbArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlb:Nlb", name, args ?? new NlbArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Nlb(string name, Input<string> id, NlbState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlb:Nlb", name, state, MakeResourceOptions(options, id))
        {
        }
