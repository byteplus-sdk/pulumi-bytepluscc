...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
