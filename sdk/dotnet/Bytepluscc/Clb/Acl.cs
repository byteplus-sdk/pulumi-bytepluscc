...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/acl:Acl")]
    public partial class Acl : global::Pulumi.CustomResource
    {
        ...
        public Acl(string name, AclArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/acl:Acl", name, args ?? new AclArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Acl(string name, Input<string> id, AclState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/acl:Acl", name, state, MakeResourceOptions(options, id))
        {
        }
