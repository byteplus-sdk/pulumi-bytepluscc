...
namespace Byteplus.Pulumi.Bytepluscc.Clb
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:clb/nlbListener:NlbListener")]
    public partial class NlbListener : global::Pulumi.CustomResource
    {
        ...
        public NlbListener(string name, NlbListenerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbListener:NlbListener", name, args ?? new NlbListenerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NlbListener(string name, Input<string> id, NlbListenerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:clb/nlbListener:NlbListener", name, state, MakeResourceOptions(options, id))
        {
        }
