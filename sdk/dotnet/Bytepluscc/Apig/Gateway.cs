...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    ...
    /// {
    ///     var aPIGGatewayDemo = new Bytepluscc.Apig.Gateway("APIGGatewayDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:apig/gateway:Gateway")]
    public partial class Gateway : global::Pulumi.CustomResource
    {
        ...
        public Gateway(string name, GatewayArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/gateway:Gateway", name, args ?? new GatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gateway(string name, Input<string> id, GatewayState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/gateway:Gateway", name, state, MakeResourceOptions(options, id))
        {
        }
