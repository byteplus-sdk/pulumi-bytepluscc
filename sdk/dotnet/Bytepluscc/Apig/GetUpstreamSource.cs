...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    public static class GetUpstreamSource
    {
        ...
        public static Task<GetUpstreamSourceResult> InvokeAsync(GetUpstreamSourceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetUpstreamSourceResult>("bytepluscc:apig/getUpstreamSource:getUpstreamSource", args ?? new GetUpstreamSourceArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::APIG::UpstreamSource
        /// </summary>
        public static Output<GetUpstreamSourceResult> Invoke(GetUpstreamSourceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetUpstreamSourceResult>("bytepluscc:apig/getUpstreamSource:getUpstreamSource", args ?? new GetUpstreamSourceInvokeArgs(), options.WithDefaults());
