...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:apig/gatewayService:GatewayService")]
    public partial class GatewayService : global::Pulumi.CustomResource
    {
        ...
        public GatewayService(string name, GatewayServiceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/gatewayService:GatewayService", name, args ?? new GatewayServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayService(string name, Input<string> id, GatewayServiceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/gatewayService:GatewayService", name, state, MakeResourceOptions(options, id))
        {
        }
