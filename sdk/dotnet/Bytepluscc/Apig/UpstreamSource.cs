...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:apig/upstreamSource:UpstreamSource")]
    public partial class UpstreamSource : global::Pulumi.CustomResource
    {
        ...
        public UpstreamSource(string name, UpstreamSourceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/upstreamSource:UpstreamSource", name, args ?? new UpstreamSourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UpstreamSource(string name, Input<string> id, UpstreamSourceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/upstreamSource:UpstreamSource", name, state, MakeResourceOptions(options, id))
        {
        }
