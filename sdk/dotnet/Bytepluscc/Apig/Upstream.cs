...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    ...
    /// {
    ///     var aPIGUpstreamAIProviderDemo = new Bytepluscc.Apig.Upstream("APIGUpstreamAIProviderDemo", new()
    ///     {
    ///         CircuitBreakingSettings = new Bytepluscc.Apig.Inputs.UpstreamCircuitBreakingSettingsArgs
    ///         {
    ...
    ///         ConnectionPoolSettings = new Bytepluscc.Apig.Inputs.UpstreamConnectionPoolSettingsArgs
    ///         {
    ///             Enable = true,
    ...
    ///         LoadBalancerSettings = new Bytepluscc.Apig.Inputs.UpstreamLoadBalancerSettingsArgs
    ///         {
    ///             Lb_policy = "SimpleLB",
    ...
    ///         Name = "test-7",
    ///         Protocol = "HTTP",
    ///         TlsSettings = new Bytepluscc.Apig.Inputs.UpstreamTlsSettingsArgs
    ///         {
    ///             Sni = "",
    ///             Tls_mode = "DISABLE",
    ///         },
    ///         SourceType = "Domain",
    ///         UpstreamSpec = new Bytepluscc.Apig.Inputs.UpstreamUpstreamSpecArgs
    ///         {
    ///             Domain = new Bytepluscc.Apig.Inputs.UpstreamUpstreamSpecDomainArgs
    ///             {
    ///                 DomainList = new[]
    ///                 {
    ///                     
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:apig/upstream:Upstream")]
    public partial class Upstream : global::Pulumi.CustomResource
    {
        ...
        public Upstream(string name, UpstreamArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/upstream:Upstream", name, args ?? new UpstreamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Upstream(string name, Input<string> id, UpstreamState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/upstream:Upstream", name, state, MakeResourceOptions(options, id))
        {
        }
