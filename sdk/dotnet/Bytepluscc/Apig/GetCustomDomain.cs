...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    public static class GetCustomDomain
    {
        ...
        public static Task<GetCustomDomainResult> InvokeAsync(GetCustomDomainArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetCustomDomainResult>("bytepluscc:apig/getCustomDomain:getCustomDomain", args ?? new GetCustomDomainArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::APIG::CustomDomain
        /// </summary>
        public static Output<GetCustomDomainResult> Invoke(GetCustomDomainInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetCustomDomainResult>("bytepluscc:apig/getCustomDomain:getCustomDomain", args ?? new GetCustomDomainInvokeArgs(), options.WithDefaults());
