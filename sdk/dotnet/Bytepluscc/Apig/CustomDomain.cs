...
namespace Byteplus.Pulumi.Bytepluscc.Apig
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:apig/customDomain:CustomDomain")]
    public partial class CustomDomain : global::Pulumi.CustomResource
    {
        ...
        public CustomDomain(string name, CustomDomainArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/customDomain:CustomDomain", name, args ?? new CustomDomainArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomDomain(string name, Input<string> id, CustomDomainState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:apig/customDomain:CustomDomain", name, state, MakeResourceOptions(options, id))
        {
        }
