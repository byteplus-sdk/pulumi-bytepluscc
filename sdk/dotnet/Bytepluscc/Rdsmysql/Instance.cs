...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// {
    ///     var rDSMySQLInstanceDemo = new Bytepluscc.Rdsmysql.Instance("RDSMySQLInstanceDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
