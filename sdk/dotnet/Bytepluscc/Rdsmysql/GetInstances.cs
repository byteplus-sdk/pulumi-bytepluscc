...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    public static class GetInstances
    {
        ...
        public static Task<GetInstancesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInstancesResult>("bytepluscc:rdsmysql/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::RDSMySQL::Instance
        /// </summary>
        public static Output<GetInstancesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInstancesResult>("bytepluscc:rdsmysql/getInstances:getInstances", InvokeArgs.Empty, options.WithDefaults());
