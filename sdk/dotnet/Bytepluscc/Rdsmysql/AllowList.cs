...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// {
    ///     var rdsMysqlAllowListDemo = new Bytepluscc.Rdsmysql.AllowList("RdsMysqlAllowListDemo", new()
    ///     {
    ///         UserAllowLists = new[]
    ///         {
    ///             "1.2.3.4",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/allowList:AllowList")]
    public partial class AllowList : global::Pulumi.CustomResource
    {
        ...
        public AllowList(string name, AllowListArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/allowList:AllowList", name, args ?? new AllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AllowList(string name, Input<string> id, AllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/allowList:AllowList", name, state, MakeResourceOptions(options, id))
        {
        }
