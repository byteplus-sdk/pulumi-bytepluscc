...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// {
    ///     var rDSMySQLParameterTemplateDemo = new Bytepluscc.Rdsmysql.ParameterTemplate("RDSMySQLParameterTemplateDemo", new()
    ///     {
    ...
    ///         TemplateParams = new[]
    ///         {
    ///             new Bytepluscc.Rdsmysql.Inputs.ParameterTemplateTemplateParamArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate")]
    public partial class ParameterTemplate : global::Pulumi.CustomResource
    {
        ...
        public ParameterTemplate(string name, ParameterTemplateArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, args ?? new ParameterTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private ParameterTemplate(string name, Input<string> id, ParameterTemplateState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/parameterTemplate:ParameterTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
