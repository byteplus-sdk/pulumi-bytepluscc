...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress")]
    public partial class EndpointPublicAddress : global::Pulumi.CustomResource
    {
        ...
        public EndpointPublicAddress(string name, EndpointPublicAddressArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, args ?? new EndpointPublicAddressArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private EndpointPublicAddress(string name, Input<string> id, EndpointPublicAddressState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/endpointPublicAddress:EndpointPublicAddress", name, state, MakeResourceOptions(options, id))
        {
        }
