...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode")]
    public partial class InstanceReadonlyNode : global::Pulumi.CustomResource
    {
        ...
        public InstanceReadonlyNode(string name, InstanceReadonlyNodeArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, args ?? new InstanceReadonlyNodeArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InstanceReadonlyNode(string name, Input<string> id, InstanceReadonlyNodeState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/instanceReadonlyNode:InstanceReadonlyNode", name, state, MakeResourceOptions(options, id))
        {
        }
