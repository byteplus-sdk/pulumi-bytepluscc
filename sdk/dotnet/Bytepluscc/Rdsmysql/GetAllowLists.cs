...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    public static class GetAllowLists
    {
        ...
        public static Task<GetAllowListsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetAllowListsResult>("bytepluscc:rdsmysql/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::RDSMySQL::AllowList
        /// </summary>
        public static Output<GetAllowListsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetAllowListsResult>("bytepluscc:rdsmysql/getAllowLists:getAllowLists", InvokeArgs.Empty, options.WithDefaults());
