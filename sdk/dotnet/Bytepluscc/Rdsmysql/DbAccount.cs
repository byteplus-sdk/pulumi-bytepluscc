...
namespace Byteplus.Pulumi.Bytepluscc.Rdsmysql
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:rdsmysql/dbAccount:DbAccount")]
    public partial class DbAccount : global::Pulumi.CustomResource
    {
        ...
        public DbAccount(string name, DbAccountArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/dbAccount:DbAccount", name, args ?? new DbAccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DbAccount(string name, Input<string> id, DbAccountState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:rdsmysql/dbAccount:DbAccount", name, state, MakeResourceOptions(options, id))
        {
        }
