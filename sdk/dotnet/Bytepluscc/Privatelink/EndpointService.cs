...
namespace Byteplus.Pulumi.Bytepluscc.Privatelink
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatelink/endpointService:EndpointService")]
    public partial class EndpointService : global::Pulumi.CustomResource
    {
        ...
        public EndpointService(string name, EndpointServiceArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/endpointService:EndpointService", name, args ?? new EndpointServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private EndpointService(string name, Input<string> id, EndpointServiceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/endpointService:EndpointService", name, state, MakeResourceOptions(options, id))
        {
        }
