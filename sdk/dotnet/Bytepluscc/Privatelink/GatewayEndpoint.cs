...
namespace Byteplus.Pulumi.Bytepluscc.Privatelink
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint")]
    public partial class GatewayEndpoint : global::Pulumi.CustomResource
    {
        ...
        public GatewayEndpoint(string name, GatewayEndpointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, args ?? new GatewayEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayEndpoint(string name, Input<string> id, GatewayEndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/gatewayEndpoint:GatewayEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
