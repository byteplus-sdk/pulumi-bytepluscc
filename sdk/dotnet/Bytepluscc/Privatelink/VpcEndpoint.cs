...
namespace Byteplus.Pulumi.Bytepluscc.Privatelink
{
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Privatelink.Inputs.VpcEndpointTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    ///         Zones = new[]
    ///         {
    ///             new Bytepluscc.Privatelink.Inputs.VpcEndpointZoneArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint")]
    public partial class VpcEndpoint : global::Pulumi.CustomResource
    {
        ...
        public VpcEndpoint(string name, VpcEndpointArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint", name, args ?? new VpcEndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpcEndpoint(string name, Input<string> id, VpcEndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:privatelink/vpcEndpoint:VpcEndpoint", name, state, MakeResourceOptions(options, id))
        {
        }
