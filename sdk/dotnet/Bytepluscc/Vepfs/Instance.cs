...
namespace Byteplus.Pulumi.Bytepluscc.Vepfs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vepfs/instance:Instance")]
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        public Instance(string name, InstanceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/instance:Instance", name, args ?? new InstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Instance(string name, Input<string> id, InstanceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/instance:Instance", name, state, MakeResourceOptions(options, id))
        {
        }
