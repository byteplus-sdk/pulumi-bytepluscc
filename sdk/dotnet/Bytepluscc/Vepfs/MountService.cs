...
namespace Byteplus.Pulumi.Bytepluscc.Vepfs
{
    ...
    ///         {
    ///             new Bytepluscc.Vepfs.Inputs.MountServiceAttachFileSystemArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vepfs/mountService:MountService")]
    public partial class MountService : global::Pulumi.CustomResource
    {
        ...
        public MountService(string name, MountServiceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/mountService:MountService", name, args ?? new MountServiceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MountService(string name, Input<string> id, MountServiceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/mountService:MountService", name, state, MakeResourceOptions(options, id))
        {
        }
