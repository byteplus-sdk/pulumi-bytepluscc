...
namespace Byteplus.Pulumi.Bytepluscc.Vepfs
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vepfs/fileset:Fileset")]
    public partial class Fileset : global::Pulumi.CustomResource
    {
        ...
        public Fileset(string name, FilesetArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/fileset:Fileset", name, args ?? new FilesetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Fileset(string name, Input<string> id, FilesetState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vepfs/fileset:Fileset", name, state, MakeResourceOptions(options, id))
        {
        }
