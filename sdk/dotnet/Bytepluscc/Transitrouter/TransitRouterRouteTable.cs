...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable")]
    public partial class TransitRouterRouteTable : global::Pulumi.CustomResource
    {
        ...
        public TransitRouterRouteTable(string name, TransitRouterRouteTableArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, args ?? new TransitRouterRouteTableArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TransitRouterRouteTable(string name, Input<string> id, TransitRouterRouteTableState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterRouteTable:TransitRouterRouteTable", name, state, MakeResourceOptions(options, id))
        {
        }
