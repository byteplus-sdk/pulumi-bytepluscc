...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation")]
    public partial class RouteTablePropagation : global::Pulumi.CustomResource
    {
        ...
        public RouteTablePropagation(string name, RouteTablePropagationArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation", name, args ?? new RouteTablePropagationArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RouteTablePropagation(string name, Input<string> id, RouteTablePropagationState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/routeTablePropagation:RouteTablePropagation", name, state, MakeResourceOptions(options, id))
        {
        }
