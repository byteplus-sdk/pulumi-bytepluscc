...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    public static class GetTransitRouterRouteEntry
    {
        ...
        public static Task<GetTransitRouterRouteEntryResult> InvokeAsync(GetTransitRouterRouteEntryArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTransitRouterRouteEntryResult>("bytepluscc:transitrouter/getTransitRouterRouteEntry:getTransitRouterRouteEntry", args ?? new GetTransitRouterRouteEntryArgs(), options.WithDefaults());
        ...
        public static Output<GetTransitRouterRouteEntryResult> Invoke(GetTransitRouterRouteEntryInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTransitRouterRouteEntryResult>("bytepluscc:transitrouter/getTransitRouterRouteEntry:getTransitRouterRouteEntry", args ?? new GetTransitRouterRouteEntryInvokeArgs(), options.WithDefaults());
