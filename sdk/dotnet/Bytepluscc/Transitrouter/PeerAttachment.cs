...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/peerAttachment:PeerAttachment")]
    public partial class PeerAttachment : global::Pulumi.CustomResource
    {
        ...
        public PeerAttachment(string name, PeerAttachmentArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, args ?? new PeerAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PeerAttachment(string name, Input<string> id, PeerAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/peerAttachment:PeerAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
