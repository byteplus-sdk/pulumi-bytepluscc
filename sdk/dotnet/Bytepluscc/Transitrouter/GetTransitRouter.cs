...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    public static class GetTransitRouter
    {
        ...
        public static Task<GetTransitRouterResult> InvokeAsync(GetTransitRouterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetTransitRouterResult>("bytepluscc:transitrouter/getTransitRouter:getTransitRouter", args ?? new GetTransitRouterArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TransitRouter::TransitRouter
        /// </summary>
        public static Output<GetTransitRouterResult> Invoke(GetTransitRouterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetTransitRouterResult>("bytepluscc:transitrouter/getTransitRouter:getTransitRouter", args ?? new GetTransitRouterInvokeArgs(), options.WithDefaults());
