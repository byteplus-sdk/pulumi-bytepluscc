...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    public static class GetVpnAttachment
    {
        ...
        public static Task<GetVpnAttachmentResult> InvokeAsync(GetVpnAttachmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpnAttachmentResult>("bytepluscc:transitrouter/getVpnAttachment:getVpnAttachment", args ?? new GetVpnAttachmentArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TransitRouter::VpnAttachment
        /// </summary>
        public static Output<GetVpnAttachmentResult> Invoke(GetVpnAttachmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpnAttachmentResult>("bytepluscc:transitrouter/getVpnAttachment:getVpnAttachment", args ?? new GetVpnAttachmentInvokeArgs(), options.WithDefaults());
