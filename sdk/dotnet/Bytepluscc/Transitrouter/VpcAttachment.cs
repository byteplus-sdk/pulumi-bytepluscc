...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/vpcAttachment:VpcAttachment")]
    public partial class VpcAttachment : global::Pulumi.CustomResource
    {
        ...
        public VpcAttachment(string name, VpcAttachmentArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/vpcAttachment:VpcAttachment", name, args ?? new VpcAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpcAttachment(string name, Input<string> id, VpcAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/vpcAttachment:VpcAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
