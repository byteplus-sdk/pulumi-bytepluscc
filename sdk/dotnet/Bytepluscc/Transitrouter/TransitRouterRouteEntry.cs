...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry")]
    public partial class TransitRouterRouteEntry : global::Pulumi.CustomResource
    {
        ...
        public TransitRouterRouteEntry(string name, TransitRouterRouteEntryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, args ?? new TransitRouterRouteEntryArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TransitRouterRouteEntry(string name, Input<string> id, TransitRouterRouteEntryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterRouteEntry:TransitRouterRouteEntry", name, state, MakeResourceOptions(options, id))
        {
        }
