...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    public static class GetPeerAttachment
    {
        ...
        public static Task<GetPeerAttachmentResult> InvokeAsync(GetPeerAttachmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPeerAttachmentResult>("bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment", args ?? new GetPeerAttachmentArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TransitRouter::PeerAttachment
        /// </summary>
        public static Output<GetPeerAttachmentResult> Invoke(GetPeerAttachmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPeerAttachmentResult>("bytepluscc:transitrouter/getPeerAttachment:getPeerAttachment", args ?? new GetPeerAttachmentInvokeArgs(), options.WithDefaults());
