...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/transitRouter:TransitRouter")]
    public partial class TransitRouter : global::Pulumi.CustomResource
    {
        ...
        public TransitRouter(string name, TransitRouterArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouter:TransitRouter", name, args ?? new TransitRouterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TransitRouter(string name, Input<string> id, TransitRouterState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouter:TransitRouter", name, state, MakeResourceOptions(options, id))
        {
        }
