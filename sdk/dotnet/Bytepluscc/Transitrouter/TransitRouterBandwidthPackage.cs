...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage")]
    public partial class TransitRouterBandwidthPackage : global::Pulumi.CustomResource
    {
        ...
        public TransitRouterBandwidthPackage(string name, TransitRouterBandwidthPackageArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage", name, args ?? new TransitRouterBandwidthPackageArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private TransitRouterBandwidthPackage(string name, Input<string> id, TransitRouterBandwidthPackageState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/transitRouterBandwidthPackage:TransitRouterBandwidthPackage", name, state, MakeResourceOptions(options, id))
        {
        }
