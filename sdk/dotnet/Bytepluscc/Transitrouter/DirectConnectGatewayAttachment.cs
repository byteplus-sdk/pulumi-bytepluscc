...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment")]
    public partial class DirectConnectGatewayAttachment : global::Pulumi.CustomResource
    {
        ...
        public DirectConnectGatewayAttachment(string name, DirectConnectGatewayAttachmentArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, args ?? new DirectConnectGatewayAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DirectConnectGatewayAttachment(string name, Input<string> id, DirectConnectGatewayAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/directConnectGatewayAttachment:DirectConnectGatewayAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
