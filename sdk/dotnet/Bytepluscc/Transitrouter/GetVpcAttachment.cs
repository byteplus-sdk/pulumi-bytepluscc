...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    public static class GetVpcAttachment
    {
        ...
        public static Task<GetVpcAttachmentResult> InvokeAsync(GetVpcAttachmentArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpcAttachmentResult>("bytepluscc:transitrouter/getVpcAttachment:getVpcAttachment", args ?? new GetVpcAttachmentArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::TransitRouter::VpcAttachment
        /// </summary>
        public static Output<GetVpcAttachmentResult> Invoke(GetVpcAttachmentInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpcAttachmentResult>("bytepluscc:transitrouter/getVpcAttachment:getVpcAttachment", args ?? new GetVpcAttachmentInvokeArgs(), options.WithDefaults());
