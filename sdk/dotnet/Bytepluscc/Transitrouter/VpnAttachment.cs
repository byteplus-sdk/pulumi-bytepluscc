...
namespace Byteplus.Pulumi.Bytepluscc.Transitrouter
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:transitrouter/vpnAttachment:VpnAttachment")]
    public partial class VpnAttachment : global::Pulumi.CustomResource
    {
        ...
        public VpnAttachment(string name, VpnAttachmentArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/vpnAttachment:VpnAttachment", name, args ?? new VpnAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnAttachment(string name, Input<string> id, VpnAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:transitrouter/vpnAttachment:VpnAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
