...
namespace Byteplus.Pulumi.Bytepluscc.Escloud
{
    ...
    /// {
    ///     var example = new Bytepluscc.Escloud.IpAllowList("Example", new()
    ///     {
    ...
    ///         Groups = new[]
    ///         {
    ///             new Bytepluscc.Escloud.Inputs.IpAllowListGroupArgs
    ///             {
    ///                 Name = "group1",
    ///                 Allow_list = new[]
    ///                 {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:escloud/ipAllowList:IpAllowList")]
    public partial class IpAllowList : global::Pulumi.CustomResource
    {
        ...
        public IpAllowList(string name, IpAllowListArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:escloud/ipAllowList:IpAllowList", name, args ?? new IpAllowListArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IpAllowList(string name, Input<string> id, IpAllowListState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:escloud/ipAllowList:IpAllowList", name, state, MakeResourceOptions(options, id))
        {
        }
