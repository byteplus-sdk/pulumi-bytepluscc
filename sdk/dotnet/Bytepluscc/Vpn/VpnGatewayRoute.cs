...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute")]
    public partial class VpnGatewayRoute : global::Pulumi.CustomResource
    {
        ...
        public VpnGatewayRoute(string name, VpnGatewayRouteArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute", name, args ?? new VpnGatewayRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGatewayRoute(string name, Input<string> id, VpnGatewayRouteState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnGatewayRoute:VpnGatewayRoute", name, state, MakeResourceOptions(options, id))
        {
        }
