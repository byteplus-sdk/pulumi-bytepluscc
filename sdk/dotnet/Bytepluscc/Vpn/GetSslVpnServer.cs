...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    public static class GetSslVpnServer
    {
        ...
        public static Task<GetSslVpnServerResult> InvokeAsync(GetSslVpnServerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSslVpnServerResult>("bytepluscc:vpn/getSslVpnServer:getSslVpnServer", args ?? new GetSslVpnServerArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPN::SslVpnServer
        /// </summary>
        public static Output<GetSslVpnServerResult> Invoke(GetSslVpnServerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSslVpnServerResult>("bytepluscc:vpn/getSslVpnServer:getSslVpnServer", args ?? new GetSslVpnServerInvokeArgs(), options.WithDefaults());
