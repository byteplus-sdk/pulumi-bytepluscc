...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    public static class GetVpnConnection
    {
        ...
        public static Task<GetVpnConnectionResult> InvokeAsync(GetVpnConnectionArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVpnConnectionResult>("bytepluscc:vpn/getVpnConnection:getVpnConnection", args ?? new GetVpnConnectionArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPN::VPNConnection
        /// </summary>
        public static Output<GetVpnConnectionResult> Invoke(GetVpnConnectionInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVpnConnectionResult>("bytepluscc:vpn/getVpnConnection:getVpnConnection", args ?? new GetVpnConnectionInvokeArgs(), options.WithDefaults());
