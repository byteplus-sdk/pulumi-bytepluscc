...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    ///         Tags = new[]
    ///         {
    ///             new Bytepluscc.Vpn.Inputs.SslVpnClientCertTagArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert")]
    public partial class SslVpnClientCert : global::Pulumi.CustomResource
    {
        ...
        public SslVpnClientCert(string name, SslVpnClientCertArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, args ?? new SslVpnClientCertArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslVpnClientCert(string name, Input<string> id, SslVpnClientCertState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/sslVpnClientCert:SslVpnClientCert", name, state, MakeResourceOptions(options, id))
        {
        }
