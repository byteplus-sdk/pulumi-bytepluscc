...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/customerGateway:CustomerGateway")]
    public partial class CustomerGateway : global::Pulumi.CustomResource
    {
        ...
        public CustomerGateway(string name, CustomerGatewayArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/customerGateway:CustomerGateway", name, args ?? new CustomerGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CustomerGateway(string name, Input<string> id, CustomerGatewayState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/customerGateway:CustomerGateway", name, state, MakeResourceOptions(options, id))
        {
        }
