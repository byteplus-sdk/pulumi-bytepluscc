...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    public static class GetSslVpnClientCert
    {
        ...
        public static Task<GetSslVpnClientCertResult> InvokeAsync(GetSslVpnClientCertArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetSslVpnClientCertResult>("bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert", args ?? new GetSslVpnClientCertArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VPN::SslVpnClientCert
        /// </summary>
        public static Output<GetSslVpnClientCertResult> Invoke(GetSslVpnClientCertInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetSslVpnClientCertResult>("bytepluscc:vpn/getSslVpnClientCert:getSslVpnClientCert", args ?? new GetSslVpnClientCertInvokeArgs(), options.WithDefaults());
