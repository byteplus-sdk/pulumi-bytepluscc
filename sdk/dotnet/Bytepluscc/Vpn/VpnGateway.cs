...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/vpnGateway:VpnGateway")]
    public partial class VpnGateway : global::Pulumi.CustomResource
    {
        ...
        public VpnGateway(string name, VpnGatewayArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnGateway:VpnGateway", name, args ?? new VpnGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnGateway(string name, Input<string> id, VpnGatewayState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnGateway:VpnGateway", name, state, MakeResourceOptions(options, id))
        {
        }
