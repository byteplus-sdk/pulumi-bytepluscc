...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/sslVpnServer:SslVpnServer")]
    public partial class SslVpnServer : global::Pulumi.CustomResource
    {
        ...
        public SslVpnServer(string name, SslVpnServerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, args ?? new SslVpnServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SslVpnServer(string name, Input<string> id, SslVpnServerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/sslVpnServer:SslVpnServer", name, state, MakeResourceOptions(options, id))
        {
        }
