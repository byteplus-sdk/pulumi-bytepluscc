...
namespace Byteplus.Pulumi.Bytepluscc.Vpn
{
    ...
    ///         IkeConfig = new Bytepluscc.Vpn.Inputs.VpnConnectionIkeConfigArgs
    ///         {
    ///             Psk = "88888888",
    ///             Version = "ikev1",
    ///             Mode = "aggressive",
    ...
    ///             Remote_id = "0.0.0.0",
    ///         },
    ///         IpsecConfig = new Bytepluscc.Vpn.Inputs.VpnConnectionIpsecConfigArgs
    ///         {
    ///             Auth_alg = "sha1",
    ///             Dh_group = "group2",
    ///             Enc_alg = "aes",
    ///             Lifetime = 86400,
    ///         },
    ///         BgpInfo = new Bytepluscc.Vpn.Inputs.VpnConnectionBgpInfoArgs
    ///         {
    ///             Enable_bgp = true,
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vpn/vpnConnection:VpnConnection")]
    public partial class VpnConnection : global::Pulumi.CustomResource
    {
        ...
        public VpnConnection(string name, VpnConnectionArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnConnection:VpnConnection", name, args ?? new VpnConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpnConnection(string name, Input<string> id, VpnConnectionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vpn/vpnConnection:VpnConnection", name, state, MakeResourceOptions(options, id))
        {
        }
