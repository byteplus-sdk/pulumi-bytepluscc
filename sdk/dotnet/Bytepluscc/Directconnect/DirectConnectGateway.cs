...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:directconnect/directConnectGateway:DirectConnectGateway")]
    public partial class DirectConnectGateway : global::Pulumi.CustomResource
    {
        ...
        public DirectConnectGateway(string name, DirectConnectGatewayArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/directConnectGateway:DirectConnectGateway", name, args ?? new DirectConnectGatewayArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DirectConnectGateway(string name, Input<string> id, DirectConnectGatewayState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/directConnectGateway:DirectConnectGateway", name, state, MakeResourceOptions(options, id))
        {
        }
