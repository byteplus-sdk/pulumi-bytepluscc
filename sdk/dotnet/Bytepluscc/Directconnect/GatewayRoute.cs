...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:directconnect/gatewayRoute:GatewayRoute")]
    public partial class GatewayRoute : global::Pulumi.CustomResource
    {
        ...
        public GatewayRoute(string name, GatewayRouteArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/gatewayRoute:GatewayRoute", name, args ?? new GatewayRouteArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GatewayRoute(string name, Input<string> id, GatewayRouteState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/gatewayRoute:GatewayRoute", name, state, MakeResourceOptions(options, id))
        {
        }
