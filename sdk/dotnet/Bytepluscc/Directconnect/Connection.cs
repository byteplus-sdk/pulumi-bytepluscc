...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:directconnect/connection:Connection")]
    public partial class Connection : global::Pulumi.CustomResource
    {
        ...
        public Connection(string name, ConnectionArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/connection:Connection", name, args ?? new ConnectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Connection(string name, Input<string> id, ConnectionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/connection:Connection", name, state, MakeResourceOptions(options, id))
        {
        }
