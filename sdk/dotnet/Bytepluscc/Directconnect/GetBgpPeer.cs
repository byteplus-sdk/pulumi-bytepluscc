...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    public static class GetBgpPeer
    {
        ...
        public static Task<GetBgpPeerResult> InvokeAsync(GetBgpPeerArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetBgpPeerResult>("bytepluscc:directconnect/getBgpPeer:getBgpPeer", args ?? new GetBgpPeerArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DirectConnect::BgpPeer
        /// </summary>
        public static Output<GetBgpPeerResult> Invoke(GetBgpPeerInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetBgpPeerResult>("bytepluscc:directconnect/getBgpPeer:getBgpPeer", args ?? new GetBgpPeerInvokeArgs(), options.WithDefaults());
