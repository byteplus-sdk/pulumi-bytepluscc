...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    public static class GetGatewayRoute
    {
        ...
        public static Task<GetGatewayRouteResult> InvokeAsync(GetGatewayRouteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGatewayRouteResult>("bytepluscc:directconnect/getGatewayRoute:getGatewayRoute", args ?? new GetGatewayRouteArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DirectConnect::DirectConnectGatewayRoute
        /// </summary>
        public static Output<GetGatewayRouteResult> Invoke(GetGatewayRouteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGatewayRouteResult>("bytepluscc:directconnect/getGatewayRoute:getGatewayRoute", args ?? new GetGatewayRouteInvokeArgs(), options.WithDefaults());
