...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    public static class GetVirtualInterface
    {
        ...
        public static Task<GetVirtualInterfaceResult> InvokeAsync(GetVirtualInterfaceArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetVirtualInterfaceResult>("bytepluscc:directconnect/getVirtualInterface:getVirtualInterface", args ?? new GetVirtualInterfaceArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::DirectConnect::VirtualInterface
        /// </summary>
        public static Output<GetVirtualInterfaceResult> Invoke(GetVirtualInterfaceInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetVirtualInterfaceResult>("bytepluscc:directconnect/getVirtualInterface:getVirtualInterface", args ?? new GetVirtualInterfaceInvokeArgs(), options.WithDefaults());
