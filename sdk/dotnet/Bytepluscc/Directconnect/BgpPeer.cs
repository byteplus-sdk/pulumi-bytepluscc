...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    ...
    /// {
    ///     var directConnectBgpPeerDemo = new Bytepluscc.Directconnect.BgpPeer("DirectConnectBgpPeerDemo", new()
    ///     {
    ///         AuthKey = "QWExxxx",
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:directconnect/bgpPeer:BgpPeer")]
    public partial class BgpPeer : global::Pulumi.CustomResource
    {
        ...
        public BgpPeer(string name, BgpPeerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/bgpPeer:BgpPeer", name, args ?? new BgpPeerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private BgpPeer(string name, Input<string> id, BgpPeerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/bgpPeer:BgpPeer", name, state, MakeResourceOptions(options, id))
        {
        }
