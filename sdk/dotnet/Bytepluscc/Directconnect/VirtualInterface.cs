...
namespace Byteplus.Pulumi.Bytepluscc.Directconnect
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:directconnect/virtualInterface:VirtualInterface")]
    public partial class VirtualInterface : global::Pulumi.CustomResource
    {
        ...
        public VirtualInterface(string name, VirtualInterfaceArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, args ?? new VirtualInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualInterface(string name, Input<string> id, VirtualInterfaceState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:directconnect/virtualInterface:VirtualInterface", name, state, MakeResourceOptions(options, id))
        {
        }
