...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    public static class GetFunctions
    {
        ...
        public static Task<GetFunctionsResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetFunctionsResult>("bytepluscc:vefaas/getFunctions:getFunctions", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::VEFAAS::Function
        /// </summary>
        public static Output<GetFunctionsResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetFunctionsResult>("bytepluscc:vefaas/getFunctions:getFunctions", InvokeArgs.Empty, options.WithDefaults());
