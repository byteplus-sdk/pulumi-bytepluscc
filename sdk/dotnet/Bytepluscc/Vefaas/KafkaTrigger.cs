...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger")]
    public partial class KafkaTrigger : global::Pulumi.CustomResource
    {
        ...
        public KafkaTrigger(string name, KafkaTriggerArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, args ?? new KafkaTriggerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KafkaTrigger(string name, Input<string> id, KafkaTriggerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/kafkaTrigger:KafkaTrigger", name, state, MakeResourceOptions(options, id))
        {
        }
