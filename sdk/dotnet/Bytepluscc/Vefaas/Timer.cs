...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vefaas/timer:Timer")]
    public partial class Timer : global::Pulumi.CustomResource
    {
        ...
        public Timer(string name, TimerArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/timer:Timer", name, args ?? new TimerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Timer(string name, Input<string> id, TimerState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/timer:Timer", name, state, MakeResourceOptions(options, id))
        {
        }
