...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    public static class GetRelease
    {
        ...
        public static Task<GetReleaseResult> InvokeAsync(GetReleaseArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetReleaseResult>("bytepluscc:vefaas/getRelease:getRelease", args ?? new GetReleaseArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::VEFAAS::Release
        /// </summary>
        public static Output<GetReleaseResult> Invoke(GetReleaseInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetReleaseResult>("bytepluscc:vefaas/getRelease:getRelease", args ?? new GetReleaseInvokeArgs(), options.WithDefaults());
