...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    ...
    /// {
    ///     var vEFAASReleaseDemo = new Bytepluscc.Vefaas.Release("VEFAASReleaseDemo", new()
    ///     {
    ///         FunctionId = "xxxxxxxx",
    ///         RevisionNumber = 0,
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vefaas/release:Release")]
    public partial class Release : global::Pulumi.CustomResource
    {
        ...
        public Release(string name, ReleaseArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/release:Release", name, args ?? new ReleaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Release(string name, Input<string> id, ReleaseState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/release:Release", name, state, MakeResourceOptions(options, id))
        {
        }
