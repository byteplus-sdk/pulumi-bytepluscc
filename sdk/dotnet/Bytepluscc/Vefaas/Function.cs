...
namespace Byteplus.Pulumi.Bytepluscc.Vefaas
{
    ...
    /// {
    ///     var vefaasFunctionDemo = new Bytepluscc.Vefaas.Function("VefaasFunctionDemo", new()
    ///     {
    ...
    ///         RequestTimeout = 30,
    ///         Port = 8000,
    ///         VpcConfig = new Bytepluscc.Vefaas.Inputs.FunctionVpcConfigArgs
    ///         {
    ///             Enable_vpc = true,
    ...
    ///         EnableApmplus = false,
    ///         ProjectName = "default",
    ///         NasStorage = new Bytepluscc.Vefaas.Inputs.FunctionNasStorageArgs
    ///         {
    ///             Enable_nas = true,
    ///             Nas_configs = new[]
    ///             {
    ...
    ///             },
    ///         },
    ///         TosMountConfig = new Bytepluscc.Vefaas.Inputs.FunctionTosMountConfigArgs
    ///         {
    ///             Enable_tos = true,
    ///             Credentials = new Bytepluscc.Vefaas.Inputs.FunctionTosMountConfigCredentialsArgs
    ///             {
    ///                 AccessKeyId = "AK**************",
    ///                 SecretAccessKey = "*****************==",
    ///             },
    ...
    ///         Envs = new[]
    ///         {
    ///             new Bytepluscc.Vefaas.Inputs.FunctionEnvArgs
    ///             {
    ///                 Key = "env",
    ///                 Value = "test",
    ///             },
    ///         },
    ///         AsyncTaskConfig = new Bytepluscc.Vefaas.Inputs.FunctionAsyncTaskConfigArgs
    ///         {
    ...
    ///         TlsConfig = new Bytepluscc.Vefaas.Inputs.FunctionTlsConfigArgs
    ///         {
    ///             Enable_log = true,
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:vefaas/function:Function")]
    public partial class Function : global::Pulumi.CustomResource
    {
        ...
        public Function(string name, FunctionArgs? args = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/function:Function", name, args ?? new FunctionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Function(string name, Input<string> id, FunctionState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:vefaas/function:Function", name, state, MakeResourceOptions(options, id))
        {
        }
