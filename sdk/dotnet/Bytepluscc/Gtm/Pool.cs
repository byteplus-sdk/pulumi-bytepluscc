...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:gtm/pool:Pool")]
    public partial class Pool : global::Pulumi.CustomResource
    {
        ...
        public Pool(string name, PoolArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/pool:Pool", name, args ?? new PoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Pool(string name, Input<string> id, PoolState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/pool:Pool", name, state, MakeResourceOptions(options, id))
        {
        }
