...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    public static class GetPool
    {
        ...
        public static Task<GetPoolResult> InvokeAsync(GetPoolArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoolResult>("bytepluscc:gtm/getPool:getPool", args ?? new GetPoolArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::GTM::Pool
        /// </summary>
        public static Output<GetPoolResult> Invoke(GetPoolInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoolResult>("bytepluscc:gtm/getPool:getPool", args ?? new GetPoolInvokeArgs(), options.WithDefaults());
