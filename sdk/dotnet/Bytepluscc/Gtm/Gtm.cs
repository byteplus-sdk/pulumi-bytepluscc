...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    ...
    /// {
    ///     var gTMGTMDemo = new Bytepluscc.Gtm.Gtm("GTMGTMDemo", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:gtm/gtm:Gtm")]
    public partial class Gtm : global::Pulumi.CustomResource
    {
        ...
        public Gtm(string name, GtmArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/gtm:Gtm", name, args ?? new GtmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Gtm(string name, Input<string> id, GtmState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/gtm:Gtm", name, state, MakeResourceOptions(options, id))
        {
        }
