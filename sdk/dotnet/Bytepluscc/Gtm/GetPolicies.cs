...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    public static class GetPolicies
    {
        ...
        public static Task<GetPoliciesResult> InvokeAsync(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetPoliciesResult>("bytepluscc:gtm/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());

        /// <summary>
        /// Plural Data Source schema for Byteplus::GTM::Policy
        /// </summary>
        public static Output<GetPoliciesResult> Invoke(InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetPoliciesResult>("bytepluscc:gtm/getPolicies:getPolicies", InvokeArgs.Empty, options.WithDefaults());
