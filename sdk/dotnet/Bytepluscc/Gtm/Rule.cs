...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    ...
    ///         PoolSets = new[]
    ///         {
    ///             new Bytepluscc.Gtm.Inputs.RulePoolSetArgs
    ///             {
    ///                 Name = "主地址池集",
    ///                 Active_addr_thr = 1,
    ///                 Pools = new[]
    ///                 {
    ///                     new Bytepluscc.Gtm.Inputs.RulePoolSetPoolArgs
    ///                     {
    ...
    ///             },
    ///         },
    ///         Probe = new Bytepluscc.Gtm.Inputs.RuleProbeArgs
    ///         {
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:gtm/rule:Rule")]
    public partial class Rule : global::Pulumi.CustomResource
    {
        ...
        public Rule(string name, RuleArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/rule:Rule", name, args ?? new RuleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Rule(string name, Input<string> id, RuleState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/rule:Rule", name, state, MakeResourceOptions(options, id))
        {
        }
