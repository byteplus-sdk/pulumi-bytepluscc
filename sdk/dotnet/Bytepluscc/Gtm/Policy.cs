...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:gtm/policy:Policy")]
    public partial class Policy : global::Pulumi.CustomResource
    {
        ...
        public Policy(string name, PolicyArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/policy:Policy", name, args ?? new PolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Policy(string name, Input<string> id, PolicyState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:gtm/policy:Policy", name, state, MakeResourceOptions(options, id))
        {
        }
