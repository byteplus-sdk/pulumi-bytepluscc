...
namespace Byteplus.Pulumi.Bytepluscc.Gtm
{
    public static class GetGtm
    {
        ...
        public static Task<GetGtmResult> InvokeAsync(GetGtmArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetGtmResult>("bytepluscc:gtm/getGtm:getGtm", args ?? new GetGtmArgs(), options.WithDefaults());

        /// <summary>
        /// Data Source schema for Byteplus::GTM::GTM
        /// </summary>
        public static Output<GetGtmResult> Invoke(GetGtmInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetGtmResult>("bytepluscc:gtm/getGtm:getGtm", args ?? new GetGtmInvokeArgs(), options.WithDefaults());
