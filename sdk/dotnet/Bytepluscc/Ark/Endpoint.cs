...
namespace Byteplus.Pulumi.Bytepluscc.Ark
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:ark/endpoint:Endpoint")]
    public partial class Endpoint : global::Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:ark/endpoint:Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, EndpointState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:ark/endpoint:Endpoint", name, state, MakeResourceOptions(options, id))
        {
        }
