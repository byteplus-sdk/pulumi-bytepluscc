...
namespace Byteplus.Pulumi.Bytepluscc.Natgateway
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:natgateway/natIp:NatIp")]
    public partial class NatIp : global::Pulumi.CustomResource
    {
        ...
        public NatIp(string name, NatIpArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/natIp:NatIp", name, args ?? new NatIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private NatIp(string name, Input<string> id, NatIpState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/natIp:NatIp", name, state, MakeResourceOptions(options, id))
        {
        }
