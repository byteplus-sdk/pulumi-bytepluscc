...
namespace Byteplus.Pulumi.Bytepluscc.Natgateway
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:natgateway/ngw:Ngw")]
    public partial class Ngw : global::Pulumi.CustomResource
    {
        ...
        public Ngw(string name, NgwArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/ngw:Ngw", name, args ?? new NgwArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ngw(string name, Input<string> id, NgwState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/ngw:Ngw", name, state, MakeResourceOptions(options, id))
        {
        }
