...
namespace Byteplus.Pulumi.Bytepluscc.Natgateway
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:natgateway/dnatentry:Dnatentry")]
    public partial class Dnatentry : global::Pulumi.CustomResource
    {
        ...
        public Dnatentry(string name, DnatentryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/dnatentry:Dnatentry", name, args ?? new DnatentryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Dnatentry(string name, Input<string> id, DnatentryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/dnatentry:Dnatentry", name, state, MakeResourceOptions(options, id))
        {
        }
