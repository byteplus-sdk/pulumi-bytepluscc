...
namespace Byteplus.Pulumi.Bytepluscc.Natgateway
{
    ...
    /// ```
    /// </summary>
    [ByteplusccResourceType("bytepluscc:natgateway/snatentry:Snatentry")]
    public partial class Snatentry : global::Pulumi.CustomResource
    {
        ...
        public Snatentry(string name, SnatentryArgs args, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/snatentry:Snatentry", name, args ?? new SnatentryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Snatentry(string name, Input<string> id, SnatentryState? state = null, CustomResourceOptions? options = null)
            : base("bytepluscc:natgateway/snatentry:Snatentry", name, state, MakeResourceOptions(options, id))
        {
        }
