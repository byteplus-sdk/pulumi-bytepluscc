...
namespace Byteplus.Pulumi.Bytepluscc
{
    public static class Config
    {
        ...
        private static readonly global::Pulumi.Config __config = new global::Pulumi.Config("bytepluscc");

        private static readonly __Value<string?> _accessKey = new __Value<string?>(() => __config.Get("accessKey") ?? Utilities.GetEnv("BYTEPLUS_ACCESS_KEY"));
        /// <summary>
        ...
        private static readonly __Value<string?> _customerHeaders = new __Value<string?>(() => __config.Get("customerHeaders") ?? Utilities.GetEnv("BYTEPLUS_CUSTOMER_HEADERS"));
        /// <summary>
        ...
        private static readonly __Value<bool?> _disableSsl = new __Value<bool?>(() => __config.GetBoolean("disableSsl") ?? Utilities.GetEnvBoolean("BYTEPLUS_DISABLE_SSL"));
        /// <summary>
        ...
        private static readonly __Value<string?> _secretKey = new __Value<string?>(() => __config.Get("secretKey") ?? Utilities.GetEnv("BYTEPLUS_SECRET_KEY"));
        /// <summary>
