...
namespace Byteplus.Pulumi.Bytepluscc
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/byteplus-sdk";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Byteplus.Pulumi.Bytepluscc.version.txt");
    ...
    internal sealed class ByteplusccResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ByteplusccResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
